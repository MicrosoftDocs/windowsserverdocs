...
You can use this procedure to install the BranchCache feature and start the BranchCache service on a computer running [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)].
