...
The operating system on any particular server is very likely unaware of its physical circumstance. In general, two Windows Server instances may not be able to tell whether they are adjacent or hundreds of miles apart. In [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], it is possible to make this distinction by specifying the arrangement of your hardware across several levels of fault domains.  
