...
> [!Note]  
> **The current Semi-Annual Channel release is Windows Server, version 1809**. If you want to put servers in this channel, you should install Windows Server, version 1809, which can be installed in Server Core mode or as Nano Server run in a container. In-place upgrades from Windows Server 2016 to Windows Server, version 1809 are not supported because they are in **different release channels**. Windows Server, version 1809 is not an update to Windows Server 2016 – it is the next Windows Server release in the Semi-Annual Channel.
