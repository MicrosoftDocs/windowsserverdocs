...
-   Client requirements:  
    ...
    -   A client computer must be running [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)], Windows 8, or Windows 7.  
  
        > [!NOTE]  
        > The following operating systems can be used as DirectAccess clients: [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)],[!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], Windows 8 Enterprise, Windows 7 Enterprise, or Windows 7 Ultimate.  
