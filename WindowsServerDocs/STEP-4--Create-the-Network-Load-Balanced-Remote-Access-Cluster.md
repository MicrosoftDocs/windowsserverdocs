...
1.  On EDGE1, in the [!INCLUDE[sm](includes/sm_md.md)] console, in the **Dashboard**, click **Add roles and features**.  
...
1.  On EDGE1, click **Start**, type **RAMgmtUI.exe**, and then press ENTER. [!INCLUDE[uac_confirm_action](includes/uac_confirm_action_md.md)]  
...
9. [!INCLUDE[clickstart](includes/clickstart_md.md)]**nlbmgr.exe**, and the press ENTER. [!INCLUDE[uac_confirm_action](includes/uac_confirm_action_md.md)]  
