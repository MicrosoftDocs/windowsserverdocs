...
Cloud Witness is a new type of Failover Cluster quorum witness that uses Microsoft Azure as the arbitration point (figure 2). It uses Azure Blob Storage to read/write a blob file, which is then used as an arbitration point in case of a split-brain resolution.
