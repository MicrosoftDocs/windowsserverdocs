...
You can configure Cloud Witness using [`Set-ClusterQuorum`](https://docs.microsoft.com/powershell/module/failoverclusters/set-clusterquorum) with the following PowerShell command:
