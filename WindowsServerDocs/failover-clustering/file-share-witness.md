...
1. Select **Select a principal**, then enter the name or locate the Cluster Name Object (CNO) for the cluster or suitable Active Directory group containing the CNO. Select **OK**.
