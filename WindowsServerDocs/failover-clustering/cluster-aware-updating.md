...
2. Puts each node of the cluster into node maintenance mode if a restart is required.
3. Moves the clustered roles off the node if put into maintenance mode.
