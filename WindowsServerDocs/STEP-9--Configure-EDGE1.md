...
1.  In the [!INCLUDE[sm](includes/sm_md.md)] console, click **Local Server**, and then in the **Properties** area, next to **Corpnet**, click the link.
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**cmd.exe**, right\-click **cmd**, click **Advanced**, and then click **Run as administrator**. [!INCLUDE[uac_confirm_action](includes/uac_confirm_action_md.md)]
