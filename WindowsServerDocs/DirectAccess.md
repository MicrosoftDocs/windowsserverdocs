...
---
# DirectAccess
You can use this topic for a brief overview of DirectAccess, including the server and client operating systems that support DirectAccess, as well as for links to additional DirectAccess documentation for [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)].  
...
-   You can deploy all versions of [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)] as a DirectAccess client or a DirectAccess server.  
  
-   You can deploy all versions of [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)] as a DirectAccess client or a DirectAccess server.  
  
-   You can deploy all versions of [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)] as a DirectAccess client or a DirectAccess server.  
...
-   [!INCLUDE[winthreshold_client_1](includes/winthreshold_client_1_md.md)] Enterprise  
  
-   [!INCLUDE[winthreshold_client_1](includes/winthreshold_client_1_md.md)] Enterprise 2015 Long Term Servicing Branch \(LTSB\)  
