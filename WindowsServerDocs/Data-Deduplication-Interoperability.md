...
## Single Instance Storage  
Volumes that have been created and optimized by using the Windows Storage Server version of deduplication, Single Instance Storage \(SIS\), must not also run Data Deduplication. We recommend that prior to migrating a volume to [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], you remove SIS from the volume by using SISAdmin.exe within Windows Storage Server or by copying the data to a different volume that is not running SIS. [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] and [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] support reading and writing to SIS\-controlled volumes, but you cannot continue to use SIS by using [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]. You can use the following command syntax to install the SIS\-Limited feature \(which includes the SIS filter driver\) on [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]:  
...
You can use the following command syntax to install the SIS\-Limited feature \(which includes the SIS filter driver\) on [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]:  
...
> [!NOTE]  
> [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] and [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] do not support sisadmin.exe and cannot be used to remove SIS from a volume.  
...
3.  Restoring SIS volumes to [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] is supported if you load the SIS\-Limited feature.  
  
### Migrating SIS volumes  
You have several options when it comes to migrating Windows Storage Server 2008 volumes to [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] to take advantage of the Data Deduplication feature.  
...
You need to first open the volumes in Windows Storage Server 2008, remove SIS from the volumes, and then uninstall SIS before migrating to [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)].  
