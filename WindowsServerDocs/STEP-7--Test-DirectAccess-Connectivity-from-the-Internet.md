...
2.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**powershell.exe**, right\-click **powershell**, click **Advanced**, and then click **Run as administrator**. [!INCLUDE[uac_confirm_action](includes/uac_confirm_action_md.md)]

3.  In the [!INCLUDE[wps_2](includes/wps_2_md.md)] window, type **gpupdate \/force** and press ENTER.
...
6.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**RSA**, and click **RSA SecurID Token**.
...
14. [!INCLUDE[clickstart](includes/clickstart_md.md)]**\\\\app1\\files**, and press ENTER.

15. In the **Files** shared folder window, double\-click the **Example.txt** file. You will see the contents of the Example.txt file.

16. [!INCLUDE[clickstart](includes/clickstart_md.md)]**\\\\app2\\files**, and press ENTER.
