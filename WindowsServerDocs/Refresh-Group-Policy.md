...
1.  On the computer where NPS is installed, open [!INCLUDE[wps_1](includes/wps_1_md.md)] by using the icon on the taskbar.  
  
2.  At the [!INCLUDE[wps_2](includes/wps_2_md.md)] prompt, type **gpupdate**, and then press ENTER.  
