...
For detailed instructions on configuring the look and feel of the AD FS sign-in pages, see [Customizing the AD FS Sign-in Pages](../operations/ad-fs-customization-in-windows-server.md).
