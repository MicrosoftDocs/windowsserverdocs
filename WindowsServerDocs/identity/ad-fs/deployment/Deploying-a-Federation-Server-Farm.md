...
||Task|Reference|  
|-|--------|-------------|  
|![](media/icon_checkboxo.gif)|Review important concepts and considerations as you prepare to deploy Active Directory Federation Services \(AD FS\). **Note:**|![](media/faa393df-4856-4431-9eda-4f4e5be72a90.gif)[AD FS Design Guide in Windows Server 2012 R2](AD-FS-Design-Guide-in-Windows-Server-2012-R2.md)<br /><br />![](media/faa393df-4856-4431-9eda-4f4e5be72a90.gif)[Understanding Key AD FS Concepts](Understanding-Key-AD-FS-Concepts.md)|  
...
|![](media/icon_checkboxo.gif)|Join your computer to an Active Directory domain.|![](media/faa393df-4856-4431-9eda-4f4e5be72a90.gif)[Join a Computer to a Domain_1](Join-a-Computer-to-a-Domain_1.md)|  
