...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: c575cc74-9d3f-49d2-a74a-fb289155ea81
author: billmath
---
...
If the refresh token is within <SSO_period>, the request will result in a new access token. The user is not prompted for credentials.  For more information on SSO settings see [AD FS Single Sign On Settings](../../ad-fs/manage/ops/../../ad-fs/manage/ops/ad-fs-2016-single-sign-settings.md)  
