...
1.  [Walkthrough: Workplace Join with a Windows Device](../../ad-fs/get-started/walkthrough-workplace-join-with-windows-device.md)

2.  [Walkthrough: Workplace Join with an iOS Device](../../ad-fs/get-started/walkthrough-workplace-join-with-ios-device.md)
