...
-   The same benefits as listed for the [Federation Server Farm Using WID_1](../../../../ad-fs/plan/WS2012R2-guide/topology/../../../../ad-fs/plan/WS2012R2-guide/topology/federation-server-farm-using-wid.md) topology, plus the benefit of providing additional access for external users  
  
### What are the limitations of using this topology?  
  
-   The same limitations as listed for the [Federation Server Farm Using WID_1](../../../../ad-fs/plan/WS2012R2-guide/topology/../../../../ad-fs/plan/WS2012R2-guide/topology/federation-server-farm-using-wid.md) topology  
