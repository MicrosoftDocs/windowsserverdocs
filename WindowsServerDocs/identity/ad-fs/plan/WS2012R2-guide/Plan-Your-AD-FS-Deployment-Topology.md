...
A [!INCLUDE[adfs2_fsp](includes/adfs2_fsp_md.md)] should be placed in the perimeter network before you configure your firewall servers for use with [!INCLUDE[nextref_adfs2](includes/nextref_adfs2_md.md)].  
