...
-   [Best Practices for Secure Planning and Deployment of AD FS](../../../ad-fs/plan/WS2012-guide/deployment/Best-Practices-for-Secure-Planning-and-Deployment-of-AD-FS.md)  
  
-   [Planning for Interoperability with AD FS 1.x](../../../ad-fs/plan/WS2012-guide/deployment/Planning-for-Interoperability-with-AD-FS-1.x.md)  
  
-   [When to Use Identity Delegation](../../../ad-fs/plan/WS2012-guide/deployment/When-to-Use-Identity-Delegation.md)  
