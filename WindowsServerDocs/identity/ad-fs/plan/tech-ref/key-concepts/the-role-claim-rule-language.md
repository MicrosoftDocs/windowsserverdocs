...
For more information about when to use custom rules, see [When to Use a Custom Claim Rule](../../../../ad-fs/plan/tech-ref/key-concepts/claim-rule-template/when-use-custom-claim-rule.md).
...
For more detailed information about claim rules and claim rule templates, see [The Role of Claim Rules](../../../../ad-fs/plan/tech-ref/key-concepts/the-role-claim-rules.md).
