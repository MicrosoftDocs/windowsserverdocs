...
- user_impersonation - The user_impersonation scope is necessary to successfully request an on-behalf-of access token from AD FS. For details on how to use this scope refer [Build a multi-tiered application using On-Behalf-Of (OBO) using OAuth with AD FS 2016](https://github.com/MicrosoftDocs/ad-fs/development/ad-fs-on-behalf-of-authentication-in-windows-server.md).
