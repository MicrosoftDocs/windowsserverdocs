...
|Microsoft Teams|Supported|Microsoft Teams fully supports AD FS (SAML-P, WS-Fed, WS-Trust, and OAuth) & Modern Authentication.<br/><br/> Core Microsoft Teams such as Channels, chats and files functionalities will work with AltIDs. </br></br>1st and 3rd party apps have to be separately investigated  by the customer. This is because each app has their own supportability authentication protocols.| 
