...
:::image type="content" source="media/Configure-AD-FS-2016-and-Azure-MFA/ADFS-Azure-MFA5.png" alt-text="Screenshot of the PowerShell window showing the warning message received after running the Set-AdfsAzureMfaTenant cmdlet.":::
