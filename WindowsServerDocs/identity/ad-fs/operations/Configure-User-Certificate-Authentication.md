...
7) When using a SmartCard/Certificate based authentication, the subject on the certificate might not match the UserPricipalName on the AD account. In this case the sign-in fails with “user not found”.
