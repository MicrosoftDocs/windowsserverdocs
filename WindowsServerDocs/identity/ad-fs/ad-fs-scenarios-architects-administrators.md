...
For more information see [Configure AD FS and Azure MFA.](../ad-fs/manage/ops/configure-ad-fs-2016-azure-mfa.md)
...
* [Access Control Policies in AD FS](../ad-fs/manage/ops/../ad-fs/manage/ops/access-control-policies-ad-fs.md)
...
For more information see [Configure AD FS as a certificate issuing authority.](../ad-fs/configure-ad-fs-as-certificate-issuing-authority.md)
...
For more information see [AD FS and Microsoft Passport for Work in Windows 10 on-premises](../ad-fs/ad-fs-microsoft-passport-work-windows-10-onpremises.md)
...
For more information see [Configure AD FS to authenticate users stored in LDAP directories.](../ad-fs/manage/ops/configure-ad-fs-authenticate-users-stored-ldap-directories.md)
...
For more information see [Auditing enhancemenet to AD FS in Windows Server 2016.](../ad-fs/manage/ops/auditing-enhancements-ad-fs-windows-server-2016.md)
...
For more information see [Configure AD FS to send password expiry claims.](../ad-fs/manage/ops/configure-ad-fs-send-password-expiry-claims.md)
...
For more information see [Access control policies in AD FS.](../ad-fs/manage/ops/../ad-fs/manage/ops/access-control-policies-ad-fs.md)
...
For more information see [Upgrading to AD FS in Windows Server 2016.](../ad-fs/get-started/upgrading-to-WS2016/upgrading-ad-fs-windows-server-2016.md)
