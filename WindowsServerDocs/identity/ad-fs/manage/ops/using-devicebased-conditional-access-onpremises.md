...
For more information on configuring AD FS access control policies, see [Access control policies in AD FS](../../../ad-fs/manage/ops/access-control-policies-ad-fs.md).  
...
2.  Or [migrate](../../../ad-fs/get-started/upgrading-to-WS2016/upgrading-ad-fs-windows-server-2016.md) a farm to AD FS 2016 from AD FS 2012 R2  
