...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 85178fbe-3a70-4e1a-850d-c67ceed5f26f
author: Femila
---
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-stagedcreation.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-stageddeploy-beta1.png)  
...
## Staging  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-precreaterodc.png)  
...
### Welcome  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-welcomestage1.png)  
...
### Network Credentials  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1creds.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcprepnotrunerror.png)  
  
### Specify the Computer Name  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1compname.png)  
...
### Select a Site  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1site.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1dcoptions.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1prp.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1prpAllow.png)  
  
### Delegation of RODC Installation and Administration  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1delegateadmin.png)  
...
### Summary  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1summary.png)  
...
### Creation  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1installprogress.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage1complete.png)  
...
See [Stage RODC Windows PowerShell](../../../active-directory-domain-services/deploy/RODC/../../../active-directory-domain-services/deploy/RODC/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200.md#BKMK_StagePS) for required and optional arguments.  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psaddrodc.png)  
  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psaddrodcValidating.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-unoccupied.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcdeployconfig.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2dcoptions.png)  
...
### Additional Options  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2additionaloptions.png)  
...
### Paths  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2paths.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2reviewoptions.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2whatif.png)  
  
### Prerequisites Check  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2prereqcheck.png)  
...
The **Prerequisites Check** also surfaces relevant information such as security changes that affect older operating systems. For more information about the prerequisite checks, see [Prerequisite Checking](../../../active-directory-domain-services/manage/ad-ds-simplified-administration.md#BKMK_PrereuisiteChecking).  
...
### Installation  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-stage2installation.png)  
...
See [Attach RODC Windows PowerShell](../../../active-directory-domain-services/deploy/RODC/../../../active-directory-domain-services/deploy/RODC/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200.md#BKMK_AttachPS) for required and optional arguments.  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psstage2.png)  
  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psstage2Complete.png)  
...
### Results  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-forestsignoff.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-rodcdeploy.png)  
...
### Domain Controller Options  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcdcoptions.png)  
...
### RODC Options  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcoptions.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-selectdeladmin.png)  
  
### Additional Options  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcadditionaloptions.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psifm.png)  
...
### Paths  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcpaths.png)  
...
### Preparation Options  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcprepoptions.png)  
...
### Review Options and View Script  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcreviewoptions.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcwhatif.png)  
  
### Prerequisites Check  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcprereqcheck.png)  
...
### Installation  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcinstallation.png)  
...
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psinstallrodc.png)  
  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-psinstallrodcProgress.png)  
...
### Results  
![](../../../media/install-windows-server-2012-active-directory-readonly-domain-controller-rodc-level-200/adds-smi-tr-rodcsignoff.png)  
