...
-   [Child and Tree Domain Workflow](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-child-tree-domain-level-200.md#BKMK_Workflow)  
  
-   [Child and Tree Domain Windows PowerShell](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-child-tree-domain-level-200.md#BKMK_PS)  
  
-   [Deployment](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-child-tree-domain-level-200.md#BKMK_Deployment)  
...
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-childtreedeploy-beta1.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childdeployconfig.png)  
  
The following screenshot shows the options for adding a tree domain:  
  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-treedeployconfig.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-dcoptions-child.gif)  
...
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childdnsoptions.png)  
...
### Additional Options  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childadditionaloptions.png)  
...
### Paths  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-upgradepaths.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childreviewoptions.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childwhatif.png)  
  
### Prerequisites Check  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childprereqcheck.png)  
...
### Installation  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-childinstallation.png)  
...
See [Child and Tree Domain Windows PowerShell](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-child-tree-domain-level-200.md#BKMK_PS) for required and optional arguments.The **Install\-addsdomain** cmdlet only has two phases \(prerequisite checking and installation\). The two figures below show the installation phase with the minimum required arguments of **\-domaintype**, **\-newdomainname**, **\-parentdomainname**, and **\-credential**. Note how, just like Server Manager, **Install\-ADDSDomain** reminds you that promotion will reboot the server automatically.  
  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-psinstalladdsdomain.png)  
  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-psinstalladdsdomainProgress.png)  
...
### Results  
![](../../media/install-new-windows-server-2012-active-directory-child-tree-domain-level-200/adds-smi-tr-forestsignoff.png)  
