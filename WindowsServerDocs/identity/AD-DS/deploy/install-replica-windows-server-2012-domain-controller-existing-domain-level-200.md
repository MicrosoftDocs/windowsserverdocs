...
-   [Upgrade and Replica Workflow](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-replica-windows-server-2012-domain-controller-existing-domain-level-200.md#BKMK_Workflow)  
  
-   [Upgrade and Replica Windows PowerShell](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-replica-windows-server-2012-domain-controller-existing-domain-level-200.md#BKMK_PS)  
  
-   [Deployment](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-replica-windows-server-2012-domain-controller-existing-domain-level-200.md#BKMK_Dep)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-forestupgrade.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradedeployconfig.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradecreds.png)  
  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradeselectdomain.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradefflerror.png)  
  
### Domain Controller Options  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradedcoptions.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradedcoptionsError.png)  
  
### DNS Options and DNS Delegation Credentials  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradednsoptions.png)  
...
### Additional Options  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradeadditionaloptions.png)  
...
### Paths  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradepaths.png)  
...
### Preparation Options  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradeprepoptions.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradeprepoptionsCreds.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradereviewoptions.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-pswhatif.png)  
  
### Prerequisites Check  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradeprereqcheck.png)  
...
For more information about the specific prerequisite checks, see [Prerequisite Checking](../../active-directory-domain-services/manage/ad-ds-simplified-administration.md#BKMK_PrereuisiteChecking).  
...
### Installation  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-upgradeinstallprogress.png)  
...
See [Upgrade and Replica Windows PowerShell](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-replica-windows-server-2012-domain-controller-existing-domain-level-200.md#BKMK_PS) for required and optional arguments.  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-psgetcred.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-psupgradeconfirm.gif)  
  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-psupgradeprogress.png)  
...
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-psupgradeexample.gif)  
  
> [!NOTE]  
> For more information on how the installation and Adprep process works, see the [Troubleshooting Domain Controller Deployment](../../active-directory-domain-services/deploy/troubleshooting-domain-controller-deployment.md).  
  
### Results  
![](../../media/install-replica-windows-server-2012-domain-controller-existing-domain-level-200/adds-smi-tr-forestsignoff.png)  
