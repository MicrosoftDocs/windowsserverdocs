...
-   [AD DS Removal Workflow](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/demoting-domain-controllers-domains-level-200.md#BKMK_Workflow)  
  
-   [Demotion and Role Removal Windows PowerShell](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/demoting-domain-controllers-domains-level-200.md#BKMK_PS)  
  
-   [Demote](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/demoting-domain-controllers-domains-level-200.md#BKMK_Demote)  
  
## <a name="BKMK_Workflow"></a>AD DS Removal Workflow  
![](../../media/demoting-domain-controllers-domains-level-200/adds-demotedomainforest.png)  
...
## <a name="BKMK_PS"></a>Demotion and Role Removal Windows PowerShell  
...
-   The **Manage** menu on the main dashboard, using **Remove Roles and Features**  
    ...
    ![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-manage.png)  
...
-   Click **AD DS** or **All Servers** on the navigation pane. Scroll down to the **Roles and Features** section. Right\-click **Active Directory Domain Services** in the **Roles and Features** list and click **Remove Role or Feature**. This interface skips the **Server Selection** page.  
    ...
    ![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-serverselection.png)  
...
### Server Selection  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-serverselection2.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-serverroles.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-removefeatures.png)  
  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-demote.png)  
  
### Credentials  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-credentials.png)  
...
-   Demoting an additional domain controller requires Domain Admin credentials. Selecting **Force removal of the domain controller** demotes the domain controller without removing the domain controller object’s metadata from Active Directory.  
    ...
    ![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-forcedemote.png)  
...
### Warnings  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-warnings.png)  
...
### Removal Options  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-reviewoptions.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-newadminpwd.png)  
...
### Confirmation  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-confirmation.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstall.png)  
...
### Demotion  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-demotion.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstallConfirm.png)  
  
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstallWindowsFeature.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstallFinished.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstallExampleForce.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstallExampleLastDC.png)  
...
![](../../media/demoting-domain-controllers-domains-level-200/adds-psuninstallError.png)  
  
> [!IMPORTANT]  
> You must restart the computer after demoting the server before you can remove the AD\-Domain\-Services role binaries.  
  
### Results  
![](../../media/demoting-domain-controllers-domains-level-200/adds-rrw-tr-demoteSignoff.png)  
