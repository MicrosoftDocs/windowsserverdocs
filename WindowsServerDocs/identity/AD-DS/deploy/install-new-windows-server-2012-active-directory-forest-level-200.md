...
-   [Active Directory Domain Services Simplified Administration](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-forest-level-200.md#BKMK_SimplifiedAdmin)  
  
-   [Technical Overview](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-forest-level-200.md#BKMK_TechOverview)  
  
-   [Deploying a Forest with Server Manager](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-forest-level-200.md#BKMK_SMForest)  
  
-   [Deploying a Forest with Windows PowerShell](../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/../../active-directory-domain-services/deploy/install-new-windows-server-2012-active-directory-forest-level-200.md#BKMK_PSForest)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-selectserverroles.gif)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psaddwindowsfeature.png)  
  
#### AD DS Role Configuration  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-deploymentconfiguration-forest.gif)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psinstalladdsForest.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-servermanagerdeployment.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-addservers.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/tadds-smi-tr-addrolesfeatures.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-addaddstoanotherserver.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-manageaddroles.png)  
  
#### Installation Type  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-selectinstallationtype.png)  
...
#### Server Selection  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-selectdestinationserver.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-selectserverroles.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-addfeaturesdialog.gif)  
  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-selectfeatures.png)  
  
Additional **Features** can be added here as desired.  
  
#### Active Directory Domain Services  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-addsintro.png)  
...
#### Confirmation  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-confirmation.png)  
...
#### Results  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-results.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-tasknotofications.png)  
  
**AD DS Details**  
  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-addsdetails.png)  
  
**Task Details**  
  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-taskdetails.png)  
  
#### Promote to Domain Controller  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-promote.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-forestdeploy2.png)  
  
#### Deployment Configuration  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-addnewforest.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestdnsoptions.png)  
...
#### Additional Options  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestadditionaloptions.png)  
...
#### Paths  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestpaths.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestreviewoptions.png)  
...
#### Prerequisites Check  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestprereqcheck.png)  
...
For more information on the specific prerequisite checks, see [Prerequisite Checking](../../active-directory-domain-services/manage/ad-ds-simplified-administration.md#BKMK_PrereuisiteChecking).  
  
#### Installation  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestinstallation.png)  
...
#### Results  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-smi-tr-forestsignoff.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-servermanagerdeployment_powershell.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psgetcommand.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psinstallwinfeature.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psgetwindowsfeature.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psinstalladds.png)  
  
Note how using the **Select\-Object** cmdlet with the **\-expandproperty** argument returns interesting data:  
  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psinstalladdsWithTools.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-pspaths.png)  
...
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psreboot.png)  
  
![](../../media/install-new-windows-server-2012-active-directory-forest-level-200/adds-psinstallprogress.png)  
