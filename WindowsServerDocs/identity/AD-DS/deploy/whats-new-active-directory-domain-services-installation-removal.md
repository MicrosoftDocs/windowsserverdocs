...
This section lists some of the known issues that affect AD DS installation in  Windows Server 2012 . For additional known issues, see [Troubleshooting Domain Controller Deployment](../../active-directory-domain-services/deploy/troubleshooting-domain-controller-deployment.md).  
