...
For more information, see [Virtualized domain controller safe restore architecture](../active-directory-domain-services/../active-directory-domain-services/get-started/virtual-dc/virtualized-domain-controller-architecture.md#BKMK_SafeRestoreArch).
...
For more information, see [Virtualized domain controller cloning architecture](../active-directory-domain-services/../active-directory-domain-services/get-started/virtual-dc/virtualized-domain-controller-architecture.md#BKMK_CloneArch).
...
> [!NOTE]
> A global catalog server \(GC\) is required for the New\-ADDCCloneConfigFile cmdlet to work successfully. The source domain controller’s membership in the **Cloneable Domain Controllers** group must be reflected on the GC. The GC does not need to be the same domain controller as the PDC emulator, but preferably it should be in the same site. If a GC is not available, the command fails with the error “The server is not operational.” For more information, see [Virtualized Domain Controller Troubleshooting](../active-directory-domain-services/../active-directory-domain-services/manage/virtual-dc/virtualized-domain-controller-troubleshooting.md).
...
For more troubleshooting information about virtualized domain controllers, see [Virtualized Domain Controller Troubleshooting](../active-directory-domain-services/../active-directory-domain-services/manage/virtual-dc/virtualized-domain-controller-troubleshooting.md).
