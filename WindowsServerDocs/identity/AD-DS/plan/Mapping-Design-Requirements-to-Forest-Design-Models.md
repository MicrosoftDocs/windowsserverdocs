...
For more information about using organizational domains, see [Using the Organizational Domain Forest Model](../../active-directory-domain-services/plan/../../active-directory-domain-services/plan/Using-the-Organizational-Domain-Forest-Model.md).  
