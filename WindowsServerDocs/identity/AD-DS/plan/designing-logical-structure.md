...
-   [Understanding the Active Directory Logical Model](../../active-directory-domain-services/plan/understanding-active-directory-logical-model.md)  
  
-   [Identifying the Deployment Project Participants](../../active-directory-domain-services/plan/identifying-deployment-project-participants.md)  
  
-   [Creating a Forest Design](../../active-directory-domain-services/plan/creating-forest-design.md)  
  
-   [Creating a Domain Design](../../active-directory-domain-services/plan/creating-domain-design.md)  
  
-   [Creating a DNS Infrastructure Design](../../active-directory-domain-services/plan/creating-dns-infrastructure-design.md)  
  
-   [Creating an Organizational Unit Design](../../active-directory-domain-services/plan/creating-organizational-unit-design.md)  
  
-   [Appendix A: DNS Inventory](../../active-directory-domain-services/plan/appendix-dns-inventory.md)  
