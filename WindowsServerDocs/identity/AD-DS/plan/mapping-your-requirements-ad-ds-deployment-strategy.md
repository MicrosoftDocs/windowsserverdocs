...
-   [Deploying AD DS in a New Organization](../../active-directory-domain-services/plan/deploying-ad-ds-new-organization.md)  
  
-   [Deploying AD DS in a Windows Server 2003 Organization](../../active-directory-domain-services/plan/deploying-ad-ds-windows-server-2003-organization.md)  
  
-   [Deploying AD DS in a Windows 2000 Organization](../../active-directory-domain-services/plan/deploying-ad-ds-windows-2000-organization.md)  
...
|--------------------------------------------|-----------------------------------------|---------------------------------------------------------|--------------------------------------------------|  
|[Designing the Logical Structure for Windows Server 2008 AD DS](designing-logical-structure-for-Windows-Server-2008-AD-DS.md)|Yes|Yes|Yes|  
|[Designing the Site Topology for Windows Server 2008 AD DS](designing-site-topology-for-Windows-Server-2008-AD-DS.md)|Yes|Yes|Yes|  
