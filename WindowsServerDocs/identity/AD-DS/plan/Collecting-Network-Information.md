...
> [!NOTE]  
> In addition to IP version 4 \(IPv4\) addresses,  Windows Server 2008  also supports IP version 6 \(IPv6\) subnet prefixes. For a worksheet to assist you in listing the IPv6 subnet prefixes, see [Appendix A: Locations and Subnet Prefixes](../../active-directory-domain-services/plan/appendix-locations-subnet-prefixes.md).  
