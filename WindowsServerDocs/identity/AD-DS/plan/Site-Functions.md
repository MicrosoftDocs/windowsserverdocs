...
---
# Site Functions
[!INCLUDE[nextref_longhorn]()] uses site information for many purposes, including routing replication, client affinity, system volume \(SYSVOL\) replication, Distributed File System Namespaces \(DFSN\), and service location.  
