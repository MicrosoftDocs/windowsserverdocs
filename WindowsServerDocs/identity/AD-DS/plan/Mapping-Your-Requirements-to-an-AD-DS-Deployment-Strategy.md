...
-   [Deploying AD DS in a New Organization](../../active-directory-domain-services/plan/Deploying-AD-DS-in-a-New-Organization.md)  
  
-   [Deploying AD DS in a Windows Server 2003 Organization](../../active-directory-domain-services/plan/Deploying-AD-DS-in-a-Windows-Server-2003-Organization.md)  
  
-   [Deploying AD DS in a Windows 2000 Organization](../../active-directory-domain-services/plan/Deploying-AD-DS-in-a-Windows-2000-Organization.md)  
...
|[Enabling Advanced Features for AD DS](../../active-directory-domain-services/plan/Enabling-Advanced-Features-for-AD-DS.md)|Yes|Yes, but all domain controllers in the environment must run [!INCLUDE[nextref_longhorn]()] before you set the domain or forest functional level to [!INCLUDE[nextref_longhorn]()].|Yes, but all domain controllers in the environment must run [!INCLUDE[nextref_longhorn]()] before you set the domain or forest functional level to [!INCLUDE[nextref_longhorn]()].|  
|[Upgrading Active Directory Domains to Windows Server 2008 and Windows Server 2008 R2 AD DS Domains]()|No|Yes|Yes|  
