...
> [!NOTE]  
> Some of the applications listed in [Appendix J: Third-Party RBAC Vendors](../../../active-directory-domain-services/plan/security-best-practices/appendix-j-thirdparty-rbac-vendors.md) and [Appendix K: Third-Party PIM Vendors](appendix-k-thirdparty-pim-vendors.md) provide mechanisms to perform “nonmigratory” migrations, as does Microsoft Forefront Identity Manager.  
