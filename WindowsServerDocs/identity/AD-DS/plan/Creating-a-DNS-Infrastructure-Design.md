...
-   [DNS and AD DS](../../active-directory-domain-services/plan/DNS-and-AD-DS.md)  
  
-   [Assigning the DNS for AD DS Owner Role]()  
  
-   [Integrating AD DS into an Existing DNS Infrastructure](../../active-directory-domain-services/plan/../../active-directory-domain-services/plan/Integrating-AD-DS-into-an-Existing-DNS-Infrastructure.md)  
