...
-   [Protected Users](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/how-configure-protected-accounts.md#BKMK_AddtoProtectedUsers)

-   [Authentication policies](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/how-configure-protected-accounts.md#BKMK_CreateAuthNPolicies)

-   [Authentication policy silos](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/how-configure-protected-accounts.md#BKMK_CreateAuthNPolicySilos)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-tgtexpiration.png)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-tshootdelegation.gif)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-kerbrefresher.gif)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-restrictas.gif)
...
1.  In the Default Domain Controllers Policy, click **Enabled** to enable **Key Distribution Center \(KDC\) client support for claims, compound authentication and Kerberos armoring** in Computer Configuration | Administrative Templates | System | KDC.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-enablekdcclaims.gif)
...
2.  Under **Options**, in the drop\-down list box, select **Always provide claims**.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-alwaysprovideclaims.png)
...
1.  Open Active Directory Administrative Center \(ADAC\).
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-openadac.gif)
...
2.  Click **Authentication Policies**, and then click **New** to create a new policy.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-newauthnpolicy.gif)
...
3.  To create an audit\-only policy, click **Only audit policy restrictions**.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-newauthnpolicyAuditOnly.gif)
...
4.  To configure a TGT lifetime for user accounts, select the **Specify a Ticket\-Granting Ticket lifetime for user accounts** check box and enter the time in minutes.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-tgtlifetime.gif)
...
5.  To restrict the user account to select devices, click **Edit** to define the conditions that are required for the device.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-editauthnpolicy.gif)

6.  In the **Edit Access Control Conditions** window, click **Add a condition**.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-addcondition.png)
...
1.  To configure computer accounts or groups, in the drop\-down list, select the drop\-down list box **Member of each** and change to **Member of any**.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-addcompmember.png)
...
2.  Click **Add items**.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-addcompadditems.png)

3.  To change object types, click **Object Types**.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-changeobjects.gif)

4.  To select computer objects in Active Directory, click **Computers**, and then click **OK**.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-changeobjectsComputers.gif)

5.  Type the name of the computers to restrict the user, and then click **Check Names**.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-changeobjectsCompName.gif)

6.  Click OK and create any other conditions for the computer account.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-addcompaddconditions.png)

7.  When done, then click **OK** and the defined conditions will appear for the computer account.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-addcompdone.png)

##### Add computer claim conditions

1.  To configure computer claims, drop\-down Group to select the claim.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-compclaim.gif)
...
2.  Type the name of OU, the user account should be restricted to sign on.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-compclaimOUName.gif)

3.  When done, then click OK and the box will show the conditions defined.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-compclaimComplete.gif)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-restrictcomputers.gif)

For the claim to be available to restrict User sign\-on to the device, select the **User** check box.

![](../../media/how-configure-protected-accounts/adds-protectacct-restrictuserscomputers.gif)

#### Provision a user account with an authentication policy with ADAC

1.  From the **User** account, click **Policy**.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-userpolicy.gif)

2.  Select the **Assign an authentication policy to this account** check box.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-userpolicyAssign.gif)

3.  Then select the authentication policy to apply to the user.

    ![](../../media/how-configure-protected-accounts/adds-protectacct-userpolicySelect.png)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-kerbclientdacsupport.gif)
...
![](../../media/how-configure-protected-accounts/adds-protectacct-accountsassigned.gif)
...
1.  Open **Active Directory Administrative Center**, click **Authentication**, right\-click **Authentication Policy Silos**, click **New**, and then click **Authentication Policy Silo**.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-createnewauthnpolicysilo.gif)
...
2.  In **Display name**, type a name for the silo. In **Permitted Accounts**, click **Add**, type the names of the accounts, and then click **OK**. You can specify users, computers, or service accounts. Then specify whether to use a single policy for all principals or a separate policy for each type of principal, and the name of the policy or policies.
    ...
    ![](../../media/how-configure-protected-accounts/adds-protectacct-newauthnpolicySiloDisplayName.gif)
