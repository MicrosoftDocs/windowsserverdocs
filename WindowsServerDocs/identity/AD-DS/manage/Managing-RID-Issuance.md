...
-   [Managing RID Issuance](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/managing-rid-issuance.md#BKMK_Manage)  
  
-   [Troubleshooting RID Issuance](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/managing-rid-issuance.md#BKMK_Tshoot)  
...
|Severity|Warning|  
|Message|A pool size for account\-identifiers \(RIDs\) that was configured by an Administrator is greater than the supported maximum. The maximum value of %1 will be used when the domain controller is the RID master.<br /><br />For more information, see [RID Block Size Limit](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/managing-rid-issuance.md#BKMK_RIDBlockMaxSize).|  
...
|Notes and resolution|Contact all domain administrators and inform them that no further security principals can be created in this domain until this protection is overridden. For more information about how to override the protection and possibly increase the overall RID pool, see [Global RID Space Size Unlock](../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/../../active-directory-domain-services/manage/managing-rid-issuance.md#BKMK_GlobalRidSpaceUnlock).|  
