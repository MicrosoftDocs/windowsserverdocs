...
-   [Installation Considerations](../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/virtualized-domain-controller-deployment-configuration.md#BKMK_InstallConsiderations)  
  
    This includes platform requirements and other important constraints.  
  
-   [Virtualized Domain Controller Cloning](../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/virtualized-domain-controller-deployment-configuration.md#BKMK_VDCCloning)  
  
    This explains in detail the entire virtualized domain controller cloning process.  
  
-   [Virtualized Domain Controller Safe Restore](../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/virtualized-domain-controller-deployment-configuration.md#BKMK_VDCSafeRestore)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-cloningprocessflow.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervvmgenidcounter.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-pdcosinfo.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-adddctogroup.png)  
...
Alternatively, run the sample [FixVDCPermissions.ps1](../../../active-directory-domain-services/reference/virtual-dc/virtualized-domain-controller-technical-reference-appendix.md#BKMK_FixPDCPerms) in a Windows PowerShell console, where the console starts as an elevated administrator on a domain controller in the affected domain. It automatically set the permissions. The sample is located in the appendix of this module.  
...
||\-Offline|Does not perform the validation tests and overwrites any existing dccloneconfig.xml. Has no parameters. For more information, see [Running New-ADDCCloneConfigFile in offline mode](../../../active-directory-domain-services/introduction-active-directory-domain-services-ad-ds-virtualization-level-100.md#BKMK_OfflineMode).|  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psnewdccloneconfig.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-shutdown.png)  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervshutdown.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-stopcomputer2.png)  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-stopvm.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervinspect.png)  
  
To delete snapshots, select a VM and delete the snapshot subtree.  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervdeletesnapshot.gif)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-returnide.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-delsnapshots.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-pscopydrive.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervexport.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psexport.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psconvertvhd.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervclickmounteddrive.png)  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervdetailsmounteddrive.gif)  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervejectmounteddrive.gif)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psmountvhd.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervconnectvhd.gif)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psnewvm.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervimportlocatefolder.png)  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervimportselectvm.png)  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervimportchoosetype.gif)  
  
Remember to remove any imported snapshots, using the Hyper\-V Management snap\-in:  
  
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-hypervimportdelsnap.gif)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psimportvm.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psgetvmsnap.png)  
...
![](../../../media/virtualized-domain-controller-deployment-configuration/adds-vdc-psstartvm.png)  
...
Review the previous [Platform Requirements](../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/../../../active-directory-domain-services/get-started/virtual-dc/virtualized-domain-controller-deployment-configuration.md#BKMK_PlatformReqs) section for known VM\-Generation ID support.  
