...
|-|-|  
|Feature|Description|  
|[What's new in Active Directory Federation Services for Windows Server 2016 Technical Preview]()|An overview of all of the new features available for AD FS in Windows Server Technical Preview.|  
|[What's new in Active Directory Domain Services Technical Preview]()|Lists all the new features available for AD DS in Windows Server Technical Preview.|  
|[Privileged Access Management for Active Directory Domain Services &#40;AD DS&#41;]()|Privileged Access Management \(PAM\) for Active Directory Domain Services \(AD DS\) is a solution that is based on Microsoft Identity Manager \(MIM\) and Windows Server 2012 R2 and Windows Server 2016 Technical Preview.|  
|[Web Application Proxy in Windows Server Technical Preview]()|The content in this section describes what's new and changed in the Web Application Proxy for Windows Server® 2016 Technical Preview.|  
