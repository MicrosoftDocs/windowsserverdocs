...
## [Windows Local Administrator Password Solution](laps/laps.md)
## [Overview](laps/laps-overview.md)
## [Concepts](laps/laps-concepts.md)
## [Scenario guides](laps/laps-scenarios.md)
### [Getting started: Windows LAPS and Azure AD](laps/laps-scenarios-aad.md)
### [Getting started: Windows LAPS and Active Directory](laps/laps-scenarios-ad.md)
### [Getting started: Windows LAPS in Legacy LAPS emulation mode](laps/laps-scenarios-legacy.md)
## [Management](laps/laps-management.md)
### [Policy settings](laps/laps-management-policysettings.md)
### [PowerShell](laps/laps-management-powershell.md)
### [Eventlog](laps/laps-management-eventlog.md)
### [User interface](laps/laps-management-userinterface.md)
## [Technical reference](laps/laps-technicalreference.md)
