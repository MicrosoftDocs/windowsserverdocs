...
#### [Windows 2016 Accurate Time](ad-ds/get-started/windows-time-service/Windows-2016-Accurate-time.md)
...
#### [Upgrading to AD FS in Windows Server 2016 using a WID database](ad-fs/deployment/Upgrading-to-AD-FS-in-Windows-Server-2016.md)
#### [Upgrading to AD FS in Windows Server 2016 using a SQL database](ad-fs/deployment/Upgrading-to-AD-FS-in-Windows-Server-2016-SQL.md)
...
#### [Plan Device-based Conditional Access on-Premises](ad-fs/deployment/Plan-Device-based-Conditional-Access-on-Premises.md)
####[Restricting access to resources with AD FS auth rules](ad-fs/operations/Restricting-access-to-resources-with-AD-FS-auth-rules.md)
