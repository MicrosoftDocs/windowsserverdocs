---
title: PKI Design Considerations
description: You can use this topic to understand PKI design considerations for the Active Directory Certificate Services Certification Authority role.
ms.topic: conceptual
author: Orin-Thomas
ms.author: orthomas
...
There are some things that you should consider when planning the deployment of a Public Key Infrastructure based on Active Directory Certificate Services. Here you can find what you need to plan to successfully install and configure your PKI environment.
...
The CA name should not be identical to the name of the computer (NetBIOS or DNS name). Also, you cannot change the name of a server after Active Directory Certificate Services (AD CS) is installed without invalidating all the certificates that are issued by the CA. 
