...
For a worksheet to assist you in documenting the proposed forest design, download Job\_Aids\_Designing\_and\_Deploying\_Directory\_and\_Security\_Services.zip from Job Aids for Windows Server 2003 Deployment Kit \([http:\/\/go.microsoft.com\/fwlink\/?LinkID\=102558](http://go.microsoft.com/fwlink/?LinkID=102558)\) and open "Forest Design" \(DSSLOGI\_3.doc\).  
  
## In this section  
  
-   [Identifying Forest Design Requirements](../../active-directory-domain-services/plan/Identifying-Forest-Design-Requirements.md)  
  
-   [Determining the Number of Forests Required](../../active-directory-domain-services/plan/Determining-the-Number-of-Forests-Required.md)  
