...
You can use [!INCLUDE[nextref_longhorn]()] AD DS to introduce advanced features into your environment by raising the domain or forest functional level. You can raise the functional level to [!INCLUDE[nextref_longhorn]()] when all domain controllers in the domain or forest are running [!INCLUDE[nextref_longhorn]()].  
