...
-   For more information about upgrading Active Directory domains to [!INCLUDE[nextref_longhorn]()], see [Upgrading Active Directory Domains to Windows Server 2008 and Windows Server 2008 R2 AD DS Domains]().  
