...
Active Directory–integrated DNS in [!INCLUDE[nextref_longhorn]()] stores zone data in application directory partitions. \(There are no behavioral changes from Windows Server 2003–based DNS integration with Active Directory.\) The following DNS\-specific application directory partitions are created during AD DS installation:  
