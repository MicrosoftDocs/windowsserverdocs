...
> [!NOTE]  
> In Windows Server® 2003 and Microsoft Windows 2000 Server, the directory service is named Active Directory® directory service. In [!INCLUDE[nextref_server_7]()] and [!INCLUDE[nextref_longhorn]()], the directory service is named [!INCLUDE[firstref_adds]()] \(AD DS\). The rest of this topic refers to AD DS, but the information is also applicable to Active Directory Domain Services in Windows Server 2016.  
