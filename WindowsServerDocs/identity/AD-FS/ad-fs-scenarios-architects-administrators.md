...
For more information see [Configure AD FS and Azure MFA.](../active-directory-federation-services/manage/ops/configure-ad-fs-2016-azure-mfa.md)
...
* [Access Control Policies in AD FS](../active-directory-federation-services/../active-directory-federation-services/manage/ops/access-control-policies-ad-fs.md)
...
For more information see [Configure AD FS as a certificate issuing authority.](../active-directory-federation-services/configure-ad-fs-as-certificate-issuing-authority.md)
...
For more information see [AD FS and Microsoft Passport for Work in Windows 10 on-premises](../active-directory-federation-services/ad-fs-microsoft-passport-work-windows-10-onpremises.md)
...
For more information see [Access control policies in AD FS.](../active-directory-federation-services/../active-directory-federation-services/manage/ops/access-control-policies-ad-fs.md)
