...
This walkthrough provides instruction for implementing an on-behalf-of (OBO) authentication using AD FS in Windows Server 2016 TP5.  o learn more about OBO authentication please read [AD FS Scenarios for Developers](../../../active-directory-federation-services/get-started/AD-FS-Scenarios-for-Developers.md)  
...
![Create an application groupmedia/ADFS_OBO2.PNG)  
...
![Add application groupmedia/ADFS_OBO11.PNG)  
...
![Propertiesmedia/ADFS_OBO16.PNG)  
  
![Configure Web APImedia/ADFS_OBO18.PNG)  
...
![Choose Access Control Policymedia/ADFS_OBO1.PNG)  
...
![Configure Application Permissionsmedia/ADFS_OBO12.PNG)  
...
![Propertiesmedia/ADFS_OBO10.PNG)  
...
![Add Applicationmedia/ADFS_OBO15.PNG)  
...
![Add a new applicationmedia/ADFS_OBO19.PNG)  
...
![Additional detailsmedia/ADFS_OBO20.PNG)  
...
![Configure application credentialsmedia/ADFS_OBO17.PNG)  
...
![Visual Studiomedia/ADFS_OBO4.PNG)  
...
![Work and School Accountsmedia/ADFS_OBO9.PNG)  
...
![Web API 2 Controllermedia/ADFS_OBO3.PNG)  
  
* Give appropriate controller name  
  
![Add Controllermedia/ADFS_OBO13.PNG)  
...
![Add applicationmedia/ADFS_OBO6.PNG)  
...
![SSL URLmedia/ADFS_OBO8.PNG)  
  
![Configure Web APImedia/ADFS_OBO7.PNG)  
...
![Run the Solutionmedia/ADFS_OBO14.PNG)  
  
Hit F5 and execute the solution  
  
![Hit F5media/ADFS_OBO24.PNG)  
  
Click on the sign-in button. You will be prompted to sign-in using AD FS  
  
![Click on the sign-in buttonmedia/ADFS_OBO25.PNG)  
...
![Add a ToDo itemmedia/ADFS_OBO26.PNG)  
