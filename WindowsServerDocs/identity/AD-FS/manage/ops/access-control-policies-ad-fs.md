...
![](../../../media/access-control-policies-ad-fs/adfsacp2.PNG)  
...
![](../../../media/access-control-policies-ad-fs/adfsacp3.PNG)  
...
![](../../../media/access-control-policies-ad-fs/adfsacp5.PNG)  
...
![](../../../media/access-control-policies-ad-fs/adfsacp4.PNG)  
...
6.  From the window that pops\-up, select **authenticated** from the drop\-down.  Click **Ok**.  
    ...
    ![](../../../media/access-control-policies-ad-fs/adfsacp6.PNG)  
  
7.  Click **Ok**. Click **Ok**.  
  
    ![](../../../media/access-control-policies-ad-fs/adfsacp7.PNG)  
...
6.  From the window that pops\-up, select **Parameter specified when the access control policy is assigned**.  Click **Ok**.  
    ...
    ![](../../../media/access-control-policies-ad-fs/adfsacp8.PNG)  
  
7.  Click **Ok**. Click **Ok**.  
  
    ![](../../../media/access-control-policies-ad-fs/adfsacp9.PNG)  
...
10. Click **Ok**. Click **Ok**.  
    ...
    ![](../../../media/access-control-policies-ad-fs/adfsacp10.PNG)  
...
9. Click **Ok**. Click **Ok**.  
    ...
    ![](../../../media/access-control-policies-ad-fs/adfsacp12.PNG)  
...
![](../../../media/access-control-policies-ad-fs/adfsacp13.PNG)  
...
![](../../../media/access-control-policies-ad-fs/adfsacp14.PNG)  
  
From here you can select the access control policy and apply it to the application.  
  
![](../../../media/access-control-policies-ad-fs/adfsacp15.PNG)  
