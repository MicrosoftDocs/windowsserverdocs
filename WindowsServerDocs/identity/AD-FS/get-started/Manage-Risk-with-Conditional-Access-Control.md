...
For more information about these rule options and logic, see [When to Use an Authorization Claim Rule](../../active-directory-federation-services/plan/tech-ref/key-concepts/claim-rule-template/When-to-Use-an-Authorization-Claim-Rule.md).
