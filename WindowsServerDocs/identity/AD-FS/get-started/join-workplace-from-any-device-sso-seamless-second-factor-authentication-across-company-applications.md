...
1.  [Walkthrough: Workplace Join with a Windows Device](../../active-directory-federation-services/get-started/walkthrough-workplace-join-with-windows-device.md)

2.  [Walkthrough: Workplace Join with an iOS Device](../../active-directory-federation-services/get-started/walkthrough-workplace-join-with-ios-device.md)
