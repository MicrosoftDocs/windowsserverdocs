...
1.  [Walkthrough: Workplace Join with a Windows Device](../../active-directory-federation-services/get-started/Walkthrough--Workplace-Join-with-a-Windows-Device.md)

2.  [Walkthrough: Workplace Join with an iOS Device](../../active-directory-federation-services/get-started/Walkthrough--Workplace-Join-with-an-iOS-Device.md)
