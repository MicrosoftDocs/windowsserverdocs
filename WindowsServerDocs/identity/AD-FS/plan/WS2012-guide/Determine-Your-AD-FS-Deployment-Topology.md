...
-   [Stand-Alone Federation Server Using WID](../../../active-directory-federation-services/plan/WS2012-guide/topology/standalone-federation-server-using-wid.md)  
...
-   [Federation Server Farm Using WID and Proxies](../../../active-directory-federation-services/plan/WS2012-guide/topology/federation-server-farm-using-wid-proxies.md)  
