...
## About this guide  
This guide provides recommendations to help you plan a new deployment of [!INCLUDE[nextref_adfs2]()], based on the requirements of your organization. This guide is intended for use by an infrastructure specialist or system architect. It highlights your main decision points as you plan your [!INCLUDE[nextref_adfs2]()] deployment. Before you read this guide, you should have a good understanding of how [!INCLUDE[nextref_adfs2]()] works on a functional level. For more information, see [Understanding Key AD FS Concepts]().  
