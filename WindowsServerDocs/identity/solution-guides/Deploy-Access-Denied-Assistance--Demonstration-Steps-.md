...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 24d106f2-b050-4fc0-ba73-9f11560a28f2
author: Femila
---
...
![](media/Deploy-Access-Denied-Assistance--Demonstration-Steps-/PowerShellLogoSmall.gif)****Windows PowerShell equivalent commands****  
  
The following Windows PowerShell cmdlet or cmdlets perform the same function as the preceding procedure. Enter each cmdlet on a single line, even though they may appear word-wrapped across several lines here because of formatting constraints.  
  
```  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName AllowEmailRequests ‚Ä"Type DWORD ‚Ä"value 1  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName GenerateLog ‚Ä"Type DWORD ‚Ä"value 1  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName IncludeDeviceClaims ‚Ä"Type DWORD ‚Ä"value 1  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName IncludeUserClaims ‚Ä"Type DWORD ‚Ä"value 1  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName PutAdminOnTo ‚Ä"Type DWORD ‚Ä"value 1  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName PutDataOwnerOnTo ‚Ä"Type DWORD ‚Ä"value 1  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName ErrorMessage ‚Ä"Type MultiString ‚Ä"value ‚ÄúType the text that the user will see in the error message dialog box.‚Äù  
Set-GPRegistryValue ‚Ä"Name ‚ÄúName of GPO‚Äù ‚Ä"key ‚ÄúHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDenied‚Äù ‚Ä"ValueName Enabled ‚Ä"Type DWORD ‚Ä"value 1  
...
4.  Configure the following settings:  
    ...
    -   In the **Default administrator recipients** and **Default ‚ÄúFrom‚Äù e-mail address** boxes, type the email address of the file server administrator.  
