...
```  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName AllowEmailRequests-Type DWORD-value 1  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName GenerateLog-Type DWORD-value 1  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName IncludeDeviceClaims-Type DWORD-value 1  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName IncludeUserClaims-Type DWORD-value 1  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName PutAdminOnTo-Type DWORD-value 1  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName PutDataOwnerOnTo-Type DWORD-value 1  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName ErrorMessage-Type MultiString-value ìType the text that the user will see in the error message dialog box.î  
Set-GPRegistryValue-Name ìName of GPOî-key ìHKLM\Software\Policies\Microsoft\Windows\ADR\AccessDeniedî-ValueName Enabled-Type DWORD-value 1 
