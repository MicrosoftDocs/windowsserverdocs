...
-   For a list of all Windows PowerShell cmdlets that are available for claims transformation, see [Active Directory PowerShell Cmdlet Reference](/windows-server/identity/solution-guides/dynamic-access-control-overview).

-   For advanced tasks that involve export and import of DAC configuration information between two forests, use the [Dynamic Access Control PowerShell Reference](/windows-server/identity/solution-guides/dynamic-access-control-overview)
