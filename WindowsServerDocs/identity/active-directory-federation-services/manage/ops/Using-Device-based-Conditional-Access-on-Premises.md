...
For more information on configuring AD FS access control policies, see [Access control policies in AD FS](../../../active-directory-federation-services/manage/ops/Access-Control-Policies-in-AD-FS.md).  
...
2.  Or [migrate](../../../active-directory-federation-services/get-started/upgrading-to-WS2016/Upgrading-to-AD-FS-in-Windows-Server-2016.md) a farm to AD FS 2016 from AD FS 2012 R2  
