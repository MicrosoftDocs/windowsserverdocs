...
> [!IMPORTANT]
> -   In the [!INCLUDE[nextref_adfs2](includes/nextref_adfs2_md.md)] Management snap\-in, claim rules can be created only using claim rule templates
...
-   Type one or more optional conditions and an issuance statement using the [!INCLUDE[nextref_adfs2](includes/nextref_adfs2_md.md)] claim rule language

For more instructions for creating a custom rule using this template, see [Create a Rule to Send Claims Using a Custom Rule](Create-a-Rule-to-Send-Claims-Using-a-Custom-Rule.md) in the [!INCLUDE[nextref_adfs2](includes/nextref_adfs2_md.md)] Deployment Guide.
