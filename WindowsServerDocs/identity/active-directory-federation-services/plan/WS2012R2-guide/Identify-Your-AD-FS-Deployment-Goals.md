...
In addition to these, AD FS in [!INCLUDE[winblue_server_1]()] adds functionality that can help you achieve the following:  
...
Managing risk is an important aspect of governance and compliance in every IT organization. There are numerous access control risk management enhancements in AD FS in [!INCLUDE[winblue_server_1]()], including the following:  
...
The following are new AD FS capabilities in [!INCLUDE[winblue_server_1]()] that enable administrator to customize and enhance the sign\-in experience:  
