...
-   [When to Create a Federation Server Proxy](../../../active-directory-federation-services/plan/WS2012-guide/proxy-placement/When-to-Create-a-Federation-Server-Proxy.md)  
  
-   [Where to Place a Federation Server Proxy](../../../active-directory-federation-services/plan/WS2012-guide/proxy-placement/Where-to-Place-a-Federation-Server-Proxy.md)  
  
-   [When to Create a Federation Server Proxy Farm](../../../active-directory-federation-services/plan/WS2012-guide/proxy-placement/When-to-Create-a-Federation-Server-Proxy-Farm.md)  
  
-   [Certificate Requirements for Federation Server Proxies](../../../active-directory-federation-services/plan/WS2012-guide/proxy-placement/Certificate-Requirements-for-Federation-Server-Proxies.md)  
...
For examples of how you can place a federation server proxy in either of the two primary AD FS design scenarios, see [Mapping Your Deployment Goals to an AD FS Design](../../../active-directory-federation-services/plan/WS2012-guide/Mapping-Your-Deployment-Goals-to-an-AD-FS-Design.md).  
