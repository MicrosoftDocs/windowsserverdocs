...
With the end of life of Windows 2003, 2008 and 2008 R2, these domain controllers (DCs) need to be updated to Windows Server 2012, 2012R2, 2016, or 2019. As a result, any domain controller that runs Windows Server 2008 R2 and older should be removed from the domain.
