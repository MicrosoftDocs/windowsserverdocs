...
With the end of life of Windows Server 2003, 2003 R2, 2008, 2008 R2, 2012 and 2012 R2 these domain controllers (DCs) need to be updated to Windows Server 2016, 2019 or 2022. As with any server, domain controllers (DCs) running on an unsupported version of Windows Server should be removed from the domain and replaced with a version of Windows Server that is supported. For more information, see [Windows Server release information](/windows-server/get-started/windows-server-release-info).
