...
| <p>/?[:{Promotion | CreateDCAccount - | <p>UseExistingAccount | Demotion}] | Displays parameters that apply to the dcpromo operation. For example, dcpromo /?:Promotion displays all of the parameters that you can use for a promotion operation. |
