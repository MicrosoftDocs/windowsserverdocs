...
- For more information about the DNS hierarchy and name resolution process, see the [DNS Technical Reference](https://go.microsoft.com/fwlink/?LinkId=106636).

- For more information about how DNS supports AD DS, see the [DNS Support for Active Directory Technical Reference](https://go.microsoft.com/fwlink/?LinkId=106660).
...
- For more information about setting Service Principal Names (SPNs), see [Service Logon Fails Due to Incorrectly Set SPNs](https://go.microsoft.com/fwlink/?LinkId=102304).
