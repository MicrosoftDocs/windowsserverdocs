...
-   The "regular" user account that the employee uses to log on to their workstation has local Administrator rights, the computer is vulnerable to [drive-by download](/events/azure-iaas-day-2021/protect-your-infrastructure-against-rising-ddos-attacks) attacks in which the user is convinced to install malware.
