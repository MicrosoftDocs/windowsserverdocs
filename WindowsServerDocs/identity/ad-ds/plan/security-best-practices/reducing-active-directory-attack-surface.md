...
-   [Implementing Least-Privilege Administrative Models](../../../ad-ds/plan/security-best-practices/../../../ad-ds/plan/security-best-practices/implementing-leastprivilege-administrative-models.md) focuses on identifying the risk that the use of highly privileged accounts for day\-to\-day administration presents, in addition to providing recommendations to implement to reduce the risk that privileged accounts present.  
