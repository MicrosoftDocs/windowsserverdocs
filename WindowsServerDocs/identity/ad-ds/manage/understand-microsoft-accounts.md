...
This article explains how a Microsoft account works to enhance security and privacy for users along with how you can manage consumer account types in your organization.

Microsoft sites, services, properties, and computers running Windows 10, can use a Microsoft account as a means of identifying a user. Microsoft account was previously called Windows Live ID. It has user-defined secrets, and consists of a unique email address and a password.
...
- [Restrict the use of the Microsoft account](#restrict-the-use-of-the-microsoft-account)
...
- [Perform password resets](#perform-password-resets)
