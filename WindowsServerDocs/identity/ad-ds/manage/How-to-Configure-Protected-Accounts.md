...
The RID-500 Administrator, as a break-glass account, is always exempted from Authentication Policies enforcement, even when they are assigned to an Authentication Policy Silo.
