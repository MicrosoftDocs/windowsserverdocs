...
2.  Create DNS zones for the same DNS domain names that were hosted on the DNS servers before the critical malfunction. For more information, see Add a Forward Lookup Zone ([http://go.microsoft.com/fwlink/?LinkId=74574](http://go.microsoft.com/fwlink/?LinkId=74574)).  
