...
**To perform a nonauthoritative restore of AD DS and authoritative restore of
SYSVOL using wbadmin.exe**

- Include the **-authsysvol** switch in your recovery command, as shown in the
    following example:
...
![Restore](media/b81604238b4288f9fac4e3f791d82e5f.png)
