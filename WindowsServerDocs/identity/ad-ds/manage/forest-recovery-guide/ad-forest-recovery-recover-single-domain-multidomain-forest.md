...
- Unhost the recovered domains partition from all GCs in the forest, except
    ...
    all GCs in the forest. Also make sure you don't overload the remaining GCs.
...
Note: To allow logon without the GC verification, it's possible also to
configure
...
domains of the forest first. After all GCs don't contain the partition anymore,
