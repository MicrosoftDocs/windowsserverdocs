...
2. You have followed the Microsoft best-practice recommendations for using
...
3. You may have a special configuration for the handling of Domain Controller
...
- The importance of operations master roles (formerly known as flexible single
    s master operations or FSMO) including: 
