...
1. On the **Deployment Configuration** screen, select **Add a domain controller to an existing domain** and select **Next**.

   ![Screenshot of the Deployment Configuration page of the Active Directory Domain Services Configuration Wizard showing the Add a domain controller to an existing domain option selected.](https://github.com/user-attachments/assets/a2640379-950a-4eff-9281-7e257c609e51)
