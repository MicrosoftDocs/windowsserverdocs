...
The **Pre-create a Read-only domain controller account** link in the Active Directory Administrative Centerâ€™s task pane is equivalent to the ADDSDeployment Windows PowerShell cmdlet:  
