...
Beginning with Windows Server 2012, there's only one version of Adprep.exe. Adprep commands are run automatically as needed when you install a domain controller that runs Windows Server to an existing Active Directory domain or forest.
