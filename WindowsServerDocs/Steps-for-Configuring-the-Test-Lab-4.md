---
title: Steps for Configuring the Test Lab-4
ms.custom: na
...
-   [STEP 3: Install and configure CLIENT2](assetId:///6cbee1b5-f6f6-443f-8fa9-31cc5c05a0ee)—CLIENT2 is a [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client computer that is used to demonstrate the backwards compatibility of a [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)], [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)] or [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)] Remote Access deployment.  
...
-   [STEP 5: Configure DC1](assetId:///205ca795-93ce-4e53-aa6b-b44c87f0e14a)—Configure DC1 with an additional Active Directory site and additional security groups for [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client computers.  
