                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h2>Connect to Azure hybrid services</h2>
                                            <p>Connect your server or cluster to Azure hybrid services to combine the best of on-premises and the cloud.</p>
            </li>
                    <li class="fullSpan">
...
<table>
     <tr>
        <td style="vertical-align: top;">
            ...
            <ol>
            <li>1. <a href="https://docs.microsoft.com/windows-server/identity/software-restriction-policies/software-restriction-policies">Software Restriction Policies</a></li><br/>       <hr width="80%">
