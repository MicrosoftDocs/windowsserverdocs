...
| Windows Admin Center in the Azure Portal | Use [Windows Admin Center (preview) in the Azure portal](../manage/windows-admin-center/wacinazure/manage-vm.md) to manage the Windows Server operating system inside an Azure VM. Manage operating system functions from the Azure portal as well as work with files in the VM without using Remote Desktop or PowerShell. |
