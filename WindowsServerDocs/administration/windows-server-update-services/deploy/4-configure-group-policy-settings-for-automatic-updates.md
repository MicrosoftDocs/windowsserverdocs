...
-   [Do not display "Install Updates and Shut Down" option in Shut Down Windows dialog box](#do-not-adjust-default-option-to-"install-updates-and-shut-down"-in-shut-down-windows-dialog)

-   [Do not adjust default option to "Install Updates and Shut Down" in Shut Down Windows dialog box](#do-not-display-"install-updates-and-shut-down"-option-in-shut-down-windows-dialog)
