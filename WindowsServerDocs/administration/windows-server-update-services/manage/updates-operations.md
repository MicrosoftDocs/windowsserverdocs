...
7. Click **OK** after setting all your approvals. The **Approval Progress** window will display the progress toward completing the approval. When the process is complete, the **Close** button will be available. Click **Close**.
...
> [!IMPORTANT]
> Not all updates support removal. 

You can see whether an update supports removal by selecting an individual update and looking at the **details** pane. Under **additional details**, you will see the **removable** category. If the update cannot be removed through WSUS, in some cases it can be removed with **add or remove Programs** from **Control Panel**.
...
- Updates newer versions of operating systems.
    > [!IMPORTANT]
    > The superseding update might not support earlier versions of operating systems.
