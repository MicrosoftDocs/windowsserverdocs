...
If you're using a VHDX file, we recommend you use the dynamic file type when you are actively monitoring storage on the hosting volume. Make sure you have enough disk space when expanding the VHD file at runtime.
