...
Windows Admin Center is a browser-based server adminstration tool set that lets you manage your Windows Servers locally-deployed with no Azure or cloud dependency, or directly integrated within the Azure Portal. Windows Admin Center gives you full control over all aspects of your server infrastructure and is particularly useful for managing servers on private networks that are not connected to the Internet.
