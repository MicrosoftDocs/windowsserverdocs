...
description: Windows Commands topic for Initialize-Server, which configures a Windows Deployment Services server for initial use after the server role has been installed.
