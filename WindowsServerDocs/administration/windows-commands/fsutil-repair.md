---
title: fsutil repair
description: Reference topic for the fsutil repair command, which administers and monitors NTFS self-healing repair operations.
...
- [Self-healing NTFS](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc771388(v=ws.10))
