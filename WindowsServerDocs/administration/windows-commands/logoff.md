---
title: logoff
description: Reference topic for the logoff command, which logs off a user from a session on a Remote Desktop Session Host server and deletes the session.
