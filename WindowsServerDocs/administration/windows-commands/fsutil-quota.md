---
title: fsutil quota
description: Reference topic for the fsutil quota command, which manages disk quotas on NTFS volumes to provide more precise control of network-based storage.
