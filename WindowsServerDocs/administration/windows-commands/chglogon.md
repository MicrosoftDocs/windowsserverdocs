---
title: chglogon
description: Reference topic for chglogon, which enables or disables logons from client sessions on an rd Session Host server, or displays current logon status.
