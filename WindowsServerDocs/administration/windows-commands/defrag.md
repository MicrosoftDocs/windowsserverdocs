...
- This maintenance task might not defrag all the volumes, at times because this task
   - doesn't wake the computer in-order to run defrag
   - starts only if the computer is on AC power
      - stops if the computer switches to battery power
