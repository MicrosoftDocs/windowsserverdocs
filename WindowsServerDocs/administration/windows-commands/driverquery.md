---
title: driverquery
description: Reference topic for the driverquery command, which enables an administrator to display a list of installed device drivers and their properties.
