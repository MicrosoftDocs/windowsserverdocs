...
| /FS:filesystem | Specifies the type of file system (FAT, FAT32, NTFS, exFAT, ReFS, UDF). |
...
| /TXF:`<state>` | Specifies TxF is enabled/disabled (enabled, disabled). TxF is enabled by default |
