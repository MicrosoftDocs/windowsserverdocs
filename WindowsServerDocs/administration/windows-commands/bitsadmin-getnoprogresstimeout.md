...
description: Windows Commands topic for bitsadmin getnoprogresstimeout, which retrieves the length of time, in seconds, that the service tries to transfer the file after a transient error occurs.
