...
| [change logon](change-logon.md) | Enables or disables logons from client sessions on a Remote Desktop Session Host server, or displays current logon status. |
...
| [chglogon](chglogon.md) | Enables or disables logons from client sessions on a Remote Desktop Session Host server, or displays current logon status. |
...
| [logoff](logoff.md) | Signs out a user from a session on a Remote Desktop Session Host server and deletes the session from the server. |
| [msg](msg.md) | Sends a message to a user on a Remote Desktop Session Host server. |
...
| [qprocess](qprocess.md) | Displays information about processes that are running on a Remote Desktop Session Host server. |
| [query](query.md) | Displays information about processes, sessions, and Remote Desktop Session Host servers. |
| [query process](query-process.md) | Displays information about processes that are running on a Remote Desktop Session Host server. |
...
| [quser](quser.md) | Displays information about user sessions on a Remote Desktop Session Host server. |
| [qwinsta](qwinsta.md) | Displays information about sessions on a Remote Desktop Session Host server. |
| [rdpsign](rdpsign.md) | Enables you to digitally sign a Remote Desktop Protocol (.rdp) file. |
| [reset session](reset-session.md) | Enables you to reset (delete) a session on a Remote Desktop Session Host server. |
| [rwinsta](rwinsta.md) | Enables you to reset (delete) a session on a Remote Desktop Session Host server. |
| [shadow](shadow.md) | Enables you to remotely control an active session of another user on a Remote Desktop Session Host server. |
| [tscon](tscon.md) | Connects to another session on a Remote Desktop Session Host server. |
| [tsdiscon](tsdiscon.md) | Disconnects a session from a Remote Desktop Session Host server. |
| [tskill](tskill.md) | Ends a process running in a session on a Remote Desktop Session Host server. |
