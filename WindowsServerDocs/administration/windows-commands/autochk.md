---
title: autochk
description: Windows Commands topic for **autochk**, which runs when the computer is started and prior to Windows Server starting to verify the logical integrity of a file system.
...
Runs when the computer is started and prior to Windows Server&reg; 2008 R2 starting to verify the logical integrity of a file system.
