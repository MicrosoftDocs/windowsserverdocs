...
| /pid `<processID>` | Specifies the process ID of the process to be ended. |
| /im `<imagename>` | Specifies the image name of the process to be ended. Use the wildcard character (`\`) to specify all image names. |
