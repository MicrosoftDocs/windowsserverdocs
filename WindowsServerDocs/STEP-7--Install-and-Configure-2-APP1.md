...
1.  Start the installation of [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] \(full installation\).  
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**explorer.exe**, and then press ENTER.  
...
4.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**notepad.exe**, right\-click **Notepad**, click **Advanced**, and then click **Run as administrator**.  
