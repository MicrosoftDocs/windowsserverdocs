...
1.  Open [!INCLUDE[wps_2](includes/wps_2_md.md)], type **notepad c:\\Windows\\CAPolicy.inf** and press ENTER.
...
5.  When you are prompted to overwrite the file, click **Yes**.
    ...
    ![](media/001-SaveCAPolicyORCA1.gif)
...
> [!IMPORTANT]
> In the CAPolicy.inf, you can see there is a line specifying the URL http:\/\/pki.corp.contoso.com\/pki\/cps.txt. The Internal Policy section of the CAPolicy.inf is just shown as an example of how you would specify the location of a certificate practice statement \(CPS\). In this guide, you are not instructed to create the certificate practice statement \(CPS\). To learn more about policy statements including CPS, see [Additional Resources](assetId:///fdb5b540-45c6-46c8-b6c0-a992661c1165).
