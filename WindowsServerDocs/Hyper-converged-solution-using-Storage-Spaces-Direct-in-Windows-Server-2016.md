...
*  [How to use this guide](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D1)  
* [Hyper-converged Solution with Software Defined Storage Overview](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D2)  
*  [Hardware requirements](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D3)  
* [Information gathering](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D4)  
* [Nano or Full/Core Installation Options](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_InstallOptions)  
* [Installing and configuring Hyper-Converged solution using Storage Spaces Direct with Windows Server 2016 Nano Server](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D5)  
* [Definitions](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D6)  
* [Storage Spaces Optmize Pool](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D7)  
...
![](media/StorageSpacesDirectHyperconverged.png)  
...
-   **[Service Package KB3157663](https://support.microsoft.com/kb/3157663)**  This package has updates that are important to have the hyper-converged nodes, as well as any server managing a [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] hyper-converged deployment.  
  
## <a name="BKMK_InstallOptions"></a>Nano or Full/Core Installation Options  
Hyper-converged deployments can be done using either Nano or Full/Core installations of [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)]. Nano is a new install type for [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], see [Getting Started with Nano Server](https://technet.microsoft.com/library/mt126167.aspx) for more information on the advantages of using Nano and deploying and managing Nano server.   
...
>[!IMPORTANT]The Mellanox driver for [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] Technical Preview 5 has some extra configuration required when installing on a Full or Core install (not on Nano).  See the section [Mellanox Driver Install for Full and Core Installations](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D8).  
...
1.  [Deploy the operating system](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D5a)  
  
2.  [Configure the network](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D5b)  
  
3.  [Configure Storage Spaces Direct](Hyper-converged-solution-using-Storage-Spaces-Direct-in-Windows-Server-2016.md#BKMK_S2D5c)  
  
Figure 2 illustrates the process for building a hyper-converged solution using Windows Server 2016 Technical Preview.  
  
![](media/S2D_HyperconvergedInfratsructureProcess.png)  
...
5.  Connecting to and managing the Nano Servers from the Management system machine  
     ...
     ![](media/S2D_Step1HyperconvergedInfratsructureProcess.png)  
...
![](media/S2D_Step2HyperconvergedInfratsructureProcess.png)  
...
![](media/S2D_Step3HyperconvergedInfratsructureProcess.png)  
