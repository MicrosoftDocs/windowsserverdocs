...
Hyper\-V is Microsoft's hardware virtualization product. It lets you create and run a software version of a computer, called a *virtual machine*. Each virtual machine acts like a complete computer, running an operating system and programs. When you need computing resources, virtual machines give you more flexibility, help save time and money, and are a more efficient way to use hardware than just running an operating system on physical hardware.
...
>[!NOTE]
>Hyper-V in Windows and Windows Server replaces older hardware virtualization products, such as Microsoft Virtual PC, Microsoft Virtual Server, and Windows Virtual PC. Support for these older products is limited, so we recommend using Hyper-V instead.
...
## How to get Hyper\-V and what it can run
Hyper\-V is available in Windows Server and Windows, as a server role available for x64 versions of Windows Server and as a Windows feature in some 64\-bit versions of Windows. On Windows, it's called Client Hyper\-V.

Many operating systems will run on a virtual machine. In general, an operating system that uses an x86 architecture will run on  a Hyper\-V virtual machine. Not all operating systems that can be run are tested and supported by Microsoft, however.  For lists of what's supported, see:
...
Hyper\-V offers many features. To give an overview of what's available, they're grouped here by what they provide or help you do. 

**Computing environment** -- A Hyper\-V virtual machine relies on the same basic parts as a physical computer, such as memory, processor, storage, and networking. Storage and networking can each be considered categories of their own, because they have features and options to meet different needs.

**Disaster recovery and backup** -- For disaster recovery, Hyper\-V Replica creates copies of virtual machines, intended to be stored in another physical location, so you can restore the virtual machine from the copy. For backup, Hyper\-V has VSS components so you can make application-consistent backups for apps that support VSS.
...
**Portability** -- Features such as live migration and import/export make it easier to move or distribute a virtual machine.
...
For a summary of the features introduced in this version, see [What's new in Hyper-V on Windows Server 2016 Technical Preview](What-s-new-in-Hyper-V-on-Windows-Server-2016-Technical-Preview.md)
...
- [Windows PowerShell Direct](Manage-Windows-virtual-machines-with-PowerShell-Direct.md)
...
* [Remote Desktop Services](Host-desktops-and-apps-in-Remote-Desktop-Services.md)
...
Hyper\-V technology is available on certain versions of Windows as a [feature](https://msdn.microsoft.com/virtualization/hyperv_on_windows/windows_welcome). It's also available as a standalone server product, as [Microsoft Hyper-V Server](https://technet.microsoft.com/library/hh923062.aspx).
