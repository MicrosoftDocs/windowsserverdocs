...
- [Additional software for Windows Server 2016](https://docs.microsoft.com/legal/windows-server/Additional-Software)

- [Windows Server Technical Preview Expiration](https://docs.microsoft.com/legal/windows-server/WinServer2016expiry)
