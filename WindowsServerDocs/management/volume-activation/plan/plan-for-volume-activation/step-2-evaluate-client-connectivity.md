...
After you understand some of the requirements that are associated with each volume activation option as described in [Step 1: Review and select Activation Methods](step-1-review-select-activation-methods.md), the next step in planning for volume Activation Services is to evaluate the types of clients you have and their location and ability to connect to the central network. After you have completed this step, you can proceed to [Step 3: Determine Activation Method and Product License Requirements](step-3-determine-activation-method-product-license-requirements.md).
...
![](../../../media/step-2-evaluate-client-connectivity/va-corenetwork.gif)
...
![](../../../media/step-2-evaluate-client-connectivity/va-branchofficescenario.gif)
...
![](../../../media/step-2-evaluate-client-connectivity/va-highsecurity.gif)
...
![](../../../media/step-2-evaluate-client-connectivity/va-disconnectedcomputers.gif)
...
-   [Step 1: Review and select Activation Methods](step-1-review-select-activation-methods.md)
