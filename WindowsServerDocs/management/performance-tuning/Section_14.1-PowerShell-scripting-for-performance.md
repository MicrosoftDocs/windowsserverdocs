---
title: Scripting for Performance in PowerShell
...
Idiomatic PowerShell typically uses cmdlets and PowerShell functions heavily, often leveraging the pipeline,
and dropping down into .Net only when necessary.
