...
[Using the get-AllDevices Command](../using-get-command/using-getalldevices-command.md)

[Using the get-Device Command](../using-get-command/using-getdevice-command.md)
