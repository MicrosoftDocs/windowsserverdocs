...
|Usage|One of the following values:<br /><br />-   PRECONFIG—use the owner's Internet Explorer defaults.<br />-   NO\_PROXY—do not use a proxy server.<br />-   OverRIDE—use an explicit proxy list and bypass list. A proxy and proxy bypass list must follow.<br />-   AUTODETECT—automatically detect proxy settings.|
