...
```
repairbde <Inputvolume> <OutputvolumeorImage> [-rk] [–rp] [-pw] [–kp] [–lf] [-f] [{-?|/?}]
```
...
```
repairbde C: D: -rk F:\recoveryKey.bek –lf Z:\log.txt
```
...
```
repairbde C: D: -rp 111111-222222-333333-444444-555555-666666-777777-888888
```
...
```
repairbde C: D: -kp F:\recoveryKeyPackage -rk F:\recoveryKey.bek -f
```
