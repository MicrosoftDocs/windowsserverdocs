...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 2dfd08f0-be59-4715-96e6-c498305873f4author: coreyp
...
```
WDSUTIL /New-CaptureImagmedia:"WinPE boot image" /Architecture:x86 /DestinationImage /FilePath:"C:\Temp\WinPECapture.wim"
```
To create a capture image and apply the specified settings, type:
```
WDSUTIL /Verbose /Progress /New-CaptureImage /Server:MyWDSServemedia:"WinPE boot image" /Architecture:x64 /Filename:boot.wim 
