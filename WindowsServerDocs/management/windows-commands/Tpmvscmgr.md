...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 8b2c8ff4-5c5d-446d-99e7-4daa1b36a163author: coreyp
...
The Destroy command securely deletes a virtual smart card from the userâ€™s computer.
> [!WARNING]
...
```
tpmvscmgr.exe create /name â€œVirtualSmartCardForCorpAccessâ€? /AdminKey DEFAULT /PIN PROMPT
```
...
```
tpmvscmgr.exe create /name â€œVirtualSmartCardForCorpAccessâ€? /AdminKey PROMPT /PIN PROMPT
```
The following command will create the unmanaged virtual smart card that can be used to enroll certificates.
```
tpmvscmgr.exe create /name â€œVirtualSmartCardForCorpAccessâ€? /AdminKey RANDOM /PIN PROMPT /generate
```
