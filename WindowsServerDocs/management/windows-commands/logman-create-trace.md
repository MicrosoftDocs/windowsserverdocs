...
The following example creates an event trace data collector called trace\_log using no fewer than 16 and no more than 256 buffers, each buffer 64kb in size, and outputs the results to the location c:\\logfile.  
