...
Allows you to generate a rollback template for a specified configuration template. for examples of how this command can be used, see [Examples](seceditgeneraterollback.md#BKMK_Examples).  
