...
Realm flags are stored in the registry in **HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Lsa\\Kerberos\\Domains\\***RealmName*. This entry does not exist in the registry by default. You can use the [ksetup:addrealmflags](ksetupaddrealmflags.md) command to populate the registry.
