...
-   [Step 5: Configure Group Policy Settings for Automatic Updates](step-5-configure-group-policy-settings-automatic-updates.md)
...
-   [Step 4: Approve and deploy Updates in WSUS](step-4-approve-deploy-updates-wsus.md)
