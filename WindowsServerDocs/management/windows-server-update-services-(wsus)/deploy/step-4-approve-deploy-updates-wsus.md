...
|Task|Description|
|--------|---------------|
|[4.1. Approve and deploy WSUS updates](step-4-approve-deploy-updates-wsus.md#BKM_4.1.)|Approve and deploy WSUS updates by using the WSUS management Console.|
|[4.2. Configure auto-approval rules](step-4-approve-deploy-updates-wsus.md#BKM_4.2.a.)|Configure WSUS to automatically approve installation of updates for selected groups, and how to approve revisions to existing updates.|
|[4.3. Review installed updates with WSUS Reports](step-4-approve-deploy-updates-wsus.md#BKM_4.3.)|Review the updates that were installed, the computers that received those updates and other details by using the WSUS Reporting feature.|
