...
2.  create a WSUS target group for the computers that need the hotfix, and add them to the group. for more information about computers and groups, see [Managing WSUS Client computers and WSUS computer Groups](managing-wsus-client-computers-wsus-computer-groups.md) in this guide, and section [3.3. Configure WSUS computer groups](../deploy/step-3-configure-wsus.md#BKMK_ConfigcomputerGroups) of Step 3: Configure WSUS, in the WSUS deployment guide.
...
-   [Update management with Windows Server Update Services](update-management-with-windows-server-update-services.md)s
