...
You can also manage computer groups on the computers page, which includes creating the groups and assigning computers to them. for more information about managing computer groups, see Managing computer Groups in the next section of this guide, and section [1.5. plan WSUS computer groups](#BKMK_1.5) in Step 1: Prepare for Your WSUS deployment of the WSUS deployment guide.

> [!NOTE]
> You must first configure client computers to contact the WSUS server before you can manage them from that server. Until you perform this task, your WSUS server will not recognize your client computers and they will not be displayed in the list on the computers page. for more information about setting up client computers, see [1.5. plan WSUS computer groups](#BKMK_1.5) of Step 1: Prepare for Your WSUS deployment, and Step 3: Configure WSUS, in the WSUS deployment guide.
...
-   WSUS Group Policies: Group Policies control when the Windows Update Agent scans and installs updates
    ...
    for more information, see: [Step 5: Configure Group Policy Settings for Automatic Updates](), in the WSUS deployment Guide.
