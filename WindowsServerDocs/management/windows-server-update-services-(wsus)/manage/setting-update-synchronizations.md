...
if a WSUS server is running in replica mode, you will not be able to perform this task. for more information about replica mode, see [Running WSUS Replica mode](running-wsus-replica-mode.md), and [Step 1: Prepare for Your WSUS deployment]().
...
for details about synchronizing updates from the Microsoft Update Catalog site, see: [WSUS and the Catalog Site](wsus-catalog-site.md).
...
-   [Managing WSUS Client computers and WSUS computer Groups](managing-wsus-client-computers-wsus-computer-groups.md)
