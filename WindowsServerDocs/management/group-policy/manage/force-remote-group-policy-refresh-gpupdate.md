...
-   [Prerequisites](force-remote-group-policy-refresh-gpupdate.md#BKMK_Prereqs)

-   [Step 1: Configure Firewall rules on each client that will be managed with remote Group Policy refresh](force-remote-group-policy-refresh-gpupdate.md#BKMK_Step1)

-   [Step 2: Schedule a remote Group Policy refresh](force-remote-group-policy-refresh-gpupdate.md#BKMK_Step2)
...
![](../../media/force-remote-group-policy-refresh-gpupdate/powershelllogosmall.gif)****Windows powershell equivalent commands****
