...
-   [remote Resultant Set of Policy \(RSoP\) Group Policy results: ports that require firewall rules](configure-firewall-port-requirements-group-policy.md#BKMK_remoteRSoP)

-   [remote Group Policy refresh: ports that require firewall rules](configure-firewall-port-requirements-group-policy.md#BKMK_remoteRefresh)
...
![](../../media/configure-firewall-port-requirements-group-policy/powershelllogosmall.gif)****Windows powershell equivalent commands****
