...
For detailed information about how to add servers that are in workgroups to manage, or manage remote servers from a workgroup computer that is running Server Manager, see [Add Servers to Server Manager_1](Add-Servers-to-Server-Manager_1.md).
