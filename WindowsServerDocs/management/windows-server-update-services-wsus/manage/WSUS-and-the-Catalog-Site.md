...
2.  Create a WSUS target group for the computers that need the hotfix, and add them to the group. For more information about computers and groups, see [Managing WSUS Client Computers and WSUS Computer Groups](Managing-WSUS-Client-Computers-and-WSUS-Computer-Groups.md) in this guide, and section [3.3. Configure WSUS computer groups](Step-3--Configure-WSUS.md#BKMK_ConfigComputerGroups) of Step 3: Configure WSUS, in the WSUS deployment guide.
