...
**General.** You may install and use any number of copies of the software to develop and test libraries with Windows Server.
----------------------------------------------------------------------------------------------------------------------------

**Third Party Software.** The software may include third party applications that Microsoft, not the third party, licenses to you under this agreement. Any included notices for third party applications are for your information only.
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
2.  Canada. If you acquired this software in Canada, you may stop receiving
