...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 74477f16-2794-4b26-8acb-c731528ac2e5
author: billmath
---
...
1.  First, configure a connection to your LDAP directory using the **New\-AdfsLdapServerConnection** cmdlet:  
    ...
    > [!NOTE]  
    > By default, Active Directory forests use port 389 for LDAP.  Keep this in mind when adding un\-trusted AD forests as LDAP directories.  
