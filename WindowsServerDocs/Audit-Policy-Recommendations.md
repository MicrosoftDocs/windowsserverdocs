...
For a comprehensive list of events that you should include when you monitor for signs of compromise, please see [Appendix L: Events to Monitor](Appendix-L--Events-to-Monitor.md).
...
Refer to [Appendix L: Events to Monitor](Appendix-L--Events-to-Monitor.md) for a list of recommended events to monitor, their criticality ratings, and an event message summary.
...
Refer to [Appendix L: Events to Monitor](Appendix-L--Events-to-Monitor.md) for a list of the recommended events to monitor, their criticality ratings, and an event message summary.
