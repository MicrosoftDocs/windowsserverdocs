---
title: Step 2: Plan the DirectAccess Deployment_4
ms.custom: na
...
-   **Windows 7 clients**—By default, [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client computers cannot connect to a [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] Remote Access deployment. If you have [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client computers in your organization that require remote access to internal resources, you can allow them to connect. Any client computers that you want to allow to access internal resources must be a member of a security group that you specify in the Enable DirectAccess wizard.  
  
    > [!NOTE]  
    > Allowing [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client computers to connect using DirectAccess requires you to use computer certificate authentication.  
