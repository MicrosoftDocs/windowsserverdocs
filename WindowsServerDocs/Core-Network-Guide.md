...
1.  [About this guide](#BKMK_about)  
  
2.  [Core Network Overview](#BKMK_overview)  
  
3.  [Core Network Planning](#BKMK_planning)  
  
4.  [Core Network Deployment](#BKMK_deployment)  
  
5.  [Additional Technical Resources](#BKMK_resources)  
  
6.  [Appendices A through E](#BKMK_appendix)  
...
### TCP\/IP  
TCP\/IP in [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] is the following:  
...
-   [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)]. This forest functional level supports only domain controllers that are running [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)] and later versions of the Windows Server operating system.  
  
-   [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)]. This forest functional level supports [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] domain controllers and domain controllers that are running later versions of the Windows Server operating system.  
  
-   [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]. This forest functional level supports [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] domain controllers and domain controllers that are running later versions of the Windows Server operating system.  
  
-   [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)]. This forest functional level supports [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] domain controllers and domain controllers that are running later versions of the Windows Server operating system.  
  
-   [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)]. This forest functional level supports only [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] domain controllers and domain controllers that are running later versions of the Windows Server operating system.  
  
If you are deploying a new domain in a new forest and all of your domain controllers will be running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], it is recommended that you configure AD DS with the [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] forest functional level during AD DS installation.  
  
> [!IMPORTANT]  
> After the forest functional level is raised, domain controllers that are running earlier operating systems cannot be introduced into the forest. For example, if you raise the forest functional level to [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], domain controllers running [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)] cannot be added to the forest.  
...
|Forest functional level|-   [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)]<br />-   [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)]<br />-   [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]<br />-   [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)]<br />-   [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)]|  
...
|Answer file name \(optional\)|**AD DS\_AnswerFile**|  
...
###### To rename computers running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]  
...
You can use the procedures in this topic to configure the Internet Protocol version 4 \(IPv4\) properties of a network connection with a static IP address for computers running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)].  
...
###### To configure a static IP address on  computers running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)],[!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]  
...
###### To join computers running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] to the domain  
...
###### To log on to the domain using computers running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)]  
...
##### To join computers running [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)] to the domain  
...
##### To join computers running [!INCLUDE[winblue_client_2](includes/winblue_client_2_md.md)] to the domain  
...
##### To log on to the domain using computers running [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)]  
...
-   You are planning to expand your network to include remote access servers that are compatible with the RADIUS protocol, such as a computer running [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)], [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] or [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)] and Routing and Remote Access service, Terminal Services Gateway, or Remote Desktop Gateway.  
...
[!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] Technical Library Resources  
...
The following sections contain additional configuration information for computers that are running operating systems other than [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)], [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)]. In addition, a network preparation worksheet is provided to assist you with your deployment.  
...
You can use the procedures in this section to provide computers running Windows Server 2008 R2, Windows 7, [!INCLUDE[firstref_longhorn](includes/firstref_longhorn_md.md)], and [!INCLUDE[firstref_vista](includes/firstref_vista_md.md)] with a different computer name.  
...
2.  In **Computer name, domain, and workgroup settings**, click **Change settings**. The **System Properties** dialog box opens.  
    ...
    > [!NOTE]  
    > On computers running [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)], before the **System Properties** dialog box opens, the **User Account Control** dialog box opens, requesting permission to continue. Click **Continue** to proceed.  
...
You can use these procedures to join computers running Windows Server 2008 R2, Windows 7, [!INCLUDE[firstref_longhorn](includes/firstref_longhorn_md.md)],  and [!INCLUDE[firstref_vista](includes/firstref_vista_md.md)] to the domain.  
...
You can use these procedures to log on to the domain using computers running Windows Server 2008 R2, Windows 7, [!INCLUDE[firstref_longhorn](includes/firstref_longhorn_md.md)], and [!INCLUDE[firstref_vista](includes/firstref_vista_md.md)].  
