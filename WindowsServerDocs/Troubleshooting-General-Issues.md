...
**Symptom**—After a [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client upgrades to [!INCLUDE[winthreshold_client_1](includes/winthreshold_client_1_md.md)] or [!INCLUDE[win8_client_1](includes/win8_client_1_md.md)] in a multisite deployment, the DirectAccess connection is not visible in the Networks list.  
  
**Cause**  
  
The [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] GPOs in a multisite deployment do not contain the [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)] Network Connectivity Assistant configuration.  
  
[!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] clients should use DirectAccess Connectivity Assistant to monitor their DirectAccess connectivity status which requires a separate manual configuration in the [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client GPOs. When [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] clients are upgraded to [!INCLUDE[winthreshold_client_1](includes/winthreshold_client_2_md.md)] or [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)], the Network Connectivity Assistant will not function if the [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] client GPO is still applied.  
  
**Solution**  
  
If DirectAccess Connectivity Assistant settings are configured in the [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] GPOs, you can resolve this issue before upgrading client computers by modifying the [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] GPOs using the following PowerShell cmdlets:  
...
If a client has already been upgraded or the DCA is not configured, move the client computer to the [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)] or [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)] security group.  
