...
-   For DirectAccess clients, you must use a DNS server running [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)], [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)], Windows Server 2003, or any DNS server that supports IPv6.  
...
-   At least one domain controller is installed on the [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)][!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)], or Windows Server 2003 operating system.  
...
In Remote Access in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], you can choose between using built\-in Kerberos authentication, which uses user names and passwords, or using certificates for IPsec computer authentication.  
...
When you configure Remote Access, DirectAccess settings are collected into [!INCLUDE[gpos](includes/gpos_md.md)] \(GPOs\). Two GPOs are populated with DirectAccess settings, and they are distributed as follows:  
