...
Storage Spaces Direct in [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2.md)] supports use of locally connected disks such as SAS HBA and SATA connected HDD, SATA SSD, and NVMe. These devices can be used in different configurations to allow flexibility to choose based on performance and cost.   
...
-   [Health Service](Health-Service-in-Windows-Server-2016.md)  
