...
> [!NOTE]  
> To perform this procedure by using [!INCLUDE[wps_2](includes/wps_2_md.md)], open [!INCLUDE[wps_2](includes/wps_2_md.md)] and type the following command, and then press ENTER.   
>   
