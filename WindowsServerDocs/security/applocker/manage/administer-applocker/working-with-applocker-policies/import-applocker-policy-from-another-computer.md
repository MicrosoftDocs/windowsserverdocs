...
Before completing this procedure, you should have exported an applocker policy. For more information, see [Export an applocker Policy to an XML File](export-applocker-policy-xml-file.md).
