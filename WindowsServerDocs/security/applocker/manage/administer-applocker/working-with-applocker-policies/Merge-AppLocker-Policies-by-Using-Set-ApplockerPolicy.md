...
This topic describes the steps to merge AppLocker policies by using Windows PowerShell in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
