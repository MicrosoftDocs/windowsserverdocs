...
This topic describes the steps for displaying a customized message to users when an AppLocker policy denies access to an application in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**gpmc.msc** to open the Group Policy Management Console \(GPMC\).
