...
-   Merge applocker policies. For procedures to do this, see [Merge applocker Policies Manually](merge-applocker-policies-manually.md) and [Merge applocker Policies by Using Set-applockerPolicy](merge-applocker-policies-by-using-setapplockerpolicy.md).
