...
This topic describes how to import an AppLocker policy in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
...
1.  On the computer where you want to edit or apply the policy, [!INCLUDE[clickstart_2](includes/clickstart_2_md.md)]**secpol.msc** to open the Local Security Policy snap\-in.
