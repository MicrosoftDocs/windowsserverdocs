...
You should test each collection of rules to ensure that the rules perform as intended. For steps to perform this testing, see [Test and Update an applocker Policy](test-update-applocker-policy.md).
