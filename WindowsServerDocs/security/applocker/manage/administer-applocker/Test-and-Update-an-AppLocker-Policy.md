...
This topic discusses the steps required to test an AppLocker policy prior to deployment in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
