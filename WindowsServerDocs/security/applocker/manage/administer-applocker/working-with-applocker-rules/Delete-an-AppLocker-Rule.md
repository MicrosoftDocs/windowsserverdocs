...
This topic describes the steps to delete an AppLocker rule, which will prevent the application that is specified in the rule from running in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
