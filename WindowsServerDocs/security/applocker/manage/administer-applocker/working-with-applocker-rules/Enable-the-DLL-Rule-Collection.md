...
This topic describes the steps to enable the DLL rule collection feature for AppLocker in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
