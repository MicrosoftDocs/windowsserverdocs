...
7.  On the **Rule Preferences** page, choose the conditions that you want the wizard to use while creating rules, and then click **Next**. For more information about rule conditions, see [Understanding applocker Rule Condition Types]().
