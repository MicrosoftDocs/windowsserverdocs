...
|File types that can be controlled|SRP can control the following file types:<br /><br />-   Executables<br />-   Dlls<br />-   Scripts<br />-   Windows Installers<br /><br />SRP cannot control each file type separately. All SRP rules are in a single rule collection.|AppLocker can control the following file types on [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] and later versions:<br /><br />-   Executables<br />-   Dlls<br />-   Scripts<br />-   Windows Installers<br /><br />Packaged apps and installersWere added beginning with[!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)]<br /><br />AppLocker maintains a separate rule collection for each of the five file types.|
