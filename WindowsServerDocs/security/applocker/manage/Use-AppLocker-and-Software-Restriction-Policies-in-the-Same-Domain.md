...
|Support for rule exceptions|SRP does not support rule exceptions|AppLocker rules can have exceptions which allows administrators to create rules such as â€œAllow everything from Windows except for Regedit.exeâ€?.|
