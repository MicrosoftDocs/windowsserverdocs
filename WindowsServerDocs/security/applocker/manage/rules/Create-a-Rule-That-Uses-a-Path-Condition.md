...
For information about the path condition, see [Understanding the Path Rule Condition in applocker](../../get-started/how-applocker-works/understanding-the-path-rule-condition-in-applocker.md).
