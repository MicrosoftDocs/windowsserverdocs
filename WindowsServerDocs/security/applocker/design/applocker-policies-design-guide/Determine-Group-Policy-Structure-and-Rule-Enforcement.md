...
> [!NOTE]
> There is no default limit on the number of AppLocker rules that you can create. However, in [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)], GPOs have a 2 MB size limit for performance. In subsequent versions, that limit is raised to 100 MB.
