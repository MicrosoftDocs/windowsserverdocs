...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**gpmc.msc** or open the Group Policy Management Console \(GPMC\).
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**secpol.msc** or **gpedit.msc**.
