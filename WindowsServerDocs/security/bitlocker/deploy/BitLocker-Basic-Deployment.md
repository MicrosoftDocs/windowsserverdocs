...
> [!NOTE]
> For more information about using this tool, see [Bdehdcfg](Bdehdcfg.md) in the Command\-Line Reference.
...
|---------------|---------------|
|Hardware configuration|The computer must meet the minimum requirements for the supported Windows versions. For more information about [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)] requirements, see the [Windows 8 Web site](http://go.microsoft.com/fwlink/p/?LinkId=222457).|
|Operating system|BitLocker is an optional feature which can be installed by Server Manager on [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)].|
