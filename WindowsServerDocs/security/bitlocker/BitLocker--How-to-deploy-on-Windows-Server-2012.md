...
The results of this command displays a table of all of the feature names beginning with â€œBitâ€? as their prefix. This allows you to confirm that the feature name is `BitLocker` for the BitLocker feature.
