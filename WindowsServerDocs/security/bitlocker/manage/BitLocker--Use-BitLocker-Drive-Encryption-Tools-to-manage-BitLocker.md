...
Manage\-bde is a command\-line tool that can be used for scripting BitLocker operations.  Manage\-bde offers additional options not displayed in the BitLocker control panel.  For a complete list of the manage\-bde options, see the [Manage\-bde](Manage-bde.md) command\-line reference.
...
For more information about using repair\-bde see [Repair\-bde](Repair-bde.md)
