...
In Windows Vista, Windows Server 2008, [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)], and [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)], the default is **Send NTLMv2 response only**.
