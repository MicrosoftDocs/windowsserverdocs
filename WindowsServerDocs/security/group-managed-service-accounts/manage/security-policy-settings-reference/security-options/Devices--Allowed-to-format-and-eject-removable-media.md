...
-   Administrators and Interactive Users \(not applicable to [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] or [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)]\)
...
The option Administrators and Interactive Users is not applicable to [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] or [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)], but it can be used for backward compatibility.
