...
Virtualization facilitates running  applications based on operating systems earlier than [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)] that historically failed to run with standard user privileges. This feature can be disabled for applications on computers running at least the [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)] operating system because it is unnecessary.
