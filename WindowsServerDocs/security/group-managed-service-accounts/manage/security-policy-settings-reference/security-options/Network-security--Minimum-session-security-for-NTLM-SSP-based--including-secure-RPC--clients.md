...
In Windows Server 2008 and earlier versions of the Windows operating system, no requirements were set. But in computers running [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)]**Require 128\-bit encryption** is the default.

In [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)], only 128\-bit encryption or NTLMv2 session security options are available.
