...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 1ea59e3c-22e1-4426-94c9-5e65fb541ad2
---
...
> [!NOTE]
> This policy setting does not have any impact on ldap\_simple\_bind or ldap\_simple\_bind\_s. LDAP client computers that are running Windows XP Professional or [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)] do not use ldap\_simple\_bind or ldap\_simple\_bind\_s to communicate with a domain controller.
