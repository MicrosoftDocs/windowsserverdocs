...
The default in Windows Vista and Windows Server 2008 was **Prompt for consent**. In [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)], the default was changed and three options were added:
