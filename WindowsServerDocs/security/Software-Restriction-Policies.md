...
This topic for the IT professional describes Software Restriction Policies \(SRP\) in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)], and provides links to technical information about SRP beginning with Windows Server 2003.
...
-   Security policies \(see [Security Policy Settings Overview](Security-Policy-Settings-Overview.md)\)
...
|**Planning**|[Software Restriction Policies Technical Overview](Software-Restriction-Policies-Technical-Overview.md) \([!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]\)<br /><br />[Software Restriction Policies Technical Reference](http://technet.microsoft.com/library/cc728085(v=WS.10).aspx) \(Windows Server 2003\)|
|**Deployment**|No resources available.|
|**Operations**|[Administer Software Restriction Policies](Administer-Software-Restriction-Policies.md) \([!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]\)<br /><br />[Software Restriction Policies Product Help](http://technet.microsoft.com/library/cc779607(v=WS.10).aspx) \(Windows Server 2003\)|
|**Troubleshooting**|[Troubleshoot Software Restriction Policies](Troubleshoot-Software-Restriction-Policies.md) \([!INCLUDE[win8_server_2](includes/win8_server_2_md.md)]\)<br /><br />[Software Restriction Policies Troubleshooting](http://technet.microsoft.com/library/cc737011(v=WS.10).aspx) \(Windows Server 2003\)|
