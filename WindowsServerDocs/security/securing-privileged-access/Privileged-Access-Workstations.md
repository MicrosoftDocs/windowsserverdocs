...
This architectural approach builds on the protections found in the [!INCLUDE[winthreshold_client_1](includes/winthreshold_client_1_md.md)][Credential Guard](https://technet.microsoft.com/en-us/library/mt483740%28v=vs.85%29.aspx) and [Device Guard](https://technet.microsoft.com/en-us/library/dn986865(v=vs.85).aspx) features and goes beyond those protections for sensitive accounts and tasks.
...
> 
> For a comparison matrix of the different editions of [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)], read [this article](https://www.microsoft.com/en-us/WindowsForBusiness/Compare).
    ...
    2.  Apply [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)] Security baselines and Cloud Service Access Link the security baselines for Windows and for cloud service access \(if required\) to the correct OUs using the steps below:
        ...
        2.  Create these GPOs, [import the policy](https://technet.microsoft.com/en-us/library/cc753786.aspx) settings, and [link](https://technet.microsoft.com/en-us/library/cc732979.aspx) per this table. Link each policy to each location and ensure the order follows the table \(lower entries in table should be applied later and higher priority\):
            ...
            **Policies:**
            ...
            |||
            |-|-|
            |CM [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)] \- Domain Security|N\/A \- Do Not Link Now|
            ...
            ||Admin\\Tier 1\\Devices|
            ||Admin\\Tier 2\\Devices|
            |SCM [!INCLUDE[winthreshold_client_2](includes/winthreshold_client_2_md.md)] \- User|Admin\\Tier 0\\Devices|
            ||Admin\\Tier 1\\Devices|
            ||Admin\\Tier 2\\Devices|
