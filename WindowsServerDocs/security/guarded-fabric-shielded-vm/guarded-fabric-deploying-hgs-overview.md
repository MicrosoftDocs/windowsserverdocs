...
For a diagram of HGS that shows how it works with hosts, see [Guarded fabric and shielded VMs overview](https://technet.microsoft.com/windows-server-docs/security/guarded-fabric-and-shielded-vms).
