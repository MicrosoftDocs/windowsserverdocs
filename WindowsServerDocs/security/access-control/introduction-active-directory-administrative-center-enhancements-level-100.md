...
-   [Active Directory Recycle Bin](introduction-active-directory-administrative-center-enhancements-level-100.md#ad_recycle_bin_mgmt)  
  
-   [Fine\-Grained Password Policy](introduction-active-directory-administrative-center-enhancements-level-100.md#fine_grained_pswd_policy_mgmt)  
  
-   [Windows PowerShell History Viewer](introduction-active-directory-administrative-center-enhancements-level-100.md#windows_powershell_history_viewer)  
...
-   [Step 1: Raise the forest functional level](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_raise_ffl)  
  
-   [Step 2: Enable Recycle Bin](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_enable_recycle_bin)  
  
-   [Step 3: Create test users, group and organizational unit](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_create_test_env)  
  
-   [Step 4: Restore deleted objects](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_restore_del_obj)  
...
![](../media/introduction-active-directory-administrative-center-enhancements-level-100/powershelllogosmall.gif)****Windows PowerShell equivalent commands****  
...
3.  In the **Tasks** pane, click **New** and then click **User**.  
    ...
    ![](../media/introduction-active-directory-administrative-center-enhancements-level-100/adds-adacnewuser.gif)  
...
-   [Step 1: Raise the domain functional level](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_raise_dfl)  
  
-   [Step 2: Create test users, group, and organizational unit](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk2_test_fgpp)  
  
-   [Step 3: Create a new fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_create_fgpp)  
  
-   [Step 4: View a resultant set of policies for a user](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_view_resultant_fgpp)  
  
-   [Step 5: Edit a fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_edit_fgpp)  
  
-   [Step 6: Delete a fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_delete_fgpp)  
...
4.  In the **Tasks** pane, click **New**, and then click **Password Settings**.  
    ...
    ![](../media/introduction-active-directory-administrative-center-enhancements-level-100/adds-adacnewfgpp.gif)  
...
3.  Select a user, **test1** that belongs to the group, **group1** that you associated a fine\-grained password policy with in [Step 3: Create a new fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_create_fgpp).  
...
In the following procedure, you will edit the fine grained password policy you created in [Step 3: Create a new fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_create_fgpp)  
...
4.  Select the fine grained password policy you created in [Step 3: Create a new fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_create_fgpp) and click **Properties** in the **Tasks** pane.  
...
4.  Select the fine grained password policy you created in [Step 3: Create a new fine\-grained password policy](introduction-active-directory-administrative-center-enhancements-level-100.md#bkmk_create_fgpp) and in the **Tasks** pane click **Properties**.  
