...
![](media/AuthN_SecuritySupportProviderInterfaceArchitecture.jpg)
...
-   [Kerberos Enhancements](https://technet.microsoft.com/library/cc749438(v=ws.10).aspx) for [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)]

-   [Changes in Kerberos Authentication](https://technet.microsoft.com/library/dd560670(v=ws.10).aspx) for [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)]
...
-   [Changes in NTLM Authentication](https://technet.microsoft.com/library/dd566199(v=ws.10).aspx) in [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)]
...
DTLS is used when explicitly called by the application. For more information about DTLS and the other protocols that are used by the Schannel provider, see [Schannel Security Support Provider Technical Reference](Schannel-Security-Support-Provider-Technical-Reference.md).
...
The PKU2U protocol was introduced and implemented as an SSP in [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] and [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)]. This SSP enables peer\-to\-peer authentication, particularly through the media and file sharing feature called HomeGroup, which was introduced in [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)]. The feature permits sharing between computers that are not members of a domain.
