...
![](../../../media/credentials-processes-windows-authentication/authn-lsa-architecture-client.gif)
...
![](../../../media/credentials-processes-windows-authentication/authn-gina-architecture.gif)
...
![](../../../media/credentials-processes-windows-authentication/authn-credman-credprov.gif)
...
For more information about these additional protections, see [Configuring Additional LSA Protection](../../../credentials-protection-management/manage/configuring-additional-lsa-protection.md).
...
For more information about ARSO, see [Winlogon Automatic Restart Sign-On &#40;ARSO&#41;](winlogon-automatic-restart-signon-arso.md).
