...
|**Password Synchronization**|Computer Configuration\Administrative Templates\Windows Components\Password Synchronization|These policy settings determine how the system manages the synchronization of passwords between Windows and UNIX-based operating systems.<p>For more information, see [Password Synchronization](https://technet.microsoft.com/library/cc732609.aspx).|
