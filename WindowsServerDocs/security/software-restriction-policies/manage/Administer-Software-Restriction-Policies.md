...
> 
>     -   If you create new software restriction policies for your local computer: [!INCLUDE[mingrp_admins](includes/mingrp_admins_md.md)]
...
> 
>     -   If you add or delete a designated file type for your local computer: [!INCLUDE[mingrp_admins](includes/mingrp_admins_md.md)]
>     -   If you create new software restriction policies for a computer that is joined to a domain, members of the Domain Admins group can perform this procedure.
