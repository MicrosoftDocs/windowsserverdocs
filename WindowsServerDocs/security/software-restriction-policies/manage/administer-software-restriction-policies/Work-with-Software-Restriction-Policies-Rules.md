...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**gpedit.msc** and then press ENTER.
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)], **gpedit.msc** in the **Search programs and files** or in [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)], on the Desktop, and then press ENTER.
...
3.  Click **Browse** to find a file.
    ...
    > [!NOTE]
    > In Windows XP it is possible to paste a pre\-calculated hash in **File hash**. In [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)], [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] and later versions, this option is not available.
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)] regedit.
