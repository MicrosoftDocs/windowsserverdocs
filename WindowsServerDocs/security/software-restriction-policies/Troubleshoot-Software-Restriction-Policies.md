...
Beginning with  Windows ServerÂ® 2008 R2  and  Windows 7Â® , Windows AppLocker can be used instead of or in concert with SRP for a portion of your application control strategy.
...
1.  Investigate the System Event Log, filtering on source of â€œSoftware Restriction Policy.â€? The entries explicitly state which rule is implemented for each application.
