...
-   [Administer Software Restriction Policies](../manage/administer-software-restriction-policies.md)
    ...
    -   [Determine Allow-Deny List and Application Inventory for Software Restriction Policies](../manage/administer/determine-allowdeny-list-application-inventory-software-restriction-policies.md)

    -   [Work with Software Restriction Policies Rules](../manage/administer/work-with-software-restriction-policies-rules.md)

    -   [Use Software Restriction Policies to Help Protect Your Computer Against an Email Virus](../manage/administer/use-software-restriction-policies-help-protect-your-computer-against-email-virus.md)
