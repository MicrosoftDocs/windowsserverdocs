...
There are no changes in functionality in SRP for [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].

**Supported versions**

Software Restriction Policies can only be configured on and applied to computers running at least Windows Server 2003, including [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], and at least Windows XP, including [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
...
|--------------------------------|-------|-------------|
|Scope|SRP policies can be applied to all Windows operating systems beginning with Windows XP and Windows Server 2003.|AppLocker policies apply only to Windows Server 2008 R2, [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], Windows 7, and [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].|
...
|Manage [!INCLUDE[applocker_modernapp](includes/applocker_modernapp_md.md)]s and [!INCLUDE[applocker_pkg](includes/applocker_pkg_md.md)]s|Unable|.appx is a valid file type which AppLocker can manage.|
