...
There have been no changes to the settings and effects of this user right policy setting since it was introduced in Windows Server 2003 and Windows XP. However, the policy setting name was changed in [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)] from **Allow log on through Terminal Services**.  
