...
A trusted publisher is a certificate issuer that the computer' user has chosen to trust and that has certificate details that have been added to the store of trusted publishers.  
