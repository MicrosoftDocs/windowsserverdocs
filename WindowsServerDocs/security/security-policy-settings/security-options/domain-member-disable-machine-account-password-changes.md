...
In Windows Server 2003, the default setting for Domain Policy and Domain Controller Policy was not defined. In  Windows Server 2008 R2  and  Windows Server 2008 , it is **Disabled**. There is no difference in the effective setting between these two, however.  
