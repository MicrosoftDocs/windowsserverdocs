...
Introduced in [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], the Schannel SSP implemented the server\-side portion of TLS session resumption. The client\-side implementation of RFC 5077 was added in [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].
