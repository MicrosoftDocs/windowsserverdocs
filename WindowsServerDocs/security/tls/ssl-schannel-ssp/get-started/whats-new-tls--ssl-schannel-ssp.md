...
-   [What's New in TLS/SSL (Schannel SSP) in Windows Server 2012 R2 and Windows 8.1](whats-new-tls--ssl-schannel-ssp.md#BKMK_Changes2012R2)

-   [What's New in TLS/SSL (Schannel SSP) in Windows Server 2012 and Windows 8](whats-new-tls--ssl-schannel-ssp.md#BKMK_Changes2012)
