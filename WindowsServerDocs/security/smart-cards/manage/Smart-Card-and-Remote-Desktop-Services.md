...
![](media/WindowsSmartCardTechnicalReference_14.PNG)
...
7.  Changes to WinSCard.dll implementation were made in [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)] to improve smart card redirection.
...
For information about this option for the command\-line tool, see [\-dsPublish](Certutil.md#BKMK_dsPublish).
...
For information about this option for the command\-line tool, see [\-SCRoots](Certutil.md#BKMK_SCRoots).
...
For information about this option for the command\-line tool, see [\-addstore](Certutil.md#BKMK_addstore).
