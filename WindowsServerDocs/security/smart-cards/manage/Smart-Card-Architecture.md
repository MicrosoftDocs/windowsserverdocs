...
For more information, see [Windows Authentication Architecture](Windows-Authentication-Architecture.md). This topic in the Windows Authentication Technical Overview explains the basic architectural scheme for Windows authentication for past and current versions of Windows.
...
![](media/WindowsSmartCardTechnicalReference_01.gif)
...
![](media/WindowsSmartCardTechnicalReference_03.gif)
...
![](media/WindowsSmartCardTechnicalReference_04.PNG)
...
![](media/WindowsSmartCardTechnicalReference_05.gif)
