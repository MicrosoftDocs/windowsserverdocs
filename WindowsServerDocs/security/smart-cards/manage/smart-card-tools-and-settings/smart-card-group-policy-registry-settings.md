...
This policy setting is applied to the computer after the [Allow time invalid certificates](smart-card-group-policy-registry-settings.md#BKMK_AllowTimeInvalidCertificates) policy setting is applied.
...
|----------------|-----------|
|HKEY\_LOCAL\_MACHINE\\SYSTEM\\CCS\\Services\\Kdc\\UseCachedCRLOnlyAndIgnoreRevocationUnknownErrors|Type \= DWORD<br /><br />Value \= 1|
|HKEY\_LOCAL\_MACHINE\\SYSTEM\\CCS\\Control\\LSA\\Kerberos\\Parameters\\UseCachedCRLOnlyAndIgnoreRevocationUnknownErrors|Type \= DWORD<br /><br />Value \= 1|
