...
For more information about Windows passwords, see the [Passwords Technical Overview](https://technet.microsoft.com/library/hh994558(WS.10).aspx) in the Windows??Server??2008??TechNet Library.
