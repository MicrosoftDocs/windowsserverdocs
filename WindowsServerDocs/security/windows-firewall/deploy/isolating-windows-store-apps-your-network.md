...
-   [Step 1: Define your network](isolating-windows-store-apps-your-network.md#BKMK_Step1)

-   [Step 2: Create custom firewall rules](isolating-windows-store-apps-your-network.md#BKMK_Step2)
