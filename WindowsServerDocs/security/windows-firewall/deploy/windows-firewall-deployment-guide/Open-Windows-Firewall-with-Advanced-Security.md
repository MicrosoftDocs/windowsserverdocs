...
Although standard users can start the [!INCLUDE[wfas](includes/wfas_md.md)] MMC snap\-in, to change most settings the user must be a member of a group with the permissions to modify those settings, such as Administrators.
