...
To use certificates in a server isolation or domain isolation design, you must first set up the infrastructure to deploy the certificates. This is called a public key infrastructure \(PKI\). The services required for a PKI are available in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] in the form of the Active Directory Certificate Services \(AD CS\) role.
