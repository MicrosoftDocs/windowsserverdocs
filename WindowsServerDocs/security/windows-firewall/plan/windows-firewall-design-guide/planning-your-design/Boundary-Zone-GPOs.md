...
In the Woodgrove Bank example, only the GPO settings for a Web service on [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)], or [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)] are discussed.
