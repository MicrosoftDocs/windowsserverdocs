...
After you finish reviewing the existing [!INCLUDE[wfas](includes/wfas_md.md)] deployment goals and you determine which goals are important to your specific deployment, you can map those goals to a specific [!INCLUDE[wfas](includes/wfas_md.md)] design.
...
Use the following table to determine which [!INCLUDE[wfas](includes/wfas_md.md)] design maps to the appropriate combination of [!INCLUDE[wfas](includes/wfas_md.md)] deployment goals for your organization. This table refers only to the [!INCLUDE[wfas](includes/wfas_md.md)] designs as described in this guide. However, you can create a hybrid or custom [!INCLUDE[wfas](includes/wfas_md.md)] design by using any combination of the [!INCLUDE[wfas](includes/wfas_md.md)] deployment goals to meet the needs of your organization.
