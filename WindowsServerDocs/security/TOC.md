...
##### [Using VMM](/system-center/vmm/guarded-deploy-host?toc=%2fwindows-server%2fvirtualization%2ftoc.json)
...
## [Disabling Per-User Services in Windows](/windows/application-management/per-user-services-in-windows)
