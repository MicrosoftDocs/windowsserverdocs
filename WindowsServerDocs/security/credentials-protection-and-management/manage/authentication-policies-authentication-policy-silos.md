...
For information about configuring authentication policy silos and authentication policies, see [How to Configure Protected Accounts](how-configure-protected-accounts.md).
...
Authentication policy silos can be configured by using the Active Directory Administrative Console or Windows PowerShell. For more information, see [How to Configure Protected Accounts](how-configure-protected-accounts.md).
...
Authentication policies can be configured for each silo by using the Active Directory Administrative Console or Windows PowerShell. For more information, see [How to Configure Protected Accounts](how-configure-protected-accounts.md).
...
-   [What's New in Kerberos Authentication](../../kerboros/get-started/whats-new-kerberos-authentication.md) \(Windows Server 2012\)
...
For troubleshooting steps that use these events, see [Troubleshoot Authentication Policies](how-configure-protected-accounts.md#BKMK_TroubleshootAuthnPolicies) and [Troubleshoot events related to Protected Users](how-configure-protected-accounts.md#BKMK_TrubleshootingEvents).
