...
The [Windows Defender Antivirus on Windows Server 2016](/windows/security/windows-defender/windows-defender-overview-windows-server) topic contains set up and configuration information specific to Windows Server 2016, including how to:
