...
For information about monitoring changes to the resource attributes that apply to files, see [Monitor the Resource Attributes on Files and Folders](monitor-resource-attributes-files-folders.md).
