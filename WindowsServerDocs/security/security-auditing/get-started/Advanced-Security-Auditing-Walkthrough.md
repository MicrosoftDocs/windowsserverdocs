...
> [!NOTE]
> For more information about operating system compatibility and requirements, see [Which Editions of Windows Support Advanced Audit Policy Configuration](which-editions-windows-support-advanced-audit-policy-configuration.md).
...
![](../../media/advanced-security-auditing-walkthrough/audit-sxs-network-diagram.gif)
