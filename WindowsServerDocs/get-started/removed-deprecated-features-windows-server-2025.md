...
| Windows Management Instrumentation Command line (WMIC) | WMIC has been converted to a feature on demand (FoD) and won't come preinstalled on new installations of Windows Server. It will be removed from Windows in a future release. [PowerShell for WMI](/powershell/scripting/learn/ps101/07-working-with-wmi) replaces the WMIC tool. Use PowerShell or programmatically query WMI as a replacement for WMIC. To learn more about WMIC depreciation, see [WMI command line (WMIC) utility deprecation: Next steps](https://techcommunity.microsoft.com/t5/windows-it-pro-blog/wmi-command-line-wmic-utility-deprecation-next-steps/ba-p/4039242) |
