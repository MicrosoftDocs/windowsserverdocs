...
>
> Customers using Windows Server SAC should move to **[Azure Stack HCI](https://learn.microsoft.com/azure-stack/hci/)**. Alternatively, customers may use the Long-Term Servicing Channel of Windows Server.
