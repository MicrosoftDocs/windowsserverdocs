...
> [!NOTE]
> Windows 7 Ultimate is not listed because it was never available as a Volume Licensing edition. Windows 7 Ultimate was sold only as a retail or OEM product and therefore **cannot be activated using KMS**. To activate Windows 7 Ultimate, use the product key that came with your retail or OEM copy of Windows.
