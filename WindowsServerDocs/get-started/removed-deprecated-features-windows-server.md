...
| Internet Explorer | The Internet Explorer 11 desktop application is [retired and out of support](https://aka.ms/IEJune15Blog) as of June 15, 2022. The standalone Internet Explorer application is removed from Windows Server 2025. To access older, legacy sites, use [IE mode in Microsoft Edge](https://aka.ms/IEmodewebsite). To disable IE mode for compliance, see [Configure IE mode Policies](/deployedge/edge-ie-mode-policies). |
