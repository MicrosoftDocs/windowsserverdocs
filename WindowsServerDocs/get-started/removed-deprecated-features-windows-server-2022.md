...
| Feature | Explanation |
|--|--|
| TLS 1.0 and 1.1 disablement | Over the past several years, internet standards and regulatory bodies have [deprecated or disallowed](https://www.ietf.org/rfc/rfc8996.html) TLS versions 1.0 and 1.1 due to various security issues. In a future release of Windows Server, TLS 1.0 and 1.1 will be disabled by default. For more information, see [TLS versions 1.0 and 1.1 disablement resources](/windows/whats-new/deprecated-features-resources). |
