...
For many additional options for moving to Windows Server 2016, such as license conversion among volume licensed editions, evaluation editions, and others, see details at [Upgrade Options](get-started/Supported-Upgrade-Paths.md).
