...
> [!NOTE]
> Microsoft.ClassicCompute VMs require additional configuration for Extended Security Updates deployment, as they don't have access to the [Azure Instance Metadata Service](https://docs.microsoft.com/azure/virtual-machines/windows/instance-metadata-service), which determinines Extended Security Updates eligibility. Please contact [Microsoft support](http://support.microsoft.com/contactus?PID=17336) for more help.
