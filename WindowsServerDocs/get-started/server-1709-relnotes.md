...
However, if you are running Windows Server 2016 with cluster nodes that have Storage Spaces Direct enabled, you can add nodes that are running Windows Server, version 1709. 
