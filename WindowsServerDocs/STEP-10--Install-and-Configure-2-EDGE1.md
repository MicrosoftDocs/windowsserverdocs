...
-   [Install the operating system on 2-EDGE1](assetId:///1938c4f3-ca96-475d-9f2e-6bea3b7a4130#installOS)—Install [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)], [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)] or [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)] on 2\-EDGE1.
...
1.  Start the installation of [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)].
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**cmd.exe**, and then press ENTER.
...
1.  In the [!INCLUDE[sm](includes/sm_md.md)] console, in **Local Server**, in the **Properties** area, next to **Computer name**, click the link.
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**mmc.exe**, and then press ENTER.
...
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**compmgmt.msc**, and then press ENTER.
...
1.  In the [!INCLUDE[sm](includes/sm_md.md)] console, in the **Dashboard**, click **Add roles and features**.
