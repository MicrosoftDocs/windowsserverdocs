...
This topic describes how to create custom, user\-defined groups of servers in [!INCLUDE[sm](includes/sm_md.md)] in [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)].  
  
## <a name="BKMK_groups"></a>Server groups  
Servers that you add to the server pool are displayed on the **All Servers** page in [!INCLUDE[sm](includes/sm_md.md)]. You can create custom groups of servers that you have added. Server groups allow you to view and manage a smaller subset of your server pool as a logical unit; for example, you can create a group called **Accounting Servers** for all servers in your organization’s Accounting department, or a group called **Chicago** for all servers that are geographically located in Chicago. After you create a server group, the group’s home page in [!INCLUDE[sm](includes/sm_md.md)] displays information about events, services, performance counters, [!INCLUDE[bpa](includes/bpa_md.md)] results, and installed roles and features for the group as a whole.  
...
4.  When you have finished adding servers to the group, click **OK**. The new group is displayed in the [!INCLUDE[sm](includes/sm_md.md)] navigation pane under the **All Servers** group.  
  
#### To edit an existing server group  
  
1.  Do one of the following.  
  
    -   In the [!INCLUDE[sm](includes/sm_md.md)] navigation pane, right\-click a server group, and then click **Edit Server Group**.  
...
2.  Change the group name, or add or remove servers from the group.  
    ...
    > [!NOTE]  
    > Removing servers from a server group does not remove servers from [!INCLUDE[sm](includes/sm_md.md)]. Servers that you remove from a group remain in the **All Servers** group, in the server pool.  
...
1.  Do one of the following.  
    ...
    -   In the [!INCLUDE[sm](includes/sm_md.md)] navigation pane, right\-click a server group, and then click **Delete Server Group**.  
...
2.  When you are prompted to make sure you want to delete the server group, click **Yes**.  
    ...
    > [!NOTE]  
    > Deleting a server group does not remove servers from [!INCLUDE[sm](includes/sm_md.md)]. Servers that were in a deleted group remain in the **All Servers** group, in the server pool.  
