...
> [!IMPORTANT]  
> To deploy DirectAccess using this guide, you must use a DirectAccess server that is running [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)], [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)] or [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)].  
