...
If you're looking to download or use Work Folders on Windows 10 or Windows 7, see the following:

-   [Work Folders for Windows 10](http://support.microsoft.com/help/12370/windows-10-work-folders)
...
> [!NOTE]
>  In addition to the sync technologies listed in the previous table, Microsoft offers other replication technologies, including DFS Replication, which is designed for server-to-server replication, and BranchCache, which is designed as a branch office WAN acceleration technology. For more information, see [DFS Namespaces and DFS Replication](../Topic/DFS%20Namespaces%20and%20DFS%20Replication%20Overview.md) and [BranchCache Overview](assetId:///e25ed2da-80d0-4f32-8518-a736ad806272)  
...
|**Related technologies**|-   [File and Storage Services](../Topic/File%20and%20Storage%20Services%20Overview.md)<br />-   [File Server Resource Manager](../Topic/File%20Server%20Resource%20Manager%20Overview.md)<br />-   [Folder Redirection, Offline Files, and Roaming User Profiles](../Topic/Folder%20Redirection,%20Offline%20Files,%20and%20Roaming%20User%20Profiles%20overview.md)<br />-   [BranchCache](../Topic/BranchCache%20Overview.md)<br />-   [DFS Namespaces and DFS Replication](../Topic/DFS%20Namespaces%20and%20DFS%20Replication%20Overview.md)|