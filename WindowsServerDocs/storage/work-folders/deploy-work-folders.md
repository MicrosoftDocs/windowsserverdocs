...
|**Technical Reference**|-   [Interactive logon: Machine account lockout threshold](/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/jj966264(v=ws.11)&preserve-view=true)<br />-   [Sync Share Cmdlets](/powershell/module/syncshare/?view=win10-ps)|
