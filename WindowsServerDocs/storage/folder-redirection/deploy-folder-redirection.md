...
| Security group of users needing to put data on share (Folder Redirection Users)     |   Traverse folder / execute file *(Advanced permissions)* <p>List folder / read data *(Advanced permissions)* <p>Create folders / append data *(Advanced permissions)* <p>Read attributes *(Advanced permissions)* <p>Read extended attributes *(Advanced permissions)* <p>Read permissions *(Advanced permissions)*      |  This folder only       |
