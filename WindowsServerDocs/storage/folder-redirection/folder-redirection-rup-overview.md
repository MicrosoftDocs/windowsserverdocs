...
| Related technologies|[Identity and Access in Windows Server](../../identity/identity-and-access.md)<br>[Storage in Windows Server](../storage.yml)<br>[Remote access and server management](../../remote/index.md) |