...
Traditional Log is based on the [Common Log File System (CLFS)](https://learn.microsoft.com/windows-hardware/drivers/kernel/introduction-to-the-common-log-file-system).
