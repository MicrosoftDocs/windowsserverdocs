...
Unfortunately, we don't support creating a *new* partnership between Windows Server 2019 and Windows Server 2016. However, you can safely upgrade a server or cluster running Windows Server 2016 to Windows Server 2019 and any *existing* partnerships will continue to work.
