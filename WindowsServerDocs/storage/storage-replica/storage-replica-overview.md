...
In Windows Server 2019 (and Windows Server, version 1709 and newer) the **Test-Failover** cmdlet was added. This now supports temporarily mounting a read-write snapshot of the destination volume for backups, testing, etc. See https://aka.ms/srfaq for more info.
