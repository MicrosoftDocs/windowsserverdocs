...
- A **destination server** running Windows Server 2019 standalone or clustered to migrate to — Windows Server 2016 and Windows Server 2012 R2 work as well but are around 50% slower
