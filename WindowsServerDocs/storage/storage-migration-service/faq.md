...
Most errors found in the transfer CSV file are Windows System Error Codes. You can find out what each error means by reviewing the (Win32 error codes documentation)[https://docs.microsoft.com/en-us/windows/win32/debug/system-error-codes]. 
