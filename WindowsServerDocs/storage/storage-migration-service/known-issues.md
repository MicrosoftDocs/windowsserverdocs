---
title: Storage Migration Service known issues (KI)
...
---
# Storage Migration Service known issues (KI)
...
The Storage Migration Service contains event logs for the Orchestrator service and the Proxy Service. The Orchestrator node always contains both event logs, and destination servers with the Proxy service installed contain the Proxy logs. These logs are located under:
...
Please review the README for usage.
