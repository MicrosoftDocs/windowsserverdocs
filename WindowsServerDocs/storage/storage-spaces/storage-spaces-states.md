...
**TO DO: Include a graphic showing the interaction of the different states.**

## Virtual disk health and operational states

A virtual disk can be in one or more operational states, which map to a health state - either **OK**, **Warning**, **Unhealthy**, or **Unknown**. The following sections list the operational states that map to each health state.

### OK virtual disk health state
...
### Warning virtual disk health state
...
### Unhealthy virtual disk health state

|Operational state    |Detached reason |Description|
|---------            |---------       |--------   |
|Detached             |By Policy            |An administrator has taken the virtual disk offline. <br>**Action**: Bring the virtual disk back online by |
...
||Max|**TO DO: Need more info here**   |
|                     |None |**TO DO: Need more info here**       <br>**Action**: |
|                     |Unknown | Storage Spaces couldn't determine why the virtual disk is detached.    <br><br>**Action**:**TO DO: Need more info here**   |
|Unknown||Storage Spaces couldn't determine the state of the virtual disk.<br><br>**Action**: **TO DO: Need more info here**   |

## Physical disk health and operational states

## Storage pool health and operational states

### OK pool health state

|Operational state    |Description|
|---------            |---------          |
|OK|The storage pool is OK.|

### Warning pool health state
