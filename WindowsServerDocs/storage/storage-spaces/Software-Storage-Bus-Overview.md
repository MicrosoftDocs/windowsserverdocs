...
![Diagram showing cache devices (solid state storage) bound to multiple capacity devices (HDDs or SSDs)](media/Software-Storage-Bus-Overview/S2D_StorageBusCache.png)  
