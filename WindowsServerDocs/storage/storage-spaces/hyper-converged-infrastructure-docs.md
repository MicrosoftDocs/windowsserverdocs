---
layout: HubPage
title: Hyper-Converged Infrastructure Documentation for Windows Server
description: Detailed info on all hyper-converged infrastructure related documentation for windows server.
keywords: Hyper-Converged Infrastructure, Documentation,Storage Spaces Direct,Windows Server,S2D,Cluster,HCI, Hyper-Converged, docs
...
<div id="main" class="v2">
    <div class="container">
      <ul class="cardsY panelContent featuredContent">
          ...
          <li>
              <a href="https://github.com/MicrosoftDocs/windowsserverdocs/issues">
                  <div class="cardSize">
                      <div class="cardPadding">
                          <div class="card">
                              <div class="cardImageOuter">
                  ...
                  <div class="cardSize">
                      <div class="cardPadding">
                          <div class="card">
                              ...
                              <div class="cardText">
                                  <h3>Read the Storage Spaces Direct blog.</h3>
                              </div>
                          </div>
                      </div>
                  </div>
        ...
        <h1>Hyper-Converged Documentation</h1>
        <ul class="pivots">
            <li>
