...
- Enable three-way mirror or dual parity so that you can tolerate a node failures and keep the virtual disks online. See our [volume guidance page](../storage/storage-spaces/plan-volumes.md) for more details.
