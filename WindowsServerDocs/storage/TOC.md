...
## [Folder Redirection & Roaming User Profiles](folder-redirection-rup-overview.md)
### [Deploy Folder Redirection](deploy-folder-redirection.md)
### [Deploy primary computers](deploy-primary-computers.md)
### [Disable Offline Files on folders](disable-offline-files-on-folders.md)
### [Enable always offline mode](enable-always-offline.md)
### [Enable optimized folder moving](enable-optimized-moving.md)
### [Troubleshoot user profiles](troubleshoot-user-profiles-events.md)
...
## [File Server and SMB](file-server-smb-overview.md)
### [SMB Direct](smb-direct.md)
