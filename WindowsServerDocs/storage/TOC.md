...
#### [Reactivate a missing or offline dynamic disk](disk-management/reactivate-a-missing-or-offline-dynamic-disk.md)
#### [Change a basic disk into a dynamic disk](disk-management/change-a-basic-disk-into-a-dynamic-disk.md)
#### [Change a dynamic disk back to a basic disk](disk-management/change-a-dynamic-disk-back-to-a-basic-disk.md)
#### [Change a Master Boot Record disk into a GUID Partition Table disk](disk-management/change-an-mbr-disk-into-a-gpt-disk.md)   
#### [Change a GUID Partition Table disk into a Master Boot Record disk](disk-management/change-a-gpt-disk-into-an-mbr-disk.md)         
#### [Remove a missing dynamic disk](disk-management/remove-a-missing-dynamic-disk.md)
...
### [Manage dynamic volumes](disk-management/manage-dynamic-volumes.md)
#### [Create a simple volume](disk-management/create-a-simple-volume.md)
#### [Create a spanned volume](disk-management/create-a-spanned-volume.md)
#### [Extend a simple or spanned volume](disk-management/extend-a-simple-or-spanned-volume.md)
#### [Create a striped volume](disk-management/create-a-striped-volume.md)
