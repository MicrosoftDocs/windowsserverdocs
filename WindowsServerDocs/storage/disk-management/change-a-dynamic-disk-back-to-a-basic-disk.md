...
description: Learn how to convert a dynamic disk back to a basic disk in Windows.
ms.date: 03/20/2023
ms.topic: article
author: JasonGerend
manager: brianlic
...
> [!WARNING]
> To convert a dynamic disk back to a basic disk, you must delete all volumes from the disk, which permanently erases all data on the disk. Make sure you back up any data you want to keep before proceeding.
