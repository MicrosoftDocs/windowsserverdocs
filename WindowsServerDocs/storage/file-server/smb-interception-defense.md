...
1. **Use group Managed Service Accounts (gMSA)** - gMSA enabled services with their 127 random
   ...
   [Group Managed Service Accounts Overview](../../ad-ds/manage/group-managed-service-accounts/group-managed-service-accounts/group-managed-service-accounts-overview.md).
