...
|--------------|---------------|  
|volume|Adds a volume to the Shadow Copy Set, which is the set of volumes to be shadow copied. See [Add volume](../commands/Add-volume.md) for syntax and parameters.|  
|alias|Adds the given name and value to the alias environment. See [Add alias](../commands/Add-alias.md) for syntax and parameters.|  
