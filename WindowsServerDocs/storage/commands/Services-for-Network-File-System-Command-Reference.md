...
|[Nfsadmin](../commands/Nfsadmin.md)|Manage Server for NFS and Client for NFS.|  
|[Nfsshare](../commands/Nfsshare.md)|Control Network File System \(NFS\) shares.|  
|[Nfsstat](../commands/Nfsstat.md)|Display or reset counts of calls made to Server for NFS.|  
|[Rpcinfo](Rpcinfo.md)|List programs on remote computers.|  
|[Showmount](../commands/Showmount.md)|Display mounted directories.|  
