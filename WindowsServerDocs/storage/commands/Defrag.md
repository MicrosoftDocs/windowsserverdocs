...
-   You cannot defragment specific types of file system volumes or drives:  
    ...
    -   You cannot defragment volumes that the file system has marked as dirty, which indicates possible corruption. You must run **chkdsk** on a dirty volume before you can defragment it. You can determine if a volume is dirty by using the **fsutil** dirty query command. For more information about **chkdsk** and **fsutil** dirty, see [Additional references](../commands/Defrag.md#BKMK_AdditionalRef).  
...
-   [Chkdsk](../commands/Chkdsk.md)  
  
-   [Fsutil](../commands/Fsutil.md)  
  
-   [Fsutil dirty](../commands/Fsutil-dirty.md)  
