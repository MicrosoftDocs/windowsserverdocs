...
- You must deploy a core network using the [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] Core Network Guide, or you must already have the technologies provided in the Core Network Guide installed and functioning correctly on your network. These technologies include TCP/IP v4, DHCP, Active Directory Domain Services (AD DS), DNS, and NPS.  
