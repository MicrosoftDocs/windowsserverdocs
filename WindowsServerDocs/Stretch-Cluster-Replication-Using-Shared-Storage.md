...
## Prerequisites  
-   Active Directory Domain Services forest (does not need to run  [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)]\).  
-   At least two servers with [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] installed. Supports up to 64 node cluster.  
