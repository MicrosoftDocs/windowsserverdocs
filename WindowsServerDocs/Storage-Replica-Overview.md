...
This topic provides an overview of the new Storage Replica feature in [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] and includes the following sections:  
