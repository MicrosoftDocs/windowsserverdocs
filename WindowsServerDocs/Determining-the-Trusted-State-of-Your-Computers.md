...
-   **Operating system.** A trusted client computer should run [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)], [!INCLUDE[nextref_client_7](includes/nextref_client_7_md.md)], or [!INCLUDE[nextref_vista](includes/nextref_vista_md.md)]. A trusted server should run [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], [!INCLUDE[nextref_server_7](includes/nextref_server_7_md.md)], or [!INCLUDE[nextref_longhorn](includes/nextref_longhorn_md.md)].
...
|---------------------|-------------------------|-------------------------|------------------------------|---------------|----------------------|
|CLIENT001|No|No|Upgrade hardware and software.|Current operating system is Windows XP. Old hardware is not compatible with [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)].|$??|
|SERVER001|Yes|No|Join trusted domain and upgrade from Windows Server 2003 to [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)].|No antivirus software present.|$??|
