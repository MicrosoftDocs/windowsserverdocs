...
![](media/GTR_ADDS_PS_Install2003DFL.gif)  
  
![](media/GTR_ADDS_PS_InstallDFL2.gif)  
...
6.  Ensure the **Extended** check box is selected on the Search Options dialog box and select **OK**.  
    ...
    ![](media/GTR_ADDS_SearchOptions.gif)  
...
![](media/GTR_ADDS_Event1644_2012.gif)  
  
NEW  
  
![](media/GTR_ADDS_Event1644_2012R2.gif)  
