...
This topic describes the File Server Resource Manager features that are included with the File and Storage Services server role in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)].
