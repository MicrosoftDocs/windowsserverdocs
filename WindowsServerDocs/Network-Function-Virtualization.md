...
![](media/Microsoft-Network-Function-Virtualization.png)

The Microsoft platform has been engineered to be a great platform to build and deploy virtual appliances. Here’s why:

-   Microsoft provides key virtualized network functions with [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)].
...
The following virtual appliances are provided with [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)]:
