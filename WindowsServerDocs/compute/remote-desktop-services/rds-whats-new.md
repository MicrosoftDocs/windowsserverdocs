...
Also be sure to check out our session from Ignite 2016: [Harness RDS improvements in Windows Server 2016](https://myignite.microsoft.com/videos/2794). In this video, the product team reviews all of the new and improved features in Remote Desktop Services, including vGPU support. 
