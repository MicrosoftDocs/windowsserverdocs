...
Please note that the official Mac app, available through the AppStore, does not support as much redirection as our [new preview Mac client](https://aka.ms/rdmac-preview). 
...
*For printer redirection - the RDC and preview Mac apps support the Publisher Imagesetter printer driver by default. They do not support redirecting native printer drivers.