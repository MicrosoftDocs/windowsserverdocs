...
|Task   |Resources|  
|-|-|  
|![](media/All_Symbols_MeetsRequirements.png)|**Evaluate Hyper-V**<br /><br />-   [What's new in Hyper-V on Windows Server 2016 Technical Preview](What-s-new-in-Hyper-V-on-Windows.md)<br />-   [System requirements for Hyper-V on Windows Server 2016 Technical Preview](System-requirements-for-Hyper-V-on-Windows.md)<br />-   [Supported Windows guest operating systems for Hyper-V](Supported-Windows-guest-operating-systems-for-Hyper-V-on-Windows.md) <br />- [Supported Linux and FreeBSD virtual machines](Supported-Linux-and-FreeBSD-virtual-machines-for-Hyper-V-on-Windows.md)<br />- [Feature compatibility by generation and guest](Hyper-V-feature-compatibility-by-generation-and-guest.md) <br /><br />**Plan for Hyper-V**<br /><br />- [VM generation](plan/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V.md) <br />- [Hyper-V scalability](plan/Plan-for-Hyper-V-scalability-in-Windows-Server-2016.md) <br />- [Hyper-V networking](plan/Plan-for-Hyper-V-networking-in-Windows-Server-2016.md)|  
