...
- Harden the Hyper-V host operating system using the baseline security setting recommendations described in the [Windows Server Security Baseline](https://technet.microsoft.com/library/jj898542.aspx). 
