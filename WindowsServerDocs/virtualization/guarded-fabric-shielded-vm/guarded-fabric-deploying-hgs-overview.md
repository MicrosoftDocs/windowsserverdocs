...
| &nbsp; |<img src="../media/Guarded-Fabric-Shielded-VM/6666.png" alt="Step 6" hspace="8" align="left" /> [Verify host&nbsp;prerequisites (Admin)](guarded-fabric-guarded-host-prerequisites##admin-trusted-attestation)<br>[Verify host&nbsp;prerequisites (TPM)](guarded-fabric-guarded-host-prerequisites#tpm-trusted-attestation)<img src="../media/Guarded-Fabric-Shielded-VM/guarded-host-verify.png" alt="Step 6" hspace="8" align="right" />| |
