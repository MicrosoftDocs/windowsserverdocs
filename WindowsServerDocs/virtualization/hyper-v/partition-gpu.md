...
This article describes how to use the graphics processing unit (GPU) partitioning feature introduced in Windows Server 2025. It provides instructions on how to configure GPU partition count, assign GPU partitions, and unassign GPU partitions via Windows Admin Center and PowerShell.
::: zone-end
