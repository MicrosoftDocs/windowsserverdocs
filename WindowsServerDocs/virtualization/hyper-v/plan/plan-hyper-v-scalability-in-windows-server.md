...
|Virtual processors|240 for generation 2;<br/>64 for generation 1;<br/>320 available to the host OS (root partition)|The number of virtual processors supported by a guest operating system might be lower. For details, see the information published for the specific operating system. The root partition limit of 320 applies to Windows Server 2016 and 2019. For Windows Server 2022, the limit is increased to 1,024.|
