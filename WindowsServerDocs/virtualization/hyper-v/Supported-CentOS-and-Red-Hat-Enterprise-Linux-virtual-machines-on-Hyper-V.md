...
15. In Red Hat Enterprise Linux or CentOS 5.2, 5.3, and 5.4 the filesystem freeze functionality isn't available, so Live Virtual Machine Backup is also not available.
