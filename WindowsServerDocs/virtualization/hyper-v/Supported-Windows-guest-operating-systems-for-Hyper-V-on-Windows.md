...
- **Host operating systems**:
  ...
  - Generation 2 virtual machine hosted on Azure Local, version 22H2 and later.
- **Notes**:  
  - Windows 11 requires an increased CPU instruction (POPCNT and SSE4.2) for installation and boot. To meet these requirements in Hyper-V:  
