...
|![User group icon](media/All_Symbols_Users_Group.png)|**Forum and newsgroups**<p>Got questions? Talk to your peers, MVPs, and the Hyper-V product team.<p>- [Windows Server Community](https://techcommunity.microsoft.com/t5/Windows-Server/ct-p/Windows-Server)<br />- [Windows Server Hyper-V TechNet forum](https://docs.microsoft.com/answers/topics/windows-server-hyper-v.html)|
