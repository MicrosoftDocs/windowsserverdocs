...
|Task|Description|  
|--------|---------------|  
|2.1 Plan the RADIUS server|For the OTP authentication server, Remote Access in [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)] and [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)] supports any RADIUS\-enabled OTP server that supports the password authentication protocol \(PAP\).|  
