...
-   [Active Directory Domain Services Simplified Administration](Install-a-New-Windows-Server-2012-Active-Directory-Forest--Level-200-.md#BKMK_SimplifiedAdmin)

-   [Technical Overview](Install-a-New-Windows-Server-2012-Active-Directory-Forest--Level-200-.md#BKMK_TechOverview)
...
-   [Deploying a Forest with Windows PowerShell](Install-a-New-Windows-Server-2012-Active-Directory-Forest--Level-200-.md#BKMK_PSForest)
...
![](media/ADDS_SMI_SelectServerRoles.gif)
...
![](media/ADDS_PSAddWindowsFeature.png)
...
![](media/ADDS_PSInstallADDSForest.png)
...
![](media/adds_servermanagerdeployment.png)
...
![](media/ADDS_SMI_TR_AddServers.png)
...
![](media/tADDS_SMI_TR_AddRolesFeatures.png)
...
![](media/ADDS_SMI_TR_AddADDSToAnotherServer.png)
...
![](media/ADDS_SMI_TR_ManageAddRoles.png)

#### Installation Type
![](media/ADDS_SMI_TR_SelectInstallationType.png)
...
#### Server Selection
![](media/ADDS_SMI_TR_SelectDestinationServer.png)
...
![](media/ADDS_SMI_TR_SelectServerRoles.png)
...
![](media/ADDS_SMI_TR_AddFeaturesDialog.gif)

![](media/ADDS_SMI_TR_SelectFeatures.png)

Additional **Features** can be added here as desired.

#### Active Directory Domain Services
![](media/ADDS_SMI_TR_ADDSIntro.png)
...
#### Confirmation
![](media/ADDS_SMI_TR_Confirmation.png)
...
![](media/ADDS_SMI_TR_TaskNotofications.png)

**AD DS Details**

![](media/ADDS_SMI_TR_ADDSDetails.png)

**Task Details**

![](media/ADDS_SMI_TR_TaskDetails.png)

#### Promote to Domain Controller
![](media/ADDS_SMI_TR_Promote.png)
...
Active Directory Domain Services role removal is different from installation, in that it requires domain controller demotion before it can complete. This is necessary to prevent a domain controller from having its role binaries uninstalled without proper metadata cleanup in the forest. For more information, see [Demoting Domain Controllers and Domains &#40;Level 200&#41;](Demoting-Domain-Controllers-and-Domains--Level-200-.md).
...
![](media/adds_forestdeploy2.png)

#### Deployment Configuration
![](media/ADDS_SMI_TR_AddNewForest.png)
...
The **Domain Controller Options** enables you to configure the **forest functional level** and **domain functional level** for the new forest root domain. By default, these settings are [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] in a new forest root domain. The [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] forest functional level does not provide any new functionality over the Windows Server 2008 R2 forest functional level. The [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] domain functional level is required only in order to implement the new Kerberos settings "always provide claims" and "Fail unarmored authentication requests." A primary use for functional levels in [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] is to restrict participation in the domain to domain controllers that meet minimum\-allowed operating system requirements. In other words, you can specify [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] domain functional level only domain controllers that run [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] can host the domain. [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] implements a new domain controller flag called **DS\_WIN8\_REQUIRED** in the **DSGetDcName** function of NetLogon that exclusively locates [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] domain controllers. This allows you the flexibility of a more homogeneous or heterogeneous forest in terms of which operating systems are permitted to be run on domain controllers.
...
![](media/ADDS_SMI_TR_ForestDNSOptions.png)
...
#### Additional Options
![](media/ADDS_SMI_TR_ForestAdditionalOptions.png)
...
#### Paths
![](media/ADDS_SMI_TR_ForestPaths.png)
...
![](media/ADDS_SMI_TR_ForestReviewOptions.png)
...
#### Prerequisites Check
![](media/ADDS_SMI_TR_ForestPrereqCheck.png)
...
#### Installation
![](media/ADDS_SMI_TR_ForestInstallation.png)
...
![](media/adds_servermanagerdeployment_powershell.png)
...
![](media/ADDS_PSInstallWinFeature.png)
...
![](media/ADDS_PSGetWindowsFeature.png)
...
![](media/ADDS_PSReboot.png)

![](media/ADDS_PSInstallProgress.png)
