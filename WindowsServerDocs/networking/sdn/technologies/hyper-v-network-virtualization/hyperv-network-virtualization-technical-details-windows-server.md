...
>[!IMPORTANT]
>HNVv2 includes vfpctrl.exe as a tool for VFP diagnostics which should be used by Administrators only under the direction of Microsoft Support.  Any other use of vfpctrl.exe is unsupported and could result in system instability.
