...
|InputProvider|All|Entry indicates whether to enable the NtpClient as an InputProvider. The NtpServer outputs (pushes) time samples to the NtpClient. <ul><li>Yes = 1  </li><li>No = 0 </li></ul><p>Default value for both domain members and stand-alone clients: 1  |
