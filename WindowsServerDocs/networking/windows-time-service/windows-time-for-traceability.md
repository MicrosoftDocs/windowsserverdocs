...
|||
|---|---|
|Event desciption |TP Client Provider Periodic Status |
...
|||
|---|---|
|Event desciption |Time service configuration and status |
...
|||
|---|---|
|Event desciption |System Time is set |
|Details |  |
...
|||
|---|---|
|Event desciption |System clock frequency adjusted |
...
|Data logged | |
|Throttling mechanism  |All clock adjustments below TimeAdjustmentAuditThreshold (min = 128 part per million, default = 800 part per million) are not logged.<br><br>2 PPM change in clock frequency with current granularity yields 120 µsec/sec change in clock accuracy.<br><br>On a synchronized system, majority of the adjustments are below this level. If finer tracking is desired, this setting can be adjusted down and/or PerfCounters should be used. |

# [263](#tab/263)

|||
|---|---|
|Event desciption |Change in the Time service settings or list of loaded time providers. |
...
|||
|---|---|
|Event desciption |Change in time source(s) used by NTP Client |
...
|||
|---|---|
|Event desciption |Time service source or stratum number changes |
...
|||
|---|---|
|Event desciption |Time re-synchronization is requested |
