...
To allow  Windows 7  client computers access through the first entry point through the security group DA\_Clients\_US and using the GPO DA\_W7\_Clients\_GPO\_US.  
...
To allow  Windows 7  client computers access through the second entry point through the security group DA\_Clients\_Europe and using the GPO DA\_W7\_Clients\_GPO\_Europe.  
