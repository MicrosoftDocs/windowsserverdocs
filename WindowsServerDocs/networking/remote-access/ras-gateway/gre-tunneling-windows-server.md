...
-   [Access from tenant virtual networks to tenant physical networks](networking/remote-access/ras-gateway/gre-tunneling-windows-server.md#BKMK_Access)  
  
-   [High speed connectivity](networking/remote-access/ras-gateway/gre-tunneling-windows-server.md#BKMK_Speed)  
  
-   [Integration with VLAN based isolation](networking/remote-access/ras-gateway/gre-tunneling-windows-server.md#BKMK_Integration)  
  
-   [Access shared resources](networking/remote-access/ras-gateway/gre-tunneling-windows-server.md#BKMK_Shared)  
  
-   [Services of third party devices to tenants](networking/remote-access/ras-gateway/gre-tunneling-windows-server.md#BKMK_thirdparty)  
...
![](networking/media/gre-tunneling-windows-server/GRE_.png)  
...
![](networking/media/gre-tunneling-windows-server/GRE-.png)  
...
![](networking/media/gre-tunneling-windows-server/GRE-VLANIsolation.png)  
...
![](networking/media/gre-tunneling-windows-server/GRE-SharedResource.png)  
...
![](networking/media/gre-tunneling-windows-server/GREThirdParty.png)  
