...
For more information, see [Add-DnsServerRecursionScope](https://docs.microsoft.com/en-us/powershell/module/dnsserver/add-dnsserverrecursionscope?view=win10-ps)
