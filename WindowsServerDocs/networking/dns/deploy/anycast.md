---
title: Deploying Anycast DNS for performance and redundancy
description: This topic provides a brief overview of DNS Anycast
manager: laurawi
...
author: greg-lindsay
---
# Deploying Anycast DNS for performance and redundancy
...
DNS Anycast is a method that enables a specified DNS server, or one of a group of servers, to respond to a DNS query based on the geographical location of a DNS client. 

With DNS Anycast, you can enhance DNS response time and simplify DNS client settings. DNS Anycast also provides an extra layer of redundancy and can help protect against DNS denial of service attacks. 
...
3. The SEA router sends the query to the 10.10.10.10 destination corresponding to the SEA load balancer virual IP address (VIP).
