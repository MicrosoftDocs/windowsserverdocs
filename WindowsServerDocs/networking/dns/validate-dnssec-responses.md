...
:::image type="content" source="../media/validate-dnssec-responses/validation-process.png" alt-text="Image showing a summary of the DNSSEC validation process":::
...
:::image type="content" source="../media/validate-dnssec-responses/recursive-query-process.png" alt-text="Image showing the recursive DNS query process as summarized in the following table":::
