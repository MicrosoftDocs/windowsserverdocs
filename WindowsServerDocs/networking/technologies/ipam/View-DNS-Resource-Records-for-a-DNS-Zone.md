...
<<<<<<< HEAD
    ![Type text upon which to filter records](../../media/View-DNS-Resource-Records-for-a-DNS-Zone/ipam_DNSzones_01c.jpg)  
...
6.  To filter the resource records by record type, access scope, or other criteria, click **Add criteria**, and then make selections from the criteria list and click **Add**.  
    ...
    ![Add criteria to filter results](../../media/View-DNS-Resource-Records-for-a-DNS-Zone/ipam_DNSzones_01d.jpg)  
=======
