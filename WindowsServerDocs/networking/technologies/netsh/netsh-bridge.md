...
| Command | Description |
|--|--|
| [help](#display-help) | Display a list of commands for the `netsh bridge` context. |
| [list](#list-bridge) | List all available bridges by their unique bridge GUIDs. |
| [show adapter](#show-adapter) | List all network adapters that can be bridged and network adapters that already form a bridge. |
| [create](#create-bridge) | Create a bridge using least two network adapters. |
| [add](#add-adapter-to-bridge) | Add a network adapter to an existing bridge. |
| [remove](#remove-adapter-from-bridge) | Remove a bridged network adapter from an existing bridge. |
| [remove all frp,](#remove-all-adapters-from) | Remove all bridged network adapters from an existing bridge and  destroy the bridge. |
| [destroy](#destroy-bridge) | Remove all bridged network adapters from an existing bridge and destroy the bridge. |
