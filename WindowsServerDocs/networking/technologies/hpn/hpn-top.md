...
- **RSC in the vSwitch:** RSC in the vSwitch is an feature that takes packets that are part of the same stream and arrive between network interrupts, and coalesces them into a single packet before delivering them to the operating system. This feature is built into the virtual switch in Windows Server 2019.  For information on the hardware only version of RSC, please see [Receive Side Scaling (RSS)](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/hh997024(v=ws.11))
