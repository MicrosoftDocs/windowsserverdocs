...
You can manage NICs and all the features via Windows PowerShell using the [NetAdapter](https://docs.microsoft.com/en-us/powershell/module/netadapter/?view=win10-ps&viewFallbackFrom=winserverr2-ps) cmdlet.  You can also manage NICs and all the features using Network Control Panel (ncpa.cpl). 
