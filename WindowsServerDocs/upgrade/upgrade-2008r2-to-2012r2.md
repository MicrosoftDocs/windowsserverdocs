...
To upgrade to Windows Server 2019, use this topic first to upgrade to Windows Server 2012 R2, and then upgrade from Windows Server 2012 R2 to Windows Server 2019.
