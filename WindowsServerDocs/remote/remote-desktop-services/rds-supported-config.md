...
|------------------------------------------|-----------|-----------|---------------|---------------|
| Windows Server 2016 Connection Broker    | Supported | Supported | Not supported | Supported     |
| Windows Server 2012 R2 Connection Broker | N/A       | N/A       | Not supported | Supported     |
