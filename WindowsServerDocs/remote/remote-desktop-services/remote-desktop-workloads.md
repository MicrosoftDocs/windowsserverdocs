...
|Workload type|Who uses this workload type|Example apps|
|---|---|---|
|Light|Someone doing basic data entry tasks|Database entry applications, command-line interfaces|
...
|Power|Graphic designers, 3D modelers, machine learning researchers|Database entry applications, command-line interfaces, Microsoft Word, static web pages, Microsoft Outlook, Microsoft PowerPoint, dynamic web pages, Adobe Photoshop, Adobe Illustrator, computer-aided design (CAD), computer-aided manufacturing (CAM)|
