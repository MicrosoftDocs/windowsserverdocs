...
Choose the client that matches your Windows Architecture. The new Remote Desktop Client (MSRDC) supports Windows 10, Windows 10 IoT Enterprise, and Windows 7 client devices. 
