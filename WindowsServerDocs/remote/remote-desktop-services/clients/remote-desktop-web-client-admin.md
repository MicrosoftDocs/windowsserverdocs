...
3. Open the Windows Registry (regedit), go to **HKLM\SYSTEM\CurrentControlSet\Control\Terminal Server\WinStations\RDP-Tcp**, and locate the key's **WebSocketURI**. The value must be set to the following:
