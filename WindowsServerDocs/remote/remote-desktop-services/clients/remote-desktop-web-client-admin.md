...
3. Open the Windows Registry (regedit), go to **HKLM\SYSTEM\CurrentControlSet\Control\Terminal Server\WinStations\RDP-Tcp**, and locate the key's **WebSocketURI**. Next, set the value to `https://+:3392/rdp/`.
