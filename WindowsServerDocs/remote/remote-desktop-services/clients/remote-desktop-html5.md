...
1. In the Connection Center, select **+**, and then select **Desktop**.
...
Need to edit these settings? Select the overflow menu (**...**) next to the name of the desktop, and then select **edit**.
