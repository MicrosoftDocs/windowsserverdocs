...
---
# Change the listening port for Remote Desktop on your PC

>Applies to: Windows 10, Windows 8.1, Windows 8

When you connect to a PC through the Remote Desktop client, the Remote Desktop feature on your PC "hears" the connection request through a defined listening port (3389 by default). You can change that listening port on Windows PCs by modifying the registry.
