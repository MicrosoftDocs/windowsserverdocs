...
## Updates for version 1.2.1023

*Date published: 05/12/2020*

Download: [Windows 64-bit](), [Windows 32-bit](), [Windows ARM64]()

- Added a new **Subscribe with URL** option that allows you to specify the URL of the Workspace you are subscribing to or leverage [email discovery](../rds-email-discovery) when available in cases where we can't automatically find your resources. This is similar to the subscription process in the other Remote Desktop clients. This can be used to subscribe directly to WVD Spring 2020 Update Workspaces.
