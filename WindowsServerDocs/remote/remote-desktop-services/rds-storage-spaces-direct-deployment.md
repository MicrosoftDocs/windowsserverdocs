...
> [!NOTE]
> Microsoft just published an [Azure template to deploy a Storage Spaces Direct scale-out file server](/windows-server/remote/remote-desktop-services/rds-storage-spaces-direct-deployment)! You can use the template to create your deployment, or use the steps in this article.
