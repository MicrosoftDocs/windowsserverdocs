...
##### [Step 5. Configure Windows 10 Client Always On VPN Connections](remote-access/vpn/always-on-vpn/deploy/vpn-deploy-client-vpn-connections.md)
##### [Step 6. Conditional access for VPN connectivity using Azure AD](remote-access/vpn/ad-ca-vpn-connectivity-windows10.md)
###### [Step 6.1. Configure EAP-TLS to ignore Certificate Revocation List (CRL) checking](remote-access/vpn/vpn-config-eap-tls-to-ignore-crl-checking.md)
###### [Step 6.2. Create root certificates for VPN authentication with Azure AD](remote-access/vpn/vpn-create-root-cert-for-vpn-auth-azure-ad.md)
