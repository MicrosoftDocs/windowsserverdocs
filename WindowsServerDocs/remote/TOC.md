...
### [Get started](remote-desktop-services/rds-get-started.md)
#### [What's new in RDS?](remote-desktop-services/rds-whats-new.md)
#### [Supported configurations for RDS](remote-desktop-services/rds-supported-config.md)
#### [Supported security configurations for Windows 10 VDI](remote-desktop-services/rds-vdi-supported-config.md)
#### [Planning poster for Remote Desktop Services](remote-desktop-services/rds-poster.md)
#### [Host Windows Desktop and Applications using Remote Desktop Services in Azure](remote-desktop-services/rds-hosting-partners.md)
### [Plan and design](remote-desktop-services/rds-plan-and-design.md)
#### [Build anywhere](remote-desktop-services/rds-plan-build-anywhere.md)
#### [Cater to different kinds of users](remote-desktop-services/rds-plan-cater-to-users.md)
#### [Access from anywhere](remote-desktop-services/rds-plan-access-from-anywhere.md)
#### [High availability](remote-desktop-services/rds-plan-high-availability.md)
#### [Multifactor Authentication](remote-desktop-services/rds-plan-mfa.md)
#### [Secure data storage](remote-desktop-services/rds-plan-secure-data-storage.md)
#### [Choose your graphics rendering technology](remote-desktop-services/rds-graphics-virtualization.md)
#### [Connect from any device](remote-desktop-services/rds-plan-connect-from-any-device.md)
#### [Choose how you pay](remote-desktop-services/rds-plan-choose-how-you-pay.md)
#### [Office 2016 in RDS and VDI deployments](remote-desktop-services/rds-office-vdi-rdsh.md)
#### [Desktop Hosting Reference Architecture](remote-desktop-services/Desktop-Hosting-Reference-Architecture.md)
##### [Remote Desktop Services architecture](remote-desktop-services/Desktop-hosting-logical-architecture.md)
##### [Desktop hosting service](remote-desktop-services/Desktop-hosting-service.md)
##### [Azure services and considerations for desktop hosting](remote-desktop-services/Azure-services-and-considerations-for-desktop-hosting.md)
### [Build and deploy](remote-desktop-services/rds-build-and-deploy.md)
#### [Deploy a proof-of-concept RDS environment with ARM and Azure Marketplace](remote-desktop-services/rds-in-azure.md)
#### [Migrate your Remote Desktop Services deployments to Windows Server 2016](remote-desktop-services/migrate-rds-role-services.md)
#### [Migrate your Remote Desktop Services Client Access Licenses (RDS CALs)](remote-desktop-services/migrate-rds-cals.md)
#### [Upgrade your Remote Desktop Services deployments to Windows Server 2016](remote-desktop-services/upgrade-to-rds-2016.md)
...
##### [Deploy a two-node Storage Spaces Direct file system for UPD storage](remote-desktop-services/rds-storage-spaces-direct-deployment.md)
##### [Deploy and manage a personal session desktops environment](remote-desktop-services/rds-personal-session-desktops.md)
##### [Create VMs for RDS](remote-desktop-services/rds-prepare-vms.md)
#### Create an Azure-based hosting environment with RDS
##### [Configure your desktop hosting environment](remote-desktop-services/Configure-your-desktop-hosting-environment.md)
###### [Create virtual machines for Remote Desktop](remote-desktop-services/create-virtual-machines-for-remote-Desktop.md)
###### [Prepare your virtual machines for Remote Desktop](remote-desktop-services/Prepare-your-virtual-machines-for-remote-Desktop.md)
###### [Validate and secure your Remote Desktop deployment](remote-desktop-services/Validate-and-secure-your-remote-Desktop-deployment.md)
##### [Deploy a basic desktop hosting environment using Azure IaaS](remote-desktop-services/Deploy-a-basic-desktop-hosting-environment-using-Azure-IaaS.md)
###### [Deploy your Remote Desktop environment](remote-desktop-services/Deploy-your-remote-Desktop-environment.md)
##### [Deploy a Remote Desktop Session Host farm to improve availability](remote-desktop-services/Deploy-a-remote-Desktop-Session-Host-farm-to-improve-availability.md)
###### [Create a virtual machine for the Remote Desktop Session Host server](remote-desktop-services/create-a-virtual-machine-for-the-remote-Desktop-Session-Host-server.md)
###### [Prepare the RDSH virtual machine](remote-desktop-services/Prepare-the-rdsh-virtual-machine.md)
###### [Add the RDSH server to the collection farm](remote-desktop-services/add-the-rdsh-server-to-the-collection-farm.md)
##### [Deploy a Remote Desktop Connection Broker cluster](remote-desktop-services/Deploy-a-remote-Desktop-Connection-Broker-cluster.md)
###### [Use an Azure SQL database to enable high availability for your Connection Broker](remote-desktop-services/Use-an-Azure-SQL-database-to-enable-high-availability-for-your-Connection-Broker.md)
###### [Create a second RD Connection Broker virtual machine](remote-desktop-services/create-a-second-RD-Connection-Broker-virtual-machine.md)
###### [Prepare the RD Connection Broker VM for Remote Desktop](remote-desktop-services/Prepare-the-RD-Connection-Broker-VM-for-remote-Desktop.md)
###### [Create an Azure SQL database for the RD Connection Broker](remote-desktop-services/create-an-Azure-SQL-database-for-the-RD-Connection-Broker.md)
###### [Install the ODBC driver for SQL on each RD Connection Broker server](remote-desktop-services/install-odbc-on-connection-broker.md)
###### [Create an Azure internal load balancer for Remote Desktop deployment](remote-desktop-services/create-an-Azure-internal-load-balancer-for-remote-Desktop-deployment.md)
###### [Add the RD Connection Broker server to the deployment and configure high availability](remote-desktop-services/add-the-RD-Connection-Broker-server-to-the-deployment-and-configure-high-availability.md)
###### [Configure trusted certificates on RD Connection Broker servers and clients](remote-desktop-services/Configure-trusted-certificates-on-rd-Connection-Broker-servers-and-clients.md)
##### [Deploy a RD Web Access and Gateway farm](remote-desktop-services/Deploy-a-RD-Web-Access-and-Gateway-farm.md)
###### [Add RD Web and Gateway server to the RDS deployment](remote-desktop-services/add-rd-Web-and-Gateway-server-to-the-rds-deployment.md)
###### [Configure the current RD Web and Gateway virtual machine for load balancing](remote-desktop-services/Configure-the-current-RD-Web-and-Gateway-virtual-machine-for-load-balancing.md)
##### [Deploy RemoteApp programs](remote-desktop-services/Deploy-remoteApp-programs.md)
###### [Add the RDSH Server, create a collection, and publish the RemoteApp programs](remote-desktop-services/add-the-rdsh-Server-create-a-collection-and-publish-the-RemoteApp-programs.md)

### [Run and tune](remote-desktop-services/rds-run-and-tune.md)
#### [Set up and configure RemoteFX vGPU for Remote Desktop Services](remote-desktop-services/rds-remotefx-vgpu.md)
#### [Manage personal desktop session collections](remote-desktop-services/rds-manage-personal-collection.md)
#### [Manage users in your RDS collection](remote-desktop-services/rds-user-management.md)
### [Additional Remote Desktop support](remote-desktop-services/rds-get-support.md)
### [Remote Desktop clients](remote-desktop-services/clients/remote-desktop-clients.md)
#### [Which client works best for you?](remote-desktop-services/clients/remote-desktop-app-compare.md)
#### [Supported PCs](remote-desktop-services/clients/remote-desktop-supported-config.md)
#### [Grant Remote Desktop access to your PC](remote-desktop-services/clients/remote-desktop-allow-access.md)
#### [Getting started with Remote Desktop client on Android](remote-desktop-services/clients/remote-desktop-android.md)
#### [Getting started with Remote Desktop client on iOS](remote-desktop-services/clients/remote-desktop-ios.md)
#### [Getting started with Remote Desktop client on Mac](remote-desktop-services/clients/remote-desktop-mac.md)
#### [Remote Desktop client FAQ](remote-desktop-services/clients/remote-desktop-client-faq.md)
#### [Remote Desktop URI scheme](remote-desktop-services/clients/remote-desktop-uri.md)
...
## [Web Application Proxy in Windows Server 2016](remote-access//web-application-proxy/web-application-proxy-windows-server.md)
