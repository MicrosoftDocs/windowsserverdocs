...
DirectAccess documentation is now located in the [Remote access and server management](../index.yml) section of the Windows Server 2016 table of contents, under [Remote Access](./remote-access.md). For more information, see [DirectAccess](directaccess/DirectAccess.md).
