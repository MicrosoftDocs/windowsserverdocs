...
5. **[Create the ProfileXML configuration files](vpn-deploy-create-profilexml.md)**. Configure the template VPN profile on a domain-joined client computer and create the ProfileXML configuration files.
