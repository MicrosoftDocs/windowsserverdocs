...
| Ability to determine intranet connectivity when connected to the corporate network. | Trusted network detection provides the capability to detect corporate network connections, and it is based on an assessment of the connection-specific DNS suffix assigned to network interfaces and network profile.<p>Define this functionality by using the VPNv2 CSP parameter:<br>**VPNv2/ProfileName/TrustedNetworkDetection** |
