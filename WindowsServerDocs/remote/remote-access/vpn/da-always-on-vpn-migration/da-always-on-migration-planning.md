...
- **•	Migrate each department or business unit in multiple phases.** Microsoft strongly recommends that you don't migrate an entire department at the same time. If an issue should arise, you don't want it to hinder remote work for the whole department. Instead, migrate each department or business unit in at least two phases.
...
Each item in this section is a use case scenario or commonly used DirectAccess function for in which Always On VPN does not have an equivalent natively. Fortunately, you can implement this functionality in other ways.<!-- so what are the other ways?-->
