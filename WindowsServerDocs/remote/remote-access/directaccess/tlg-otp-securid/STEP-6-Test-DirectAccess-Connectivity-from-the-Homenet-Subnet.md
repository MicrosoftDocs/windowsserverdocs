...
1. Paste the previously copied eight digit tokencode, and select **OK**. Wait for authentication to complete. The DirectAccess Workplace Connection status will be **Connected**.
...
1. In the **Files** shared folder window, double-select the **Example.txt** file. You see the contents of the Example.txt file.

1. On the **Start** screen, type<strong>\\\app2\files</strong>, and press ENTER.

1. In the **Files** shared folder window, double-select the **New Text Document.txt** file. You see the contents of the New Text Document.txt file.