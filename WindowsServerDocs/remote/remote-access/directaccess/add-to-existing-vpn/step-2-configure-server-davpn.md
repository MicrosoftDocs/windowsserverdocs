...
description: Learn how to configure the client and server settings required for a basic Remote Access deployment using the Enable DirectAccess Wizard.w
manager: brianlic
ms.topic: article
