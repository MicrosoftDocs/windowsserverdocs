...
The Health Service is a new feature in [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] which significantly improves the day-to-day monitoring, operations, and maintenance experience of Storage Spaces. As of Technical Preview 5, it is supported only for Storage Spaces Direct.

## Prerequisites

The Health Service is enabled by default with Storage Spaces Direct. No additional action is required to set it up or start it. To learn more about Storage Spaces Direct, see [Storage Spaces Direct in Windows Server 2016 Technical Preview](Storage-Spaces-Direct-in-Windows-Server-2016-Technical-Preview.md).
...
In [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], the Health Service provides the following Metrics:
...
![HealthServicePoolVolumeCapacitymedia/CapacityMetricsBreakdown.png)
...
>[!NOTE] The physical location is derived from your fault domain configuration. For more information about fault domains, see [Fault Domains in Windows Server 2016 Technical Preview](Fault-Domains-in-Windows-Server-2016-Technical-Preview.md). If you do not provide this information, the location field will be less helpful - for example, it may only show the slot number.
...
>[!NOTE] In [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], it may take up to 30 minutes for certain Faults to appear. Improvements are forthcoming in subsequent releases. 
...
In [!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)], the **Get-StorageHealthAction** cmdlet can return any of the following information:
