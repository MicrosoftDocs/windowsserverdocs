...
As of [!INCLUDE[winthreshold_server_2_mdincludes/winthreshold_server_2_md.md)], integration services are delivered through Windows Update. Ensure the virtual machines are configured to receive updates to get the latest version of integration services.  
