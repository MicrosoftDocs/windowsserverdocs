...
This topic lists the planning steps that are required to deploy a single DirectAccess server running [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)], [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)], or [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)] with a full range of basic and advanced features. The planning phase includes the following topics.  
