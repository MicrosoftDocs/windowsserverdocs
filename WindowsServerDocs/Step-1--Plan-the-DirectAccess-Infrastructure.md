...
Certificate requirements for IPsec include a computer certificate used by DirectAccess client computers when establishing the IPsec connection between the client and the DirectAccess server, and a computer certificate used by DirectAccess servers to establish IPsec connections with DirectAccess clients. For DirectAccess in [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] and [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)] the use of these IPsec certificates is not mandatory. The Getting Started Wizard configures the DirectAccess server to act as a Kerberos proxy to perform IPsec authentication without requiring certificates.  
...
If you want to provision a certificate for these purposes, refer to [Deploy a Single DirectAccess Server with Advanced Settings](Deploy-a-Single-DirectAccess-Server-with-Advanced-Settings.md). If no certificates are available, the Getting Started wizard automatically creates self\-signed certificates for these purposes.  
...
-   For DirectAccess clients, you must use a DNS server that is running [!INCLUDE[firstref_longhorn](includes/firstref_longhorn_md.md)], [!INCLUDE[firstref_server_7](includes/firstref_server_7_md.md)], [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)], [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)], [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)], or any DNS server that supports IPv6.  
...
If you want to deploy a Network Location Server and not use self\-signed certificates, refer to [Deploy a Single DirectAccess Server with Advanced Settings](Deploy-a-Single-DirectAccess-Server-with-Advanced-Settings.md).  
