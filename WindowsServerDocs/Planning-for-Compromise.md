...
> [!NOTE]
> Some of the applications listed in [Appendix J: Third-Party RBAC Vendors](Appendix-J--Third-Party-RBAC-Vendors.md) and [Appendix K: Third-Party PIM Vendors](Appendix-K--Third-Party-PIM-Vendors.md) provide mechanisms to perform “nonmigratory” migrations, as does Microsoft Forefront Identity Manager.
