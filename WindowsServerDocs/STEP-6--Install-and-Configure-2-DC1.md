...
First, install [!INCLUDE[winthreshold_server_1](includes/winthreshold_server_1_md.md)], [!INCLUDE[winblue_server_1](includes/winblue_server_1_md.md)] or [!INCLUDE[win8_server_1](includes/win8_server_1_md.md)].  
...
13. In the [!INCLUDE[sm](includes/sm_md.md)] console, in **Local Server**, in the **Properties** area, next to **Computer name**, click the link.  
...
1.  In the [!INCLUDE[sm](includes/sm_md.md)] console, on the **Dashboard**, click **Add roles and features**.  
...
Use this procedure to provide the CORP\\User1 user with full permissions to create and change corp2 [!INCLUDE[gpos](includes/gpos_md.md)].  
  
#### To provide Group Policy permissions  
  
1.  [!INCLUDE[clickstart](includes/clickstart_md.md)]**gpmc.msc**, and then press ENTER.  
