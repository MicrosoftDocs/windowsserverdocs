...
- [Visit](https://docs.microsoft.com/dotnet/api/microsoft.systeminsights.capability?view=systeminsights-preview-1.0) the API documentation to learn about the System Insights classes and interfaces. 
