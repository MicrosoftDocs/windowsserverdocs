...
> [!IMPORTANT]
> Azure Stack HCI OS deployment isn't supported on Windows Admin Center. To read about how to deploy Azure Local infrastructure, see the [Azure Local documentation](/azure/azure-local/deploy/create-cluster).
