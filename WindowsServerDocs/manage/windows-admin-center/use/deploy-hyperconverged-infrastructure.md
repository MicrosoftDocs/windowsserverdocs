...
As of Windows Admin Center version 2007, Windows Admin Center supports the Azure Local OS. Read about [how to deploy a cluster in Windows Admin Center in the Azure Local docs](/azure/azure-local/deploy/create-cluster). Although this documentation is focused on Azure Local, the instructions are also mostly applicable to Windows Server deployments.
