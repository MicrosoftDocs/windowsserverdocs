...
Extra configuration is required for Windows Admin Center to manage WDAC enforced environments. This document covers these requirements and known issues when managing a WDAC enforced environment.
