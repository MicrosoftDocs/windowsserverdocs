...
- **Interface incorrectly extends another interface**
 [ ![Picture depicting the interface incorrectly extends another interface error.](./../../media/extend-guides-angular11/error.png) ](./../../media/extend-guides-angular11/error.png#lightbox)
