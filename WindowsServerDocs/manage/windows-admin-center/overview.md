...
- **Streamline hyperconverged management**: Streamline management of Windows Server hyperconverged clusters. Use simplified workloads to create and manage VMs, Storage Spaces Direct volumes, Software-Defined Networking and more. For details, see [Manage HCI](use/manage-hyper-converged.md). For Azure Local management, see the [Azure Local documentation](azure/azure-local/overview.md).
