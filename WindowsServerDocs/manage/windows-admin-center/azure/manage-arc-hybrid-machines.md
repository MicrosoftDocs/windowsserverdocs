...
- Outbound internet access or an outbound port rule allowing HTTPS traffic to the following endpoints:
  ...
  - `*.wac.azure.com` or the `WindowsAdminCenter` [service tag](/azure/azure-arc/servers/network-requirements#service-tags) (for extension versions less than 0.0.0.200)
  - `*.waconazure.com` or the 'WindodwsAdminCenter' [service tag](/azure/azure-arc/servers/network-requirements#service-tags) (for extension versions greater than 0.0.0.200)
  - `pas.windows.net`
