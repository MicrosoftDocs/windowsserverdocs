...
> [!IMPORTANT]
> If outbound connectivity is restricted by your firewall or proxy server, make sure your [network URLs are configured properly](../deploy/networking-requirements.md). If your network isn't configured properly, you won't receive extension updates.
