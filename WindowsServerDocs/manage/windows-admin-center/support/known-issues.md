...
### Incorrectly deleting all CSVs in Volumes tool
Instances of Windows Admin Center with installed versions of Cluster Manager lower than 5.2.6 might experience problems with volume deletion operations. The tool might mistakenly delete all CSVs when performing a single CSV delete operation on Windows Server 2022 and newer as well as Azure Local versions 21H2 and higher. To prevent data loss, [update the Cluster manager extension](/manage/windows-admin-center/configure/using-extensions#installing-an-extension) to version 5.2.6. Don't make changes to your volumes in Windows Admin Center unless you update your extension. 
