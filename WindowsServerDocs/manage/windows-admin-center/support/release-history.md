...
- Version [2110.2](https://aka.ms/wac2110.2) is the most recent GA release - it includes major bug fixes to Role-based Access Control (RBAC), the connections page’s search feature, as well as bug fixes in several extensions.
