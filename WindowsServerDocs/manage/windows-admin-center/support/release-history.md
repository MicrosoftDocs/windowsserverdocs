...
- Version [2211](https://aa.ms/wac2211) is the most recent generally available (GA) release - it includes support for 400% zoom and WDAC-enabled infrastructure, improvements to Azure Stack HCI management features, as well as bug fixes and updates in several extensions.
