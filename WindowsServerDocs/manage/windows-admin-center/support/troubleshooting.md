...
- Platform where Windows Admin Center is **installed** (Windows client or Windows Server).
  ...
  - If installed on a Server device, provide the Windows [version](#check-the-windows-version) of **the machine running the browser** to access Windows Admin Center:
...
- Provide the Windows [version](#check-the-windows-version) where Windows Admin Center is **installed**:
