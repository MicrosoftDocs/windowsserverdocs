...
[Windows Admin Center **Preview** 1907](https://www.microsoft.com/en-us/software-download/windowsinsiderpreviewserver) - Includes the latest feature updates.
...
|     |     |
| --- | --- |
| ![](../media/simple-icon.png)| **Simple & lightweight** <br/> Familiar tools are streamlined to make management tasks a breeze. Install in under 5 minutes and manage servers in your environment immediately, no target configuration required. |
| ![](../media/future-icon.png)| **Built for the future** <br/> Integration with Azure services helps you leverage the power of the hybrid world. Manage Hyper-Converged clusters with powerful yet simple tools. |
