---
title: Troubleshoot SIL and SIL Aggregator 
...
# Troubleshoot SIL and SIL Aggregator 
...
>[!NOTE] 
>There are rules to processing data files in the SILA directory. These are only relevant in low traffic situations. High traffic will always trigger process in real time. The default behavior is that processing will commence either after 100 files arrive in the directory, Or after 15 minutes. When troubleshooting end to end in a small environment it is often necessary to wait this 15 minutes.
