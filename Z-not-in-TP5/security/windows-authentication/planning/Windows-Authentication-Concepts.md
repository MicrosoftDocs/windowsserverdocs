...
For more information about constrained delegation, see [Kerberos Constrained Delegation Overview](../../kerboros/get-started/Kerberos-Constrained-Delegation-Overview.md).
