...
As with Azure Virtual Network integration and Azure Backup integration, the you must either log in to Azure with you existing Azure account, or create a new account:
