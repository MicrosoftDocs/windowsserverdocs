---
title: "Perform post-migration tasks for Windows Server Essentials migration4"
...
# Perform post-migration tasks for Windows Server Essentials migration4
...
1.  [Delete DNS entries of the Source Server](Perform-post-migration-tasks-for-Windows-Server-Essentials-migration4.md#BKMK_DeleteDNSEntries)  
  
2.  [Share line-of-business and other application data folders](Perform-post-migration-tasks-for-Windows-Server-Essentials-migration4.md#BKMK_ShareLineOfBusinessAndOtherApplications)  

1.  [Delete DNS entries of the Source Server](../migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration4.md#BKMK_DeleteDNSEntries)  
  
2.  [Share line-of-business and other application data folders](../migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration4.md#BKMK_ShareLineOfBusinessAndOtherApplications)  
