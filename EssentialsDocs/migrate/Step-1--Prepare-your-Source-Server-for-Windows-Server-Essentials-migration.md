...
1. The following table provides links to the Microsoft Download Center where you can download and install the Best Practices Analyzer (BPA) for the Source Server from.
   ...
   |----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
   |                     Windows SBS 2003                     | [Microsoft Windows Small Business Server 2003 Best Practices Analyzer website](https://www.microsoft.com/en-us/windows-server/blog/tag/best-practices-analyzer/) |
   |                     Windows SBS 2008                     | [Microsoft Windows Small Business Server 2008 Best Practices Analyzer website](https://www.microsoft.com/en-us/windows-server/blog/tag/best-practices-analyzer/) |
