---
title: "Join computers to the new Windows Server Essentials server2"
...
# Join computers to the new Windows Server Essentials server2
The next step in the migration process is to connect client computers to the new  Windows Server Essentials server.  
...
>  You can skip this step for computers that are running the Windows XP or Windows Vista operating systems. The Windows Server Connector software does not support computers that are running Windows XP or Windows Vista.  
 ...
 Before you can join a client computer to the new  Windows Server Essentials server, you must first disconnect it from the Source Server by uninstalling the Windows Server Connector software on the client computer.  
