...
1.  [Delete DNS entries for the Source Server](Step-7--Perform-post-migration-tasks-for-the-Windows-Server-2012-R2-Essentials-migration.md#BKMK_DeleteDNSEntries)  
  
2.  [Share line-of-business and other application data folders](Step-7--Perform-post-migration-tasks-for-the-Windows-Server-2012-R2-Essentials-migration.md#BKMK_ShareLineOfBusinessAndOtherApplications)  
...
## Next steps  
 You have performed the post-migration tasks for  Windows Server 2012 R2 Essentials migration. Now go to [Step 8-- Run the Windows Server 2012 R2 Essentials Best Practices Analyzer](Step-8--Run-the-Windows-Server-2012-R2-Essentials-Best-Practices-Analyzer.md).  
