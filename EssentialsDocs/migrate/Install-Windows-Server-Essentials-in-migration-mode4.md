---
title: "Install Windows Server Essentials in migration mode4"
...
# Install Windows Server Essentials in migration mode4
...
> [!NOTE]
>  For information about how to migrate email to another on-premises computer that is running Exchange Server, see [Integrate an On-Premises Exchange Server with Windows Server Essentials](../manage/Integrate-an-On-Premises-Exchange-Server-with-Windows-Server-Essentials.md).
