...
> [!NOTE]
>  **Windows Server 2012 Essentials:** You can download the Health Report add-in for [!INCLUDE[sbs_sbs8web_2](../windows-server-essentials-manage/includes/sbs_sbs8web_2_md.md)] from the [Microsoft Download Center](http://go.microsoft.com/fwlink/p/?LinkId=266342).  
>   
>  **Windows Server 2012 R2 Essentials:** By default, the Health Report add-in is integrated with [!INCLUDE[wseblue_2](../windows-server-essentials-manage/includes/wseblue_2_md.md)] or [!INCLUDE[winblue_server_2](../windows-server-essentials-manage/includes/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../windows-server-essentials-manage/includes/wseblue_experience_md.md)] role installed, and the health reports are displayed on the **Health Reports** tab of the Dashboard’s **Home** page.  
...
> [!NOTE]
>  You can download the Health Report add-in for [!INCLUDE[sbs_sbs8web_2](../windows-server-essentials-manage/includes/sbs_sbs8web_2_md.md)] from the [Microsoft Download Center](http://go.microsoft.com/fwlink/p/?LinkId=266342).  
...
> [!NOTE]
>  By default, the Health Report add-in is integrated with [!INCLUDE[wseblue_2](../windows-server-essentials-manage/includes/wseblue_2_md.md)] or [!INCLUDE[winblue_server_2](../windows-server-essentials-manage/includes/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../windows-server-essentials-manage/includes/wseblue_experience_md.md)] role installed, and the health reports are displayed on the **Health Reports** tab of the Dashboard’s **Home** page.  
