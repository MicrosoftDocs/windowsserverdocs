...
> [!IMPORTANT]
>  If you’re managing online accounts in  Windows Server 2012 Essentials, you’re accustomed to seeing the Microsoft Online Services accounts referred to as *Office 365 accounts*. On the Dashboard in  Windows Server 2012 R2 Essentials, the labels were changed to *Microsoft Online Services accounts*, or *Microsoft online accounts* for short. The accounts and the procedures are the same; only the labels changed. Most procedures in this topic use the term *online account*.  
...
### Simplified account creation  
 There’s another advantage when you create your initial online accounts from the Dashboard. You can create online accounts for all of your users with a single action. On the other hand, if your employees are using  Office 365 already, and you’re setting up a new  Windows Server Essentials server, you can create all of your user accounts from the online accounts with a single action. For more information, see [Create online accounts](#BKMK_SECTION_CreateOnlineAccounts).  
  
### Manage email addresses and distribution groups from the Dashboard  
 You will be able to manage your email addresses and distribution groups for Exchange Online from the Dashboard. And you can use your organization’s Internet domain in the email addresses. You can do all of this from the Dashboard, without signing in to  Office 365. (You’ll need to be using  Windows Server 2012 R2 Essentials to manage distribution groups from the Dashboard. This feature is not supported in  Windows Server 2012 Essentials.) For more information, see [Manage email addresses for Exchange Online](#BKMK_SECTION_ManageEmailAddresses) and [Manage distribution groups for Exchange Online](#BKMK_SECTION_ManageDistributionGroups).  
...
> [!NOTE]
>  If you’re using  Windows Server 2012 Essentials, you will see *Office 365 account* instead of *Microsoft Online Services account* throughout these procedures. The process is the same, but the terminology changed in  Windows Server 2012 R2 Essentials.  
...
4.  On the **Assign a Microsoft Online Services account** page, either create a new online account for the user or assign an existing online account:  
    ...
    > [!NOTE]
    >  In  Windows Server 2012 Essentials, Microsoft Online Services accounts are referred to as “Office 365 accounts�? in wizards and Dashboard labels.  
...
###  <a name="BKMK_UnderstandingAccountStatus"></a> Understanding the online account status  
 When you assign a Microsoft Online Services account to a user account, the email address for the account appears in the **Microsoft online account** column on the **Users** page of the Dashboard. (In  Windows Server 2012 Essentials, the column label is **Office 365 account**.)  
...
###  <a name="BKMK_UnassignOnlineAccount"></a> Restrict access to an online account  
 What do you do if a user leaves your organization, or you want to restrict the user’s access to your  Office 365 services? If you’re managing your users’ online accounts along with their user accounts in  Windows Server Essentials, you have three options:  
...
2.  Right-click the user account in the list, and then click **Unassign a Microsoft online account** (in  Windows Server 2012 Essentials, click **Unassign an Office 365 account**).  
...
3.  On the **Microsoft online** tab of the account properties (or the **Office 365** tab in  Windows Server 2012 Essentials), click **Add**.  
...
##  <a name="BKMK_SECTION_ManageDistributionGroups"></a> Manage distribution groups for Exchange Online (Windows Server 2012 R2 Essentials only)  
 After you integrate your  Windows Server 2012 R2 Essentials server with  Office 365, you can create and manage distribution groups for Exchange Online from the  Windows Server Essentials Dashboard. You’ll do this on the **Distribution Groups** tab that is added to the **Users** page. You will only see this tab if you have an Exchange Online subscription. This feature is not available in  Windows Server 2012 Essentials.  
...
1.  On the Dashboard in  Windows Server 2012 R2 Essentials, click **Users**, and then click the **Distribution Groups** tab.  
