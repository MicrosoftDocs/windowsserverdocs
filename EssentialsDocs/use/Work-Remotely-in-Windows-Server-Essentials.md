...
##  <a name="BKMK_App"></a> Use the My Server app to connect to Windows Server Essentials  
 The My Server app lets you connect to resources and perform light administrative tasks on your [!INCLUDE[wsessentials](../manage/includes/wsessentials_md.md)] server from your Windows-based PC, laptop, or Surface device. If your server is running [!INCLUDE[win8_server_2](../install/includes/win8_server_2_md.md)], download the original My Server app from [Apps for Windows](http://windows.microsoft.com/windows-8/apps). If your server is running [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)], you must download the My Server 2012 R2 app instead.  
  
 With the expanded My Server 2012 R2 app, you can connect to the server or client computers by using Remote Desktop. If your [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] server is integrated with [!INCLUDE[office_365_2](../manage/includes/office_365_2_md.md)], and your subscription includes SharePoint Online, you also can work with documents in your SharePoint Online libraries and open your SharePoint team sites from My Server 2012 R2.  
...
##  <a name="BKMK_2"></a> Use the My Server app for Windows Phone  
 The My Server Windows app for Windows Phone (for [!INCLUDE[win8_server_2](../install/includes/win8_server_2_md.md)]) and the My Server 2012 R2 app for Windows Phone (for [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)]) are designed to help you stay seamlessly connected to your servers through smart phones while working at remote locations. This is one of the various ways to access [!INCLUDE[wsessentials](../manage/includes/wsessentials_md.md)] after you configure your server for remote access.  
