...
##  <a name="BKMK_Install"></a> Install My Server  
 You can download the appropriate My Server app from the [Apps for Windows](http://windows.microsoft.com/windows-8/apps) store. If your computer has the  Windows 8 or  Windows RT operating system, and you want to connect to the server on your intranet by using the server name, you also need to install a certificate from the server.  
...
1.  Install the appropriate My Server app from [Apps for Windows](http://windows.microsoft.com/windows-8/apps) onto your Windows-based laptop, PC, or Surface device.  
    ...
    |-----------------------------|--------------|  
    | Windows Server 2012 Essentials|[My Server](http://apps.microsoft.com/webpdp/app/19d94f81-db21-4234-8b49-806694dbbaea)|  
    | Windows Server 2012 R2 Essentials|[My Server 2012 R2](http://apps.microsoft.com/webpdp/app/67e86695-bda3-4f32-96c4-2e20e56f1cf3)|  
...
1.  Open My Server (for  Windows Server 2012 Essentials) or My Server 2012 R2 (for  Windows Server 2012 R2 Essentials) from the **Start** page of your Windows device.  
