# [Windows Server 2016 Essentials and Windows Server Essentials](Windows-Server-Essentials-Overview.md)
...
### [Customize and Deploy Windows Server Essentials in Windows Server 2012 R2](install/Customize-and-Deploy-Windows-Server-Essentials.md)
...
### [Demote and remove the Source Server from the new Windows Server Essentials network1](migrate/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-Essentials-network1.md)
### [Demote and remove the Source Server from the new Windows Server Essentials network2](migrate/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-Essentials-network2.md)
### [Demote and remove the Source Server from the new Windows Server Essentials network3](migrate/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-Essentials-network3.md)
### [Demote and remove the Source Server from the new Windows Server Essentials network4](migrate/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-Essentials-network4.md)
### [Demote and remove the Source Server from the new Windows Server Essentials network5](migrate/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-Essentials-network5.md)
### [Demote and remove the Source Server from the new Windows Server Essentials network6](migrate/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-Essentials-network6.md)
### [Enable folder redirection on the Windows Server Essentials Destination Server1](migrate/Enable-folder-redirection-on-the-Windows-Server-Essentials-Destination-Server1.md)
### [Enable folder redirection on the Windows Server Essentials Destination Server2](migrate/Enable-folder-redirection-on-the-Windows-Server-Essentials-Destination-Server2.md)
### [Enable folder redirection on the Windows Server Essentials Destination Server3](migrate/Enable-folder-redirection-on-the-Windows-Server-Essentials-Destination-Server3.md)
### [Enable folder redirection on the Windows Server Essentials Destination Server4](migrate/Enable-folder-redirection-on-the-Windows-Server-Essentials-Destination-Server4.md)
### [Enable folder redirection on the Windows Server Essentials Destination Server5](migrate/Enable-folder-redirection-on-the-Windows-Server-Essentials-Destination-Server5.md)
### [Install Windows Server Essentials in migration mode1](migrate/Install-Windows-Server-Essentials-in-migration-mode1.md)
### [Install Windows Server Essentials in migration mode2](migrate/Install-Windows-Server-Essentials-in-migration-mode2.md)
### [Install Windows Server Essentials in migration mode3](migrate/Install-Windows-Server-Essentials-in-migration-mode3.md)
### [Install Windows Server Essentials in migration mode4](migrate/Install-Windows-Server-Essentials-in-migration-mode4.md)
### [Install Windows Server Essentials in migration mode5](migrate/Install-Windows-Server-Essentials-in-migration-mode5.md)
### [Install Windows Server Essentials in migration mode6](migrate/Install-Windows-Server-Essentials-in-migration-mode6.md)
### [Join computers to the new Windows Server Essentials network1](migrate/Join-computers-to-the-new-Windows-Server-Essentials-network1.md)
### [Join computers to the new Windows Server Essentials network2](migrate/Join-computers-to-the-new-Windows-Server-Essentials-network2.md)
### [Join computers to the new Windows Server Essentials network3](migrate/Join-computers-to-the-new-Windows-Server-Essentials-network3.md)
### [Join computers to the new Windows Server Essentials server1](migrate/Join-computers-to-the-new-Windows-Server-Essentials-server1.md)
### [Join computers to the new Windows Server Essentials server2](migrate/Join-computers-to-the-new-Windows-Server-Essentials-server2.md)
### [Join computers to the new Windows Server Essentials server3](migrate/Join-computers-to-the-new-Windows-Server-Essentials-server3.md)
...
### [Perform post-migration tasks for Windows Server Essentials migration1](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration1.md)
### [Perform post-migration tasks for Windows Server Essentials migration2](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration2.md)
### [Perform post-migration tasks for Windows Server Essentials migration3](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration3.md)
### [Perform post-migration tasks for Windows Server Essentials migration4](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration4.md)
### [Perform post-migration tasks for Windows Server Essentials migration5](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration5.md)
### [Perform post-migration tasks for Windows Server Essentials migration6](migrate/Perform-post-migration-tasks-for-Windows-Server-Essentials-migration6.md)
### [Prepare your Source Server for Windows Server Essentials migration1](migrate/Prepare-your-Source-Server-for-Windows-Server-Essentials-migration1.md)
### [Prepare your Source Server for Windows Server Essentials migration2](migrate/Prepare-your-Source-Server-for-Windows-Server-Essentials-migration2.md)
### [Prepare your Source Server for Windows Server Essentials migration3](migrate/Prepare-your-Source-Server-for-Windows-Server-Essentials-migration3.md)
### [Prepare your Source Server for Windows Server Essentials migration4](migrate/Prepare-your-Source-Server-for-Windows-Server-Essentials-migration4.md)
### [Prepare your Source Server for Windows Server Essentials migration5](migrate/Prepare-your-Source-Server-for-Windows-Server-Essentials-migration5.md)
### [Prepare your Source Server for Windows Server Essentials migration6](migrate/Prepare-your-Source-Server-for-Windows-Server-Essentials-migration6.md)
...
### [Run the Windows Server Essentials Best Practices Analyzer1](migrate/Run-the-Windows-Server-Essentials-Best-Practices-Analyzer1.md)
### [Run the Windows Server Essentials Best Practices Analyzer2](migrate/Run-the-Windows-Server-Essentials-Best-Practices-Analyzer2.md)
### [Run the Windows Server Essentials Best Practices Analyzer3](migrate/Run-the-Windows-Server-Essentials-Best-Practices-Analyzer3.md)
### [Run the Windows Server Essentials Best Practices Analyzer4](migrate/Run-the-Windows-Server-Essentials-Best-Practices-Analyzer4.md)
### [Run the Windows Server Essentials Best Practices Analyzer5](migrate/Run-the-Windows-Server-Essentials-Best-Practices-Analyzer5.md)
### [Run the Windows Server Essentials Best Practices Analyzer6](migrate/Run-the-Windows-Server-Essentials-Best-Practices-Analyzer6.md)
