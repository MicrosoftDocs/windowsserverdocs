...
##  <a name="BKMK_WSEEOverview"></a> Windows Server Essentials Experience overview  
 The [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] is a server role that is available in the [!INCLUDE[winblue_server_standard_2](../install/includes/winblue_server_standard_2_md.md)] and [!INCLUDE[winblue_server_datacenter_2](../install/includes/winblue_server_datacenter_2_md.md)]. When the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role is installed on a server running [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)], the customer can take advantage of all the features that are available in [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] without the locks and limits. The [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] enables the following cross-premises solutions for small and midsize businesses:  
...
-   **User management** You can manage the users and groups through the simplified server dashboard. In addition, integration with [!INCLUDE[aad_1](../install/includes/aad_1_md.md)] enables easy data access for Microsoft online services (for example, Office 365, Exchange Online, and SharePoint Online) for users by using their domain credentials.  
  
-   **Service integration** You can integrate the server with Microsoft online services (such as Office 365, SharePoint Online, and [!INCLUDE[sbs8_mob_1](../install/includes/sbs8_mob_1_md.md)]). You can also integrate the server with your services or services provided by third-party providers.  
...
-   **Media streaming** If you install the Media package on a server with [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] enabled, the end customer can store music, video, and photographs in shared folders, then access these media files from networked computers or Remote Web Access.  
...
##  <a name="BKMK_Benefits"></a> Benefits of hosting Windows Server Essentials Experience  
 [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] is a role in Windows Server, so you can reuse the existing deployment and management framework in Windows Server to deploy and configure the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role. Hosting the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role provides the following benefits:  
  
-   **Streamlined deployment** By simply turning on the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role, some of the most commonly used roles and features are turned on and configured with best practices for small and midsized businesses. You can customize the Windows Server Essentials features, or hide some of the on-premises features. If you use the [!INCLUDE[katal_2](../install/includes/katal_2_md.md)], you can download the gallery template for [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] on [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)].  
...
##  <a name="BKMK_SupportedDeployment"></a> Supported deployment options  
 [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] can be deployed as a domain controller in a new Active Directory environment; or it can be deployed into an existing Active Directory environment as a domain member.  
  
 We recommend that you first deploy [!INCLUDE[winblue_server_standard_2](../install/includes/winblue_server_standard_2_md.md)] or [!INCLUDE[winblue_server_datacenter_2](../install/includes/winblue_server_datacenter_2_md.md)], and then install the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role. With this deployment method, you get all the functionalities of [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] edition, without the locks and limits.  
  
 For more information about installing [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role, see [Install and Configure Windows Server 2012 R2 Essentials](../install/Install-and-Configure-Windows-Server-2012-R2-Essentials-or-Windows-Server-Essentials-Experience.md).  
...
##  <a name="BKMK_SupportedToplogy"></a> Supported network topologies  
 To use [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] from a roaming client, VPN should be enabled. To enable remote access to the server from roaming clients, you need to open port 443 and port 80 on the server.  
...
##  <a name="BKMK_CustomizeImage"></a> Customize the image of Windows Server Essentials Experience role  
 ...
 After you install the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role, you can customize the features in Windows Server Essentials. One of the most important customizations is the **IsHosted** registry key: **HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows Server\Deployment\IsHosted**.  
...
##  <a name="BKMK_AutomateDeployment"></a> Automate the deployment of Windows Server Essentials Experience  
 To automate the deployment, you need to first deploy the operating system and then install the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role.  
  
-   To automatically deploy [!INCLUDE[winblue_server_standard_2](../install/includes/winblue_server_standard_2_md.md)] or [!INCLUDE[winblue_server_datacenter_2](../install/includes/winblue_server_datacenter_2_md.md)], follow the instructions in [Windows Assessment and Deployment Kit](http://msdn.microsoft.com/library/hh825420.aspx).  
  
-   To learn how to install the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role by using Windows PowerShell, see [Install and Configure Windows Server 2012 R2 Essentials](http://technet.microsoft.com/library/dn281793.aspx).  
  
> [!NOTE]
>  Ensure that the time zone settings of the host virtual machine and the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] are the same. Otherwise, you may experience several errors. These include: the initial configuration of the server may not be successful on certificate related tasks, the certificate may not work for a few hours after the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] role is installed, and device information will not update correctly.  
...
##  <a name="BKMK_Migrate"></a> Migrate data from Windows Small Business Server to Windows Server Essentials Experience  
 You can migrate data from servers running Windows Small Business Server 2011, Windows Small Business Server 2008, Windows Small Business Server 2003, or Windows Server 2012 Essentials to the server running [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)]. Review the [Migrate to Windows Server 2012 R2 Essentials](../migrate/Migrate-from-Previous-Versions-to-Windows-Server-2012-R2-Essentials-or-Windows-Server-Essentials-Experience.md) migration guide for on-premises  2migrations, and make necessary customizations based on your hosting environment.  
...
##  <a name="BKMK_EmailIntegration"></a> Email integration with Windows Server Essentials  
 You can integrate [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] with Office 365 or hosted Exchange Server. If you want your  customer to use your hosted email, you need to develop an add-in to integrate Windows Server Essentials Experience with your hosted email solution. For more information, see [Windows Server Essentials SDK](http://msdn.microsoft.com/library/gg513877.aspx).  
  
##  <a name="BKMK_Monitoring"></a> Monitor and manage by using native tools  
 This section discusses the native tools that are available in [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] to monitor and manage the server.  
  
### Group Policy  
 [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] leverages the native Group Policy support in [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] and provides a user interface to configure Folder Redirection and security settings.  
...
### System Center Monitoring Pack  
 System Center Monitoring Pack for [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] monitors the health alert system to help you manage large numbers of servers running Windows Server Essentials that are dedicated to small business organizations. For more information, see [System Center Management Pack for Windows Server 2012 R2 Essentials](http://www.microsoft.com/download/details.aspx?id=40809).  
  
### Backup and restore  
 [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] with Windows Server Essentials Experience allows you to back up server and client computers in the network.  
...
-   **Off-premises backup** Allows you to periodically back up your server data to a cloud-based service. You can download and install the [!INCLUDE[sbs8_mob_1](../install/includes/sbs8_mob_1_md.md)] Integration Module for Windows Server Essentials to leverage the [!INCLUDE[sbs8_mob_2](../install/includes/sbs8_mob_2_md.md)] that is provided by Microsoft.  
    ...
    -   Update the user interface of the Dashboard so that it links to your preferred cloud service instead of to the default [!INCLUDE[sbs8_mob_2](../install/includes/sbs8_mob_2_md.md)].  
...
##### Full client backup  
 Full client backup is on by default for all the client devices that are connected to the Windows Server Essentials network. It fully backs up the system information and data for the client and supports data deduplication. The backup data will be stored on the server running [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)]. This enables a failed client to retrieve data from a previous backup point.  
...
-   Deploy a server running [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] as a domain controller in your lab environment, and then install the Windows Server Essentials Experience role.  
  
-   Deploy a server running [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] in your lab environment, join this server to an existing domain, and then install the Windows Server Essentials Experience role.  
