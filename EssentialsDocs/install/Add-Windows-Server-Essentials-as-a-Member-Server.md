...
> [!NOTE]
>  [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] can only be deployed as domain controller. In this document, Windows Server Essentials does not include [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)].  
...
-   Add Windows Server Essentials as a member server within a [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] network to help extend storage on your network by adding additional server folders on your member server.  
  
-   Add Windows Server Essentials as a member server in the local office if your primary server running [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] is hosted in [!INCLUDE[azure_1](../install/includes/azure_1_md.md)] or hosted by a third-party hoster. Having Windows Server Essentials as a member server at your local office site helps to optimize bandwidth usage.  
  
## Adding Windows Server Essentials as a member server  
 To add Windows Server Essentials as a member server to a primary server running [!INCLUDE[winblue_server_2](../install/includes/winblue_server_2_md.md)] or [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] in an existing Active Directory environment, you must complete the following steps:  
  
1.  Join the server running Windows Server Essentials to a workgroup.  
  
2.  Join the server running Windows Server Essentials to the domain of a primary [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] server.  
  
3.  Configure the [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)] from Server Manager.  
...
5.  In **Computer Name/Domain Changes**, in the **Member** section, choose if you want to join the server running [!INCLUDE[wseblue_2](../install/includes/wseblue_2_md.md)] to a **Workgroup** or to a **Domain**.  
...
1.  (Optional) Change the server name, if needed.  
    ...
    > [!IMPORTANT]
    >  You cannot change the server name after you have configured [!INCLUDE[wseblue_experience](../install/includes/wseblue_experience_md.md)].  
