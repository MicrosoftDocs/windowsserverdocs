...
-   [Add an implementation of the ISettingsData interface to the assembly](../Topic/Add-a-Tab-to-Settings.md#BKMK_ISettingsData).  
  
-   [Sign the assembly with an Authenticode signature](../Topic/Add-a-Tab-to-Settings.md#BKMK_SignAssembly).  
  
-   [Install the assembly on the reference computer](../Topic/Add-a-Tab-to-Settings.md#BKMK_InstallAssembly).  
