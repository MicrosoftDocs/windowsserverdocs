---
title: Troubleshooting Enabling OTP_1
ms.custom: na
...
author: vhorne
---
# Troubleshooting Enabling OTP_1
...
2.  If the template doesn’t exist, create it as described in [3.3 Plan the registration authority certificate](../Topic/Step-3--Plan-OTP-Certificate-Deployment.md#bkmk_3_3_RA_Cert), or if another matching template exists reconfigure DirectAccess OTP with the new template name.  
...
1.  Make sure that the OTP logon template and the OTP signing certificate template are configured properly as described in [3.2 Plan the OTP certificate template](../Topic/Step-3--Plan-OTP-Certificate-Deployment.md#bkmk_3_2_OTP_Cert) and [3.3 Plan the registration authority certificate](../Topic/Step-3--Plan-OTP-Certificate-Deployment.md#bkmk_3_3_RA_Cert).  
