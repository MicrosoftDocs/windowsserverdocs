---
title: Step 2: Plan the Remote Access Deployment_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: d68d8d84-d08a-4ee9-b113-5e391166f8dd
author: vhorne
---
# Step 2: Plan the Remote Access Deployment_1
...
> [!NOTE]  
> Before you continue with these tasks, see [Step 1: Plan the Remote Access Infrastructure](../Topic/Step-1--Plan-the-Remote-Access-Infrastructure.md).  
...
-   **Network topology**  
    ...
    For more information, see [1.1 Plan network topology and settings](../Topic/Step-1--Plan-the-DirectAccess-Infrastructure_4.md#bkmk_1_1_Network_svr_top_settings).  
...
-   **Authentication**  
    ...
    -   **Computer authentication**: You can configure computer authentication to use certificates. Or the Remote Access server can act as a proxy for Kerberos authentication without requiring certificates.. For more information, see [1.3 Plan certificate requirements](../Topic/Step-1--Plan-the-DirectAccess-Infrastructure_4.md#bkmk_1_2_CAs_and_certs).  
  
    -   **Windows 7 clients** By default, client computers running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] cannot connect to a Remote Access deployment running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)]. If you have clients running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] in your organization that require remote access to internal resources, you can allow them to connect. Any client computers that you want to allow to access internal resources must be a member of a security group that you specify in the DirectAccess Client Setup Wizard.  
  
        > [!NOTE]  
        > Allowing clients running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] to connect by using DirectAccess requires you to use computer certificate authentication.  
...
-   [Step 1: Plan the Remote Access Infrastructure](../Topic/Step-1--Plan-the-Remote-Access-Infrastructure.md)  
