...
You can also deploy an SDN infrastructure  using  [!INCLUDE[vmmblue_2](../Token/vmmblue_2_md.md)]. For more information, see [Deploy Software Defined Networks using Virtual Machine Manager](../Topic/Deploy-Software-Defined-Networks-using-Virtual-Machine-Manager.md).  
...
All Hyper\-V hosts must have [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] installed.  
...
2.  Designate one computer as your deployment computer.  This computer must be running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]. Expand the zip file and copy the **SDNExpress** folder to the deployment computer's `C:\` folder.  
...
4.  Navigate to the `C:\SDNExpress` folder.  
    ...
    |Images|Empty, place your [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] vhdx image here|  
...
5.  Verify the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] VHDX file is in the **Images** folder.  
