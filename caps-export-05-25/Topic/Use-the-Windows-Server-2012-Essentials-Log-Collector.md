...
When you are troubleshooting computer issues, a representative from Microsoft Customer Service and Support may ask you to gather logs from servers, computers on the network, or both by using the [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] Log Collector.  
...
1.  [Install the Windows Server 2012 Essentials Log Collector](../Topic/Install-the-Windows-Server-2012-Essentials-Log-Collector.md)  
  
2.  [Run the Windows Server 2012 Essentials Log Collector](../Topic/Run-the-Windows-Server-2012-Essentials-Log-Collector.md)  
...
-   Registry keys, from  
    ...
    -   \\\\HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Windows Server\\  
  
    -   \\\\HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\DevicesProviderSvc  
  
    -   \\\\HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\DomainManagerProviderSvc  
...
-   Registry keys from \\\\HKEY\_LOCAL\_MACHINE \\SOFTWARE\\Microsoft\\Windows Server\\  
...
-   [Troubleshoot Windows Server 2012 Essentials Log Collector Errors](../Topic/Troubleshoot-Windows-Server-2012-Essentials-Log-Collector-Errors.md)  
