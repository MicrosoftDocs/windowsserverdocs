...
> [!NOTE]  
> To find out how to update group policies, see [Local Group Policy Editor \[Blue\]](../Topic/Local-Group-Policy-Editor.md) \(http:\/\/technet.microsoft.com\/library\/dn265982.aspx\).  
...
## Update the Registry  
For a domain deployment of [!INCLUDE[win8_server_multipoint_2](../Token/win8_server_multipoint_2_md.md)], you should update the following registry subkeys.  
  
> [!IMPORTANT]  
> Incorrectly editing the registry may severely damage your system. Before making changes to the registry, you should back up any valued data on the computer.  
  
#### To update Registry subkeys for a domain deployment of [!INCLUDE[win8_server_multipoint_2](../Token/win8_server_multipoint_2_md.md)]  
