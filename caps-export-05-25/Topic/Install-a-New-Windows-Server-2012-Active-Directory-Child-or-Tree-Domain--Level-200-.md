...
-   [Child and Tree Domain Workflow](../Topic/Install-a-New-Windows-Server-2012-Active-Directory-Child-or-Tree-Domain--Level-200-.md#BKMK_Workflow)  
  
-   [Child and Tree Domain Windows PowerShell](../Topic/Install-a-New-Windows-Server-2012-Active-Directory-Child-or-Tree-Domain--Level-200-.md#BKMK_PS)  
  
-   [Deployment](../Topic/Install-a-New-Windows-Server-2012-Active-Directory-Child-or-Tree-Domain--Level-200-.md#BKMK_Deployment)  
...
![](../Image/adds_childtreedeploy_beta1.png)  
...
![](../Image/ADDS_SMI_TR_ChildDeployConfig.png)  
  
The following screenshot shows the options for adding a tree domain:  
  
![](../Image/ADDS_SMI_TR_TreeDeployConfig.png)  
...
![](../Image/ADDS_SMI_TR_ChildDNSOptions.png)  
...
### Additional Options  
![](../Image/ADDS_SMI_TR_ChildAdditionalOptions.png)  
...
![](../Image/ADDS_SMI_TR_ChildReviewOptions.png)  
...
![](../Image/ADDS_SMI_TR_ChildWhatIf.png)  
  
### Prerequisites Check  
![](../Image/ADDS_SMI_TR_ChildPrereqCheck.png)  
...
### Installation  
![](../Image/ADDS_SMI_TR_ChildInstallation.png)  
