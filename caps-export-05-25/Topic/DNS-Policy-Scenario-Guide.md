...
DNS Policy is a new feature for DNS in [!INCLUDE[winthreshold_server_1_md](/Token/winthreshold_server_1_md.md)]. You can use this guide to learn how to use DNS policy to control how a DNS server processes name resolution queries based on different parameters that you define in policies.   
