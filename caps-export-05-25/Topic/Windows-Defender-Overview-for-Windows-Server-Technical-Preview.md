...
To add custom exclusions in addition to the ones automatically added, start a [!INCLUDE[wps_2](../Token/wps_2_md.md)] console as an administrator, and run the following command:  
