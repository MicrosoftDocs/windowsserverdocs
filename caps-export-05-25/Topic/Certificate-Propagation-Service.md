...
![](../Image/WindowsSmartCardTechnicalReference_06.gif)  
...
For more information about root certificate requirements, see [Smart card root certificate requirements for use with domain join](../Topic/Certificate-Requirements-and-Enumeration.md#BKMK_SmartCardRoot).  
