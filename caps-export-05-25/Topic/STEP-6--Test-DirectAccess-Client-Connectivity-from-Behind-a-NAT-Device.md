...
1.  On CLIENT1, open an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/all** and press ENTER.  
...
3.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER.  
...
4.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **Get\-DnsClientNrptPolicy** and press ENTER.  
...
6.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app2** and press ENTER. You should see replies from the NAT64 address assigned by EDGE1 to APP2, which in this case is fdc9:9f4e:eb1b:7777::a00:4.  
  
7.  Leave the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window open for the next procedure.  
...
1.  Open an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **netsh interface teredo set state disabled** and press ENTER. This disables Teredo on the client computer and enables the client computer to configure itself to use IP\-HTTPS. An **Ok** response appears when the command completes.  
...
9. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App2\\Files**, and then press ENTER. Double\-click the New Text Document file. This demonstrates that you were able to connect to an IPv4 only server using SMB to obtain a resource on an IPv4 only host.  
