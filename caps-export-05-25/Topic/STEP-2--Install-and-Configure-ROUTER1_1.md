---
title: STEP 2: Install and Configure ROUTER1_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: e4b1a298-d5b0-410e-970b-c5358a9378f9
author: vhorne
---
# STEP 2: Install and Configure ROUTER1_1
...
-   [Install the operating system on ROUTER1](../Topic/STEP-2--Install-and-Configure-ROUTER1_1.md#bkmk_InstallOS)  
  
-   [Configure TCP/IP properties and rename the computer](../Topic/STEP-2--Install-and-Configure-ROUTER1_1.md#bkmk_TCP)  
  
-   [Turn off the firewall](../Topic/STEP-2--Install-and-Configure-ROUTER1_1.md#TurnOffFirewall)  
  
-   [Configure routing and forwarding](../Topic/STEP-2--Install-and-Configure-ROUTER1_1.md#RouteandForward)  
...
3.  Connect ROUTER1 to a network that has Internet access and run Windows Update to install the latest updates for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], and then disconnect from the Internet.  
