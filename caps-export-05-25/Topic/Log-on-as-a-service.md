...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: b80a97c6-23f5-4d3a-8611-c057a0f4f4fa
---
# Log on as a service
...
The default changed in [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] from Not defined in that only the Network Service account has this right by default. Any service that runs under a separate user account must be assigned this user right.  
