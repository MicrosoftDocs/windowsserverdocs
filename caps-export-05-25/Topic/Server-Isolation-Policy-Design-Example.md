...
This design example continues to use the fictitious company Woodgrove Bank, as described in the [Firewall Policy Design Example](../Topic/Firewall-Policy-Design-Example.md) section and the [Domain Isolation Policy Design Example](../Topic/Domain-Isolation-Policy-Design-Example.md) section.  
...
If you do not have an Active Directory domain then you can manually apply the connection security rules to the client computers, or you can use a netsh command\-line script \(or Windows PowerShell in [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)]\) to help automate the configuration of the rules on larger numbers of computers. If you do not have an Active Directory domain, you cannot use the Kerberos V5 protocol, but instead must provide the clients and the isolated servers with certificates that are referenced in the connection security rules.  
...
![](../Image/WFAS-Design3Example1.gif)  
...
-   All of the design requirements shown in the [Firewall Policy Design Example](../Topic/Firewall-Policy-Design-Example.md) section are still enforced.  
  
-   All of the design requirements shown in the [Domain Isolation Policy Design Example](../Topic/Domain-Isolation-Policy-Design-Example.md) section are still enforced.  
...
**Next:**[Certificate-based Isolation Policy Design Example](../Topic/Certificate-based-Isolation-Policy-Design-Example.md)  
