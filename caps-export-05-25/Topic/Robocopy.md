...
|\/e|Copies subdirectories. Note that this option includes empty directories. For additional information, see [Remarks](../Topic/Robocopy.md#BKMK_remarks).|  
...
|\/purge|Deletes destination files and directories that no longer exist in the source. For additional information, see [Remarks](../Topic/Robocopy.md#BKMK_remarks).|  
|\/mir|Mirrors a directory tree \(equivalent to **\/e** plus **\/purge**\). For additional information, see [Remarks](../Topic/Robocopy.md#BKMK_remarks).|  
