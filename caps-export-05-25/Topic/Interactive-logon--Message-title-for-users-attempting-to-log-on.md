...
> [!NOTE]  
> Simply changing a logon message that is defined by a computer running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)], or Windows XP Professional by using a Windows 2000\-based computer does not work. The setting must be undefined first.  
