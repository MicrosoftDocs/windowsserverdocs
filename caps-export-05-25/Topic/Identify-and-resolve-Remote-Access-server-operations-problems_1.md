---
title: Identify and resolve Remote Access server operations problems_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 01913def-a5fe-48d0-b687-eec40b268bb2
author: vhorne
---
# Identify and resolve Remote Access server operations problems_1
...
[Simulate an operations issue](../Topic/Identify-and-resolve-Remote-Access-server-operations-problems_1.md#BKMK_Simulate)  
  
[Identify the operations issue and take corrective action](../Topic/Identify-and-resolve-Remote-Access-server-operations-problems_1.md#BKMK_Identify)  
  
[Restore the IP Helper service](../Topic/Identify-and-resolve-Remote-Access-server-operations-problems_1.md#BKMK_Restart)  
