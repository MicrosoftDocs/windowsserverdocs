...
-   [Upgrade and Replica Workflow](../Topic/Install-a-Replica-Windows-Server-2012-Domain-Controller-in-an-Existing-Domain--Level-200-.md#BKMK_Workflow)  
  
-   [Upgrade and Replica Windows PowerShell](../Topic/Install-a-Replica-Windows-Server-2012-Domain-Controller-in-an-Existing-Domain--Level-200-.md#BKMK_PS)  
  
-   [Deployment](../Topic/Install-a-Replica-Windows-Server-2012-Domain-Controller-in-an-Existing-Domain--Level-200-.md#BKMK_Dep)  
...
![](../Image/ADDS_SMI_TR_UpgradeDeployConfig.png)  
...
![](../Image/ADDS_SMI_TR_UpgradeCreds.png)  
  
![](../Image/ADDS_SMI_TR_UpgradeSelectDomain.png)  
...
![](../Image/ADDS_SMI_TR_UpgradeFFLError.png)  
  
### Domain Controller Options  
![](../Image/ADDS_SMI_TR_UpgradeDCOptions.png)  
...
![](../Image/ADDS_SMI_TR_UpgradeDCOptionsError.png)  
  
### DNS Options and DNS Delegation Credentials  
![](../Image/ADDS_SMI_TR_UpgradeDNSOptions.png)  
...
### Additional Options  
![](../Image/ADDS_SMI_TR_UpgradeAdditionalOptions.png)  
...
### Paths  
![](../Image/ADDS_SMI_TR_UpgradePaths.png)  
...
### Preparation Options  
![](../Image/ADDS_SMI_TR_UpgradePrepOptions.png)  
...
![](../Image/ADDS_SMI_TR_UpgradePrepOptionsCreds.png)  
...
![](../Image/ADDS_SMI_TR_UpgradeReviewOptions.png)  
...
![](../Image/ADDS_PSWhatIf.png)  
  
### Prerequisites Check  
![](../Image/ADDS_SMI_TR_UpgradePrereqCheck.png)  
...
For more information about the specific prerequisite checks, see [Prerequisite Checking](../Topic/AD-DS-Simplified-Administration.md#BKMK_PrereuisiteChecking).  
...
### Installation  
![](../Image/ADDS_SMI_TR_UpgradeInstallProgress.png)  
...
See [Upgrade and Replica Windows PowerShell](../Topic/Install-a-Replica-Windows-Server-2012-Domain-Controller-in-an-Existing-Domain--Level-200-.md#BKMK_PS) for required and optional arguments.  
...
![](../Image/ADDS_PSUpgradeConfirm.gif)  
  
![](../Image/ADDS_PSUpgradeProgress.png)  
...
![](../Image/ADDS_PSUpgradeExample.gif)  
  
> [!NOTE]  
> For more information on how the installation and Adprep process works, see the [Troubleshooting Domain Controller Deployment](../Topic/Troubleshooting-Domain-Controller-Deployment.md).  
