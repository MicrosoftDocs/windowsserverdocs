...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 82ccf82d-5b3f-43c9-91ff-908d344cf972
author: vhorne
---
# Performance Tuning Network Adapters
This topic contains the following sections.  
  
-   [Enabling Offload Features](#bkmk_offload)  
  
-   [Enabling Receive Side Scaling \(RSS\) for Web Servers](#bkmk_rss_web)  
  
-   [Increasing Network Adapter Resources](#bkmk_resources)  
  
-   [Performance Tuning for Low Latency Packet Processing](#bkmk_low)  
  
-   [System Management Interrupts](#bkmk_smi)  
  
-   [Performance Tuning TCP](#bkmk_tcp)  
...
RSS predefined profiles are new in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)].  
...
-   Set the computer BIOS to **High Performance**, with C\-states disabled. However, note that this is system and BIOS dependent, and some systems will provide higher performance if the operating system controls power management. You can check and adjust your power management settings from Control Panel or by using the **powercfg** command. For more information, see [Powercfg Command\-Line Options](http://technet.microsoft.com/library/cc748940(v=WS.10).aspx)  
...
-   [TCP Receive Window Auto\-Tuning](#bkmk_tcpreceive)  
  
-   [Windows Filtering Platform](#bkmk_wfp)  
  
-   [TCP Parameters](#bkmk_tcp_params)  
  
Details are provided in the following sections.  
  
### <a name="bkmk_tcpreceive"></a>TCP Receive Window Auto\-Tuning  
Prior to [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], the network stack used a fixed\-size receive\-side window that limited the overall potential throughput for connections. One of the most significant changes to the TCP stack is TCP receive window auto\-tuning. You can calculate the total throughput of a single connection when you use this fixed size default as:  
...
For more information, see [Windows Filtering Platform](http://msdn.microsoft.com/windows/hardware/gg463267.aspx) in the Windows Dev Center.  
  
### <a name="bkmk_tcp_params"></a>TCP Parameters  
The following registry keywords from Windows Server 2003 are no longer supported, and they are ignored in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], and [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)].  
