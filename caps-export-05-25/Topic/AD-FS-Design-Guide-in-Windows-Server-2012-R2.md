...
## About this guide  
This guide provides recommendations to help you plan a new deployment of [!INCLUDE[nextref_adfs2](../Token/nextref_adfs2_md.md)], based on the requirements of your organization. This guide is intended for use by an infrastructure specialist or system architect. It highlights your main decision points as you plan your [!INCLUDE[nextref_adfs2](../Token/nextref_adfs2_md.md)] deployment. Before you read this guide, you should have a good understanding of how [!INCLUDE[nextref_adfs2](../Token/nextref_adfs2_md.md)] works on a functional level. For more information, see [Understanding Key AD FS Concepts](../Topic/Understanding-Key-AD-FS-Concepts.md).  
  
## In this guide  
  
-   [Identify Your AD FS Deployment Goals](../Topic/Identify-Your-AD-FS-Deployment-Goals.md)  
  
-   [Plan Your AD FS Deployment Topology](../Topic/Plan-Your-AD-FS-Deployment-Topology.md)  
  
-   [AD FS Requirements](../Topic/AD-FS-Requirements.md)  
...
## See Also  
[AD FS Design](../Topic/AD-FS-Design.md)  
