...
You can use this procedure to install and configure BranchCache hosted cache servers that are located in branch offices where you want to deploy BranchCache hosted cache mode. With BranchCache in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], you can deploy multiple hosted cache servers in one branch office.  
