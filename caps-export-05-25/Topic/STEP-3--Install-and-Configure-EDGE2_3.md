---
title: STEP 3: Install and Configure EDGE2_3
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: e75e9778-0993-4f06-9421-6ddeaabfbd51
author: vhorne
---
# STEP 3: Install and Configure EDGE2_3
...
1.  [Install the operating system on EDGE2](../Topic/STEP-3--Install-and-Configure-EDGE2_3.md#installOS)—Install [!INCLUDE[win8_server_1](../Token/win8_server_1_md.md)] on EDGE2.  
  
2.  [Configure TCP/IP properties](../Topic/STEP-3--Install-and-Configure-EDGE2_3.md#TCP)—After installing the operating system on EDGE2, configure static IP addressing information on its internal and external network adapters.  
  
3.  [Rename EDGE2 and join it to the domain](../Topic/STEP-3--Install-and-Configure-EDGE2_3.md#rename)—Rename the computer to EDGE2 and join it to the CORP domain.  
  
4.  [Install the IP-HTTPS certificate](../Topic/STEP-3--Install-and-Configure-EDGE2_3.md#IPHTTPSCert)—To accept incoming IP\-HTTPS requests, the EDGE2 Remote Access cluster member must have an IP\-HTTPS website certificate installed in its machine certificate store. The certificate must have the same name as the IP\-HTTPS certificate on EDGE1.  
  
5.  [Install the Remote Access role on EDGE2](../Topic/STEP-3--Install-and-Configure-EDGE2_3.md#InstallDA)—Before you can join EDGE2 to the Remote Access cluster, you must install the Remote Access server role on EDGE2.  
  
## <a name="installOS"></a>Install the operating system on EDGE2  
  
1.  On EDGE2, start the installation of [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)].  
...
3.  Connect EDGE2 to a network that has Internet access and run Windows Update to install the latest updates for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], and then disconnect from the Internet.  
...
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**mmc.exe**, and then press ENTER. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
