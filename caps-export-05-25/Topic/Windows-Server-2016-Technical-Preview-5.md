...
Welcome to [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)] 5.  
  
This is the fifth release of [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]. In this documentation, Windows Server is referred to as Windows Server Technical Preview unless there is a need to distinguish between this release and the previous release. This collection contains information about the following:  
  
-   [System Requirements  and Installation](../Topic/System-Requirements--and-Installation.md)  
  
-   [What's New in Windows Server Technical Preview 5](What-s-New-in-Windows-Server-2016-Technical-Preview-5.md)  
  
-   [Compute](../Topic/Compute.md)  
  
-   [Identity and Access](Identity-and-Access.md)  
  
-   [Management and  Automation](../Topic/Management-and--Automation.md)  
  
-   [Networking](../Topic/Networking.md)  
  
-   [Storage](../Topic/Storage.md)  
  
-   [Security and Assurance](../Topic/Security-and-Assurance.md)  
