...
-   [!INCLUDE[winblue_start](../Token/winblue_start_md.md)]**gpedit.msc**, and then press **ENTER**.  
  
#### To open the Local Group Policy Editor as a snap\-in  
  
1.  [!INCLUDE[winblue_start](../Token/winblue_start_md.md)]**mmc**, and then press **ENTER**.  
