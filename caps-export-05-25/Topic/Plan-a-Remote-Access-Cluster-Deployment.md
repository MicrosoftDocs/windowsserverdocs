...
[!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)] and [!INCLUDE[win8_server_1](../Token/win8_server_1_md.md)] combine DirectAccess and Routing and Remote Access Service \(RRAS\) VPN into a single Remote Access role. This overview provides an introduction to the planning steps required in order to deploy a cluster of [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_2_md.md)] or [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] Remote Access servers.  
