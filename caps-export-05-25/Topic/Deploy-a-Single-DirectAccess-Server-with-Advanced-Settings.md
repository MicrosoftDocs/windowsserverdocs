...
In this scenario, a single computer running either  [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)], [!INCLUDE[winblue_server_1](../Token/winblue_server_1_md.md)] or [!INCLUDE[win8_server_1](../Token/win8_server_1_md.md)],  is configured as a DirectAccess server with advanced settings.  
  
> [!NOTE]  
> If you want to configure a basic deployment with simple settings only, see [Deploy a Single DirectAccess Server Using the Getting Started Wizard](../Topic/Deploy-a-Single-DirectAccess-Server-Using-the-Getting-Started-Wizard.md). In the simple scenario, DirectAccess is configured with default settings by using a wizard, without any need to configure infrastructure settings such as a certification authority \(CA\) or Active Directory security groups.  
...
-   Client requirements:  
    ...
    -   A client computer must be running [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)], Windows 8, or Windows 7.  
  
        > [!NOTE]  
        > The following operating systems can be used as DirectAccess clients: [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)],[!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], Windows 8 Enterprise, Windows 7 Enterprise, or Windows 7 Ultimate.  
...
|**Deployment**|[DirectAccess Deployment Paths in Windows Server](../Topic/DirectAccess-Deployment-Paths-in-Windows-Server.md)<br /><br />[Deploy a Single DirectAccess Server Using the Getting Started Wizard](../Topic/Deploy-a-Single-DirectAccess-Server-Using-the-Getting-Started-Wizard.md)|  
