---
title: Create a One-Way, Outgoing, Shortcut Trust for Both Sides of the Trust
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.assetid: ba972a70-7dfa-4572-84e3-d576070fbaa5
author: Femila
---
# Create a One-Way, Outgoing, Shortcut Trust for Both Sides of the Trust
  You can this procedure to create both sides of a one\-way, outgoing, shortcut trust. You must administrative credentials for your domain as well as for the reciprocal domain. If you have administrative credentials only for your domain, you can use the procedure [Create a One-Way, Outgoing, Shortcut Trust for One Side of the Trust](../Topic/Create-a-One-Way,-Outgoing,-Shortcut-Trust-for-One-Side-of-the-Trust.md) to create your side of the trust. Then, have the administrator for the reciprocal domain create a one\-way, incoming, shortcut trust from his or her domain.  
