...
## Remarks  
This command shows the value for each proxy usage, not just the proxy usage you specified for the service account. For details on setting the proxy usage for service accounts, see the [Bitsadmin util and setieproxy](../Topic/Bitsadmin-util-and-setieproxy.md) command.  
