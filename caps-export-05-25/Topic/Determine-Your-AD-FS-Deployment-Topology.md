...
-   [Stand-Alone Federation Server Using WID](../Topic/Stand-Alone-Federation-Server-Using-WID.md)  
...
After you finish selecting your [!INCLUDE[nextref_adfs2](../Token/nextref_adfs2_md.md)] deployment topology, we recommend that you review the topic [Planning for AD FS Server Capacity](../Topic/Planning-for-AD-FS-Server-Capacity.md) to determine the recommended number of servers that you will need to deploy to support this topology.  
