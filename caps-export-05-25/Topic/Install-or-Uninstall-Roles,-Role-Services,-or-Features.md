...
In a single session in the [!INCLUDE[arfw](../Token/arfw_md.md)], you can install [!INCLUDE[rrsandf_plural](../Token/rrsandf_plural_md.md)] on the local server, a remote server that has been added to [!INCLUDE[sm](../Token/sm_md.md)], or an offline VHD. For more information about how to add a server to [!INCLUDE[sm](../Token/sm_md.md)] to manage, see [Add Servers to Server Manager_1](../Topic/Add-Servers-to-Server-Manager_1.md).  
  
> [!NOTE]  
> If you are running [!INCLUDE[sm](../Token/sm_md.md)] on [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] or [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)], you can use the [!INCLUDE[arfw](../Token/arfw_md.md)] to install roles and features only on servers and offline VHDs that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
...
5.  On the **Select destination server** page, select a server from the server pool, or select an offline VHD. To select an offline VHD as your destination server, first select the server on which to mount the VHD, and then select the VHD file. For information about how to add servers to your server pool, see [Add Servers to Server Manager_1](../Topic/Add-Servers-to-Server-Manager_1.md). After you have selected the destination server, click **Next**.  
...
2.  Type **Get\-WindowsFeature** and then press **Enter** to view a list of available and installed roles and features on the local server. If the local computer is not a server, or if you want information about a remote server, run **Get\-WindowsFeature \-ComputerName <***computer\_name***>**, in which *computer\_name* represents the name of a remote computer that is running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]. The results of the cmdlet contain the command names of roles and features that you add to your cmdlet in step 4.  
...
4.  On the **Select destination server** page, select a server from the server pool, or select an offline VHD. To select an offline VHD, first select the server on which to mount the VHD, and then select the VHD file.  
    ...
    For information about how to add servers to your server pool, see [Add Servers to Server Manager_1](../Topic/Add-Servers-to-Server-Manager_1.md). After you have selected the destination server, click **Next**.  
  
    > [!NOTE]  
    > You can use the [!INCLUDE[rrfw](../Token/rrfw_md.md)] to remove roles and features from servers that are running the same release of Windows Server that supports the version of [!INCLUDE[sm](../Token/sm_md.md)] that you are using. You cannot remove roles, role services, or features from servers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], if you are running [!INCLUDE[sm](../Token/sm_md.md)] on [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)]. You cannot use the [!INCLUDE[rrfw](../Token/rrfw_md.md)] to remove roles and features from servers that are running [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] or [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)].  
...
7.  After you click **Remove**, the **Removal progress** page displays removal progress, results, and messages such as warnings, failures, or post\-removal configuration steps that are required, such as restarting the destination server. In [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and later releases of Windows Server, you can close the [!INCLUDE[rrfw](../Token/rrfw_md.md)] while removal is still in progress, and view removal results or other messages in the **Notifications** area at the top of the [!INCLUDE[sm](../Token/sm_md.md)] console. Click the **Notifications** flag to see more details about removals or other tasks that you are performing in [!INCLUDE[sm](../Token/sm_md.md)].  
  
## <a name="BKMK_removewps"></a>Remove roles, role services, and features by using Windows PowerShell cmdlets  
The [!INCLUDE[sm](../Token/sm_md.md)] deployment cmdlets for [!INCLUDE[wps_2](../Token/wps_2_md.md)] function similarly to the GUI\-based [!INCLUDE[rrfw](../Token/rrfw_md.md)], with an important difference. In [!INCLUDE[wps_2](../Token/wps_2_md.md)], unlike in the [!INCLUDE[rrfw](../Token/rrfw_md.md)], management tools and snap\-ins for a role are not removed by default. To remove management tools as part of a role removal, add the `IncludeManagementTools` parameter to the cmdlet. If you are uninstalling roles and features from a server that is running the Server Core installation option of [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or a later release of Windows Server, this parameter removes command\-line and [!INCLUDE[wps_2](../Token/wps_2_md.md)] management tools for the specified roles and features.  
...
> [!IMPORTANT]  
> All target servers that are specified in your script must be running the release of Windows Server that matches the version of [!INCLUDE[sm](../Token/sm_md.md)] you are running on the local computer. For example, if you are running [!INCLUDE[sm](../Token/sm_md.md)] on [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)], you can install [!INCLUDE[rrsandf_plural](../Token/rrsandf_plural_md.md)] on servers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]. If GUI\-based management tools are added to the installation, the installation process automatically converts target servers that are running the Server Core installation option of Windows Server to the full installation option \(server with a full GUI, also known as running Server Graphical Shell\).  
>   
...
2.  Select a destination server that is running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
