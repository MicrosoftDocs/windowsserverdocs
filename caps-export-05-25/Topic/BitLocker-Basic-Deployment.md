...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 325d0f53-0f5a-4812-af7d-00decf0e4cf2
---
...
-   [Using BitLocker to encrypt volumes](../Topic/BitLocker-Basic-Deployment.md#BKMK_dep1)  
  
-   [Down\-level compatibility](../Topic/BitLocker-Basic-Deployment.md#BKMK_dep2)  
  
-   [Using manage\-bde to encrypt volumes with BitLocker](../Topic/BitLocker-Basic-Deployment.md#BKMK_dep3)  
  
-   [Using PowerShell to encrypt volumes with BitLocker](../Topic/BitLocker-Basic-Deployment.md#BKMK_dep4)  
...
> [!NOTE]  
> For more information about using this tool, see [Bdehdcfg](../Topic/Bdehdcfg.md) in the Command\-Line Reference.  
...
|---------------|---------------|  
|Hardware configuration|The computer must meet the minimum requirements for the supported Windows versions. For more information about [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] requirements, see the [Windows 8 Web site](http://go.microsoft.com/fwlink/p/?LinkId=222457).|  
|Operating system|BitLocker is an optional feature which can be installed by Server Manager on [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)].|  
...
> [!NOTE]  
> For more information on creating strong passwords, see Strong passwords section in the [Passwords Technical Overview](http://technet.microsoft.com/library/hh994558(v=ws.10).aspx).  
...
## <a name="BKMK_dep2"></a>Down\-level compatibility  
...
## <a name="BKMK_dep4"></a>Using PowerShell to encrypt volumes with BitLocker  
