---
title: Network Load Balancing Overview
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: bad6f3ac-ab94-425c-8a51-883765dc7f97
author: kumudd
---
...
> [!NOTE]  
> The NLB functionality in [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] is generally the same as in [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)]. However, some task details are changed. For information about new ways to do tasks, see [Common Management Tasks and Navigation in Windows](../Topic/Common-Management-Tasks-and-Navigation-in-Windows.md).  
...
|**Related technologies**|[Web Server \(IIS\)](http://technet.microsoft.com/windowsserver/dd448617) &#124; [Application Server](http://technet.microsoft.com/windowsserver/dd448610) &#124; [Load Balancing and Failover](assetId:///912908f6-4c97-43d3-a442-7e11b62dda8a)|  
