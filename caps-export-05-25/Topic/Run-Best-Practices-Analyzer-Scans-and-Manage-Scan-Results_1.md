...
[!INCLUDE[bpa](../Token/bpa_md.md)] \(BPA\) is a server management tool that is available in [!INCLUDE[winblue_server_1](../Token/winblue_server_1_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], and [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)]. BPA can help administrators reduce best practice violations by scanning roles that are installed on managed servers that are running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], and reporting best practice violations to the administrator.  
...
You can find the [!INCLUDE[bpa](../Token/bpa_md.md)] tile on role and server group pages of [!INCLUDE[sm](../Token/sm_md.md)] in [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], or you can open a [!INCLUDE[wps_2](../Token/wps_2_md.md)] session with elevated user rights to run [!INCLUDE[bpa](../Token/bpa_md.md)] cmdlets.  
...
2.  Starting in [!INCLUDE[wps_2](../Token/wps_2_md.md)] 3.0, cmdlet modules are automatically imported into your [!INCLUDE[wps_2](../Token/wps_2_md.md)] session the first time a cmdlet from the module is used. There is no need to import or load the BPA cmdlet module.  
