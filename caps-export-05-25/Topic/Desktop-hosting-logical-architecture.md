...
![Basic desktop hosting deployment with RDS](/Image/Basic-desktop-hosting-deployment-with-RDS.png)  
...
![Extended desktop hosting with high availability](/Image/Desktop-hosting-environment-with-Azure-IaaS.png)   
...
![Extended logical architecture with Azure SQL database, Azure AD DS, and Azure AD AppProxy](/Image/Extended-logical-architecture-with-Azure-SQL-database,-Azure-AD-DS,-and-Azure-AD-AppProxy.png)  
