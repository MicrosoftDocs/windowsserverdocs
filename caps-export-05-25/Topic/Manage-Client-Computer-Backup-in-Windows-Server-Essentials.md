...
-   [How the Repair the Backup Database Wizard works](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Understand the computer backup settings](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_2)  
  
-   [Set up backup for a client computer](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_3)  
  
-   [Change the time that backup is scheduled to run](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_4)  
  
-   [Change the computer backup retention policy](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_5)  
  
-   [Reset backup to default settings](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_6)  
  
-   [Use repair and recovery tools](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_7)  
  
-   [Repair the backup database](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_8)  
  
-   [Disable backup for a computer](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_9)  
  
-   [Run the backup Cleanup task](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_10)  
  
-   [View alerts in the task bar on a client computer](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_11)  
  
-   [View backup status from the Launchpad](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_12)  
  
-   [Stop a backup in progress from the Launchpad](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_13)  
  
-   [Start a backup from the Launchpad](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_14)  
  
-   [How computer backup works](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_15)  
  
-   [Tips to help prevent data loss due to corruption of the client backup database](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_16)  
  
-   [Restore files or folders from a client computer backup](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_17)  
  
-   [Understanding File History](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_FileHistory)  
...
> [!IMPORTANT]  
> [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] does not support backing up and restoring dynamic disks on client computers.  
...
2.  In **Devices Tasks**, click **Customize Computer Backup and File History settings**.  
    ...
    > [!NOTE]  
    > In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], this task has been renamed **Client computer backup tasks**.  
...
2.  In **Devices Tasks**, click **Customize Computer Backup and File History settings**.  
    ...
    > [!NOTE]  
    > In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], click **Client computer backup tasks**.  
...
7.  Depending on how large the backup database is, the database repair can take several hours. Click **Close**, and then click **OK** to close the **Customize Computer Backup and File History settings** page.  
    ...
    > [!NOTE]  
    > In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], click **Client computer backup settings and tools**.  
...
For information about how to enable backup for a computer after backup has been disabled, see [Set up backup for a client computer](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_3).  
...
For information about changing the backup retention policy, see [Change the computer backup retention policy](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md#BKMK_5).  
...
-   [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] only: A new volume is added to your computer. The person who administers your network needs to run the Customize Backup Wizard to include or exclude the volume for future backups.  
...
3.  In the **Backup Properties** dialog box, in the **Backup status** section, the status of the backup is displayed.  
    ...
    -   **Cannot connect**: Backup cannot connect to the Windows Server Client Computer Backup Provider Service.  
        ...
        > [!NOTE]  
        > In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], this service has been renamed Windows Server Essentials Client Computer Management Service.  
...
-   Enable an additional method of backing up the client backup database. For example, depending on the version of Windows Server Essentials you are running, use Server Backup, Online Backup, or [!INCLUDE[sbs8_mob_1](../Token/sbs8_mob_1_md.md)] to back up the database.  
...
-   Before you clean up or restore the client backup database, make sure to stop all client backups that are currently in progress.  
    ...
    If you are running [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], you should also stop the Windows Server Client Computer Backup Service and the Windows Server Client Computer Backup Provider Service.  
  
    If you are running [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], you should also stop the Windows Server Computer Backup Service.  
...
In [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], you can customize File History settings from the **File History** page of **Client computer backup settings and tools**.  
...
|Backup data|Documents and Desktop|There are three pre\-configured settings, which allow you to specify a variety of backup solutions. You can choose one of the following options:<br /><br />-   Documents and Desktop<br />-   All Libraries, Desktop, Contacts, and Favorites<br />-   All data in Libraries, Desktop, Contacts, and Favorites excluding data in the Music, Video and Pictures Libraries|  
...
For information about file history issues, see [Troubleshoot File History in Windows Server Essentials](../Topic/Troubleshoot-File-History-in-Windows-Server-Essentials.md).  
