...
-   A failover cluster running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] with at least two nodes configured. The cluster must pass the cluster validation tests included in the validation wizard.  
...
-   Client computers must be running [!INCLUDE[win8_client_1](../Token/win8_client_1_md.md)] or [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], both of which include the updated SMB client that supports continuous availability.  
...
-   At least two computers running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] are required. No extra features need to be installed—the technology is on by default.  
...
## See also  
The following list provides additional resources on the web about SMB and related technologies in [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)].  
