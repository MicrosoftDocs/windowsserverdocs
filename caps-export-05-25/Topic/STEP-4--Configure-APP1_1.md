...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: a0ee655e-c01e-4bf3-a7b3-064e9614f810
author: vhorne
---
# STEP 4: Configure APP1_1
Configure static IPv6 addressing and gateway settings to enable APP1 access to the 2\-Corpnet subnet.  
  
-   [To configure the default gateway and DNS server](../Topic/STEP-4--Configure-APP1_1.md#IPv6)—The multisite configuration uses the ROUTER1 computer as a default gateway. Configure the default gateway on APP1.  
