...
The default configuration for a stand\-alone computer running [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)] or Windows XP Professional is Guest only. The default configuration for domain\-joined computers running the [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)] or Windows XP Professional operating system is Classic. Computers that run the [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] or Windows Server 2003 operating system also use the Classic security model.  
