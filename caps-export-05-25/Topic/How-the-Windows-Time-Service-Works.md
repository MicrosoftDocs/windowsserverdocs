...
> [!NOTE]  
> This topic explains only how the Windows Time service \(W32Time\) works. For information about how to configure Windows Time service, see the list of topics in the section [Where to Find Windows Time Service Configuration Information](../Topic/Windows-Time-Service-Technical-Reference.md#BKMK_Config).  
  
> [!NOTE]  
> In Windows Server® 2003 and Microsoft Windows 2000 Server, the directory service is named Active Directory® directory service. In [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] and later versions, the directory service is named [!INCLUDE[firstref_adds](../Token/firstref_adds_md.md)] \(AD DS\). The rest of this topic refers to AD DS, but the information is also applicable to Active Directory.  
...
## See Also  
[Windows Time Service Technical Reference](../Topic/Windows-Time-Service-Technical-Reference.md#w2k3tr_times_intro)  
[Windows Time Service Tools and Settings](../Topic/Windows-Time-Service-Tools-and-Settings.md)  
