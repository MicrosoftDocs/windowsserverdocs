...
|[3.5. Configure DirectAccess clients for a multisite deployment](assetId:///2325da4a-3987-4132-b8d0-95c275f544b1#BKMK_Client)|Remove [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers from [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security groups.|  
...
4.  In the [!INCLUDE[sm](../Token/sm_md.md)] console, in the **Dashboard**, click **Add roles and features**.  
...
1.  On the Remote Access server in the additional entry point: [!INCLUDE[startscreen](../Token/startscreen_md.md)] **Computer Management**, and then press ENTER.  
...
On each Remote Access server that will be added to the multisite deployment, an SSL certificate is required to verify the HTTPS connection to the IP\-HTTPS web server. [!INCLUDE[mingrp_admins](../Token/mingrp_admins_md.md)]  
  
#### To obtain an IP\-HTTPS certificate  
  
1.  On each Remote Access server: [!INCLUDE[startscreen](../Token/startscreen_md.md)] **mmc**, and then press ENTER. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
...
1.  On the Remote Access server: [!INCLUDE[startscreen](../Token/startscreen_md.md)] **mmc**, and then press ENTER. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
...
1.  On the DNS server: [!INCLUDE[startscreen](../Token/startscreen_md.md)] **dnsmgmt.msc**, and then press ENTER.  
...
DirectAccess Windows client computers must be members of security group\(s\) which define their DirectAccess association. Before multisite is enabled, these security group\(s\) can contain both [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] clients and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] clients \(if the appropriate “downlevel” mode was selected\). Once multisite is enabled, existing client security group\(s\), in single server mode, are converted to security group\(s\) for [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] only. After multisite is enabled, DirectAccess [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers must be moved to corresponding dedicated [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client security groups \(which are associated with specific entry\-points\), or they will not be able to connect over DirectAccess. The [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] clients must first be removed from the existing security groups which are now [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security groups. Caution: [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers that are members of both [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] client security groups will lose remote connectivity, and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] clients without SP1 installed will lose corporate connectivity as well. Therefore, all [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers must be removed from [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security groups.  
  
#### Remove [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] clients from [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security groups  
...
3.  Select the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computer, and click **Remove**.  
  
4.  Repeat this procedure to remove the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers from the [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security groups.  
  
> [!IMPORTANT]  
> When enabling a Remote Access multisite configuration all client computers \([!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)]\) will lose remote connectivity until they are able to connect to the corporate network directly or by VPN to update their group policies. This is true when enabling multisite functionality for the first time, and also when disabling multisite.  
...
2.  The security group\(s\) containing [!INCLUDE[firstref_client_7](../Token/firstref_client_7_md.md)] client computers for the first entry point in your deployment, if you want to enable Remote Access for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers.  
  
3.  [!INCLUDE[gpo](../Token/gpo_md.md)] names, if you are required to use non\-default [!INCLUDE[gpos](../Token/gpos_md.md)], which are applied on [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers for the first entry point in your deployment, if you require support for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers.  
...
1.  On your existing Remote Access server: [!INCLUDE[startscreen](../Token/startscreen_md.md)] **RAMgmtUI.exe**, and then press ENTER. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
...
5.  On the **Entry Point Selection** page, do one of the following:  
    ...
    -   Click **Assign entry points automatically, and allow clients to select manually** to automatically route client computers to the most suitable entry point, while also allowing client computers to select an entry point manually. Manual entry point selection is available only for [!INCLUDE[win8_client_1](../Token/win8_client_1_md.md)] computers. Click **Next**.  
...
7.  On the **Client Support** page, do one of the following:  
    ...
    -   To limit access to client computers running [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or later operating systems, click **Limit access to client computers running Windows 8 or a later operating system**, and then click **Next**.  
  
    -   To allow client computers running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] to access this entry point, click **Allow client computers running Windows 7 to access this entry point**, and click **Add**. On the **Select Groups** dialog box, select the security group\(s\) that contains the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers, click **OK**, and then click **Next**.  
  
8.  On the **Client GPO Settings** page, accept the default GPO for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers for this entry point, type the name of the GPO that want Remote Access to create automatically, or click **Browse** to locate the GPO for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers, and then click **Next**.  
  
    > [!NOTE]  
    > -   The **Client GPO Settings** page appears only when you configure the entry point to allow [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers to access the entry point.  
...
To allow [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers access through the first entry point through the security group DA\_Clients\_US and using the GPO DA\_W7\_Clients\_GPO\_US.  
...
-   The security group\(s\) containing [!INCLUDE[firstref_client_7](../Token/firstref_client_7_md.md)] client computers for each entry point that will be added if you want to enable Remote Access for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers.  
  
-   [!INCLUDE[gpo](../Token/gpo_md.md)] names, if you are required to use non\-default [!INCLUDE[gpos](../Token/gpos_md.md)], which are applied on [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers for each entry point that will be added, if you require support for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers.  
...
10. On the **Client Support** page, do one of the following:  
    ...
    -   To allow client computers running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] to access this entry point, click **Allow client computers running Windows 7 to access this entry point**, and click **Add**. On the **Select Groups** dialog box, select the security group\(s\) that contain the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers that will connect to this entry point, click **OK**, and click **Next**.  
  
11. On the **Client GPO Settings** page, accept the default GPO for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers for this entry point, type the name of the GPO that you want Remote Access to create automatically, or click **Browse** to locate the GPO for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers, and click **Next**.  
...
To allow [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers access through the second entry point through the security group DA\_Clients\_Europe and using the GPO DA\_W7\_Clients\_GPO\_Europe.  
