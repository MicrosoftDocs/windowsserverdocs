...
-   **Hardware components for the stations** \- For information about planning stations for your environment, see [Selecting Hardware for Your MultiPoint Server System](http://technet.microsoft.com/library/JJ916407(l=en-us,v=Technet.10).aspx).  
