...
This topic provides an overview of the Core Network Guide for [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)], and contains the following sections.  
...
## <a name="bkmk_core"></a>Core Network Guide for [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]  
The [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] Core Network Guide provides instructions on how to plan and deploy the core components required for a fully functioning network and a new Active Directory® domain in a new forest. Using this guide, you can deploy computers configured with the following Windows server components:  
...
-   The [Core Network Guide](../Topic/Core-Network-Guide.md) in the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] Technical Library.  
