...
The Users page of the Windows Server Essentials Dashboard centralizes information and tasks that help you manage the user accounts on your small business network. For an overview of the Users Dashboard, see [Overview of the Dashboard in Windows Server Essentials](../Topic/Overview-of-the-Dashboard-in-Windows-Server-Essentials.md).  
  
In this topic:  
  
-   [Managing user accounts](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_ManageAccounts)  
  
-   [Managing passwords and access](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_ManageAccess)  
...
-   [Add a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage1)  
  
-   [Remove a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Remove)  
  
-   [View user accounts](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage3)  
  
-   [Change the Display Name for the user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage4)  
  
-   [Activate a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage5)  
  
-   [Deactivate a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage6)  
  
-   [Understand user accounts](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage7)  
...
-   Assign a Microsoft Online Services account \(referred to as an “[!INCLUDE[office_365_2](../Token/office_365_2_md.md)] account” in [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)]\) if applicable.  
  
-   Assign user groups \([!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] only\).  
  
> [!NOTE]  
> -   Non\-ASCII characters are not supported in [!INCLUDE[aad_1](../Token/aad_1_md.md)]. Do not use any non\-ASCII characters in your password, if your server is integrated with [!INCLUDE[aad_2](../Token/aad_2_md.md)].  
...
If the user account has a Microsoft online account assigned, the online account is also deactivated. The user cannot use resources in [!INCLUDE[office_365_2](../Token/office_365_2_md.md)] and other online services that you subscribe to, but the user’s data, including email, is retained in Microsoft Online Services.  
...
> [!NOTE]  
> -   If you integrate your server that is running [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] with Office 365, a new tab called **Distribution Groups** is also added within the **Users** page of the Dashboard.  
> -   In [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], the **Users** page of the Dashboard includes only a single tab \- **Users**.  
...
-   A list of user accounts, which displays:  
    ...
    -   In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], if the server is integrated with [!INCLUDE[office_365_2](../Token/office_365_2_md.md)] or Windows Intune, the Microsoft online account is displayed.  
  
    -   In [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], if the server is integrated with Microsoft Office 365, the status of the Office 365 account \(known in [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] as the Microsoft online account\) for the user account is displayed.  
...
> [!NOTE]  
> If you integrate [!INCLUDE[office365_sbp_3](../Token/office365_sbp_3_md.md)] with Windows Server Essentials, additional tasks will become available. For more information, see [Manage Online Accounts for Windows Server Essentials Users](../Topic/Manage-Online-Accounts-for-Windows-Server-Essentials-Users.md).  
...
|Refresh|Refreshes the Users tab.<br /><br />This task is applicable to [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)].|  
|Change File History settings|Enables you to change File History settings, such as backup frequency, or backup duration.<br /><br />This task is applicable to [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)].|  
...
-   [Change or reset the password for a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access1)  
  
-   [What you should know about password policies](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access3)  
  
-   [Change the password policy](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access4)  
  
-   [Level of access to shared folders](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access5)  
  
-   [Retain and manage access to files for removed user accounts](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access6)  
  
-   [Synchronize the DSRM password with the network administrator password](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access7)  
  
-   [Give user accounts remote desktop permission](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access8)  
  
-   [Enable users to access resources on the server](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access9)  
  
-   [Change remote access permissions for a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access10)  
  
-   [Change virtual private network permissions for a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access11)  
  
-   [Change access to internal shared folders for a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access12)  
  
-   [Allow user accounts to establish a remote desktop session to their computer](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Access13)  
...
7.  Provide the new password to the user.  
    ...
    > -   Non\-ASCII characters are not supported in [!INCLUDE[aad_2](../Token/aad_2_md.md)]. Therefore, if your server is integrated with [!INCLUDE[aad_2](../Token/aad_2_md.md)], do not use any non\-ASCII characters in your password.  
    > -   If a Microsoft online account \(known in [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] as an “[!INCLUDE[office_365_2](../Token/office_365_2_md.md)] account”\) is assigned to the user, the password is synchronized with the online account password. The user will use the new password to sign in on the server or sign in to Office 365. For more information, see [Manage Online Accounts for Windows Server Essentials Users](../Topic/Manage-Online-Accounts-for-Windows-Server-Essentials-Users.md).  
...
> [!IMPORTANT]  
> Be aware that if you remove a user account that has a Microsoft online account assigned, the online account is also removed, and the user data, including email, is subject to data retention policies in Microsoft Online Services. To retain the user data for the online account, deactivate the user account instead of removing it. For more information, see [Manage Online Accounts for Windows Server Essentials Users](../Topic/Manage-Online-Accounts-for-Windows-Server-Essentials-Users.md).  
...
3.  To synchronize the DSRM password on a domain controller with the current network administrator’s account, type:  
    ...
    **sync from domain account***<current\_network\_administrator\_account>*, and then press Enter.  
...
5.  Define the task actions:  
    ...
    3.  In the **Add arguments**\(optional\) text box, type the following \(you must include the quotation marks\): **“set dsrm password” “sync from domain account SBS\_network\_administrator\_account” q q** where *SBS\_network\_administrator\_account* is the current network administrator’s account name.  
...
For more information about Anywhere Access, see [Manage Anywhere Access in Windows Server Essentials](../Topic/Manage-Anywhere-Access-in-Windows-Server-Essentials.md).  
  
### <a name="BKMK_Access9"></a>Enable users to access resources on the server  
[!INCLUDE[wse_all_section](../Token/wse_all_section_md.md)]  
  
If you want users to use remote access, and\/or have individual user accounts, after you finish connecting a computer to the server, you can create new network user accounts for the users of the networked computer on the server by using the Dashboard. For more information about creating a user account, see [Add a user account](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage1). After creating the user accounts, you must provide the network user name and password information to the users of the client computer so that they can access resources on the server by using the Launchpad.  
...
-   [Manage Online Accounts for Windows Server Essentials Users](../Topic/Manage-Online-Accounts-for-Windows-Server-Essentials-Users.md)  
