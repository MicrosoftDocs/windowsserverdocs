...
1.  There are several key words or characters that are special in this language \(referred to as terminals\). These are presented in the [Language terminals](../Topic/Claims-Transformation-Rules-Language.md#BKMK_LT) table later in this topic. The error messages use the tags for these terminals for disambiguation.  
