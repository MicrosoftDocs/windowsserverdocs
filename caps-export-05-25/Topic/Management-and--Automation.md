...
This collection contains tool and reference information for IT pros who want to run and manage [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)].  
  
## In this collection  
  
-   [Server Manager](http://technet.microsoft.com/library/mt126175.aspx)  
  
    The content in this section describes how to use Server Manager in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] to manage both local and remote Windows\-based servers from desktop computers.  
  
-   [Remote Server Administration Tools](http://technet.microsoft.com/library/mt126174.aspx)  
  
    To ease remote server management, you can download and install Remote Server Administration Tools for [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)]. Remote Server Administration Tools for [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)] includes Server Manager, Microsoft Management Console \(MMC\) snap\-ins, consoles, Windows PowerShell cmdlets and providers, and some command\-line tools for managing roles and features that run on [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
...
To learn more about what’s new in [!INCLUDE[wps_2](../Token/wps_2_md.md)] 5.0, the release of [!INCLUDE[wps_2](../Token/wps_2_md.md)] that is included with [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] and [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)], see [What’s New in Windows PowerShell](http://technet.microsoft.com/library/hh857339.aspx).  
  
For information about how to manage [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] with [!INCLUDE[wps_2](../Token/wps_2_md.md)], see [Scripting with Windows PowerShell](http://technet.microsoft.com/library/bb978526.aspx) in the TechNet Library.  
  
For [!INCLUDE[wps_2](../Token/wps_2_md.md)] cmdlet Help reference topics for automating and managing [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] roles and features, see [Windows and Windows Server Automation with Windows PowerShell](http://technet.microsoft.com/library/dn249523.aspx).  
