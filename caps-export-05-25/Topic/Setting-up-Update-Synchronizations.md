...
If a WSUS server is running in replica mode, you will not be able to perform this task. For more information about replica mode, see [Running WSUS Replica Mode](../Topic/Running-WSUS-Replica-Mode.md), and [Step 1: Prepare for Your WSUS Deployment](../Topic/Step-1--Prepare-for-Your-WSUS-Deployment.md).  
...
>   
> To remove those products,  Decline the update, as documented in [Updates Operations](../Topic/Updates-Operations.md), and then use the [The Server Cleanup Wizard](../Topic/The-Server-Cleanup-Wizard.md) to remove them.  
...
For details about synchronizing updates from the Microsoft Update Catalog site, see: [WSUS and the Catalog Site](../Topic/WSUS-and-the-Catalog-Site.md).  
...
-   You can specify a custom port for synchronization. For information about configuring ports, see [Step 3: Configure WSUS](../Topic/Step-3--Configure-WSUS.md) in the WSUS deployment guide.  
  
-   You can use Secure Socket Layers \(SSL\) to secure synchronization of update information between WSUS servers. For more information about using SSL, see section "3.5. Secure WSUS with the Secure Sockets Layer Protocol" of [Step 3: Configure WSUS](../Topic/Step-3--Configure-WSUS.md) in the WSUS deployment guide.  
...
-   [Managing WSUS Client Computers and WSUS Computer Groups](../Topic/Managing-WSUS-Client-Computers-and-WSUS-Computer-Groups.md)  
