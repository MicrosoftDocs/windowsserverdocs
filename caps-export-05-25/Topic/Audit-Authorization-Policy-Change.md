...
-   Assigning or removing user rights \(privileges\) such as **SeCreateTokenPrivilege**, except for the system access rights that are audited by using the [Audit Authentication Policy Change](../Topic/Audit-Authentication-Policy-Change.md) subcategory.  
