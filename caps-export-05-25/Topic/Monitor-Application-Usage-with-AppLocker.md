...
This topic describes how to monitor application usage when AppLocker policies are applied in [!INCLUDE[win8_server_1](../Token/win8_server_1_md.md)] and [!INCLUDE[win8_client_1](../Token/win8_client_1_md.md)].  
...
-   **Enable the Audit only AppLocker enforcement setting**  
    ...
    For the procedure to do this, see [Configure an AppLocker Policy for Audit Only](../Topic/Configure-an-AppLocker-Policy-for-Audit-Only.md).  
...
-   **Review AppLocker events with Test\-AppLockerPolicy**  
    ...
    For the procedure to do this, see [Test an AppLocker Policy by Using Test-AppLockerPolicy](../Topic/Test-an-AppLocker-Policy-by-Using-Test-AppLockerPolicy.md).  
