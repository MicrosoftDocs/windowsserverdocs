...
> [!NOTE]  
> In Windows Server® 2003 and Microsoft Windows 2000 Server, the directory service is named Active Directory® directory service. In [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], the directory service is named [!INCLUDE[firstref_adds](../Token/firstref_adds_md.md)] \(AD DS\). The rest of this topic refers to AD DS, but the information is also applicable to Active Directory Domain Services in Windows Server 2016.  
...
## See Also  
[How the Windows Time Service Works](../Topic/How-the-Windows-Time-Service-Works.md)  
