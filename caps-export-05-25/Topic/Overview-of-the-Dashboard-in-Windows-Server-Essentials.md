...
|5|Tasks pane|The Tasks pane contains links to tools and to information that help you manage the properties for either a specific object \(such as a user account or a computer\), or for global settings for the object category. The Tasks pane is divided into these two sections:<br /><br />-   Object tasks – Contains links to tools and information that help you manage the properties for an object that you select in the list view \(such as a user account or a computer\).<br />-   Global tasks – Contains links to tools and information that help you manage global tasks for a feature area. Global tasks include tasks to add new objects, set policy, and so on.|  
...
![](../Image/WSE12_Dashboard_Home_Page.jpg)  
...
|Section|Description|  
|-----------|---------------|  
|Home|The **Home** page appears by default each time that you open the Dashboard. It includes tasks and information in the following categories:<br /><br />-   **SETUP** – Complete the tasks in this category to configure your server for the first time. For information about these tasks, see [Install and Configure Windows Server 2012 Essentials](../Topic/Install-and-Configure-Windows-Server-2012-Essentials.md).<br />-   **EMAIL** – Choose an option in this category to integrate an email service with the server. **Note:**     This category is only available in Windows Server 2012 Essentials.<br />-   **SERVICES** – Choose a task in this category to integrate Microsoft online services with the server. **Note:**     This category is only available in Windows Server 2012 R2 Essentials and Windows Server 2012 R2 Standard with the Windows Server Essentials Experience role enabled.<br />-   **ADD\-INS** – Click this category to install valuable add\-ins for your business.<br />-   **QUICK STATUS** – Displays high\-level server status. Click a status to view information and configuration options for that feature. If you complete all of the tasks in the SETUP category, this category appears at the top of the Category pane.<br />-   **HELP** – Use the Search box to search for help on the Web. Click a link to visit the website for the selected support option.|  
|Users|For users to access the resources that Windows Server Essentials provides, you need to create user accounts by using the Windows Server Essentials Dashboard. After creating user accounts, you can manage the accounts by using the tasks that are available on the **Users** page of the Dashboard. Tasks that you can perform on this page include:<br /><br />-   View a list of user accounts.<br />-   View and manage user account properties.<br />-   Activate or deactivate user accounts.<br />-   Add or remove user accounts.<br />-   Assign local network accounts to Microsoft online services accounts if your server is integrated with Office 365.<br />-   Change user account passwords and manage the password policy.<br /><br />For information about managing user accounts, see [Manage User Accounts in Windows Server Essentials](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md).|  
|User groups|**Note:** This feature is available only in Windows Server 2012 R2 Essentials and Windows Server 2012 R2 Standard with the Windows Server Essentials Experience role enabled.<br /><br />Tasks that you can perform on this page include:<br /><br />-   View a list of user groups.<br />-   View and manage user groups.<br />-   Add or remove user groups.|  
|Distribution groups|**Note:** This feature is available only in Windows Server 2012 R2 Essentials and Windows Server 2012 R2 Standard with the Windows Server Essentials Experience role enabled. This tab is only displayed when Windows Server Essentials is integrated with Office 365.<br /><br />Tasks that you can perform on this page include:<br /><br />-   View a list of distribution groups.<br />-   Add or remove distribution groups.|  
|Devices|After you connect computers to the Windows Server Essentials network, you can manage the computers from the **Devices** page of the Dashboard. Tasks that you can perform on this page include:<br /><br />-   View a list of computers that are joined to your network.<br />-   Manage mobile devices by leveraging the Office 365 Mobile Device Management capability. **Note:**     This feature is only available in Windows Server 2012 R2 Essentials and Windows Server 2012 R2 Standard with the Windows Server Essentials Experience role enabled.<br />-   View the computer properties and health alerts for each computer.<br />-   Set up and manage computer backups.<br />-   Restore files and folders to computers.<br />-   Establish a Remote Desktop connection to a computer<br />-   Customize Computer Backup and File History settings<br />-   <br /><br />For information about managing computers and backups, see [Manage Devices in Windows Server Essentials](../Topic/Manage-Devices-in-Windows-Server-Essentials.md).|  
|Storage|Depending on the version of Windows Server Essentials you are running, the **Storage** section of the Dashboard contains the following sections by default.<br /><br />-   The **Server Folders** subsection includes tasks that help you view and manage the properties for server folders. The page also includes tasks to open and add server folders.<br />-   The **Hard Drives** page includes tasks that help you view and check the health of the drives that are attached to the server.<br />-   In Windows Server 2012 R2 Essentials and Windows Server 2012 R2 Standard with the Windows Server Essentials Experience role enabled, the **SharePoint Libraries** page includes tasks that help you manage the SharePoint Libraries in Office 365 service.<br /><br />For information about managing server folders, see [Manage Server Folders in Windows Server Essentials](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md).<br /><br />For information about managing hard drives, see [Manage Server Storage in Windows Server Essentials](../Topic/Manage-Server-Storage-in-Windows-Server-Essentials.md).|  
|Applications|The **Applications** section of the Windows Server Essentials Dashboard contains two subsections by default.<br /><br />For information about managing add\-in applications, see [Manage Applications in Windows Server Essentials](../Topic/Manage-Applications-in-Windows-Server-Essentials.md).<br /><br />-   The **Add\-ins** subsection displays a list of installed add\-ins, and provides tasks that enable you to remove an add\-in, and to access additional information about a selected add\-in.<br />-   The **Microsoft Pinpoint** subsection displays a list of applications that are available from Microsoft Pinpoint.|  
...
> [!WARNING]  
> In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], to connect to the Dashboard from the client computer, right\-click the tray icon, and then open the Dashboard from the context menu.  
...
When you are working from a remote computer, you can access the Windows Server Essentials Dashboard by using the [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] site.  
...
3.  Type your username and password to sign in to the [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] site.  
  
4.  In the **Computers** section of the [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)]**Home** page; locate your server and click **Connect**.  
    ...
    >   
    > To give a user permission to access the Dashboard from [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)], open the Properties page for the user account, and then select the **Server Dashboard** option on the **Anywhere Access** tab.  
...
-   [Manage Applications in Windows Server Essentials](../Topic/Manage-Applications-in-Windows-Server-Essentials.md)  
