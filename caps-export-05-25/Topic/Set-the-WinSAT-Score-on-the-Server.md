...
You should set the WinSAT CPU score for a server that is running the [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] operating system to optimize the video streaming resolution. You do this by creating and installing the .xml file that contains the WinSAT score information.  
...
Where *WinSAT\_Score* is replaced with the value that is discovered on the server.  
