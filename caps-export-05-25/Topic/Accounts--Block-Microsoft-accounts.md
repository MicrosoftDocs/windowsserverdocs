...
### Group Policy  
Because this policy setting was introduced to control sign\-in options for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], it has no affect on earlier Windows operating systems.  
