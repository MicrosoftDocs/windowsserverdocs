...
> [!NOTE]  
> By default, the media streaming functionality is unavailable in [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] and [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../Token/wseblue_experience_md.md)] role installed. To add the media streaming functionality in these versions, [download and install the Windows Server Essentials Media Pack](http://www.microsoft.com/download/details.aspx?id=40837) from the Microsoft Download Center.  
  
-   [Digital media overview](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_1)  
  
-   [Manage media server using the Dashboard](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_2)  
  
-   [How media streaming works](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_3)  
  
-   [Turn media streaming on or off](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_4)  
  
-   [Add digital media files to the server](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_5)  
  
-   [Allow or restrict access to a media library on the server](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_6)  
  
-   [Rename the media library](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_8)  
  
-   [Stop sharing digital media](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_9)  
  
-   [Enable media devices that use the Server Message Block \(SMB\) protocol to access shared files on the server](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_10)  
  
-   [Common processors and the video profiles they support](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_CommonProcessors)  
  
-   [Known issues with media file types](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_KnownIssues)  
...
Many people store music, video, and pictures in shared folders in [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)]. There may be times when you want to do the following:  
...
[!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] makes it possible to perform common administrative tasks by using the [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] Dashboard. The **Media** tab of the server **Settings** page of the Dashboard provides the following:  
...
|Media library|Displays the name of the media library. The default name of the library is called **Digital Media Library**, which is created when you turn on media streaming. To change the media library name, see [Rename the media library](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_8). You can click **Customize** to customize the folders that are shared into the media library.|  
  
For more information, see [Allow or restrict access to a media library on the server](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_6) and [Sharing copy\-protected media](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_1.5).  
  
## <a name="BKMK_3"></a>How media streaming works  
The media streaming feature in [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] makes it possible for networked computers and some networked digital media devices to play digital media files that are stored on the server.  
...
For more information, see [Enable media streaming](../Topic/Manage-Digital-Media-in-Windows-Server-2012-Essentials.md#BKMK_4).  
  
## <a name="BKMK_4"></a>Turn media streaming on or off  
You can share music, videos, and pictures from [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] by streaming files to any supported digital media receiver \(DMR\) such as computers, mobile phones, televisions, digital media receivers, extenders for Windows Media Center \(including Xbox 360\), and other personal electronic devices.  
  
For a current list of digital media devices that are compatible with [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], see the [Windows Compatibility Center](http://www.microsoft.com/windows/compatibility/CompatCenter/Home).  
  
### Enabling media sharing  
To share the media that is stored in [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)], you need to turn on media streaming. Media streaming is turned off by default.  
...
1.  Use one of the following methods to sign in to the server:  
    ...
    1.  For information about logging on to Remote Web Access, see [Log on to Remote Web Access](../Topic/Use-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_1).  
...
The server administrator can stop sharing digital media that is stored in shared folders on a server running [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)].  
