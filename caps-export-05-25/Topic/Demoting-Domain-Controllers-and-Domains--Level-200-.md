...
-   [AD DS Removal Workflow](../Topic/Demoting-Domain-Controllers-and-Domains--Level-200-.md#BKMK_Workflow)  
  
-   [Demotion and Role Removal Windows PowerShell](../Topic/Demoting-Domain-Controllers-and-Domains--Level-200-.md#BKMK_PS)  
  
-   [Demote](../Topic/Demoting-Domain-Controllers-and-Domains--Level-200-.md#BKMK_Demote)  
  
## <a name="BKMK_Workflow"></a>AD DS Removal Workflow  
![](../Image/adds_demotedomainforest.png)  
...
-   Click **AD DS** or **All Servers** on the navigation pane. Scroll down to the **Roles and Features** section. Right\-click **Active Directory Domain Services** in the **Roles and Features** list and click **Remove Role or Feature**. This interface skips the **Server Selection** page.  
    ...
    ![](../Image/ADDS_RRW_TR_ServerSelection.png)  
...
### Server Selection  
![](../Image/ADDS_RRW_TR_ServerSelection2.png)  
...
![](../Image/ADDS_RRW_TR_ServerRoles.png)  
...
![](../Image/ADDS_RRW_TR_RemoveFeatures.png)  
  
![](../Image/ADDS_RRW_TR_Demote.png)  
  
### Credentials  
![](../Image/ADDS_RRW_TR_Credentials.png)  
...
-   Demoting an additional domain controller requires Domain Admin credentials. Selecting **Force removal of the domain controller** demotes the domain controller without removing the domain controller object’s metadata from Active Directory.  
    ...
    ![](../Image/ADDS_RRW_TR_ForceDemote.png)  
...
### Warnings  
![](../Image/ADDS_RRW_TR_Warnings.png)  
...
### Removal Options  
![](../Image/ADDS_RRW_TR_ReviewOptions.png)  
...
![](../Image/ADDS_RRW_TR_NewAdminPwd.png)  
...
### Confirmation  
![](../Image/ADDS_RRW_TR_Confirmation.png)  
...
### Demotion  
![](../Image/ADDS_RRW_TR_Demotion.png)  
...
![](../Image/ADDS_PSUninstallConfirm.png)  
  
![](../Image/ADDS_PSUninstallWindowsFeature.png)  
...
![](../Image/ADDS_PSUninstallFinished.png)  
...
![](../Image/ADDS_PSUninstallExampleForce.png)  
...
![](../Image/ADDS_PSUninstallExampleLastDC.png)  
