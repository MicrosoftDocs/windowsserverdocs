...
|-------------|---------------|  
|[Nslookup exit Command](../Topic/Nslookup-exit-Command.md)|Exits **nslookup**.|  
|[Nslookup finger Command](../Topic/Nslookup-finger-Command.md)|Connects with the finger server on the current computer.|  
|[Nslookup help](../Topic/Nslookup-help.md)|Displays a short summary of **nslookup** subcommands.|  
|[Nslookup ls](../Topic/Nslookup-ls.md)|Lists information for a DNS domain.|  
|[Nslookup lserver](../Topic/Nslookup-lserver.md)|Changes the default server to the specified DNS domain.|  
|[Nslookup root](../Topic/Nslookup-root.md)|Changes the default server to the server for the root of the DNS domain name space.|  
|[Nslookup server](../Topic/Nslookup-server.md)|Changes the default server to the specified DNS domain.|  
|[Nslookup set](../Topic/Nslookup-set.md)|Changes configuration settings that affect how lookups function.|  
|[Nslookup set all](../Topic/Nslookup-set-all.md)|Prints the current values of the configuration settings.|  
|[Nslookup set class](../Topic/Nslookup-set-class.md)|Changes the query class. The class specifies the protocol group of the information.|  
|[Nslookup set d2](../Topic/Nslookup-set-d2.md)|Turns exhaustive Debugging Mode on or off. All fields of every packet are printed.|  
|[Nslookup set debug](../Topic/Nslookup-set-debug.md)|Turns Debugging Mode on or off.|  
...
|[Nslookup set domain](../Topic/Nslookup-set-domain.md)|Changes the default DNS domain name to the name specified.|  
|[Nslookup \/set ignore](assetId:///7ebc431b-cc44-4cee-b520-0d6879071275)|Ignores packet truncation errors.|  
|[Nslookup set port](../Topic/Nslookup-set-port.md)|Changes the default TCP\/UDP DNS name server port to the value specified.|  
|[Nslookup set querytype](../Topic/Nslookup-set-querytype.md)|Changes the resource record type for the query.|  
|[Nslookup set recurse](../Topic/Nslookup-set-recurse.md)|Tells the DNS name server to query other servers if it does not have the information.|  
|[Nslookup set retry](../Topic/Nslookup-set-retry.md)|Sets the number of retries.|  
|[Nslookup set root](../Topic/Nslookup-set-root.md)|Changes the name of the root server used for queries.|  
|[Nslookup set search](../Topic/Nslookup-set-search.md)|Appends the DNS domain names in the DNS domain search list to the request until an answer is received. This applies when the set and the lookup request contain at least one period, but do not end with a trailing period.|  
|[Nslookup set srchlist](../Topic/Nslookup-set-srchlist.md)|Changes the default DNS domain name and search list.|  
|[Nslookup set timeout](../Topic/Nslookup-set-timeout.md)|Changes the initial number of seconds to wait for a reply to a request.|  
|[Nslookup set type](../Topic/Nslookup-set-type.md)|Changes the resource record type for the query.|  
|[Nslookup set vc](../Topic/Nslookup-set-vc.md)|Specifies to use or not use a virtual circuit when sending requests to the server.|  
|[Nslookup view](../Topic/Nslookup-view.md)|Sorts and lists the output of the previous **ls** subcommand or commands.|  
