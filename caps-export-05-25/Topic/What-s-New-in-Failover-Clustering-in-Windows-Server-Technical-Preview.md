...
This topic explains the new and changed functionality in Failover Clustering in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
  
-   [Cluster Operating System Rolling Upgrade](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_RollingUpgrade)  
  
-   [Storage Replica](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_SR)  
  
-   [Cloud Witness](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_CloudWitness)  
  
-   [Virtual Machine Resiliency](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_VMs)  
  
-   [Diagnostic Improvements](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_Diagnostics)  
  
-   [Site-aware Failover Clusters](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_SiteAware)  
  
-   [Workgroup and Multi-domain Clusters](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_multidomainclusters)  
  
-   [Virtual Machine Node Fairness](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_VMNodeFairness)  
  
-   [Virtual Machine Start Order](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_VMStartOrder)  
-   [Simplified SMB Multichannel and Multi-NIC Cluster Networks](../Topic/What-s-New-in-Failover-Clustering-in-Windows-Server-Technical-Preview.md#BKMK_SMBMultiChannel)  
...
Upgrading a Hyper\-V or Scale\-Out File Server cluster from Windows Server 2012 R2 to [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] no longer requires downtime. The cluster will continue to function at a Windows Server 2012 R2 level until all of the nodes in the cluster are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]. The cluster functional level is upgraded to [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] by using the Windows PowerShell cmdlt `Update-ClusterFunctionalLevel`.  
  
> [!WARNING]  
> -   After you update the cluster functional level, you cannot go back to a [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] cluster functional level.  
> -   Until the `Update-ClusterFunctionalLevel` cmdlet is run, the process is reversible, and Windows Server 2012 R2 nodes can be added and [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] nodes can be removed.  
  
**What works differently?**  
  
A Hyper\-V or Scale\-Out File Server failover cluster can now easily be upgraded without any downtime or need to build a new cluster with nodes that are running the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] operating system. Migrating clusters to Windows Server 2012 R2 involved taking the existing cluster offline and reinstalling the new operating system for each nodes, and then bringing the cluster back online. The old process was cumbersome and required downtime. However, in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], the cluster does not need to go offline at any point.  
...
-   The existing operating system is removed and a clean installation of the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] operating system on the node is performed.  
  
-   The node running the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] operating system is added back to the cluster.  
  
-   At this point, the cluster is said to be running in mixed mode, because the cluster nodes are running either [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] or [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
  
-   The cluster functional level stays at [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)]. At this functional level, new features in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] that affect compatibility with previous versions of the operating system will be unavailable.  
  
-   Eventually, all nodes are upgraded to [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
  
-   Cluster functional level is then changed to [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] using the Windows PowerShell cmdlet `Update-ClusterFunctionalLevel`. At this point, you can take advantage of the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] features.  
  
For more information, see [Cluster Operating System Rolling Upgrade](../Topic/Cluster-Operating-System-Rolling-Upgrade.md).  
...
**Compute Resiliency**[!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] includes increased virtual machines compute resiliency to help reduce intra\-cluster communication issues in your compute cluster as follows: .  
...
In [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], virtual machine storage resiliency is aware and optimized for guest clusters too.  
  
## <a name="BKMK_Diagnostics"></a>Diagnostic Improvements in Failover Clustering  
To help diagnose issues with failover clusters, [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] includes the following:  
...
* [What's New in File and Storage Services](../Topic/What-s-New-in-File-and-Storage-Services-in-Windows-Server-2016-Technical-Preview.md)  
