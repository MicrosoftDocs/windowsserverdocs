...
-   If you already have an existing DNS infrastructure, you must integrate the Active Directory namespace into that environment. For more information, see [Integrating AD DS into an Existing DNS Infrastructure](../Topic/Integrating-AD-DS-into-an-Existing-DNS-Infrastructure.md).  
...
> [!NOTE]  
> In addition to IP version 4 \(IPv4\) addresses, [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] also supports IP version 6 \(IPv6\) addresses. For a worksheet to assist you in listing the IPv6 addresses while documenting the recursive name resolution method of your current DNS structure, see [Appendix A: DNS Inventory](../Topic/Appendix-A--DNS-Inventory.md).  
...
-   [Reviewing DNS Concepts](../Topic/Reviewing-DNS-Concepts.md)  
  
-   [DNS and AD DS](../Topic/DNS-and-AD-DS.md)  
  
-   [Assigning the DNS for AD DS Owner Role](../Topic/Assigning-the-DNS-for-AD-DS-Owner-Role.md)  
  
-   [Integrating AD DS into an Existing DNS Infrastructure](../Topic/Integrating-AD-DS-into-an-Existing-DNS-Infrastructure.md)  
