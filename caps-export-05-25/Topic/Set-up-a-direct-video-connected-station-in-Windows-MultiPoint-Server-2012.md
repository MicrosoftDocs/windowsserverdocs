---
title: Set up a direct-video-connected station in Windows MultiPoint Server 2012
ms.custom: na
...
The following illustration shows a MultiPoint Server environment that has a single MultiPoint Server computer and four direct video\-connected stations. For more information, see [MultiPoint Server Stations](../Topic/MultiPoint-Server-Stations.md).  
