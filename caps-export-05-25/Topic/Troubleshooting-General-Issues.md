...
**Symptom**—After a [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client upgrades to [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)] or [!INCLUDE[win8_client_1](../Token/win8_client_1_md.md)] in a multisite deployment, the DirectAccess connection is not visible in the Networks list.  
...
If a client has already been upgraded or the DCA is not configured, move the client computer to the [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)] or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security group.  
