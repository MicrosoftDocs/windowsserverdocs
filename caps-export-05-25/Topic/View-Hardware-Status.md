...
In [!INCLUDE[win8_server_multipoint_manager](../Token/win8_server_multipoint_manager_md.md)], use the **Stations** tab to view *station* information, such as:  
...
-   Open [!INCLUDE[win8_server_multipoint_manager](../Token/win8_server_multipoint_manager_md.md)] in station mode, and then click the **Stations** tab.  
...
[Switch Between Modes](../Topic/Switch-Between-Modes.md)  
