...
> [!NOTE]  
> Excluding [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], AppLocker can manage Windows Store apps. For information about how to add rules for these apps to your existing GPO, see [Add Rules for Packaged Apps to Existing AppLocker Rule-set](../Topic/Add-Rules-for-Packaged-Apps-to-Existing-AppLocker-Rule-set.md).  
