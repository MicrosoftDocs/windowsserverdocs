...
For more information about how to set up a station, see [Set Up a Station](../Topic/Set-Up-a-Station.md).  
...
For more information about how to set up a MultiPoint Services station, see [Set Up a Station](../Topic/Set-Up-a-Station.md).  
