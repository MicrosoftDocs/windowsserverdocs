...
After [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)] or [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] is installed, you can enable the built\-in Administrator account, but we strongly recommend that this account remain disabled.  
