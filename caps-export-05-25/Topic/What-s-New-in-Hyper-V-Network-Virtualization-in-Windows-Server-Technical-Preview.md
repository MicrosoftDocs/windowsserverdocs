...
This topic describes the Hyper\-V Network Virtualization \(HNV\) functionality that is new or changed in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
...
|--------------------------|-------------------|---------------|  
|[Programmable Hyper-V switch](../Topic/What-s-New-in-Hyper-V-Network-Virtualization-in-Windows-Server-Technical-Preview.md#SDN)|New|HNV policy is programmable through the Microsoft Network Controller.|  
|[VXLAN encapsulation support](../Topic/What-s-New-in-Hyper-V-Network-Virtualization-in-Windows-Server-Technical-Preview.md#VXLAN)|New|HNV now supports VXLAN encapsulation.|  
|[Software Load Balancer (SLB) interoperability](../Topic/What-s-New-in-Hyper-V-Network-Virtualization-in-Windows-Server-Technical-Preview.md#SLB)|New|HNV is fully integrated with the Microsoft Software Load Balancer.|  
|[Compliant IEEE Ethernet headers](../Topic/What-s-New-in-Hyper-V-Network-Virtualization-in-Windows-Server-Technical-Preview.md#L2)|Improved|Compliant with IEEE Ethernet standards|  
...
For more information about network controller integration, see [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] HNV Technical Details \(coming soon\)  
  
![](../Image/HNVOverview.png)  
