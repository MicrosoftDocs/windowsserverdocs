---
title: Prepare your Source Server for Windows Server 2012 Essentials migration_5
ms.custom: na
...
author: cfreemanwa
---
# Prepare your Source Server for Windows Server 2012 Essentials migration_5
...
1.  [Back up your Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_5.md#BKMK_BackUpYourSourceServerToPrepareForMigration)  
  
2.  [Install the most recent service packs](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_5.md#BKMK_InstallTheMostRecentServicePacksToPrepareForMigration)  
  
3.  [Verify the network configuration](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_5.md#BKMK_Verify)  
  
4.  [Evaluate the health of the Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_5.md#BKMK_UseWindowsBestPracticeAnalyzer)  
  
5.  [Run the Migration Preparation Tool on the Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_5.md#BKMK_MPT)  
  
6.  [Create a plan to migrate line\-of\-business applications](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_5.md#BKMK_PlanToMigrateLineOfBusinessApplications)  
...
[!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] does not run the DHCP Server role by default. During migration, you can manage the DHCP Server role from the Source Server or from the router, depending on your current network configuration:  
...
> [!NOTE]  
> If you used the Windows Server 2008 Foundation SDK to develop a customized system health or alert add\-In, and you want to continue to use the add\-in with [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], you must also update the add\-in and deploy it on the Destination Server.  
