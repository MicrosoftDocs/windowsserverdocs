...
---
# Secedit:validate
Validates the security settings stored in a security template \(.inf file\). For examples of how this command can be used, see [Examples](../Topic/Secedit-validate.md#BKMK_Examples).  
