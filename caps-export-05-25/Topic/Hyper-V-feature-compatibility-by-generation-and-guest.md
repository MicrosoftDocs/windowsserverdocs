...
Single root input/output virtualization \(SR-IOV) | 1 and 2 | 64-bit Windows guests, starting with [!INCLUDE[win8_server_2_md](/Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2_md](/Token/win8_client_2_md.md)].  
