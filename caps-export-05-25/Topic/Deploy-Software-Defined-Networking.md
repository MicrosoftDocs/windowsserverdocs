...
The topics in this section provide information about the different methods you can use to deploy a Software Defined Networking (SDN) infrastructure and the individual technologies that are included in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
