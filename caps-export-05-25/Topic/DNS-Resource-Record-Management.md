...
In [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], IPAM provides integration between IP address inventory, DNS Zones, and DNS resource records:  
