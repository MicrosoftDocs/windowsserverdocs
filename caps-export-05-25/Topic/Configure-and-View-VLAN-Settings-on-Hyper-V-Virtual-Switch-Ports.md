...
When you want to configure VLAN settings on Hyper-V Virtual Switch ports, you can use either [!INCLUDE[winthreshold_server_1_md](/Token/winthreshold_server_1_md.md)] Hyper-V Manager or System Center Virtual Machine Manager (VMM).
...
- If you are using [!INCLUDE[winthreshold_server_2_md](/Token/winthreshold_server_2_md.md)] Hyper-V Manager or Windows PowerShell cmdlets, and you have not deployed Software Defined Networking \(SDN\), you must use the **VMNetworkAdapterVlan** cmdlets.
