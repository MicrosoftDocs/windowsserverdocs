...
-   The same benefits as listed for the [Federation Server Farm Using WID_1](../Topic/Federation-Server-Farm-Using-WID_1.md) topology, plus the benefit of providing additional access for external users  
  
### What are the limitations of using this topology?  
  
-   The same limitations as listed for the [Federation Server Farm Using WID_1](../Topic/Federation-Server-Farm-Using-WID_1.md) topology  
