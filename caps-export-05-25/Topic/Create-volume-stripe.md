...
> [!IMPORTANT]  
> For [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)], this DiskPart command is only available in the [!INCLUDE[nextref_vistau](../Token/nextref_vistau_md.md)], [!INCLUDE[nextref_vistae](../Token/nextref_vistae_md.md)], and Windows Vista Business editions.  
