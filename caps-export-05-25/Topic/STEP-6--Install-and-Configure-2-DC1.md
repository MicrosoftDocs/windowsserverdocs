...
13. In the [!INCLUDE[sm](../Token/sm_md.md)] console, in **Local Server**, in the **Properties** area, next to **Computer name**, click the link.  
...
Use this procedure to provide the CORP\\User1 user with full permissions to create and change corp2 [!INCLUDE[gpos](../Token/gpos_md.md)].  
  
#### To provide Group Policy permissions  
  
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**gpmc.msc**, and then press ENTER.  
