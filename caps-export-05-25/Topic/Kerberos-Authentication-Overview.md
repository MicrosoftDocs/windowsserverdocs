...
Kerberos is an authentication protocol that is used to verify the identity of a user or host. This topic contains information about Kerberos authentication in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
...
For a description of changes made to the Kerberos implementation in Windows, see [What's New in Kerberos Authentication](../Topic/What-s-New-in-Kerberos-Authentication.md).  
  
## <a name="BKMK_LINKS"></a>See also  
  
|Content type|References|  
|----------------|--------------|  
|**Product evaluation**|[Kerberos Constrained Delegation Overview](../Topic/Kerberos-Constrained-Delegation-Overview.md)<br /><br />[Dynamic Access Control: Scenario Overview](../Topic/Dynamic-Access-Control--Scenario-Overview.md)<br /><br />Access Control and Authorization Overview [New and changed functionality](assetId:///f50aa089-c29a-43c5-9e61-83091d7e4ee7#BKMK_NEW)<br /><br />[What's New in Active Directory Domain Services &#40;AD DS&#41;](../Topic/What-s-New-in-Active-Directory-Domain-Services--AD-DS-.md)|  
|**Planning**|[What's New in Kerberos Authentication](../Topic/What-s-New-in-Kerberos-Authentication.md)<br /><br />[Kerberos Documentation for Windows 7, Windows Vista, Windows Server 2008 R2, and Windows Server 2008](http://technet.microsoft.com/library/cc753173(WS.10).aspx)|  
|**Deployment**|Not yet available|  
|**Operations**|Not yet available|  
|**Troubleshooting**|Not yet available|  
|**Security**|Not yet available|  
|**Tools and settings**|[\[MS\-KILE\]: Kerberos Protocol Extensions](http://msdn.microsoft.com/library/cc233855(v=prot.13))<br /><br />[\[MS\-KKDCP\]: Kerberos Key Distribution Center \(KDC\) Proxy Protocol Specification](http://msdn.microsoft.com/library/hh553774(v=prot.13))|  
...
## See Also  
[Windows Authentication Overview](../Topic/Windows-Authentication-Overview.md)  
