...
Remote Web Access in Windows Server Essentials, or in [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../Token/wseblue_experience_md.md)] role installed, provides a streamlined, touch\-friendly browser experience for accessing applications and data from virtually anywhere that you have an Internet connection and by using almost any device. To use the Remote Web Access functionality, you must first turn it on by using the Set Up Anywhere Access Wizard, and then set up your router and domain name.  
  
## In this topic  
  
-   [Turn on and configure Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Set up your router](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_2)  
  
-   [Set up your domain name](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_3)  
  
-   [Customize Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_4)  
  
-   [Troubleshoot Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_5)  
...
-   [Remote Web Access overview](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Overview)  
  
-   [Turn on Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_TurnOnRWA)  
  
-   [Change your region](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Region)  
  
-   [Manage Remote Web Access Permissions](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ManagePerms)  
  
-   [Secure Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SecureRWA)  
  
-   [Manage Remote Web Access and VPN users](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ManageRWAVPN)  
  
### <a name="BKMK_Overview"></a>Remote Web Access overview  
When you are away from your office, you can open a web browser and access [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] from anywhere that has Internet access. In [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)], you can:  
...
[!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] is not turned on by default. When you run the Set up Anywhere Access Wizard, the wizard attempts to set up your router and Internet connectivity. After [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] is turned on, you can set up a domain name for your server and customize [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)]. You can also set up the router again if you change your router.  
  
Permission to access [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] is not automatically granted when you add a new user account. When you add a user account, you can choose to allow access to shared folders, the Media Library, computers, Home page links, and the server Dashboard. You can also specify that a user not be allowed to use [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)].  
  
The [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] setting is displayed for each user account on the **USERS** tab of the Windows Server Essentials Dashboard. To change the [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] setting, right\-click the user account, and then click **View the account properties**.  
...
For more information, see [Manage User Accounts in Windows Server Essentials](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md).  
...
-   [Set up your router](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SetUpRouter)  
  
-   [Replace a router](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ReplaceRouter)  
  
-   [Network location defined](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_NetworkLocation)  
  
-   [Enable Remote Desktop Services ActiveX controls](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ActiveX)  
...
The Remote Desktop Services ActiveX controls allows you to access your home or business computer, via the Internet, from another computer by using [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)].  
...
-   [Domain names overview](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_DNOverview)  
  
-   [Understand Microsoft personalized domain names](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_PersonalizedNames)  
  
-   [Use a new or existing domain name](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_UseNewName)  
  
-   [Set up a domain name](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SetUpName)  
  
-   [Choose a domain name service provider](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ChooseProvider)  
  
-   [Choose a domain name](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ChooseDomainName)  
  
-   [Choose a domain name prefix](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Prefixes)  
  
-   [Choose a domain name extension](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Extension)  
  
-   [Update or upgrade your domain name service](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_UpdateService)  
  
-   [Export or import your certificate on your server](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_ExportCert)  
  
-   [Set up a domain name manually](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_SetNameManually)  
  
-   [Find your domain name service provider](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_Find)  
...
-   A custom domain name for [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] \(for example, *yourhostname*.remotewebaccess.com\). Your domain name is associated with your public IP address.  
  
-   A DNS dynamic update protocol service so that [!INCLUDE[sbs8_rwa](../Token/sbs8_rwa_md.md)] using your domain name will not be interrupted if your public IP address changes. Typically, Internet Service Providers \(ISPs\) for your organization’s broadband connections provide dynamic public IP addresses that can change.  
...
To view the complete list of top\-level domains, see the [Internet Assigned Numbers Authority website](http://go.microsoft.com/fwlink/?LinkId=117438).  
...
If you want to create a backup copy of a certificate or use it on another server, you must export the certificate. For information about exporting certificates, see [Export a Certificate](http://go.microsoft.com/fwlink/p/?LinkId=214362).  
...
-   [Customize Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_CustomizeRWA)  
  
-   [Customize images for backgrounds and logos](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_CustomizeImages)  
  
-   [Repair Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_RepairRWA)  
...
> [!NOTE]  
> The Repair Wizard is not available until you turn on Remote Web Access. For information about turning on Remote Web Access, see [Turn on Remote Web Access](../Topic/Manage-Remote-Web-Access-in-Windows-Server-Essentials.md#BKMK_TurnOnRWA).  
...
-   [Troubleshoot Remote Web Access connectivity in Windows Server Essentials](../Topic/Troubleshoot-Remote-Web-Access-connectivity-in-Windows-Server-Essentials.md)  
  
-   [Troubleshoot your firewall in Windows Server Essentials](../Topic/Troubleshoot-your-firewall-in-Windows-Server-Essentials.md)  
  
-   [Troubleshoot Anywhere Access in Windows Server Essentials](../Topic/Troubleshoot-Anywhere-Access-in-Windows-Server-Essentials.md)  
  
## See also  
  
-   [Remote desktop options](../Topic/Remote-desktop-options.md)  
