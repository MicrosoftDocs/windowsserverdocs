...
To configure Windows Firewall to log dropped packets or successful connections, use the [!INCLUDE[wfas](../Token/wfas_md.md)] node in the Group Policy Management MMC snap\-in.  
