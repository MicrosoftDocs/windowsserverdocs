...
-   [Introduction to Troubleshooting](../Topic/Troubleshooting-Domain-Controller-Deployment.md#BKMK_Intro)  
  
-   [Troubleshooting Options](../Topic/Troubleshooting-Domain-Controller-Deployment.md#BKMK_Options)  
  
## <a name="BKMK_Intro"></a>Introduction to Troubleshooting  
![](../Image/adds_deploy_troubleshooting.png)  
