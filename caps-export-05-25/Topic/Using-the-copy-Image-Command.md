...
Copies images that are within the same image group. To copy images between image groups, use the [Using the Export-Image Command](../Topic/Using-the-Export-Image-Command.md) command and then the [Using the add-Image Command](../Topic/Using-the-add-Image-Command.md) command.  
