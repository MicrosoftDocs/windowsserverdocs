...
> [!NOTE]  
> This policy setting does not have any impact on ldap\_simple\_bind or ldap\_simple\_bind\_s. LDAP client computers that are running Windows XP Professional or [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)] do not use ldap\_simple\_bind or ldap\_simple\_bind\_s to communicate with a domain controller.  
