...
For details about removing processors, see the instructions that came with the computer or contact the hardware manufacturer. See the following instructions to use Msconfig.
