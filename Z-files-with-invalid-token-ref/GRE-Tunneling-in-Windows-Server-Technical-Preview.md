...
[!INCLUDE[winthreshold_server_2](includes/winthreshold_server_2_md.md)] provides updates to Generic Routing Encapsulation (GRE) tunnel capability for the RAS Gateway.
...
-   They can be managed with [!INCLUDE[vmmblue_2](includes/vmmblue_2_md.md)]
...
-   [Access from tenant virtual networks to tenant physical networks](GRE-Tunneling-in-Windows-Server-Technical-Preview.md#BKMK_Access)

-   [High speed connectivity](GRE-Tunneling-in-Windows-Server-Technical-Preview.md#BKMK_Speed)

-   [Integration with VLAN based isolation](GRE-Tunneling-in-Windows-Server-Technical-Preview.md#BKMK_Integration)

-   [Access shared resources](GRE-Tunneling-in-Windows-Server-Technical-Preview.md#BKMK_Shared)

-   [Services of third party devices to tenants](GRE-Tunneling-in-Windows-Server-Technical-Preview.md#BKMK_thirdparty)
