...
-   **Applications** The type and number of applications running at the same time, especially graphic\-heavy or memory intensive applications will affect the overall performance of your system. For more information, see [Applications and Internet Content](../../../compute/remote-desktop-services/multipoint-1/Hardware-Requirements-and-Performance-Recommendations.md#BKMK_TypeandNumberofInstancesofApplicationsandInternetContent) in this guide.  
...
-   **RemoteFX** For RDP\-over\-LAN connected stations, you may be able to utilize RemoteFX to greatly improve the delivery of high\-definition multimedia content. For more information, see [Microsoft RemoteFX](../../../compute/remote-desktop-services/multipoint-1/Microsoft-RemoteFX.md) in this guide.  
