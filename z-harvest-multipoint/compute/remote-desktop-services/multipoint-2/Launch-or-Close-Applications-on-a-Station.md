...
As *MultiPoint Dashboard User*, you can open or close an application on a user’s desktop, selected desktops, or all desktops.  
  
#### To launch an application on a user station  
  
1.  In [!INCLUDE[win8_server_multipoint_dashboard](../../../compute/remote-desktop-services/multipoint-1/includes/win8_server_multipoint_dashboard_md.md)], click the thumbnail image of the user desktop on which you want to launch the application, and then click the drop–down menu for **Launch** in the ribbon under **Applications**.  
...
1.  In [!INCLUDE[win8_server_multipoint_dashboard](../../../compute/remote-desktop-services/multipoint-1/includes/win8_server_multipoint_dashboard_md.md)], click the drop–down menu for **Launch** (in the ribbon under **Applications**).  
...
1.  In [!INCLUDE[win8_server_multipoint_dashboard](../../../compute/remote-desktop-services/multipoint-1/includes/win8_server_multipoint_dashboard_md.md)], click the thumbnail image of the desktop on which you want to close an application.  
