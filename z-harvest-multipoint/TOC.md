...
#### [Install MultiPoint Services](compute/remote-desktop-services/multipoint-1/Install-Windows-MultiPoint-Server-2012.md)
...
#### [Attach additional stations to your MultiPoint Services computer](compute/remote-desktop-services/multipoint-1/Attach-additional-stations-to-your-Windows-MultiPoint-Server-2012-computer.md)
##### [Set up a direct-video-connected station in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Set-up-a-direct-video-connected-station-in-Windows-MultiPoint-Server-2012.md)
##### [Set up a USB zero client-connected station in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Set-up-a-USB-zero-client-connected-station-in-Windows-MultiPoint-Server-2012.md)
##### [Set up an RDP-over-LAN connected station in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Set-up-an-RDP-over-LAN-connected-station-in-Windows-MultiPoint-Server-2012.md)
#### [Activate MultiPoint Services and add CALs](compute/remote-desktop-services/multipoint-1/Activate-Windows-MultiPoint-Server-2012-and-add-CALs.md)
#### [Install software on your MultiPoint Services System](compute/remote-desktop-services/multipoint-1/Install-software-on-your-Windows-MultiPoint-Server-2012-system.md)
...
#### [Set up a split-screen station in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Set-up-a-split-screen-station-in-Windows-MultiPoint-Server-2012.md)
#### [Add printers in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Add-printers-in-Windows-MultiPoint-Server-2012.md)
#### [Enable access over a wireless LAN in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Enable-access-over-a-wireless-LAN-in-Windows-MultiPoint-Server-2012.md)
...
#### [Change the display language in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Change-the-display-language-in-Windows-MultiPoint-Server-2012.md)
...
#### [Example scenarios: MultiPoint Services user accounts](compute/remote-desktop-services/multipoint-1/Example-scenarios--Windows-MultiPoint-Server-2012-user-accounts.md)
...
#### [Enable file sharing in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Enable-file-sharing-in-Windows-MultiPoint-Server-2012.md)
...
#### [Configure Disk Protection in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Configure-Disk-Protection-in-Windows-MultiPoint-Server-2012.md)
#### [Install Server Backup on your MultiPoint Services computer](compute/remote-desktop-services/multipoint-1/Install-Server-Backup-on-your-Windows-MultiPoint-Server-2012-computer.md)
...
#### [Configure sleep settings in MultiPoint Services](compute/remote-desktop-services/multipoint-1/Configure-sleep-settings-in-Windows-MultiPoint-Server-2012.md)
...
## [Appendixes: Deploying MultiPoint Services](compute/remote-desktop-services/multipoint-1/Appendixes--Deploying-Windows-MultiPoint-Server-2012.md)
### [Task Lists: Deploying MultiPoint Services](compute/remote-desktop-services/multipoint-1/Task-Lists--Deploying-Windows-MultiPoint-Server-2012.md)
### [Display language scenarios for MultiPoint Services](compute/remote-desktop-services/multipoint-1/Display-language-scenarios-for-Windows-MultiPoint-Server-2012.md)
