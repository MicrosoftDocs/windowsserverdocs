...
This topic describes the steps to export an AppLocker policy to an XML file for review or testing in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
  
[!INCLUDE[mingrp_admins](../Token/mingrp_admins_md.md)]  
  
### To export an AppLocker policy to an XML file  
  
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**secpol.msc**.  
