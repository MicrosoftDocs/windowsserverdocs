...
Event, service, and performance log data is displayed in two places in the [!INCLUDE[sm](../Token/sm_md.md)] console in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
...
If the [!INCLUDE[sm](../Token/sm_md.md)] console is running on a client computer as part of Remote Server Administration Tools, there is no **Local Server** thumbnail.  
...
For more information about advanced performance monitoring and analysis tools that are available for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and later releases of Windows Server, including Server Performance Advisor 3.0, see [Performance](http://msdn.microsoft.com/windows/hardware/gg463374.aspx) on MSDN.  
