...
> [!IMPORTANT]  
> This command is not available in any edition of [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)].  
...
-   When used without parameters in [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)], this command operates on a disk group. For basic disks, there is never more than one disk per group. For dynamic disks, the group includes all non\-foreign dynamic disks.  
