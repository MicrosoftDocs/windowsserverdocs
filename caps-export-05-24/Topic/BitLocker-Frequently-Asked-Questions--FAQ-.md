...
-   [Overview and requirements](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_Overview)  
  
-   [Upgrading](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_Upgrading)  
  
-   [Deployment and administration](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_Deploy)  
  
-   [Key management](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_KeyManagement)  
  
-   [BitLocker To Go](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_BTGsect)  
  
-   [Active Directory Domain Services \(AD DS\)](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_ADDS)  
  
-   [Security](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_Security)  
  
-   [BitLocker Network Unlock](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_BNUsect)  
  
-   [Other questions](../Topic/BitLocker-Frequently-Asked-Questions--FAQ-.md#BKMK_Other)  
...
Yes. To upgrade from Windows 7 to [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] without decrypting the operating system drive, open the **BitLocker Drive Encryption** Control Panel item in Windows 7, click **Manage BitLocker**, and then and click **Suspend**. Suspending protection does not decrypt the drive; it disables the authentication mechanisms used by BitLocker and uses a clear key on the drive to enable access. Proceed with the upgrade process by using your [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] DVD or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] upgrade. After the upgrade has completed, open Windows Explorer, right\-click the drive, and then click **Resume Protection**. This reapplies the BitLocker authentication methods and deletes the clear key.  
...
|Upgrade from Windows 7 to [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)]|Suspend|  
...
Capabilities introduced in [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], allow you to choose whether or not BitLocker should encrypt the entire drive or just the used space on the drive when you turn on BitLocker. On a new hard drive, encrypting just the used spaced can be considerably faster than encrypting the entire drive. When this encryption option is selected, BitLocker automatically encrypts data as it is saved, ensuring that no data is stored unencrypted.  
...
> [!NOTE]  
> Capabilities introduced in [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] makes mounting the hard disk on another computer a quick and straightforward way to recover information from a damaged computer that has a BitLocker\-protected drive on the hard disk.  
...
All of the versions of BitLocker that have been included with the operating system have obtained the Federal Information Processing Standard \(FIPS\) 140\-2 certification, and have been Common Criteria certified EAL4\+. These certifications have also been completed for [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], and [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] and [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] are in process.  
...
BitLocker is not supported on bootable VHDs, but BitLocker is supported on data volume VHDs, such as those used by clusters, if you are running [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)].  
