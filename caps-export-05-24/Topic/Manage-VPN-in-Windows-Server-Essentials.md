...
-   [Enable VPN for remote access on the server](../Topic/Manage-VPN-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Set VPN permissions for network users](../Topic/Manage-VPN-in-Windows-Server-Essentials.md#BKMK_2)  
  
-   [Connect client computers to the server](../Topic/Manage-VPN-in-Windows-Server-Essentials.md#BKMK_Connect)  
  
-   [Use VPN to connect to Windows Server Essentials](../Topic/Manage-VPN-in-Windows-Server-Essentials.md#BKMK_3)  
