...
2.  In an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER. This flushes name resolution entries that may still exist in the client DNS cache from when the client computer was connected to the corpnet.  
  
3.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **Get\-DnsClientNrptPolicy** and press ENTER.  
...
4.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app1** and press ENTER. You should see replies from the IPv6 address for APP1, which in this case is 2001:db8:1::3.  
  
5.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app2** and press ENTER. You should see replies from the NAT64 address assigned by EDGE1 to APP2, which in this case is fdc9:9f4e:eb1b:7777::a00:4.  
...
6.  Leave the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window open for the next procedure.  
...
9. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App2\\Files**, and then press ENTER. Double\-click the New Text Document file.  
...
10. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**wf.msc**, and then press ENTER.  
...
2.  On CLIENT1, in the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER. This flushes name resolution entries that may still exist in the client DNS cache.  
  
3.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, ping APP1, and APP2. You should receive replies from both of these resources.  
  
4.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\app2\\files**. You should see the shared folder on the APP2 computer. The ability to open the file share on APP2 indicates that the second tunnel, which requires Kerberos authentication for the user, is working correctly.  
