---
title: Prepare your Source Server for Windows Server 2012 Essentials migration_1
ms.custom: na
...
---
# Prepare your Source Server for Windows Server 2012 Essentials migration_1
...
1.  [Back up your Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_1.md#BKMK_BackUpYourSourceServerToPrepareForMigration)  
  
2.  [Install the most recent service packs](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_1.md#BKMK_InstallTheMostRecentServicePacksToPrepareForMigration)  
  
3.  [Evaluate the health of the Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_1.md#BKMK_UseWindowsBestPracticeAnalyzer)  
  
4.  [Run the Migration Preparation Tool on the Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_1.md#BKMK_MPT)  
  
5.  [Create a plan to migrate line\-of\-business applications](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration_1.md#BKMK_PlanToMigrateLineOfBusinessApplications)  
