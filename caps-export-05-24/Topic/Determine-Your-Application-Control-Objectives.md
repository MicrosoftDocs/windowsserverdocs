...
|--------------------------------|-------|-------------|  
|Scope|SRP policies can be applied to all Windows operating systems beginning with Windows XP and Windows Server 2003.|AppLocker policies apply only to the support versions of Windows listed in [Requirements to Use AppLocker](../Topic/Requirements-to-Use-AppLocker.md).|  
