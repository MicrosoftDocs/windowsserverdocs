...
Modifying this setting may affect compatibility with clients, services, and applications, including those running in operating systems earlier than [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)].  
