...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: dc28e9e8-74e3-4777-9c09-c143dcd1fc43
author: billmath
---
...
> [!NOTE]  
> For the Federated Web Single\-Sign\-On \(SSO\) design, you must have at least one federation server in the account partner organization and at least one federation server in the resource partner organization. For more information, see [Where to Place a Federation Server](../Topic/Where-to-Place-a-Federation-Server.md).  
