...
-   [Remote Resultant Set of Policy \(RSoP\) Group Policy results: ports that require firewall rules](../Topic/Configure-Firewall-Port-Requirements-for-Group-Policy.md#BKMK_RemoteRSoP)  
  
-   [Remote Group Policy refresh: ports that require firewall rules](../Topic/Configure-Firewall-Port-Requirements-for-Group-Policy.md#BKMK_RemoteRefresh)  
