...
![ADFS_ITPRO_1](/Image/ADFS_ITPRO4.png)  
...
For more information on configuring AD FS access control policies, see [Access control policies in AD FS](Access-Control-Policies-in-AD-FS.md).  
...
2.  Or [migrate](Upgrading-to-AD-FS-in-Windows-Server-2016.md) a farm to AD FS 2016 from AD FS 2012 R2  
