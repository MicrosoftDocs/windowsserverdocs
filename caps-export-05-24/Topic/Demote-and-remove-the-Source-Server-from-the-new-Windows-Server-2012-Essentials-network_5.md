---
title: Demote and remove the Source Server from the new Windows Server 2012 Essentials network_5
ms.custom: na
...
---
# Demote and remove the Source Server from the new Windows Server 2012 Essentials network_5
...
After you finish installing [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] and you complete the migration, you can remove the source server from the network. To remove the Source Server, perform the following tasks:  
  
1.  [Remove Active Directory Certificate Services](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_5.md#BKMK_ADCS)  
  
2.  [Disconnect printers that are directly connected to the Source Server](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_5.md#BKMK_PhysicallyDisconnect)  
  
3.  [Demote the Source Server](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_5.md#BKMK_DemoteTheSourceServer)  
  
4.  [Remove and repurpose the Source Server](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_5.md#BKMK_RemoveTheSourceServer)  
