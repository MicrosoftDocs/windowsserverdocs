...
---
# Secedit:configure
Allows you to configure the current system settings using security settings stored in a database. For examples of how this command can be used, see [Examples](../Topic/Secedit-configure.md#BKMK_Examples).  
...
-   [Secedit:analyze](../Topic/Secedit-analyze.md)  
