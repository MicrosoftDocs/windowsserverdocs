...
You create this rule using either the claim rule language or using the Pass Through or Filter an Incoming Claim rule template in the [!INCLUDE[nextref_adfs2](../Token/nextref_adfs2_md.md)] Management snap\-in. This rule template provides the following configuration options:  
...
For more instructions on how to create this template, see [Create a Rule to Pass Through or Filter an Incoming Claim_1](../Topic/Create-a-Rule-to-Pass-Through-or-Filter-an-Incoming-Claim_1.md) in the [!INCLUDE[nextref_adfs2](../Token/nextref_adfs2_md.md)] Deployment Guide.  
