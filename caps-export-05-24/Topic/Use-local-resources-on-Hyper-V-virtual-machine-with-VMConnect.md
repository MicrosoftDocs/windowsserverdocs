...
If your Hyper\-V host runs [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)], you might not have to go through the following steps to turn on enhanced session mode. It's turn on by default. But if your host runs [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], you must turn on enhanced session mode to use it. It is turned off by default for those operating systems.  
...
2.  In Hyper\-V Manager, select the host’s computer name.  
    ...
    ![](../Image/Hyper-V-HyperVManager-HostNameSelected.png)  
  
3.  Select **Hyper\-V settings**.  
  
    ![](../Image/HyperV-ActionsHyperVSettings.png)  
  
4.  Under **Server**, select **Enhanced session mode policy**.  
  
    ![](../Image/Hyper-V-Settings-ServerEnhancedSessionModePolicy.png)  
  
5.  Select the **Allow enhanced session mode** check box.  
  
    ![](../Image/Hyper-V-Settings-EnhancedSessionModePolicyCheckBox.png)  
  
6.  Under **User**, select **Enhanced session mode**.  
  
    ![](../Image/Hyper-V-Settings-UserEnhancedSessionMode.png)  
...
3.  Click **Show options**.  
    ...
    ![](../Image/HyperV-VMConnect-DisplayConfig.png)  
  
4.  Select **Local resources**.  
  
    ![](../Image/HyperV-VMConnect-DisplayConfig-LocalResources.png)  
  
5.  Click **More**.  
  
    ![](../Image/HyperV-VMConnect-DisplayConfig-LocalResourcesMore.png)  
  
6.  Select the drive that you want to use on the virtual machine and click **Ok**.  
  
    ![](../Image/HyperV-VMConnect-Settings-LocalResourcesDrives.png)  
  
7.  Select **Save my settings for future connections to this virtual machine**.  
  
    ![](../Image/HyperV-VMConnect-SaveSettings.png)  
...
-   The computer that you use to connect to the virtual machine with VMConnect must run [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], or [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)].  
  
-   The virtual machine must have Remote Desktop Services enabled and run [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] as the guest operating system.  
