...
If the **Audit Kernel Object** setting is configured, the following events are generated. The events appear on computers running [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], Windows Server 2008, [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], or Windows Vista.  
