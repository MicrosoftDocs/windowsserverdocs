...
---
# Secedit:export
Exports security settings stored in a database configured with security templates. For examples of how this command can be used, see [Examples](../Topic/Secedit-export.md#BKMK_Examples).  
...
-   [Secedit:import](../Topic/Secedit-import.md)  
