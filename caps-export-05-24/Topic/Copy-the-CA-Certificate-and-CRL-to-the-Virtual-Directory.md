...
1.  On CA1, run [!INCLUDE[wps_2](../Token/wps_2_md.md)] as an Administrator, and then publish the CRL with the following command:  
...
![adcs_pkiview](/Image/adcs_pkiview.png)  
