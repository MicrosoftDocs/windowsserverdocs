...
---
# Secedit:import
Imports security settings stored in an inf file previously exported from the database configured with security templates. For examples of how this command can be used, see [Examples](../Topic/Secedit-import.md#BKMK_Examples).  
...
In Windows Server 2008, `Secedit /refreshpolicy` has been replaced with `gpupdate`. For information on how to refresh security settings, see [Gpupdate](../Topic/Gpupdate.md).  
...
-   [Secedit:export](../Topic/Secedit-export.md)  
  
-   [Secedit:generaterollback](../Topic/Secedit-generaterollback.md)  
  
-   [Secedit:validate](../Topic/Secedit-validate.md)  
