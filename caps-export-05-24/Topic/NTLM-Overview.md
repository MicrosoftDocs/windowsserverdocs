...
---
# NTLM Overview
This topic for the IT professional describes NTLM, any changes in functionality, and provides links to technical resources to Windows Authentication and NTLM for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and previous versions.  
...
There are no changes in functionality for NTLM for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)].  
  
## <a name="BKMK_DEP"></a>Removed or deprecated functionality  
There is no removed or deprecated functionality for NTLM for [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)].  
...
|**Related technologies**|[Windows Authentication Overview](../Topic/Windows-Authentication-Overview.md)|  
