...
This topic shows how to create an AppLocker rule with a path condition in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
...
For information about the path condition, see [Understanding the Path Rule Condition in AppLocker](../Topic/Understanding-the-Path-Rule-Condition-in-AppLocker.md).  
