...
|Virus protection is turned off, not installed, or not up to date.|The data on your computer is at risk if the **Virus protection** security setting is turned off or not updated. [To protect your computer](../Topic/Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_Protect), follow the steps indicated.|  
|Spyware and unwanted software protection is turned off, not installed, or not up to date.|The data on your computer is at risk if the **Spyware and unwanted software protection** is turned off or not updated. [To protect your computer](../Topic/Manage-System-Health-in-Windows-Server-Essentials.md#BKMK_Protect), follow the steps indicated.|  
