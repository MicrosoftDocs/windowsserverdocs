---
title: Prepare your Source Server for Windows Server 2012 Essentials migration
ms.custom: na
...
1.  [Back up your Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_BackUpYourSourceServerToPrepareForMigration)  
  
2.  [Install the most recent service packs](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_InstallTheMostRecentServicePacksToPrepareForMigration)  
  
3.  [Verify the network configuration](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_Verify)  
  
4.  [Evaluate the health of the Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_UseWindowsBestPracticeAnalyzer)  
  
5.  [Run the Migration Preparation Tool on the Source Server](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_MPT)  
  
6.  [Create a plan to migrate line\-of\-business applications](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_PlanToMigrateLineOfBusinessApplications)  
  
7.  [Create a plan to migrate email that is hosted on Windows Small Business Server 2011 Standard](../Topic/Prepare-your-Source-Server-for-Windows-Server-2012-Essentials-migration.md#BKMK_PlanToMigrateEmail)  
...
You cannot perform a migration mode installation without first running the Migration Preparation Tool on your Source Server. This tool is designed to prepare your Source Server and domain to be migrated to [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)].  
...
> [!NOTE]  
> If you used the Windows Small Business Server 2011 Standard SDK to develop a customized system health or alert add\-In, and you want to continue to use the add\-in with [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], you must also update the add\-in and deploy it on the Destination Server.  
...
In Windows Small Business Server 2011 Standard, email is provided through Exchange Server. However, [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] does not provide an inbox email service. If you are currently using Windows Small Business Server 2011 Standard to host your company’s email, you will need to migrate to an alternate on\-premise or hosted solution.  
...
If you have chosen to use Microsoft Office 365 as the email solution for your domain, see [Migrate All Mailboxes to the Cloud with a Cutover Exchange Migration](http://go.microsoft.com/fwlink/p/?LinkId=248619) to start the email migration to Office 365. We recommend that you complete the email migration before you [Install Windows Server 2012 Essentials in migration mode_5](../Topic/Install-Windows-Server-2012-Essentials-in-migration-mode_5.md).  
...
>   
> After you [Install Windows Server 2012 Essentials in migration mode_5](../Topic/Install-Windows-Server-2012-Essentials-in-migration-mode_5.md), you should turn on the Office 365 Integration feature on [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)].  
  
#### Migrate email to another on\-premises Exchange Server  
For information about how to migrate email to another on\-premises Exchange Server, see [Integrate an On\-Premises Exchange Server with Windows Server 2012 Essentials](http://go.microsoft.com/fwlink/?LinkId=244290). We recommend that you set up the new on\-premises Exchange Server after you [Install Windows Server 2012 Essentials in migration mode_5](../Topic/Install-Windows-Server-2012-Essentials-in-migration-mode_5.md), and then finish the email migration before demoting the Source Server.  
