---
title: Join computers to the new Windows Server 2012 Essentials network_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 412c38dd-7286-409d-82cf-a8d93f6664db
---
# Join computers to the new Windows Server 2012 Essentials network_1
  
## <a name="BKMK_JoinComputers"></a>  
The next step in the migration process is to join client computers to the new [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] network and update Group Policy settings.  
