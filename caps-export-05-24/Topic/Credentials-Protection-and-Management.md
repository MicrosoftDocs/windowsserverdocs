...
This topic for the IT professional discusses features and methods introduced in [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] and [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] for credential protection and domain authentication controls to reduce credential theft.  
...
For more information, see [What's New in Remote Desktop Services in Windows Server](../Topic/What-s-New-in-Remote-Desktop-Services-in-Windows-Server.md).  
  
### LSA protection  
The Local Security Authority \(LSA\), which resides within the Local Security Authority Security Service \(LSASS\) process, validates users for local and remote sign\-ins and enforces local security policies. The [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] operating system provides additional protection for the LSA to prevent code injection by non\-protected processes. This provides added security for the credentials that the LSA stores and manages. This protected process setting for LSA can be configured in [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] but is on by default in [!INCLUDE[winblue_winrt_2](../Token/winblue_winrt_2_md.md)] and cannot be changed.  
  
For information about configuring LSA protection, see [Configuring Additional LSA Protection](../Topic/Configuring-Additional-LSA-Protection.md).  
  
### Protected Users security group  
This new domain global group triggers new non\-configurable protection on devices and host computers running [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] and [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)]. The Protected Users group enables additional protections for domain controllers and domains in [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] domains. This greatly reduces the types of credentials available when users are signed in to computers on the network from a non\-compromised computer.  
...
For more information, see [Authentication Policies and Authentication Policy Silos](../Topic/Authentication-Policies-and-Authentication-Policy-Silos.md).  
  
For more information how to configure protected accounts, see [How to Configure Protected Accounts](../Topic/How-to-Configure-Protected-Accounts.md).  
