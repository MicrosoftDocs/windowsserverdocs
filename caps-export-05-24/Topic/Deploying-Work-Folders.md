...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: c29ef64e-05fc-40e9-8a9d-9614d83537f4
---
# Deploying Work Folders
This topic discusses the steps needed to implement Work Folders. It assumes that you’ve already read [Designing a Work Folders Implementation](../Topic/Designing-a-Work-Folders-Implementation.md).  
...
>   
> -   [Step 3: Install Work Folders on file servers](../Topic/Deploying-Work-Folders.md#step3)  
> -   [Step 5: Create security groups for Work Folders](../Topic/Deploying-Work-Folders.md#step5)  
> -   [Step 7: Create sync shares for user data](../Topic/Deploying-Work-Folders.md#step6)  
...
-   The subject name of the certificate must contain the public Work Folders URL used for discovering the Work Folders service from across the Internet – this must be in the format of **workfolders.***<domain\_name>*.  
...
3.  On the **Authentication** page, optionally choose **Active Directory Federation Services** and specify a Federation Service URL. For more information about AD FS, see [Active Directory Federation Services Overview](../Topic/Active-Directory-Federation-Services-Overview.md), and [Deploying Work Folders with AD FS and Web Application Proxy \(WAP\)](http://blogs.technet.com/b/filecab/archive/2014/03/03/deploying-work-folders-with-ad-fs-and-web-application-proxy-wap.aspx).  
...
-   Force Work Folders to be set up automatically, using default settings \(review the Group Policy discussion in [Designing a Work Folders Implementation](../Topic/Designing-a-Work-Folders-Implementation.md) before doing this\)  
...
|----------------|--------------|  
|**Product evaluation**|-   [Work Folders Overview](../Topic/Work-Folders-Overview.md)|  
|**Deployment**|-   [Designing a Work Folders Implementation](../Topic/Designing-a-Work-Folders-Implementation.md)<br />-   [Deploying Work Folders with AD FS and Web Application Proxy \(WAP\)](http://blogs.technet.com/b/filecab/archive/2014/03/03/deploying-work-folders-with-ad-fs-and-web-application-proxy-wap.aspx)<br />-   [Work Folders Test Lab Deployment](http://blogs.technet.com/b/filecab/archive/2013/07/10/work-folders-test-lab-deployment.aspx) \(blog post\)<br />-   [A new user attribute for Work Folders server Url](http://blogs.technet.com/b/filecab/archive/2013/10/09/a-new-user-attribute-for-work-folders-server-url.aspx) \(blog post\)|  
|**Technical Reference**|-   [Interactive logon: Machine account lockout threshold](../Topic/Interactive-logon--Machine-account-lockout-threshold.md)<br />-   [Sync Share Cmdlets](http://technet.microsoft.com/library/dn296644.aspx)|  
