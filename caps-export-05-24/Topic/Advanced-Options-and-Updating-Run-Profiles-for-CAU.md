...
> [!IMPORTANT]  
> To set the **PreUpdateScript** or **PostUpdateScript** option, ensure that [!INCLUDE[wps_2](../Token/wps_2_md.md)] 4.0 and .NET Framework 4.5 are installed and that [!INCLUDE[wps_2](../Token/wps_2_md.md)] remoting is enabled on each node in the cluster. For more information, see [Configure nodes for remote management](../Topic/Requirements-and-Best-Practices-for-Cluster-Aware-Updating.md#BKMK_NODE_CONFIG) in [Requirements and Best Practices for Cluster\-Aware Updating \[WS8\]](../Topic/Requirements-and-Best-Practices-for-Cluster-Aware-Updating.md).  
