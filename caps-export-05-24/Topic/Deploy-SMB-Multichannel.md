...
SMB Multichannel, a feature included with [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and part of the Server Message Block \(SMB\) 3.0 protocol, increases the network performance and availability of file servers.  
...
-   At least two computers that run on [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] operating systems are required. No additional features have to be installed—SMB Multichannel is enabled by default.  
...
For detailed information, see [Example configurations](../Topic/Deploy-SMB-Multichannel.md#BKMK_exam_config).  
