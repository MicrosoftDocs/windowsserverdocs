...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: f292ee3b-ca77-41f4-9ac3-c6ed5b244855
---
# STEP 2: Configure EDGE1
The following procedure is performed on the DirectAccess server:  
  
-   [Configure DirectAccess on EDGE1](../Topic/STEP-2--Configure-EDGE1.md#configDA)—Configure DirectAccess for your organization.  
  
## <a name="configDA"></a>Configure DirectAccess on EDGE1  
  
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**RAMgmtUI.exe**, and then press ENTER. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
