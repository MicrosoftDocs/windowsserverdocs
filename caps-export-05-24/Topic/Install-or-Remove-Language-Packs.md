...
> [!NOTE]  
> You must first create a multilingual Windows image as described in the [Language Packs and Deployment](http://technet.microsoft.com/library/hh824829) before you add the [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] language pack.  
  
Language packs are only available for creating multi\-lingual images. The information in this section is specific to installing or removing language packs on [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)].  
...
> [!IMPORTANT]  
> You must also apply language packs for [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] to fully localize the operating system.  
