---
title: Step 3: Approve and Deploy Updates in WSUS_deleted
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: d9254848-1ae5-4178-80fb-8bceed7b1fc9
author: britw
---
# Step 3: Approve and Deploy Updates in WSUS_deleted
...
|Task|Description|  
|--------|---------------|  
|[4.1. Approve and deploy WSUS updates](../Topic/Step-4--Approve-and-Deploy-Updates-in-WSUS.md#BKM_4.1.)|Approve and deploy WSUS updates by using the WSUS Management Console.|  
|[4.2. Configure auto-approval rules](../Topic/Step-4--Approve-and-Deploy-Updates-in-WSUS.md#BKM_4.2.a.)|Configure WSUS to automatically approve installation of updates for selected groups, and how to approve revisions to existing updates.|  
|[4.3. Review installed updates with WSUS Reports](../Topic/Step-4--Approve-and-Deploy-Updates-in-WSUS.md#BKM_4.3.)|Review the updates that were installed, the computers that received those updates and other details by using the WSUS Reporting feature.|  
