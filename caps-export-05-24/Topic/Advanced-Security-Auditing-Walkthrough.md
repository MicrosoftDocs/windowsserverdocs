...
![](../Image/audit_sxs_network_diagram.gif)  
...
1.  Start your computer by using the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] product CD.  
