...
>   
> -   [BranchCache Network Shell and Windows PowerShell Commands](../Topic/BranchCache-Network-Shell-and-Windows-PowerShell-Commands.md)  
> -   [BranchCache Deployment Guide](../Topic/BranchCache-Deployment-Guide.md)  
...
-   The client computers in your branch offices are running [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)],  [!INCLUDE[winblue_client_1](../Token/winblue_client_1_md.md)], [!INCLUDE[win8_client_1](../Token/win8_client_1_md.md)], or [!INCLUDE[firstref_client_7](../Token/firstref_client_7_md.md)].  
...
### Web servers  
Supported Web servers include computers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[firstref_server_7](../Token/firstref_server_7_md.md)] that have the Web Server \(IIS\) server role installed and that use Hypertext Transfer Protocol \(HTTP\) or HTTP Secure \(HTTPS\). In addition, the Web server must have the BranchCache feature installed.  
  
### File servers  
Supported file servers include computers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] that have the File Services server role and the BranchCache for Network Files role service installed. These file servers use Server Message Block \(SMB\) to exchange information between computers. After you complete installation of your file server, you must also share folders and enable hash generation for shared folders by using Group Policy or Local Computer Policy to enable BranchCache.  
  
### Application servers  
Supported application servers include computers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] with Background Intelligent Transfer Service \(BITS\) installed and enabled. In addition, the application server must have the BranchCache feature installed. As examples of application servers, you can deploy Microsoft Windows Server Update Services \(WSUS\) and Microsoft System Center Configuration Manager Branch Distribution Point servers as BranchCache content servers.  
...
|-------------|---------------------|--------------------------|-------------------------------|  
|[!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)]|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later; none for distributed cache mode|V1|  
|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later; [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or later|[!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)]|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later; none for distributed cache mode|V1|  
|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later; [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or later|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later|[!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)]|V1|  
|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later;  [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or later|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later|[!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or later; none for distributed cache mode|V2|  
  
When you have content servers and hosted cache servers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], they use the content information version that is appropriate based on the operating system of the BranchCache client that requests information. When computers running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or later operating systems request content, the content and hosted cache servers use V2 content information; when computers running [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] request content, the content and hosted cache servers use V1 content information.  
  
When you deploy BranchCache in distributed cache mode, clients that use different content information versions do not share content with each other. For example, a client computer running [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] and a client computer running [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)] that are installed in the same branch office do not share content with each other.  
...
-   [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)] Enterprise  
  
-   [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)] Education  
  
-   [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] Enterprise  
  
-   [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] Enterprise  
...
-   [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)] Pro, BITS support only  
  
-   [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] Pro, BITS support only  
  
-   [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] Pro, BITS support only  
  
-   Windows® 7 Pro, BITS support only  
  
### Operating systems for BranchCache content server functionality  
You can use the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] families of operating systems as BranchCache content servers.  
  
In addition, the [!INCLUDE[firstref_server_7](../Token/firstref_server_7_md.md)] family of operating systems can be used as BranchCache content servers, with the following exceptions:  
...
You can use the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], and [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] families of operating systems as BranchCache hosted cache servers.  
  
In addition, the following [!INCLUDE[firstref_server_7](../Token/firstref_server_7_md.md)] operating systems can be used as BranchCache hosted cache servers:  
...
-   For hosted cache servers that are running [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], a hosted cache server certificate and associated private key are required, and the certification authority \(CA\) that issued the certificate must be trusted by client computers in the branch office. This allows the client and server to participate successfully in HTTPS Server authentication.  
  
    > [!IMPORTANT]  
    > Hosted cache servers that are running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], or [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] do not require a hosted cache server certificate and associated private key.  
