...
The NLB feature distributes traffic across several servers by using the TCP\/IP networking protocol. By combining two or more computers that are running applications into a single virtual cluster, NLB provides reliability and performance for web servers and other mission\-critical servers.  
...
-   Manage and configure multiple NLB clusters and the cluster hosts from a single computer by using NLB Manager or the NLB [!INCLUDE[wps_2](../Token/wps_2_md.md)] cmdlets.  
...
> [!NOTE]  
> NLB functionality is the same as in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)].  
...
![](../Image/NLBoverviewconfiguration.gif)  
...
In Server Manager, use the Add Roles and Features Wizard to add the Network Load Balancing feature. Optionally you can install the Network Load Balancing Tools to manage a local or remote NLB cluster. The tools include Network Load Balancing Manager and the NLB [!INCLUDE[wps_2](../Token/wps_2_md.md)] cmdlets. For more information about installing features, see [Install or Uninstall Roles, Role Services, or Features](http://go.microsoft.com/fwlink/p/?LinkID=239563).  
...
|----------------|--------------|  
|**Deployment**|[Network Load Balancing Deployment Guide](http://technet.microsoft.com/library/cc754833(WS.10).aspx)|  
...
|**Tools and settings**|[Network Load Balancing Windows PowerShell cmdlets](http://technet.microsoft.com/library/hh801274.aspx)|  
...
|**Related technologies**|[Web Server \(IIS\)](http://technet.microsoft.com/windowsserver/dd448617) &#124; [NIC Teaming Overview](assetId:///912908f6-4c97-43d3-a442-7e11b62dda8a)|  
