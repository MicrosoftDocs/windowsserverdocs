...
|\-ln <logger\_name>|Specifies the logger name for Event Trace Sessions.|  
...
The following command updates the existing data collector perf\_log, changing the maximum log size to 10 MB, updating the log file format to CSV, and appending file versioning in the format mmddhhmm.  
...
[logman create trace](../Topic/logman-create-trace.md)  
