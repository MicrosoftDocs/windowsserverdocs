...
-   [Add an implementation of the IDomainSignupProvider interface to the assembly](../Topic/Add-Third-Level-Domain-Names.md#BKMK_DomainSignup)  
  
-   [Add an implementation of the IDomainMaintenanceProvider interface to the assembly](../Topic/Add-Third-Level-Domain-Names.md#BKMK_DomainMaintenance)  
  
-   [Sign the assembly with an Authenticode signature](../Topic/Add-Third-Level-Domain-Names.md#BKMK_SignAssembly)  
  
-   [Install the assembly on the reference computer](../Topic/Add-Third-Level-Domain-Names.md#BKMK_InstallAssembly)  
  
-   [Restart the Windows Server Domain Name Management service](../Topic/Add-Third-Level-Domain-Names.md#BKMK_RestartService)  
...
4.  Type the identifier for the provider as the name for the key. The identifier is the GUID that you defined for the provider in step 8 of [Add an implementation of the IDomainSignupProvider interface to the assembly](../Topic/Add-Third-Level-Domain-Names.md#BKMK_DomainSignup).  
