---
title: Demote and remove the Source Server from the new Windows Server 2012 Essentials network_3
ms.custom: na
...
---
# Demote and remove the Source Server from the new Windows Server 2012 Essentials network_3
...
1.  [Uninstall Exchange Server 2010](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_3.md#BKMK_UninstallExchangeServer2010)  
  
2.  [Remove Active Directory Certificate Services](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_3.md#BKMK_ADCS)  
  
3.  [Disconnect printers that are directly connected to the Source Server](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_3.md#BKMK_PhysicallyDisconnect)  
  
4.  [Demote the Source Server](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_3.md#BKMK_DemoteTheSourceServer)  
  
5.  [Remove and repurpose the Source Server](../Topic/Demote-and-remove-the-Source-Server-from-the-new-Windows-Server-2012-Essentials-network_3.md#BKMK_RemoveTheSourceServer)  
