---
title: Web Application Proxy: Application is using an external certificate that has expired
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 97fd0c0b-8765-4765-be8b-f74b334dd610
author: kgremban
...
> *Application <application\_name> that is published by [!INCLUDE[adfs_webproxy](../Token/adfs_webproxy_md.md)] is using a certificate that has expired.*  
