...
In Windows Server 2003, the default setting for Domain Policy and Domain Controller Policy was not defined. In [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], it is **Disabled**. There is no difference in the effective setting between these two, however.  
