...
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**secpol.msc** in the **Search programs and files** box, and then press ENTER.  
...
-   The packaged apps and packaged apps installer rule collection is available only on [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
