...
-   [Prepare to connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_A)  
  
-   [Connect computers to the server by using the Connector software](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_B)  
  
-   [Use the Launchpad](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_C)  
...
-   [Connector software overview](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Prerequisites for connecting a computer to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_2)  
  
-   [Prerequisites for connecting a Mac computer to the network](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_3)  
  
-   [Supported operating systems for client computers](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_4)  
  
-   [Changes the server makes to a client computer](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_5)  
  
-   [Network user name and password information](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_6)  
  
-   [Server administrator’s account](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_7)  
  
-   [Remove a computer from a Windows domain](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_8)  
  
### <a name="BKMK_1"></a>Connector software overview  
The Connector software for the Windows Server Essentials operating system connects the computers in your network to the Windows Server Essentials server. When you connect computers to the server, the Connector software enables you to automatically back up the computers and monitor their health. The Connector software also enables you to configure and remotely administer the Windows Server Essentials server. The Connector software is installed when you connect a client computer to the server. For detailed instructions about connecting client computers to the Windows Server Essentials server, see [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9) later in this topic.  
...
-   The client computer is running a supported operating system. For more information, see [Supported operating systems for client computers](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_4).  
...
> [!NOTE]  
> In an on\-premises client deployment for [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] or [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)], you can connect computers to the server without adding them to the Windows Server Essentials domain. This method is not available for all supported client operating systems, and features such as Group Policy and virtual private networks \(VPNs\), which require that a computer be connected to the domain, are not available. For requirements and instructions, see [Connect computers to a Windows Server Essentials server without joining the domain](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_10).  
  
For step\-by\-step instructions to connect a computer to the server running Windows Server Essentials, see [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9).  
...
[!INCLUDE[wseblue_section](../Token/wseblue_section_md.md)] The following computer operating systems are supported:  
  
**Windows 7 operating systems**  
  
-   [!INCLUDE[nextref_client_7hb](../Token/nextref_client_7hb_md.md)] SP1 \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7hp](../Token/nextref_client_7hp_md.md)] SP1 \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7pro](../Token/nextref_client_7pro_md.md)] SP1 \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7ult](../Token/nextref_client_7ult_md.md)] SP1 \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7ent](../Token/nextref_client_7ent_md.md)] SP1 \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7str](../Token/nextref_client_7str_md.md)] SP1 \(x86\)  
...
> [!NOTE]  
> You can view the health and backup status for a Mac computer from the [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] Dashboard. However, you cannot configure computer backup or start a backup from the Dashboard. In addition, you cannot use Remote Web Access to connect a Mac computer.  
  
#### Windows Server 2012 Essentials  
[!INCLUDE[wse_section](../Token/wse_section_md.md)] The following computer operating systems are supported:  
  
**Windows 7 operating systems**  
  
-   [!INCLUDE[nextref_client_7hb](../Token/nextref_client_7hb_md.md)] \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7hp](../Token/nextref_client_7hp_md.md)] \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7pro](../Token/nextref_client_7pro_md.md)] \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7ult](../Token/nextref_client_7ult_md.md)] \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7ent](../Token/nextref_client_7ent_md.md)] \(x86 and x64\)  
  
-   [!INCLUDE[nextref_client_7str](../Token/nextref_client_7str_md.md)] \(x86\)  
...
-   Deploys VPN on the client computer and provides a single click experience if the VPN functionality is enabled on [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)], or provides an auto\-connect experience if the VPN functionality is enabled on [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)]  
  
For information about connecting your computer to the server, see [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9).  
  
### <a name="BKMK_6"></a>Network user name and password information  
You can obtain your network user name and password information from the person who manages your server. You can use these credentials to connect your computer to the server and access information from the server. For more information about connecting your computer to the server, see [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9).  
  
If you are the server administrator, you can create the network credentials by adding a user account from the **Users** tab of the Dashboard. For more information about user accounts, see [Manage user accounts using the Dashboard](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md#BKMK_Manage8).  
...
-   [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9)  
  
-   [Connect computers to a Windows Server Essentials server without joining the domain](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_10)  
  
-   [Install the Connector software](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_11)  
  
-   [Move computer data and settings manually](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_12)  
  
-   [Transfer multiple user profiles during computer deployment](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_Transfer)  
  
-   [Uninstall the Connector software](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_13)  
  
-   [Disconnect your computer from or reconnect your computer to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_14)  
  
-   [How backup works with sleep and hibernate modes](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_Sleep)  
  
### <a name="BKMK_9"></a>Connect computers to the server  
When you connect a computer to a server that is running [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] or [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] with the Windows Server Essentials Experience role installed, ensure that your client computer has a valid connection to the Internet.  
...
9. After the computer is successfully connected to the server, shortcuts to the Connector TrayApp and the server Dashboard appear on the Start menu, which can be used as follows \(if your computer is running [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)], the Dashboard and Connector TrayApp will be available from the computer’s Start screen\):  
  
    -   If your computer is running [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)], the Dashboard and Connector TrayApp will be searchable as an App.  
...
This topic describes how to add a [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] computer to a Windows Server Essentials network without joining the computer to the Windows Server Essentials domain in an on\-premises client deployment. This connection method is supported in [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] and [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)].  
...
-   One of the following operating systems must be installed on the computer:  
    ...
    -   [!INCLUDE[winblue_client_pro_2](../Token/winblue_client_pro_2_md.md)], [!INCLUDE[winblue_client_ent_2](../Token/winblue_client_ent_2_md.md)], [!INCLUDE[win8_client_pro_2](../Token/win8_client_pro_2_md.md)], [!INCLUDE[win8_client_ent_2](../Token/win8_client_ent_2_md.md)]  
  
    -   [!INCLUDE[nextref_client_7pro](../Token/nextref_client_7pro_md.md)] \(x86 and x64\), [!INCLUDE[nextref_client_7ent](../Token/nextref_client_7ent_md.md)] \(x86 and x64\), [!INCLUDE[nextref_client_7ult](../Token/nextref_client_7ult_md.md)] \(x86 and x64\)  
  
-   The computer must meet all other requirements for client computers in Windows Server Essentials. For more information, see [Prerequisites for connecting a computer to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_2).  
...
2.  Open a command prompt with Administrator rights.  
    ...
    -   In [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], on the **Start** page, type **command** and then press Enter. In the results, right\-click **Command Prompt**, and then click **Run as administrator**.  
  
    -   In [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], on the **Start** menu, enter **command** in the search box, right\-click **Command Prompt**, and then click **Run as Administrator**.  
...
4.  Complete the steps in [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9).  
...
3.  If Internet Explorer Enhanced Security Configuration is enabled on the server that you are trying to connect to the Windows Server Essentials network, complete the following; otherwise, skip this step.  
    ...
    4.  To connect the second server to a server running Windows Server Essentials, follow the instructions in [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9).  
...
1.  From a computer that is running Windows 7, Windows 8, or Windows 8.1, open **Control Panel**, and then in the **Programs** section, click **View installed updates**.  
...
> [!NOTE]  
> -   Uninstalling the Connector software does not remove the computer from the list of computers that are displayed on the **DEVICES** tab of the Dashboard. To remove the computer from the Dashboard, see [Remove a computer from the server](../Topic/Manage-Devices-in-Windows-Server-Essentials.md#BKMK_3).  
...
> -   Uninstalling the Connector software does not make the computer unjoin the original domain. You must manually unjoin the computer from the domain. For instructions, see [Remove a computer from a Windows domain](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_8).  
...
1.  Uninstall the Connector software from the computer by using the Control Panel. For step\-by\-step instructions, see [Uninstall the Connector software](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_13).  
...
3.  Remove the computer from the server by using the Dashboard. For step\-by\-step instructions, see [Remove a computer from the server](../Topic/Manage-Devices-in-Windows-Server-Essentials.md#BKMK_3).  
...
3.  Connect the computer to the server by using the Connect Computer Wizard. For step\-by\-step instructions, see [Connect computers to the server](../Topic/Get-Connected-in-Windows-Server-Essentials.md#BKMK_9).  
  
### <a name="BKMK_Sleep"></a>How backup works with sleep and hibernate modes  
If you select the **Wake This Computer for Backup** option when you connect a computer to the server, the computer will automatically wake up from sleep or hibernate mode every day as specified in the Backup schedule so that it can be backed up. After the backup is finished, the computer will return to sleep or hibernate mode, based on its power management settings. If you do not select this option, the server will not back up a computer if the computer is sleeping or hibernating. For more information, see [Manage Client Computer Backup in Windows Server Essentials](../Topic/Manage-Client-Computer-Backup-in-Windows-Server-Essentials.md).  
...
-   [Use the Launchpad with a Mac computer](../Topic/Overview-of-the-Launchpad-in-Windows-Server-Essentials.md#BKMK_Mac)  
  
## See also  
  
-   [Troubleshoot connecting computers to the server in Windows Server Essentials](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md)  
  
-   [Manage User Accounts in Windows Server Essentials](../Topic/Manage-User-Accounts-in-Windows-Server-Essentials.md)  
...
-   [Play Digital Media in Windows Server 2012 Essentials](../Topic/Play-Digital-Media-in-Windows-Server-2012-Essentials.md)  
