...
Starting with [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)] and [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)], you can choose between standard and production checkpoints for each virtual machine.  
...
Production checkpoints are the default for new virtual machines, starting in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] and [!INCLUDE[winthreshold_client_2](../Token/winthreshold_client_2_md.md)].  
...
-   [Production checkpoints](../Topic/What-s-new-in-Hyper-V-on-Windows-Server-2016-Technical-Preview.md#BKMK_check)  
