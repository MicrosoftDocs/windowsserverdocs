...
> [!NOTE]  
> Beginning with [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)] or [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], the Smart Card Removal Policy service must be started for this setting to work.  
...
In [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], the option **Disconnect if a remote Terminal Services session** was added, and in [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], it was changed to **Disconnect if a remote Remote Desktop Services session** to accommodate the renaming of that feature.  
