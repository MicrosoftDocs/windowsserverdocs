...
-   The **tsprof** command is only available when you have installed the Terminal Server role service on a computer running [!INCLUDE[firstref_longhorn](../Token/firstref_longhorn_md.md)] or RD Session Host role service on a computer running Windows Server 2008 R2.  
