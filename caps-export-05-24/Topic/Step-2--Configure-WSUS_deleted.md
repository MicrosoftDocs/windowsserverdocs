---
title: Step 2: Configure WSUS_deleted
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 6a02eedd-fd60-40a4-93bc-8e86f671e27b
author: britw
---
# Step 2: Configure WSUS_deleted
...
|Task|Description|  
|--------|---------------|  
|[3.1. Configure network connections](../Topic/Step-3--Configure-WSUS.md#BKM_ConfigureNetworkConnections)|Configure the cluster network by using the Network Configuration Wizard.|  
|[3.2. Configure WSUS by using the WSUS Configuration Wizard](../Topic/Step-3--Configure-WSUS.md#BKM_ConfigureWSUSusingConfigurationWizard)|Use the WSUS Configuration wizard to perform the base WSUS configuration.|  
|[3.3. Configure WSUS computer groups](../Topic/Step-3--Configure-WSUS.md#BKMK_ConfigComputerGroups)|Create computer groups in the WSUS administration console to manage updates in your organization.|  
|[3.4. Configure client updates](../Topic/Step-3--Configure-WSUS.md#BKM_ConfigureClientUpdates)|Specify how and when automatic updates are applied to client computers.|  
|[3.5. Secure WSUS with the Secure Sockets Layer Protocol](../Topic/Step-3--Configure-WSUS.md#bkmk_3.5.ConfigSSL)|Configure Secure Sockets Layer \(SSL\) protocol to help protect Windows Server Update Services \(WSUS\).|  
...
-   On WSUS 6.2 and later \(at least [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)]\), port 8530 for HTTP and 8531 for HTTPS are used  
...
4.  In the Command Prompt window, go to the C:\\Program Files\\Update Services\\Tools folder. Type the following command:  
    ...
    **wsusutil ConfigureSSLProxy \[< proxy\_server proxy\_port>\] –enable**, where:  
  
    1.  proxy\_server is the name of the proxy server that supports HTTPS.  
  
    2.  proxy\_port is the proxy server port number.  
...
-   [Step 5: Configure Group Policy Settings for Automatic Updates](../Topic/Step-5--Configure-Group-Policy-Settings-for-Automatic-Updates.md)  
  
-   [3.3. Configure computer groups](../Topic/Step-3--Configure-WSUS.md#BKMK_ConfigComputerGroups) in this topic  
...
-   [Step 4: Approve and Deploy Updates in WSUS](../Topic/Step-4--Approve-and-Deploy-Updates-in-WSUS.md)  
