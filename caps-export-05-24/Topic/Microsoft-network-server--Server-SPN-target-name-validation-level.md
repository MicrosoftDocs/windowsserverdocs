...
Windows Server 2008 and Windows Vista support SMB protocol \(SMB 2.0 or SMB2\). [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] supports SMB 2.0, SMB2 and SMB 2.1.  
