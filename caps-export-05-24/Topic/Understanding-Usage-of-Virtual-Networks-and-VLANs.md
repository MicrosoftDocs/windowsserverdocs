...
Software Defined Networking (SDN) in [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] is based on programming policy for overlay virtual networks within a Hyper-V Virtual Switch. You can create overlay virtual networks, also called Virtual Networks, with Hyper-V Network Virtualization.   
