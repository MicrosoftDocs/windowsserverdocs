...
-   *[Microsoft Accounts](../Topic/Microsoft-Accounts.md)*  
...
-   [How to manage local accounts](#SEC_Manage_Accounts)  
    ...
    -   [Enforce local account restrictions for remote access](#SEC_Enforce_Account_Restrictions)  
...
For information about security principals, see [Security Principals Technical Overview](../Topic/Security-Principals-Technical-Overview.md).  
...
When a computer is shutting down or starting up, it is possible that a guest user or anyone with local access could gain unauthorized access to the computer. To help prevent this risk, do not grant the Guest account the [Shut down the system](../Topic/Shut-down-the-system.md) user right.  
...
### <a name="SEC_Restrict_Protect_Accounts"></a>Restrict and protect local accounts with administrative rights  
...
The User Account Control \(UAC\) is a security feature in Windows that has been in use in [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] and in [!INCLUDE[nextref_vista](../Token/nextref_vista_md.md)], and the operating systems to which the **Applies To** list refers. UAC enables you to stay in control of your computer by informing you when a program makes a change that requires administrator\-level permission. UAC works by adjusting the permission level of your user account. By default, UAC is set to notify you when applications try to make changes to your computer, but you can change how often UAC notifies you.  
...
|1|Policy name|[User Account Control: Run all administrators in Admin Approval Mode](../Topic/User-Account-Control--Run-all-administrators-in-Admin-Approval-Mode.md)|  
||Policy setting|Enabled|  
|2|Policy location|Computer Configuration\\Windows Settings\\Security Settings\\Local Policies\\Security Options|  
||Policy name|[User Account Control: Run all administrators in Admin Approval Mode](../Topic/User-Account-Control--Run-all-administrators-in-Admin-Approval-Mode.md)|  
||Policy setting|Enabled|  
...
3.  In the console tree, right\-click **Group Policy Objects**, and > **New**.  
    ...
    ![](../Image/LocalAccounts_Proc1_Sample1.png)  
...
4.  In the **New GPO** dialog box, type <***gpo\_name***>, and > **OK** where *gpo\_name* is the name of the new GPO. The GPO name indicates that the GPO is used to restrict local administrator rights from being carried over to another computer.  
    ...
    ![](../Image/LocalAccounts_Proc1_Sample2.png)  
  
5.  In the details pane, right\-click <***gpo\_name***>, and > **Edit**.  
  
    ![](../Image/LocalAccounts_Proc1_Sample3.png)  
...
7.  Ensure that the local account restrictions are applied to network interfaces by doing the following:  
    ...
    2.  Right\-click **Registry**, and > **New** > **Registry Item**.  
        ...
        ![](../Image/LocalAccounts_Proc1_Sample4.png)  
    ...
    9. Verify this configuration, and > **OK**.  
        ...
        ![](../Image/LocalAccounts_Proc1_Sample5.png)  
...
8.  Link the GPO to the first **Workstations** organizational unit \(OU\) by doing the following:  
    ...
    2.  Right\-click the **Workstations** OU, and > **Link an existing GPO**.  
        ...
        ![](../Image/LocalAccounts_Proc1_Sample6.png)  
...
|1|Policy name|[Deny access to this computer from the network](../Topic/Deny-access-to-this-computer-from-the-network.md)|  
...
||Policy name|[Deny log on through Remote Desktop Services](../Topic/Deny-log-on-through-Remote-Desktop-Services.md)<br /><br />\([!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and later.\)<br /><br />Deny logon through Terminal Services<br /><br />\([!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)]\)|  
||Policy setting|User name of the default Administrator account<br /><br />\(Might be renamed through policy\).|  
...
4.  In the **New GPO** dialog box, type <***gpo\_name***>, and then > **OK** where *gpo\_name* is the name of the new GPO indicates that it is being used to restrict the local administrative accounts from interactively signing in to the computer.  
    ...
    ![](../Image/LocalAccounts_Proc2_Sample1.png)  
  
5.  In the details pane, right\-click <***gpo\_name***>, and > **Edit**.  
  
    ![](../Image/LocalAccounts_Proc2_Sample2.png)  
...
6.  Configure the user rights to deny network logons for administrative local accounts as follows:  
    ...
    3.  Click **Add User or Group**, type the name of the default Administrator account, and > **OK**. The default name is Administrator on US English installations, but it can be renamed either by policy or manually.  
        ...
        ![](../Image/LocalAccounts_Proc2_Sample3.png)  
...
7.  Configure the user rights to deny Remote Desktop \(Remote Interactive\) logons for administrative local accounts as follows:  
    ...
    2.  On computers that run [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], double\-click **Deny logon through Terminal Services**, and then select **Define these policy settings**.  
  
    3.  On computers running [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)], [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)], and [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], double\-click **Deny logon through Remote Desktop Services**, and then select **Define these settings**.  
...
-   [Access Control Overview](../Topic/Access-Control-Overview.md)  
