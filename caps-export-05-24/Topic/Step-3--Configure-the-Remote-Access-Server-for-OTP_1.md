---
title: Step 3: Configure the Remote Access Server for OTP_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 26462967-f450-476b-ae90-b1b2e7248699
---
# Step 3: Configure the Remote Access Server for OTP_1
...
|Task|Description|  
|--------|---------------|  
|[3.1 Exempt users from OTP authentication (optional)](../Topic/Step-3--Configure-the-Remote-Access-Server-for-OTP_1.md#BKMK_Exempt)|If specific users will be exempted from DirectAccess with OTP authentication, then follow these preliminary steps.|  
|[3.2 Configure the Remote Access server to support OTP](../Topic/Step-3--Configure-the-Remote-Access-Server-for-OTP_1.md#BKMK_Config)|On the Remote Access server update the Remote Access configuration to support OTP two\-factor authentication.|  
|[3.3 Smart cards for additional authorization](../Topic/Step-3--Configure-the-Remote-Access-Server-for-OTP_1.md#BKMK_Smartcard)|Additional information regarding the use of smart cards.|  
...
18. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**powershell.exe**, right\-click **powershell**, click **Advanced**, and click **Run as administrator**. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
  
19. In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **gpupdate \/force** and press ENTER.  
