---
title: STEP 12: Test DirectAccess Connectivity_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: aa293b5d-4b6f-4004-95f3-0ab54804b15c
---
# STEP 12: Test DirectAccess Connectivity_1
...
-   [Verify clients have the correct group policy](../Topic/STEP-12--Test-DirectAccess-Connectivity_1.md#policy)  
  
-   [Test DirectAccess connectivity from the Internet through EDGE1](../Topic/STEP-12--Test-DirectAccess-Connectivity_1.md#EDGE1)  
  
-   [Move CLIENT2 to the Win7_Clients_Site2 security group](../Topic/STEP-12--Test-DirectAccess-Connectivity_1.md#secgroup)  
  
-   [Test DirectAccess connectivity from the Internet through 2-EDGE1](../Topic/STEP-12--Test-DirectAccess-Connectivity_1.md#DAConnect)  
...
1.  On CLIENT1, click **Start**, type **powershell.exe**, right\-click **powershell**, click **Advanced**, and then click **Run as administrator**. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
  
2.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig** and press ENTER.  
  
    Make sure that the Corpnet adapter IPv4 address starts with 10.0.0.  
  
3.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window type **Get\-DnsClientNrptPolicy** and press ENTER. The Name Resolution Policy Table \(NRPT\) entries for DirectAccess are displayed.  
...
4.  Leave the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window open for the next procedure.  
  
5.  On CLIENT2, click **Start**, click **All Programs**, click **Accessories**, click **Windows PowerShell**, right\-click **Windows PowerShell**, and then click **Run as administrator**. [!INCLUDE[uac_confirm_action](../Token/uac_confirm_action_md.md)]  
  
6.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig** and press ENTER.  
  
    Make sure that the Corpnet adapter IPv4 address starts with 10.0.0.  
  
7.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **netsh namespace show policy** and press ENTER.  
...
8.  Leave the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window open for the next procedure.  
...
3.  On CLIENT1, in the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/all** and press ENTER.  
...
5.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER. This flushes name resolution entries that may still exist in the client DNS cache from when the client computer was connected to the corpnet.  
...
7.  Ensure you are connected through EDGE1. Type **netsh interface httpstunnel show interfaces** and press ENTER.  
    ...
    > [!TIP]  
    > On CLIENT1, you can also run the following [!INCLUDE[wps_2](../Token/wps_2_md.md)] command: **Get\-NetIPHTTPSConfiguration**. The output shows the available server URL connections and the currently active profile.  
  
8.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app1** and press ENTER. You should see replies from the IPv6 address assigned to APP1, which in this case is 2001:db8:1::3.  
  
9. In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping 2\-app1** and press ENTER. You should see replies from the IPv6 address assigned to 2\-APP1, which in this case is 2001:db8:2::3.  
  
10. In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app2** and press ENTER. You should see replies from the NAT64 address assigned by EDGE1 to APP2, which in this case is fd**c9:9f4e:eb1b**:7777::a00:4. Note that the bold values will vary due to how the address is generated.  
...
14. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\2\-App1\\Files**, and then press ENTER. Double\-click the example text file.  
...
15. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App2\\Files**, and then press ENTER. Double\-click the New Text Document file.  
...
16. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**wf.msc**, and then press ENTER.  
...
8.  On CLIENT2, open an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **netsh namespace show policy** and press ENTER.  
...
3.  On CLIENT1, open an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window.  
  
4.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER. This flushes name resolution entries that may still exist in the client DNS cache from when the client computer was connected to the corpnet.  
...
6.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app1** and press ENTER. You should see replies from the IPv6 address assigned to APP1, which in this case is 2001:db8:1::3.  
  
7.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping 2\-app1** and press ENTER. You should see replies from the IPv6 address assigned to 2\-APP1, which in this case is 2001:db8:2::3.  
  
8.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app2** and press ENTER. You should see replies from the NAT64 address assigned by EDGE1 to APP2, which in this case is fd**c9:9f4e:eb1b**:7777::a00:4. Note that the bold values will vary due to how the address is generated.  
...
12. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App1\\Files**, and then press ENTER. Double\-click the example text file.  
...
13. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App2\\Files**, and then press ENTER. Double\-click the New Text Document file.  
