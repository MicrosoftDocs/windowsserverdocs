...
|Basic drivers for a variety of network adapters and storage controllers. This is the same set of drivers included in a Server Core installation of [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].|\-OEMDrivers|  
...
In [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], the Recovery Console allows you to view and configure network adapters and TCP\/IP settings, as well as firewall rules.  
...
For steps to use the Internet Information Services \(IIS\) role, see [IIS on Nano Server](../Topic/IIS-on-Nano-Server.md).  
...
> -   This Unattend.xml file will not work with versions of Windows prior to [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)] or [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
