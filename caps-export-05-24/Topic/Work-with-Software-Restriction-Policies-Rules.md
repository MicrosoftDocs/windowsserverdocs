...
For information about other tasks to manage Software Restriction Policies, see [Administer Software Restriction Policies](../Topic/Administer-Software-Restriction-Policies.md).  
  
To learn how to work with rules using AppLocker, see [Administer AppLocker](../Topic/Administer-AppLocker.md).  
...
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)]**gpedit.msc** and then press ENTER.  
...
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)], **gpedit.msc** in the **Search programs and files** or in [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], on the Desktop, and then press ENTER.  
...
3.  Click **Browse** to find a file.  
    ...
    > [!NOTE]  
    > In Windows XP it is possible to paste a pre\-calculated hash in **File hash**. In [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] and later versions, this option is not available.  
...
1.  [!INCLUDE[clickstart](../Token/clickstart_md.md)] regedit.  
