...
This topic describes the steps to import an AppLocker policy into a Group Policy Object \(GPO\) in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
...
> [!IMPORTANT]  
> Follow your organization's standard procedures for updating GPOs. For information about specific steps to follow for AppLocker policies, see [Maintain AppLocker Policies](../Topic/Maintain-AppLocker-Policies.md).  
