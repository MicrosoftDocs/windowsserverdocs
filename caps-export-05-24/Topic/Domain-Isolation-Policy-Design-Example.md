...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 3e680a57-5044-4db6-aeba-147240ed6c4b
author: vhorne
---
# Domain Isolation Policy Design Example
This design example continues to use the fictitious company Woodgrove Bank, and builds on the example described in the [Firewall Policy Design Example](../Topic/Firewall-Policy-Design-Example.md) section. See that example for an explanation of the basic corporate network infrastructure at Woodgrove Bank with diagrams.  
...
![](../Image/WFAS-Design2Example1.gif)  
...
-   All of the design requirements described in the [Firewall Policy Design Example](../Topic/Firewall-Policy-Design-Example.md) section are still enforced.  
...
**Next:**[Server Isolation Policy Design Example](../Topic/Server-Isolation-Policy-Design-Example.md)  
