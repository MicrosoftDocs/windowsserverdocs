...
![](../Image/GTR_ADDS_PS_Install2003DFL.gif)  
  
![](../Image/GTR_ADDS_PS_InstallDFL2.gif)  
...
6.  Ensure the **Extended** check box is selected on the Search Options dialog box and select **OK**.  
    ...
    ![](../Image/GTR_ADDS_SearchOptions.gif)  
...
2.  Using LDP, enable search statistics \(see [To enable the Stats control in LDP](../Topic/Directory-Services-component-updates.md#BKMK_EnableStats)\)  
...
![](../Image/GTR_ADDS_Event1644_2012.gif)  
  
NEW  
  
![](../Image/GTR_ADDS_Event1644_2012R2.gif)  
