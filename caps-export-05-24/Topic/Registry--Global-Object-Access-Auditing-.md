...
This policy setting must be used in combination with the **Registry** security policy setting under Object Access. For more information, see [Audit Registry](../Topic/Audit-Registry.md).  
