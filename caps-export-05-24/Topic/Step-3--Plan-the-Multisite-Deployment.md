...
1.  For each GPO used for [!INCLUDE[winthreshold_client_1](../Token/winthreshold_client_1_md.md)] or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] client computers, run the Set\-DAEntryPointTableItem PowerShell cmdlet  
