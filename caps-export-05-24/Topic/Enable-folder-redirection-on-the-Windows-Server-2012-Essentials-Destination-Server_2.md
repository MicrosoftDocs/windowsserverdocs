---
title: Enable folder redirection on the Windows Server 2012 Essentials Destination Server_2
ms.custom: na
...
---
# Enable folder redirection on the Windows Server 2012 Essentials Destination Server_2
You can perform this task if folder redirection is enabled on the Source Server.  
  
First, delete the old Folder Redirection Group Policy setting, and then use the [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] Dashboard to enable folder redirection on the Destination Server.  
