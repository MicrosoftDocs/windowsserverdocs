...
This guide describes sets of tasks for several possible starting points of a [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] AD DS deployment. The guide helps you determine the most appropriate deployment strategy for your environment.  
...
> [!NOTE]  
> The information in this guide also applies to [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] AD DS.  
  
## In this guide  
[Understanding AD DS Design](../Topic/Understanding-AD-DS-Design.md)  
  
[Identifying Your AD DS Design and Deployment Requirements](../Topic/Identifying-Your-AD-DS-Design-and-Deployment-Requirements.md)  
  
[Mapping Your Requirements to an AD DS Deployment Strategy](../Topic/Mapping-Your-Requirements-to-an-AD-DS-Deployment-Strategy.md)  
  
[Designing the Logical Structure for Windows Server 2008 AD DS](../Topic/Designing-the-Logical-Structure-for-Windows-Server-2008-AD-DS.md)  
  
[Designing the Site Topology for Windows Server 2008 AD DS](../Topic/Designing-the-Site-Topology-for-Windows-Server-2008-AD-DS.md)  
  
[Enabling Advanced Features for AD DS](../Topic/Enabling-Advanced-Features-for-AD-DS.md)  
  
[Evaluating AD DS Deployment Strategy Examples](../Topic/Evaluating-AD-DS-Deployment-Strategy-Examples.md)  
  
[Appendix A: Reviewing Key AD DS Terms](../Topic/Appendix-A--Reviewing-Key-AD-DS-Terms.md)  
