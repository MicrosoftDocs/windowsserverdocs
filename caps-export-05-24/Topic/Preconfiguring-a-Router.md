...
|UPnP support|You should enable UPnP™ support to provide the easiest router configuration for the customer and the best customer experience during installation. **Warning:** The UPnP architecture can pose a security risk if it is left enabled.|  
...
> [!NOTE]  
> For more information about configuring wireless connections, see [Configure Support for a Wireless Network](../Topic/Configure-Support-for-a-Wireless-Network.md).  
