...
2.  In the console tree, right\-click the site that you want to set Group Policy for.  
    ...
    **Where?**  
    ...
    -   Active Directory Sites and Services \[*Domain\_Controller\_Name.Domain\_Name*\]\/Sites\/Site  
