...
This topic contains troubleshooting guidance for issues that you might encounter when you connect a computer to the server that is running [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] or [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)].  
  
> [!NOTE]  
> For the most current troubleshooting information from the [!INCLUDE[sbs_sbs8web_2](../Token/sbs_sbs8web_2_md.md)] and [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] community, we suggest that you visit the [Windows Server Essentials Forum](https://social.technet.microsoft.com/Forums/windowsserver/home?forum=winserveressentials). The Windows Server Essentials Forum is a great place to search for help, or to ask a question.  
  
This topic provides solutions for the following issues:  
  
-   Issue 1: [I get a “Package installation did not succeed. Try to install the Windows Server Essentials Connector again. If the issue persists, contact your network administrator” error when connecting a computer to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BMRK_Package)  
  
-   Issue 2: [Cannot join a computer to Windows Server 2012 Essentials](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ConnectorIssue2)  
  
-   Issue 3: [I get a “The installation is canceled” error when connecting a computer to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ConnectorIssue2a)  
  
-   Issue 4: [I get a “To run this application, you must install one of the following versions of the .NET Framework: V4.5.50709" error when connecting a computer to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ConnectorIssueNetFramework)  
  
-   Issue 5: [I get a “The server is not available. To resolve this issue, contact the person responsible for your network.” error when connecting a computer to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_Time)  
  
-   Issue 6: [I get an “An unexpected error has occurred. To resolve this issue, contact the person responsible for your network.” error when connecting a computer to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ServiceStopped)  
  
-   Issue 7: [When I try to connect a computer to the server again after an unsuccessful connection attempt, I receive the warning “A computer with this name is already connected to the server"](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ConnectorIssueReconnect)  
  
-   Issue 8: [Cannot connect a client computer that is running Windows 7 Home to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_JoinWin7)  
  
-   Issue 9: [Auto logon stopped working after I connected the computer to the server](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ConnectorIssueAutologon)  
  
-   Issue 10: [Uninstalling a prerelease version of the connector software does not remove the existing logs](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_ConnectorIssueOldLogs)  
  
-   Issue 11: [I want to upgrade the operating system on a client computer](../Topic/Troubleshoot-connecting-computers-to-the-server-in-Windows-Server-Essentials.md#BKMK_UpgradeClientOS)  
...
This issue may occur if you connect a computer to a server that is running [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] while other Windows updates or application installations are pending and the Connector installation is canceled.  
...
Cannot join a computer to [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)]  
  
**Description**  
  
Computers that have non\-ASCII characters in the computer name cannot be joined to [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)]. If the computer name includes non\-ASCII characters, you receive the error message "An unexpected error has occurred."  
...
To be able to connect a computer to the server, the SYSTEM account must have Full Control permissions on server folders displayed on the [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] Dashboard. If the required permissions have not been granted, you receive the "The Connector software installation is canceled" error message.  
...
1.  Open the [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] Dashboard.  
...
When you connect a computer to a server that is running Windows Server 2012 Essentials or [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)], the wizard attempts to install .NET Framework version 4.5.50709 on the computer. However, if an earlier release of .NET Framework version 4.5 is present, the updated release cannot be installed, and the connection attempt fails with this error message: “To run this application, you must install one of the following versions of the .NET Framework: V4.5.50709. Contact your allocation publisher for instructions about obtaining the appropriate version of the .NET Framework.”  
...
This can happen if the date and time on the connected computer are not synchronized with the date and time on the server. [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] and [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] use the time synchronization service to synchronize the date and time of computers running in a [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] or [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] network. Synchronized time is critical because the default authentication protocol uses server time as part of the authentication process. For example, if the clock on a client computer is not synchronized to the correct date and time, [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] or [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] authentication might falsely interpret a logon request as an intrusion attempt and deny access to the user.  
...
1.  Log on to the server using the password that you set up during [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)] or [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] installation and configuration.  
...
If auto logon is set for the user account when you connect the computer to [!INCLUDE[sbs_sbs8_2](../Token/sbs_sbs8_2_md.md)], the setting is overwritten when the connector software is installed on the computer.  
...
> [!NOTE]  
> The [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] domain account requires a password that meets the default password policy requirements.  
