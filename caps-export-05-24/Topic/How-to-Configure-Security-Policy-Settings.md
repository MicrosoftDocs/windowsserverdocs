...
1.  To open Local Security Policy, [!INCLUDE[clickstart_2](../Token/clickstart_2_md.md)],   **secpol.msc**.  
...
1.  To open the MMC and add the Group Policy Object Editor, [!INCLUDE[clickstart_2](../Token/clickstart_2_md.md)]**mmc.msc**.  
