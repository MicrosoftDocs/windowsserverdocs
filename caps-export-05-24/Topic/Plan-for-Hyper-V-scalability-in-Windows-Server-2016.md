...
|Virtual SCSI controllers|4|Use of virtual SCSI devices requires integration services, which are available for supported guest operating systems. For details on which operating systems are supported, see [Supported Linux and FreeBSD virtual machines](https://technet.microsoft.com/library/dn531030(ws.12).aspx) and [Supported Windows guest operating systems](https://technet.microsoft.com/library/mt126119.aspx).|  
