...
---
# Site Functions
[!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)] uses site information for many purposes, including routing replication, client affinity, system volume \(SYSVOL\) replication, Distributed File System Namespaces \(DFSN\), and service location.  
