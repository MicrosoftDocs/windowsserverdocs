...
This topic describes the steps to force an update for an AppLocker policy in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
...
To use Group Policy to distribute the AppLocker policy change, you need to retrieve the deployed AppLocker policy first. To prepare for the update and subsequent refresh, see [Edit an AppLocker Policy](../Topic/Edit-an-AppLocker-Policy.md) and [Use the AppLocker Windows PowerShell Cmdlets](../Topic/Use-the-AppLocker-Windows-PowerShell-Cmdlets.md).  
...
-   Merge AppLocker policies. For procedures to do this, see [Merge AppLocker Policies Manually](../Topic/Merge-AppLocker-Policies-Manually.md) and [Merge AppLocker Policies by Using Set-ApplockerPolicy](../Topic/Merge-AppLocker-Policies-by-Using-Set-ApplockerPolicy.md).  
