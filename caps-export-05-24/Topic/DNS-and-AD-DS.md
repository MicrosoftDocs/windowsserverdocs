...
> [!NOTE]  
> If you implement a disjoint namespace in which the AD DS domain name differs from the primary DNS suffix that clients use, AD DS integration with DNS is more complex. For more information, see [Disjoint Namespace](../Topic/Disjoint-Namespace.md).  
  
## In this section  
  
-   [Domain Controller Location](../Topic/Domain-Controller-Location.md)  
  
-   [Active Directory-Integrated DNS Zones](../Topic/Active-Directory-Integrated-DNS-Zones.md)  
  
-   [Computer Naming](../Topic/Computer-Naming.md)  
  
-   [Disjoint Namespace](../Topic/Disjoint-Namespace.md)  
