...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 7d36fe78-341d-47be-9988-18d65c6c602b
---
...
In a multisite deployment, [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] client computers are able to roam between different entry points. [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers must be associated with a specific entry point in the multisite deployment. If client computers are not in the correct security group, they may receive the wrong group policy settings.  
  
**Solution**  
  
DirectAccess requires at least one security group for all [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] client computers; we recommend using one security group for all [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] computers per domain. DirectAccess also requires a security group for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers for each entry point. Each client computer should be included in only one security group. Therefore, you should make sure that the security groups for [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] clients contain only computers running [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], and that each [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computer belongs to a single dedicated security group for the relevant entry point and that no [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] clients belong to the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] security groups.  
  
Configure the [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] security groups on the **Select Groups** page of the **DirectAccess Client Setup** wizard. Configure [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] security groups on the **Client Support** page of the **Enable Multisite Deployment** wizard, or on the **Client Support** page of the **Add an Entry Point** wizard.  
...
To enable computer certificate authentication using [!INCLUDE[wps_2](../Token/wps_2_md.md)], use the `Set-DAServer` cmdlet and specify the *IPsecRootCertificate* parameter.  
...
In the existing DirectAccess deployment, [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client support was enabled.  
  
**Solution**  
  
DirectAccess requires at least one security group for all [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] client computers and a security group for [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computers for each entry point. Each client computer should be included in only one security group. Therefore, you should make sure that the security group for [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] clients contains only computers running [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)], and that each [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] client computer belongs to a single dedicated security group for the relevant entry point and that no [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)] clients belong to the [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)] security groups.  
