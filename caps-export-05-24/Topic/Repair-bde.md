...
> [!NOTE]  
> The BitLocker Recovery Password Viewer is included as one of the optional management features installable using Server Manage on [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)].  
