---
title: Create the BranchCache Hash Publication Group Policy Object_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 2a521b24-5c1b-478c-906e-84e7b611c22b
---
# Create the BranchCache Hash Publication Group Policy Object_1
You can use this procedure to create the BranchCache hash publication Group Policy Object \(GPO\).  
  
Membership in **Domain Admins**, or equivalent is the minimum required to perform this procedure.  
  
> [!NOTE]  
> Before performing this procedure, you must create the BranchCache file servers organizational unit and move file servers into the OU. For more information, see [Enable Hash Publication for Domain Member File Servers_1](../Topic/Enable-Hash-Publication-for-Domain-Member-File-Servers_1.md).  
