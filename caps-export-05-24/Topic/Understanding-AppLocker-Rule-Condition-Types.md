...
2.  What rule condition type does your organization prefer?  
    ...
    > [!NOTE]  
    > For a list of supported operating system versions and editions to which SRP and AppLocker rules can be applied, see [Requirements to Use AppLocker](../Topic/Requirements-to-Use-AppLocker.md).  
