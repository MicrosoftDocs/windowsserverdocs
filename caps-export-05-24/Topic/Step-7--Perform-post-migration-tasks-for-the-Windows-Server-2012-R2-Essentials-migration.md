...
1.  [Delete DNS entries of the Source Server](../Topic/Step-7--Perform-post-migration-tasks-for-the-Windows-Server-2012-R2-Essentials-migration.md#BKMK_DeleteDNSEntries)  
  
2.  [Share line\-of\-business and other application data folders](../Topic/Step-7--Perform-post-migration-tasks-for-the-Windows-Server-2012-R2-Essentials-migration.md#BKMK_ShareLineOfBusinessAndOtherApplications)  
...
## Next steps  
You have performed the post\-migration tasks for [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] migration. Now go to [Step 8: Run the Windows Server 2012 R2 Essentials Best Practices Analyzer](../Topic/Step-8--Run-the-Windows-Server-2012-R2-Essentials-Best-Practices-Analyzer.md).  
