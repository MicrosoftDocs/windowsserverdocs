...
For information about monitoring potential central access policy changes for an entire file server, see [Monitor the Central Access Policies that Apply on a File Server](../Topic/Monitor-the-Central-Access-Policies-that-Apply-on-a-File-Server.md).  
