---
title: DirectAccess Offline Domain Join_1
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 83df2c09-c2e7-426c-8a28-563ca94d1c8d
---
# DirectAccess Offline Domain Join_1
...
You can run Djoin.exe for DIrectAccess only on computers that run [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)]. The computer on which you run Djoin.exe to provision computer account data into AD DS must be running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)]. The computer that you want to join to the domain must also be running [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] or [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
