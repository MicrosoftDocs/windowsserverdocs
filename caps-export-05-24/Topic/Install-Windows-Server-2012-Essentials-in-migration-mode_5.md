---
title: Install Windows Server 2012 Essentials in migration mode_5
ms.custom: na
...
---
# Install Windows Server 2012 Essentials in migration mode_5
...
> [!NOTE]  
> For information about how to migrate email to another on\-premises computer that is running Exchange Server, see [Integrate an On-Premises Exchange Server with Windows Server Essentials](../Topic/Integrate-an-On-Premises-Exchange-Server-with-Windows-Server-Essentials.md).  
