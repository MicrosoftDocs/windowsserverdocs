...
> [!IMPORTANT]  
> Handle Manipulation events are generated only for object types where the corresponding File System or Registry Object Access subcategory is enabled. For more information, see [Audit File System](../Topic/Audit-File-System.md) or [Audit Registry](../Topic/Audit-Registry.md).  
