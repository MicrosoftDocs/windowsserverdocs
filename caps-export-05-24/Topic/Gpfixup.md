...
---
# Gpfixup
Fix domain name dependencies in [!INCLUDE[gpos](../Token/gpos_md.md)] and Group Policy links after a domain rename operation. For examples of how this command can be used, see [Examples](#BKMK_Examples).  
...
-   The **gpfixup** command is available in [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], except on Server Core installations.  
  
-   Although the [!INCLUDE[gpmc_1](../Token/gpmc_1_md.md)] is distributed with [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_longhorn](../Token/nextref_longhorn_md.md)], you must install Group Policy Management as a feature through Server Manager.  
