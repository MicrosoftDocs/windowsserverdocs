...
For example, if you want to provide DHCP service to a limited number of client computers using a specific set of DHCP servers, you can configure the following rules on the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] computer that is running Hyper\-V, where the user VMs are hosted:  
