...
This policy was introduced in [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], and it can be applied to Windows Server operating systems that support the Negotiate Extensions SSP \(Negoexts.dll\).  
