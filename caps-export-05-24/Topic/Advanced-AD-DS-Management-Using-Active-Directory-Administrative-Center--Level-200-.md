...
This topic covers the updated Active Directory Administrative Center with its new Active Directory Recycle Bin, Fine\-grained Password policy, and Windows PowerShell History Viewer in more detail, including architecture, examples for common tasks, and troubleshooting information. For an introduction, see [Introduction to Active Directory Administrative Center Enhancements &#40;Level 100&#41;](../Topic/Introduction-to-Active-Directory-Administrative-Center-Enhancements--Level-100-.md).  
  
-   [Active Directory Administrative Center Architecture](../Topic/Advanced-AD-DS-Management-Using-Active-Directory-Administrative-Center--Level-200-.md#BKMK_Arch)  
  
-   [Enabling and Managing the Active Directory Recycle Bin Using Active Directory Administrative Center](../Topic/Advanced-AD-DS-Management-Using-Active-Directory-Administrative-Center--Level-200-.md#BKMK_EnableRecycleBin)  
  
-   [Configuring and Managing Fine\-Grained Password Policies Using Active Directory Administrative Center](../Topic/Advanced-AD-DS-Management-Using-Active-Directory-Administrative-Center--Level-200-.md#BKMK_FGPP)  
  
-   [Using the Active Directory Administrative Center Windows PowerShell History Viewer](../Topic/Advanced-AD-DS-Management-Using-Active-Directory-Administrative-Center--Level-200-.md#BKMK_HistoryViewer)  
  
-   [Troubleshooting AD DS Management](../Topic/Advanced-AD-DS-Management-Using-Active-Directory-Administrative-Center--Level-200-.md#BKMK_Tshoot)  
...
![](../Image/ADDS_ADAC_TR_EnableRecycleBin.png)  
...
![](../Image/ADDS_ADAC_TR_EnableRecycleBinExampleOU.png)  
...
![](../Image/ADDS_ADAC_TR_DeletedObjectsContainer.png)  
...
![](../Image/ADDS_ADAC_TR_MgmtList.png)  
...
![](../Image/ADDS_ADAC_TR_AddCriteria.png)  
...
![](../Image/ADDS_ADAC_TR_ColumnHeaders.png)  
...
![](../Image/ADDS_ADAC_TR_RestoreSingle.gif)  
...
![](../Image/ADDS_ADAC_TR_RestoreToSingle.gif)  
...
![](../Image/ADDS_ADAC_TR_RestorePeers.png)  
...
![](../Image/ADDS_ADAC_TR_LastKnownParentSalesRestored.gif)  
...
![](../Image/ADDS_ADAC_TR_LastKnownParentSalesUndelete.png)  
...
![](../Image/ADDS_ADAC_TR_PasswordSettings.png)  
...
![](../Image/ADDS_ADAC_TR_CreatePasswordSettings.png)  
...
![](../Image/ADDS_ADAC_TR_Precedence.png)  
...
![](../Image/ADDS_ADAC_TR_FGPPSettings.gif)  
...
![](../Image/ADDS_ADAC_TR_HistoryViewer.gif)  
  
Click the chevron \(arrow\) to show Windows PowerShell History Viewer.  
  
![](../Image/ADDS_ADAC_TR_RaiseViewer.png)  
...
![](../Image/ADDS_ADAC_TR_ViewArgs.png)  
...
## See Also  
[Introduction to Active Directory Administrative Center Enhancements &#40;Level 100&#41;](../Topic/Introduction-to-Active-Directory-Administrative-Center-Enhancements--Level-100-.md)  
