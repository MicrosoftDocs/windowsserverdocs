...
1.  On CLIENT1, open an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window.  
  
2.  Enable the Teredo adapter, type **netsh interface teredo set state enterpriseclient**, and then press ENTER.  
  
3.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/all** and press ENTER.  
...
5.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER.  
...
6.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app1** and press ENTER. You should see replies from the IPv6 address of APP1, 2001:db8:1::3.  
  
7.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app2** and press ENTER. You should see replies from the NAT64 address assigned by EDGE1 to APP2, which in this case is fd**c9:9f4e:eb1b**:7777::a00:4. Note that the bold values will vary due to how the address is generated.  
  
8.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping 2\-app1** and press ENTER. You should see replies from the IPv6 address of 2\-APP1, 2001:db8:2::3.  
...
11. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App2\\Files**, and then press ENTER. Double\-click the New Text Document file. This demonstrates that you were able to connect to an IPv4 only server using SMB to obtain a resource on an IPv4 only host.  
  
12. Repeat this procedure on CLIENT2.  
  
## <a name="IPHTTPS_CLIENT1"></a>Test IP\-HTTPS connectivity  
  
1.  On CLIENT1, open an elevated [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, and type **netsh interface teredo set state disabled** and press ENTER. This disables Teredo on the client computer and enables the client computer to configure itself to use IP\-HTTPS. An **Ok** response appears when the command completes.  
  
2.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/all** and press ENTER.  
...
4.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ipconfig \/flushdns** and press ENTER. This will flush name resolution entries that may still exist in the client DNS cache from when the client computer was connected to the corpnet.  
  
5.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app1** and press ENTER. You should see replies from the IPv6 address of APP1, 2001:db8:1::3.  
  
6.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping app2** and press ENTER. You should see replies from the NAT64 address assigned by EDGE1 to APP2, which in this case is fd**c9:9f4e:eb1b**:7777::a00:4. Note that the bold values will vary due to how the address is generated.  
  
7.  In the [!INCLUDE[wps_2](../Token/wps_2_md.md)] window, type **ping 2\-app1** and press ENTER. You should see replies from the IPv6 address of 2\-APP1, 2001:db8:2::3.  
...
10. [!INCLUDE[clickstart](../Token/clickstart_md.md)]**\\\\App2\\Files**, and then press ENTER. Double\-click the New Text Document file. This demonstrates that you were able to connect to an IPv4 only server using SMB to obtain a resource on an IPv4 only host.  
