...
-   [Which guest operating systems are supported?](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_OS)  
  
-   [How can I boot the virtual machine?](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Boot)  
  
-   [What are the advantages of using generation 2 virtual machines?](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Advantages) 
- [What's the difference in device support?](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_DeviceCompare)
- [More about generation 2 virtual machines](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_More)

 - [Enable kernel debugging by using a COM port on a generation 2 virtual machine](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Debug)
...
-   [Windows guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Windows)  
  
-   [CentOS and Red Hat Enterprise Linux guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_CentOS)  
  
-   [Debian guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Debian)  
  
-   [FreeBSD guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_FreeBSD)  
  
-   [Oracle Linux guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Oracle)  
  
-   [SUSE guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_SUSE)  
  
-   [Ubuntu guest operating system support](../Topic/Should-I-create-a-generation-1-or-2-virtual-machine-in-Hyper-V-.md#BKMK_Ubuntu)  
...
For more information, see [Generation 2 Virtual Machine Overview](../Topic/Generation-2-Virtual-Machine-Overview.md).  
...
For more information, see [CentOS and Red Hat Enterprise Linux virtual machines on Hyper\-V](../Topic/Supported-CentOS-and-Red-Hat-Enterprise-Linux-virtual-machines-on-Hyper-V.md).  
...
For more information, see [Debian virtual machines on Hyper\-V](../Topic/Supported-Debian-virtual-machines-on-Hyper-V.md).  
...
For more information, see [FreeBSD virtual machines on Hyper\-V](../Topic/Supported-FreeBSD-virtual-machines-on-Hyper-V.md).  
...
For more information, see [Oracle Linux virtual machines on Hyper\-V](../Topic/Supported-Oracle-Linux-virtual-machines-on-Hyper-V.md).  
...
For more information, see [SUSE virtual machines on Hyper\-V](../Topic/Supported-SUSE-virtual-machines-on-Hyper-V.md).  
...
For more information, see [Ubuntu virtual machines on Hyper\-V](../Topic/Supported-Ubuntu-virtual-machines-on-Hyper-V.md).  
...
[Linux and FreeBSD Virtual Machines on Hyper\-V](../Topic/Supported-Linux-and-FreeBSD-virtual-machines-for-Hyper-V-on-Windows.md) 
