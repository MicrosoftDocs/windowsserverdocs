...
This topic describes the steps to export an AppLocker policy from a Group Policy Object \(GPO\) so that it can be modified in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] and [!INCLUDE[win8_client_2](../Token/win8_client_2_md.md)].  
