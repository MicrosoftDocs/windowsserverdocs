...
You can use this procedure to install the **BranchCache for Network Files** role service of the File Services server role on a computer running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)].  
  
> [!IMPORTANT]  
> If the File Services server role is not already installed, do not follow this procedure. Instead, see [Install a New File Server as a Content Server](../Topic/Install-a-New-File-Server-as-a-Content-Server.md).  
