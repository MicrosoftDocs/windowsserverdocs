    ...
    <sections>
      ...
      <section address="BKMK_MaxPacket">
        ...
        <content>
          ...
          <para>Membership in <embeddedLabel>Domain Users</embeddedLabel>, or equivalent, and the <embeddedLabel>Log on locally</embeddedLabel> right on the domain controller are the minimum required to complete this procedure. <token>review_details</token></para>
          <procedure>
