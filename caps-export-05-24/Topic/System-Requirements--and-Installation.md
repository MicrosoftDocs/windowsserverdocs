...
This topic addresses the information you need to install [!INCLUDE[winthreshold_server_1](../Token/winthreshold_server_1_md.md)]. We use the following terms to distinguish among different actions, any of which could be involved in a new [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] deployment.  
...
-   **Upgrade** means moving from your existing operating system to [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)], while staying on the same hardware. For this release, upgrade to or from [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] is not supported  
  
-   **Migration** means moving from your existing operating system to [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] by transferring to a different set of hardware. For this release, migration is not supported.  
...
The following are estimated system requirements for the [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)]. If your computer has less than the "minimum" requirements, you will not be able to install this product correctly. Actual requirements will vary based on your system configuration and the applications and features you install.  
