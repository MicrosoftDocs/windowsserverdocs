...
- The Hyper\-V role in [!INCLUDE[winthreshold_server_2_md](/Token/winthreshold_server_2_md.md)] installed on the source and destination servers. For instructions, see [Install the Hyper\-V role and configure a virtual machine](assetId:///243b5705-96c9-4ec7-9ec5-c68a22b0d42d).  
...
- The Hyper\-V management tools installed on a computer running [!INCLUDE[winthreshold_server_2_md](/Token/winthreshold_server_2_md.md)] or [!INCLUDE[winthreshold_client_2_md](/Token/winthreshold_client_2_md.md)], unless the tools are installed on the source or destination server.  
