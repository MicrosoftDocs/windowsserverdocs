...
To enable remote\-updating mode for a [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] failover cluster, you must install the Failover Clustering Tools from the RSAT on a local or a remote computer that is running [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] or [!INCLUDE[winblue_client_2](../Token/winblue_client_2_md.md)] and that has network connectivity to the failover cluster.  
