...
![](../Image/AuthorizationandAccessControlProcess.gif)  
...
For information about which user rights are available and how they can be implemented, see [User Rights Assignment](../Topic/User-Rights-Assignment.md).  
