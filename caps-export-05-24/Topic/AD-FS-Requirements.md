...
-   [Certificate requirements](../Topic/AD-FS-Requirements.md#BKMK_1)  
  
-   [Hardware requirements](../Topic/AD-FS-Requirements.md#BKMK_2)  
  
-   [Software requirements](../Topic/AD-FS-Requirements.md#BKMK_3)  
  
-   [AD DS requirements](../Topic/AD-FS-Requirements.md#BKMK_4)  
  
-   [Configuration database requirements](../Topic/AD-FS-Requirements.md#BKMK_5)  
  
-   [Browser requirements](../Topic/AD-FS-Requirements.md#BKMK_6)  
  
-   [Extranet requirements](../Topic/AD-FS-Requirements.md#BKMK_extranet)  
  
-   [Network requirements](../Topic/AD-FS-Requirements.md#BKMK_7)  
  
-   [Attribute store requirements](../Topic/AD-FS-Requirements.md#BKMK_8)  
  
-   [Application requirements](../Topic/AD-FS-Requirements.md#BKMK_9)  
  
-   [Authentication requirements](../Topic/AD-FS-Requirements.md#BKMK_10)  
  
-   [Workplace join requirements](../Topic/AD-FS-Requirements.md#BKMK_11)  
  
-   [Cryptography requirements](../Topic/AD-FS-Requirements.md#BKMK_12)  
  
-   [Permissions requirements](../Topic/AD-FS-Requirements.md#BKMK_13)  
...
To provide extranet access to the AD FS service, you must deploy the Web Application Proxy role service as the extranet facing role that proxies authentication requests in a secure manner to the AD FS service. This provides isolation of the AD FS service endpoints as well as isolation of all security keys \(such as token signing certificates\) from requests that originate from the internet. In addition, features such as Soft Extranet Account Lockout require the use of the Web Application Proxy. For more information about Web Application Proxy, see [Web Application Proxy](../Topic/Web-Application-Proxy.md).  
...
AD FS requires at least one attribute store to be used for authenticating users and extracting security claims for those users. For a list of attribute stores that AD FS supports, see [The Role of Attribute Stores](../Topic/The-Role-of-Attribute-Stores.md).  
...
For more information on MFA, see [Manage Risk with Additional Multi-Factor Authentication for Sensitive Applications](../Topic/Manage-Risk-with-Additional-Multi-Factor-Authentication-for-Sensitive-Applications.md).  
