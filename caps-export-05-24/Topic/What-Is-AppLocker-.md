...
For information about the application control scenarios that AppLocker addresses, see [AppLocker Policy Use Scenarios](../Topic/AppLocker-Policy-Use-Scenarios.md).  
