---
title: Requirements and Best Practices for Cluster-Aware Updating
ms.custom: na
...
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: c4c50fef-cfa1-4844-8921-deeb7653d8ba
author: kumudd
---
...
For more information about enabling [!INCLUDE[wps_2](../Token/wps_2_md.md)] remoting, see [about\_Remote\_Requirements](http://go.microsoft.com/fwlink/p/?LinkId=135187).  
...
To install the .NET Framework 4.5 Features, use the Add Roles and Features Wizard in Server Manager. For more information, see [Install or Uninstall Roles, Role Services, or Features_1](../Topic/Install-or-Uninstall-Roles,-Role-Services,-or-Features_1.md).  
