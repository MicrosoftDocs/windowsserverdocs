...
## Registry settings  
The encryption zone uses the same registry settings as the isolated domain to optimize IPsec operation. For more information, see the description of the registry settings in [Isolated Domain](../Topic/Isolated-Domain.md).  
...
**Next:**[Server Isolation GPOs](../Topic/Server-Isolation-GPOs.md)  
