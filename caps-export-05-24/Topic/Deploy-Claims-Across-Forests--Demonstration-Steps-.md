...
1.  [Set up the prerequisites and the test environment](../Topic/Deploy-Claims-Across-Forests--Demonstration-Steps-.md#BKMK_1.1)  
  
2.  [Set up claims transformation on trusted forest (Adatum)](../Topic/Deploy-Claims-Across-Forests--Demonstration-Steps-.md#BKMK_3)  
  
3.  [Set up claims transformation in the trusting forest (Contoso)](../Topic/Deploy-Claims-Across-Forests--Demonstration-Steps-.md#BKMK_4)  
  
4.  [Validate the scenario](../Topic/Deploy-Claims-Across-Forests--Demonstration-Steps-.md#BKMK_5)  
...
You need to set up the following for the lab. These procedures are explained in detail in [Appendix B: Setting Up the Test Environment](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md)  
  
You need to implement the following procedures to set up the lab for this scenario:  
  
1.  [Set Adatum as trusted forest to Contoso](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md)  
  
2.  [Create the “Company” claim type on Contoso](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.8)  
  
3.  [Enable the “Company” resource property on Contoso](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.55)  
  
4.  [Create the central access rule](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.9)  
  
5.  [Create the central access policy](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.10)  
  
6.  [Publish the new policy through Group Policy](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.11)  
  
7.  [Create the Earnings folder on the file server](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.12)  
  
8.  [Set classification and apply the central access policy on the new folder](../Topic/Appendix-B--Setting-Up-the-Test-Environment.md#BKMK_2.13)  
...
-   For a list of all Windows PowerShell cmdlets that are available for claims transformation, see [Active Directory PowerShell Cmdlet Reference](http://go.microsoft.com/fwlink/?LinkId=243150).  
  
-   For advanced tasks that involve export and import of DAC configuration information between two forests, use the [Dynamic Access Control PowerShell Reference](http://go.microsoft.com/fwlink/?LinkId=243150)  
  
-   [Deploy Claims Across Forests](../Topic/Deploy-Claims-Across-Forests.md)  
  
-   [Claims Transformation Rules Language](../Topic/Claims-Transformation-Rules-Language.md)  
