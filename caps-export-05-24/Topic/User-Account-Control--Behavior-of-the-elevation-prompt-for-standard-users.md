...
The default in Windows Vista and Windows Server 2008 is **Prompt for credentials**. In [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)] and [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], the default is changed to **Prompt for credentials on the secure desktop**.  
