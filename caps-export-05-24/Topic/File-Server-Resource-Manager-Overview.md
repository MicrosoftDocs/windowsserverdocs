...
This topic describes the File Server Resource Manager features that are included with the File and Storage Services server role.  
  
## <a name="BKMK_OVER"></a>Feature descriptions  
File Server Resource Manager is a set of features that enables you to manage and classify data that is stored on file servers. File Server Resource Manager includes the following features:  
...
-   [Dynamic Access Control Scenario Overview](http://technet.microsoft.com/library/hh831717.aspx)  
