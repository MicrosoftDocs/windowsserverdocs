...
-   [Red Hat Compatible Kernel Series](../Topic/Supported-Oracle-Linux-virtual-machines-on-Hyper-V.md#BKMK_rhc)  
  
-   [Unbreakable Enterprise Kernel Series](../Topic/Supported-Oracle-Linux-virtual-machines-on-Hyper-V.md#BKMK_uek)  
  
-   [Notes](../Topic/Supported-Oracle-Linux-virtual-machines-on-Hyper-V.md#BKMK_notes)  
...
13. On [!INCLUDE[winblue_server_2_md](/Token/winblue_server_2_md.md)] Generation 2 virtual machines have secure boot enabled by default and some Linux virtual machines will not boot unless the secure boot option is disabled. You can disable secure boot in the **Firmware** section of the settings for the virtual machine in **Hyper\-V Manager** or you can disable it using Powershell:  
