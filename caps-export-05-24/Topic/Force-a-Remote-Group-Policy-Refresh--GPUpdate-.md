...
This document describes a method to force a remote Group Policy refresh to all computers in an OU and all OUs that are contained within the selected OU by using the GPMC. An equivalent [!INCLUDE[wps_2](../Token/wps_2_md.md)] method is also presented for each procedure.  
  
**In this document**  
  
-   [Prerequisites](../Topic/Force-a-Remote-Group-Policy-Refresh--GPUpdate-.md#BKMK_Prereqs)  
  
-   [Step 1: Configure Firewall rules on each client that will be managed with remote Group Policy refresh](../Topic/Force-a-Remote-Group-Policy-Refresh--GPUpdate-.md#BKMK_Step1)  
  
-   [Step 2: Schedule a remote Group Policy refresh](../Topic/Force-a-Remote-Group-Policy-Refresh--GPUpdate-.md#BKMK_Step2)  
