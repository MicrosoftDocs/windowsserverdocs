...
[!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] Storage Spaces Direct enhances the resiliency of virtual disks to enable resiliency to node failures. This is in addition to the existing disk and enclosure resiliency.  
...
![](../Image/StorageSpacesFaultTolerance.png)  
...
For more information on Fault Domains, see [Fault Domains in Windows Server 2016 Technical Preview](../Topic/Fault-Domains-in-Windows-Server-2016-Technical-Preview.md)  
