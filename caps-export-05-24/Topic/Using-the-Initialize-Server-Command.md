...
Configures a Windows Deployment Services server for initial use after the server role has been installed. After you run this command, you should use the [Using the add-Image Command](../Topic/Using-the-add-Image-Command.md) command to add images to the server.  
