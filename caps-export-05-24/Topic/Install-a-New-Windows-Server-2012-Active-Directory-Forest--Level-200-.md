...
-   [Active Directory Domain Services Simplified Administration](../Topic/Install-a-New-Windows-Server-2012-Active-Directory-Forest--Level-200-.md#BKMK_SimplifiedAdmin)  
  
-   [Technical Overview](../Topic/Install-a-New-Windows-Server-2012-Active-Directory-Forest--Level-200-.md#BKMK_TechOverview)  
...
-   [Deploying a Forest with Windows PowerShell](../Topic/Install-a-New-Windows-Server-2012-Active-Directory-Forest--Level-200-.md#BKMK_PSForest)  
...
![](../Image/ADDS_SMI_SelectServerRoles.gif)  
...
![](../Image/ADDS_PSAddWindowsFeature.png)  
...
![](../Image/ADDS_PSInstallADDSForest.png)  
...
![](../Image/adds_servermanagerdeployment.png)  
...
![](../Image/ADDS_SMI_TR_AddServers.png)  
...
![](../Image/tADDS_SMI_TR_AddRolesFeatures.png)  
...
![](../Image/ADDS_SMI_TR_AddADDSToAnotherServer.png)  
...
![](../Image/ADDS_SMI_TR_ManageAddRoles.png)  
  
#### Installation Type  
![](../Image/ADDS_SMI_TR_SelectInstallationType.png)  
...
#### Server Selection  
![](../Image/ADDS_SMI_TR_SelectDestinationServer.png)  
...
![](../Image/ADDS_SMI_TR_SelectServerRoles.png)  
...
![](../Image/ADDS_SMI_TR_AddFeaturesDialog.gif)  
  
![](../Image/ADDS_SMI_TR_SelectFeatures.png)  
  
Additional **Features** can be added here as desired.  
  
#### Active Directory Domain Services  
![](../Image/ADDS_SMI_TR_ADDSIntro.png)  
...
#### Confirmation  
![](../Image/ADDS_SMI_TR_Confirmation.png)  
...
![](../Image/ADDS_SMI_TR_TaskNotofications.png)  
  
**AD DS Details**  
  
![](../Image/ADDS_SMI_TR_ADDSDetails.png)  
  
**Task Details**  
  
![](../Image/ADDS_SMI_TR_TaskDetails.png)  
  
#### Promote to Domain Controller  
![](../Image/ADDS_SMI_TR_Promote.png)  
...
Active Directory Domain Services role removal is different from installation, in that it requires domain controller demotion before it can complete. This is necessary to prevent a domain controller from having its role binaries uninstalled without proper metadata cleanup in the forest. For more information, see [Demoting Domain Controllers and Domains &#40;Level 200&#41;](../Topic/Demoting-Domain-Controllers-and-Domains--Level-200-.md).  
...
![](../Image/adds_forestdeploy2.png)  
  
#### Deployment Configuration  
![](../Image/ADDS_SMI_TR_AddNewForest.png)  
...
The **Domain Controller Options** enables you to configure the **forest functional level** and **domain functional level** for the new forest root domain. By default, these settings are [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] in a new forest root domain. The [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] forest functional level does not provide any new functionality over the Windows Server 2008 R2 forest functional level. The [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] domain functional level is required only in order to implement the new Kerberos settings "always provide claims" and "Fail unarmored authentication requests." A primary use for functional levels in [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] is to restrict participation in the domain to domain controllers that meet minimum\-allowed operating system requirements. In other words, you can specify [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] domain functional level only domain controllers that run [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] can host the domain. [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] implements a new domain controller flag called **DS\_WIN8\_REQUIRED** in the **DSGetDcName** function of NetLogon that exclusively locates [!INCLUDE[win8_server_2](../Token/win8_server_2_md.md)] domain controllers. This allows you the flexibility of a more homogeneous or heterogeneous forest in terms of which operating systems are permitted to be run on domain controllers.  
...
![](../Image/ADDS_SMI_TR_ForestDNSOptions.png)  
...
#### Additional Options  
![](../Image/ADDS_SMI_TR_ForestAdditionalOptions.png)  
...
#### Paths  
![](../Image/ADDS_SMI_TR_ForestPaths.png)  
...
#### Prerequisites Check  
![](../Image/ADDS_SMI_TR_ForestPrereqCheck.png)  
...
For more information on the specific prerequisite checks, see [Prerequisite Checking](../Topic/AD-DS-Simplified-Administration.md#BKMK_PrereuisiteChecking).  
  
#### Installation  
![](../Image/ADDS_SMI_TR_ForestInstallation.png)  
...
#### Results  
![](../Image/ADDS_SMI_TR_ForestSignOff.png)  
...
![](../Image/adds_servermanagerdeployment_powershell.png)  
...
![](../Image/ADDS_PSInstallWinFeature.png)  
...
![](../Image/ADDS_PSGetWindowsFeature.png)  
...
![](../Image/ADDS_PSReboot.png)  
  
![](../Image/ADDS_PSInstallProgress.png)  
