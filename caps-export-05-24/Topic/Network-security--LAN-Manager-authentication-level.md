...
In Windows Vista, Windows Server 2008, [!INCLUDE[nextref_client_7](../Token/nextref_client_7_md.md)], and [!INCLUDE[nextref_server_7](../Token/nextref_server_7_md.md)], the default is **Send NTLMv2 response only**.  
