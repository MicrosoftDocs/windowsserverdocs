...
Realm flags are stored in the registry under **HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Lsa\\Kerberos\\Domains\\***RealmName*. This entry does not exist in the registry by default. You can use the [Ksetup:addrealmflags](../Topic/Ksetup-addrealmflags.md) command to populate the registry.  
