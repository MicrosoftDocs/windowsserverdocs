...
-   [Manage server folders using the Dashboard](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_2)  
  
-   [Manage access to server folders](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_1)  
  
-   [Add or move a server folder](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_5)  
  
-   [Add a missing server folder](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_9)  
  
-   [Understand shared folders](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_11)  
  
-   [Understand shadow copies](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Shadow)  
...
|View the folder properties|Displays the properties for a selected folder, and enables you to:<br /><br />-   Change the name of user\-created folders.<br />-   Change the description for a selected folder.<br />-   View the size of the folder.<br />-   Open the selected folder in File Explorer.<br />-   Specify user account access permissions for a selected folder.<br />-   Hide a selected folder from Remote Web Access and Web Service applications.<br />-   Specify folder quota.|  
...
-   [Hide server folders](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Hide)  
  
-   [Set permissions to server folders](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_Perms)  
  
-   [View or modify server folder properties](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_10)  
...
> [!NOTE]  
> In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] and [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../Token/wseblue_experience_md.md)] role installed, you can also modify folder quota.  
...
5.  In **<Foldername> Properties**, on the **General** tab, view or modify the name and description of the server folder.  
    ...
    > [!NOTE]  
    > In [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] and [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../Token/wseblue_experience_md.md)] role installed, you can also modify folder quota that gives a warning message when a server folder reaches its specified size.  
...
-   A member server running [!INCLUDE[wseblue_2](../Token/wseblue_2_md.md)] or [!INCLUDE[winblue_server_2](../Token/winblue_server_2_md.md)] with the [!INCLUDE[wseblue_experience](../Token/wseblue_experience_md.md)] role installed  
...
4.  Follow the instructions to complete the wizard.  
    ...
    > -   You can define which server folders can be accessed via Remote Web Access. For more information, see [Manage access to server folders](../Topic/Manage-Server-Folders-in-Windows-Server-Essentials.md#BKMK_1).  
...
For information about restoring files from server backups, see the section “Learn more about restoring files and folders” in the topic [Manage Backup and Restore in Windows Server Essentials](../Topic/Manage-Backup-and-Restore-in-Windows-Server-Essentials.md).  
  
## <a name="BKMK_11"></a>Understand shared folders  
There are several different ways that you can access your shared folders on Windows Server Essentials from a device that is connected to the server. For more information, see the topic [Use Shared Folders in Windows Server Essentials](../Topic/Use-Shared-Folders-in-Windows-Server-Essentials.md).  
...
-   [Manage Server Storage in Windows Server Essentials](../Topic/Manage-Server-Storage-in-Windows-Server-Essentials.md)  
