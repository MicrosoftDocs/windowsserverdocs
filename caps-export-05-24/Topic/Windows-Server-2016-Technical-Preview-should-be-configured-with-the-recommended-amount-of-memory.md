...
## **Issue**  
*A virtual machine running [!INCLUDE[winthreshold_server_2](../Token/winthreshold_server_2_md.md)] is configured with less than the recommended amount of RAM, which is 1 GB.*  
