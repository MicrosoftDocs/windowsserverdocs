...
-   A copy of the [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] ISO  
  
-   A copy of the [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)] ISO  
...
Build a virtual machine to be used as the domain controller (DC1). Install the virtual machine using [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] ISO, and name it DC1.  
...
1.  Build a virtual machine with the name FILE1 from the [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] ISO.  
...
You should install the Microsoft Office Filter Packs on [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] to enable IFilters for a wider array of Office files than are provided by default. [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] does not have any IFilters for Microsoft Office Files installed by default, and the file classification infrastructure uses IFilters to perform content analysis.  
...
-   Build a virtual machine from the [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] ISO.  
