---
title: Configure Dynamic IP Addresses (DIPs) for Software Load Balancing for Virtual Networks or VLANs
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.topic: article
ms.assetid: 537f8135-1e63-4907-8dfa-b35d76989feb
---
# Configure Dynamic IP Addresses (DIPs) for Software Load Balancing for Virtual Networks or VLANs
