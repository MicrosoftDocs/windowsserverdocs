...
For more information, see [Cluster Operating System Rolling Upgrade ]() and [Upgrading Windows Server 2012 R2 clusters to Windows Server 2016 Technical Preview in VMM](https://technet.microsoft.com/library/mt445417.aspx).  
