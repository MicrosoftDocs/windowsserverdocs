...
If your Hyper\-V host runs [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)] or [!INCLUDE[winblue_client_2](includes/winblue_client_2_md.md)], you might not have to go through the following steps to turn on enhanced session mode. It's turn on by default. But if your host runs [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] or [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], you must turn on enhanced session mode to use it. It is turned off by default for those operating systems.  
...
-   The computer that you use to connect to the virtual machine with VMConnect must run [!INCLUDE[win8_client_2](includes/win8_client_2_md.md)], [!INCLUDE[winblue_client_2](includes/winblue_client_2_md.md)], [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)], or [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)].  
  
-   The virtual machine must have Remote Desktop Services enabled and run [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)] or [!INCLUDE[winblue_client_2](includes/winblue_client_2_md.md)] as the guest operating system.  
