...
6.  If you are using Dynamic Memory on [!INCLUDE[winthreshold_server_2_mdincludes/winthreshold_server_2_md.md)] or [!INCLUDE[win8_server_2](includes/win8_server_2_md.md)] operating systems, specify **Startup memory**, **Minimum memory**, and **Maximum memory** parameters in multiples of 128 megabytes \(MB\). Failure to do so can lead to Hot\-Add failures, and you may not see any memory increase in a guest operating system.  
  
7.  In [!INCLUDE[winthreshold_server_2_mdincludes/winthreshold_server_2_md.md)] or [!INCLUDE[winblue_server_2](includes/winblue_server_2_md.md)], the key\/value pair infrastructure might not function correctly without a Linux software update. Contact your distribution vendor to obtain the software update in case you see problems with this feature.  
